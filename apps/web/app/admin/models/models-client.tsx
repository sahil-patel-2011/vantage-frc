...
export default function ModelsClient() {
  ...
  return <main className="intel-app"><header className="intel-header"><div><span className="eyebrow">VANTAGE / ROUTER</span><h1>Provider vault + router</h1><p className="app-muted">Encrypt platform keys, route models, then test the result in the AI hub. Keys never appear in Partners CRM.</p></div><nav className="admin-related" aria-label="AI entry points" style={{display:"flex",flexWrap:"wrap",gap:8}}><a href="/admin">Teams</a><a href="/admin/partners">Partners</a><a href="/admin/sponsored">Sponsored AI</a><Button as="a" variant="primary" href="/ai">AI hub</Button><a href="/ai?tab=chat">Test chat</a></nav></header>
