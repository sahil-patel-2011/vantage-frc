    ...
    return Response.json(
      {
        ...
        message: "Could not load Auton paths. Choose your team and confirm database access.",
        steps: [
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Auton paths request failed";
