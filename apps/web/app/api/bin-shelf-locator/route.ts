    ...
    return Response.json(
      {
        ...
        message: "Could not load Bin locator. Choose your team and confirm database access.",
        steps: [
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Bin locator request failed";
