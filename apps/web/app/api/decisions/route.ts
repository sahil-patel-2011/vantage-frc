    ...
    return Response.json(
      {
        ...
        message: "Could not load the decision log. Choose your team and confirm database access.",
        steps: [
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = publicErrorMessage(error, "Decision log request failed");
