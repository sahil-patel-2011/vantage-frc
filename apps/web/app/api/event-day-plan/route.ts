    ...
    return Response.json(
      {
        ...
        message: "Could not load the event-day plan. Select a workspace and confirm database access.",
        steps: [
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Event-day plan request failed";
