...
// which also has an `id`, so unqualified columns raised
// `column reference "id" is ambiguous` and every debrief read 400'd.
      ...
      if (!row) {
        return {
          ...
          message: requestedOrg
            ? "Choose your team to log your matches."
            : "Choose your team to log your matches, or join the waitlist.",
        };
      }
