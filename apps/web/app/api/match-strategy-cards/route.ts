    ...
    return Response.json(
      {
        ...
        message: "Could not load Match Strategy Cards. Select a workspace and confirm database access.",
        steps: [
          { id: "workspace", label: "Select workspace", detail: "Choose your team organization", href: "/workspace", done: false },
        ],
        orgId: null,
        eventKey: null,
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Match Strategy Cards request failed";
