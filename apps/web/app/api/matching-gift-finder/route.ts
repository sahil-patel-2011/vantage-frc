    ...
    return Response.json(
      {
        ...
        message: "Could not load Matching gifts. Choose your team and confirm database access.",
        steps: [
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Matching gifts request failed";
