    ...
    return Response.json(
      {
        ...
        message: "Could not load Safety Training. Choose your team and confirm database access.",
        steps: [
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = publicErrorMessage(error, "Safety Training request failed");
