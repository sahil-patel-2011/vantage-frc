    ...
    <details className="app-card cad-adaptive-panel">
      ...
      <div className="cad-adaptive-grid">
        ...
        >
          ...
          <Button type="submit" variant="primary" disabled={busy}>Save my private preferences</Button>
        </form>
        ...
        >
          ...
          {value.canManageTeamProfile ? <Button type="submit" variant="primary" disabled={busy}>Save team standards</Button> : <small className="app-muted">Owner or admin manages shared standards.</small>}
        </form>
      </div>
    </details>
  );
