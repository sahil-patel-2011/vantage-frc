...
import { CODE_RULE_LESSONS, type Narration } from "../../lib/agent-narration/narration";
...
import { bugbotScanMetaLine, type BugbotScanTarget } from "../../lib/bugbot";
import { BUGBOT_INSTRUCTION_MAX } from "../../lib/cockpit/prefs";
import type { CockpitPrefs } from "../../lib/cockpit/prefs";
import { CODE_COACH_SAMPLE, type CodeCoachNextAction, type CodeCoachRelatedLink } from "../../lib/code/code-related";
import {
  type BugbotFinding,
