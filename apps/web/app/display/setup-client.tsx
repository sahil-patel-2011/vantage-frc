  ...
  return (
    <main className="module-page display-setup">
      <PageHeader
        ...
        title="Pit TV boards"
        description="Pick a preset, save a board, then pair a TV or Raspberry Pi with a read-only token. Empty boards stay empty until Team Data, Strategy, and Pit ops sync."
      />
        ...
        <div className="disp-stack">
          ...
          {!loading && !activeEventKey ? (
            <EmptyState
              ...
              description="Set an Event Day event so next-match and coverage can read the posted schedule. Boards stay blank until then."
            >
...
function NextActionsPanel({
  ...
  return (
    <Panel className="disp-next-actions">
      <header>
        <h2>Next actions</h2>
        <p>Real Event Day and Strategy paths only — boards stay blank until Team Data and scored data exist.</p>
      </header>
      <ol>
        {actions.map((action) => (
