...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <html lang="en" data-theme="light" suppressHydrationWarning><head><script dangerouslySetInnerHTML={{ __html: themeBootstrap }} /></head><body><PwaRegister /><ThemeProvider>{children}</ThemeProvider>{domain && (
    <Script
      defer
      data-domain={domain}
