  ...
  if (view.alerts.length === 0) {
    return (
      <EmptyState
        ...
        description="Alerts appear here once a watched team's stored rating moves or their next match is scheduled or rescheduled."
      />
    );
  }
  return (
  ...
  return (
    ...
    >
      ...
      <p className="app-muted" style={{ margin: 0 }}>
        Alerts use stored ratings and scheduled matches for the teams you watch.
      </p>
      <FormGrid min={160}>
