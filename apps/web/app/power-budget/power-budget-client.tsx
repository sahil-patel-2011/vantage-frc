      ...
      return (
        <main className="module-page power-budget-page">
          <PageHeader
            ...
            description={
              offerWaitlist
                ...
                : "Typical and peak amps you logged for each branch."
            }
          >
            <PowerBudgetRelated orgId={orgId} />
          </PageHeader>
          ...
          <EmptyState
            ...
            className={offerWaitlist ? "power-budget-setup" : undefined}
          >
            {offerWaitlist ? (
              <div className="power-budget-setup-actions">
                <Button as="a" variant="primary" href="/workspace">
                  Choose your team
                </Button>
                <a className="power-budget-setup-waitlist" href="/#waitlist">
                  Join the waitlist
                </a>
              </div>
            ) : (
