...
const individualPlans: PlanCard[] = [
  ...
  },
  {
    ...
    name: "Individual Pro",
    price: "$49",
    signal: "PRIVATE · $40 API INCLUDED",
    featured: true,
    flag: "Popular starting point",
    features: [
      "$40 included managed API allowance per month, then hard cut-off",
  ...
  },
  {
    ...
    name: "Individual Max",
    price: "$79",
    signal: "PRIVATE · $68 API · ~2× PRO LIMITS",
    features: [
      "$68 included managed API allowance per month, then hard cut-off",
...
const teamPlans: PlanCard[] = [
  {
    ...
    name: "Team Pro",
    price: "$149",
    signal: "ORG · $130 API POOLED",
    featured: true,
    flag: "Most teams start here",
    features: [
      "$130 pooled managed API allowance per month, then hard cut-off",
  ...
  },
  {
    ...
    name: "Team Max",
    price: "$299",
    signal: "ORG · $260 API · ~2× PRO LIMITS",
    features: [
      "$260 pooled managed API allowance per month, then hard cut-off",
...
const creditPackOptions = [
  { value: "team_max", label: "$299/mo subscription ($260 included API)" },
...
const alternatePaths: PlanCard[] = [
  {
    ...
    features: [
      ...
      "Best when you want managed routing without a $149–$299 commit",
    ],
  },
  {
    code: "access",
    ...
    features: [
      "$35/mo unlocks Vantage managed routing, tools, and context at API list rates",
  ...
  return (
    <>
      ...
      <section id="alternates" className="pricing-alternates">
        ...
        <p>
          Prefer no $149–$299 subscription? Use pure PAYG, or Access ($35/mo) plus Usage Credits / PAYG for managed
