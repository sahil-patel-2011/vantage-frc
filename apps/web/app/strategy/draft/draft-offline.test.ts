...
describe("Alliance board last snapshot stays on the phone", () => {
  it("reads and writes the draft IndexedDB feature cache", () => {
    const src = readFileSync(join(DIR, "draft-client.tsx"), "utf8");
