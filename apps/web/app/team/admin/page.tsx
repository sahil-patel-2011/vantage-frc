...
export const metadata = {
  ...
  description: "Membership, invites, GitHub, and provider settings.",
};
    ...
    return (
      <main className="module-page">
        ...
        <EmptyState
          ...
          description="Open a team workspace to manage membership and integrations."
          badge="Setup"
          badgeTone="setup"
        >
          <a className="app-button" href="/workspace">Select workspace</a>
        </EmptyState>
      </main>
    );
  }
