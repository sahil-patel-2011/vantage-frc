...
export default function TuningClient({ orgId }: { orgId: string | null }) {
  ...
  switch (view.status) {
    case "setup_required": {
      ...
      return (
        <main className="module-page tuning-page">
          <PageHeader
            breadcrumbs={
              <>
                <a href={robotHref}>Build</a>
            ...
            description={
              offerWaitlist
                ...
                : "Offsets, gains, and zeros that a reflash should not wipe."
            }
          >
            <TuningRelated orgId={orgId} />
          </PageHeader>
          ...
          <EmptyState
            ...
            className={offerWaitlist ? "tuning-setup" : undefined}
          >
            {offerWaitlist ? (
              <div className="tuning-setup-actions">
                <Button as="a" variant="primary" href="/workspace">
                  Choose your team
                </Button>
                <a className="tuning-setup-waitlist" href="/#waitlist">
                  Join the waitlist
                </a>
              </div>
            ) : (
