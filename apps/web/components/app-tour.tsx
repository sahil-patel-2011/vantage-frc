 ...
 * box on top of "Step 1 of 3 · You" is two teachers talking at once, and a
 * full-screen scrim there swallows the first tap; the tour waits until the
 * person reaches the app proper.
 */
