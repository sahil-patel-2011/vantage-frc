      ...
      offers: [
        {
          ...
          price: "0",
          priceCurrency: "USD",
          description: "Complete Soft-UI competition core with bring-your-own-key or local AI.",
        },
        {
          "@type": "Offer",
          name: "Access",
          ...
          priceCurrency: "USD",
          description: "Light plan unlocking managed Soft-UI routing; hosted AI cheaper than typical BYOK.",
        },
        {
          "@type": "Offer",
          name: "Individual Pro",
          ...
          priceCurrency: "USD",
          description: "Private Soft-UI workspace with hosted AI included and native scouting, strategy, and CAD tools.",
        },
        {
          "@type": "Offer",
          name: "Individual Max",
          price: String(c.individual_max.monthlyUsd),
          priceCurrency: "USD",
          description: "Private Soft-UI workspace with higher hosted capacity, priority features, and ~2× Pro limits.",
        },
        {
          "@type": "Offer",
          name: "Team Pro",
          price: String(c.team_pro.monthlyUsd),
          priceCurrency: "USD",
          description: "Organization Soft-UI + ops with hosted models and native Event Day / Pit workflows.",
        },
        {
          "@type": "Offer",
          name: "Team Max",
          price: String(c.team_max.monthlyUsd),
          priceCurrency: "USD",
          description: "Organization Soft-UI + ops with the highest hosted capacity and advanced CAD, strategy, and admin.",
        },
      ],
    },
  ],
