  ...
  "@graph": [
    ...
    },
    {
      ...
      offers: [
        ...
        { "@type": "Offer", name: "Access", price: "25", priceCurrency: "USD", description: "Light plan unlocking managed routing at provider list rates; use Usage Credits or PAYG." },
        { "@type": "Offer", name: "Individual Pro", price: "35", priceCurrency: "USD", description: "Private workspace with $30 included managed API allowance at list rates." },
        { "@type": "Offer", name: "Individual Max", price: "60", priceCurrency: "USD", description: "Private workspace with $52 included API and ~2× Pro rate limits." },
        { "@type": "Offer", name: "Team Pro", price: "120", priceCurrency: "USD", description: "Organization plan with $105 pooled managed API allowance." },
        { "@type": "Offer", name: "Team Max", price: "240", priceCurrency: "USD", description: "Organization plan with $220 pooled API and ~2× Team Pro rate limits." },
      ],
    },
  ],
};
