  ...
  "@graph": [
    ...
    },
    {
      ...
      offers: [
        ...
        { "@type": "Offer", name: "Access", price: "35", priceCurrency: "USD", description: "Light plan unlocking managed routing at provider list rates; use Usage Credits or PAYG." },
        { "@type": "Offer", name: "Individual Pro", price: "49", priceCurrency: "USD", description: "Private workspace with $40 included managed API allowance at list rates." },
        { "@type": "Offer", name: "Individual Max", price: "79", priceCurrency: "USD", description: "Private workspace with $68 included API and ~2× Pro rate limits." },
        { "@type": "Offer", name: "Team Pro", price: "149", priceCurrency: "USD", description: "Organization plan with $130 pooled managed API allowance." },
        { "@type": "Offer", name: "Team Max", price: "299", priceCurrency: "USD", description: "Organization plan with $260 pooled API and ~2× Team Pro rate limits." },
      ],
    },
  ],
};
