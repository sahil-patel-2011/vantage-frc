      ...
      offers: [
        {
          ...
          price: "0",
          priceCurrency: "USD",
          description: "Complete non-AI Soft-UI competition core with BYOK or local AI; $0 managed API allowance.",
        },
        {
          "@type": "Offer",
          name: "Access",
        ...
        },
        {
          ...
          priceCurrency: "USD",
          description: `Private Soft-UI workspace with $${c.individual_max.includedAllowanceUsd} included API and ~2× Pro rate limits.`,
        },
        {
          "@type": "Offer",
          name: "Team Pro",
          ...
          priceCurrency: "USD",
          description: `Organization Soft-UI + ops plan with $${c.team_pro.includedAllowanceUsd} pooled managed API allowance.`,
        },
        {
          "@type": "Offer",
          name: "Team Max",
          ...
          priceCurrency: "USD",
          description: `Organization Soft-UI + ops plan with $${c.team_max.includedAllowanceUsd} pooled API and ~2× Team Pro rate limits.`,
        },
      ],
    },
  ],
