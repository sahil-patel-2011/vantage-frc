...
/** Product-nav glyphs plus the few the shell chrome needs on its own. */
export type IconName = ProductNavIcon | "panel" | "plus" | "check" | "clock" | "logout" | "sparkle";
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  sparkle: <path d="M12 3v4m0 10v4M3 12h4m10 0h4M6.5 6.5l2.5 2.5m6 6 2.5 2.5m0-11-2.5 2.5m-6 6L6.5 17.5" />,
};

export function Icon({ name, size = 18 }: { name: IconName; size?: number }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" width={size} height={size} {...STROKE}>
      {PATHS[name]}
    </svg>
  );
}
