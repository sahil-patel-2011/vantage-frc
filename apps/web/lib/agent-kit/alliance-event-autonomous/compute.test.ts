...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 12.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 34.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 44.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 44.0 } },
];

describe("alliance-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-event-autonomous");
...
describe("alliance-event-autonomous-deep", () => {
...
describe("alliance-event-autonomous-wide", () => {
...
describe("alliance-event-autonomous-lovat", () => {
