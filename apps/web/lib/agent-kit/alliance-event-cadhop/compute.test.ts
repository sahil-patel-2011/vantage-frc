...
describe("alliance-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-event-cadhop");
...
describe("alliance-event-cadhop-deep", () => {
...
describe("alliance-event-cadhop-wide", () => {
...
describe("alliance-event-cadhop-lovat", () => {
