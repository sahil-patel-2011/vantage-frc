...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 10.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 32.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 42.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 42.0 } },
];

describe("alliance-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-event-excerpts");
...
describe("alliance-event-excerpts-deep", () => {
...
describe("alliance-event-excerpts-wide", () => {
...
describe("alliance-event-excerpts-lovat", () => {
