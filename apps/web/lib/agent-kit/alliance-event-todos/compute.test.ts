...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { totalPoints: 41.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 25.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 22.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 41.0 } },
];

describe("alliance-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-event-todos");
...
describe("alliance-event-todos-deep", () => {
...
describe("alliance-event-todos-wide", () => {
...
describe("alliance-event-todos-lovat", () => {
