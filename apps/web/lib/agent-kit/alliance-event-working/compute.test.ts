...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 11.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 33.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 43.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 43.0 } },
];

describe("alliance-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-event-working");
...
describe("alliance-event-working-deep", () => {
...
describe("alliance-event-working-wide", () => {
...
describe("alliance-event-working-lovat", () => {
