...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 15.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 22.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 47.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 22.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 47.0 } },
];

describe("alliance-last12-autonomous", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "totalPoints")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last12-autonomous");
...
describe("alliance-last12-autonomous-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { totalPoints: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { totalPoints: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { totalPoints: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { totalPoints: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { totalPoints: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { totalPoints: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "totalPoints")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("alliance-last12-autonomous-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statTotalPoints(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesTotalPoints(rows, "frc9").length).toBe(0);
...
describe("alliance-last12-autonomous-lovat", () => {
