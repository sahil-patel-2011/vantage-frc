...
describe("alliance-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last12-cadhop");
...
describe("alliance-last12-cadhop-deep", () => {
...
describe("alliance-last12-cadhop-wide", () => {
...
describe("alliance-last12-cadhop-lovat", () => {
