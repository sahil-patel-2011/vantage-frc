...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 25.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 32.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 45.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 25.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 45.0 } },
];

describe("alliance-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last12-excerpts");
...
describe("alliance-last12-excerpts-deep", () => {
...
describe("alliance-last12-excerpts-wide", () => {
...
describe("alliance-last12-excerpts-lovat", () => {
