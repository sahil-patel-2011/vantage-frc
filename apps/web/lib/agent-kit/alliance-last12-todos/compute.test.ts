...
describe("alliance-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last12-todos");
...
describe("alliance-last12-todos-deep", () => {
...
describe("alliance-last12-todos-wide", () => {
...
describe("alliance-last12-todos-lovat", () => {
