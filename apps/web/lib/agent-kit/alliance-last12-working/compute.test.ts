...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 22.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 24.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 46.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 46.0 } },
];

describe("alliance-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last12-working");
...
describe("alliance-last12-working-deep", () => {
...
describe("alliance-last12-working-wide", () => {
...
describe("alliance-last12-working-lovat", () => {
