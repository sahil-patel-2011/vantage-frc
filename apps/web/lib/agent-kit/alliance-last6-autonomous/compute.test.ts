...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 18.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 20.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 42.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 18.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 20.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 42.0 } },
];

describe("alliance-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last6-autonomous");
...
describe("alliance-last6-autonomous-deep", () => {
...
describe("alliance-last6-autonomous-wide", () => {
...
describe("alliance-last6-autonomous-lovat", () => {
