...
describe("alliance-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last6-cadhop");
...
describe("alliance-last6-cadhop-deep", () => {
...
describe("alliance-last6-cadhop-wide", () => {
...
describe("alliance-last6-cadhop-lovat", () => {
