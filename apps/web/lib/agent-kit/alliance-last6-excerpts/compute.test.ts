...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 16.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 33.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 40.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 16.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 40.0 } },
];

describe("alliance-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last6-excerpts");
...
describe("alliance-last6-excerpts-deep", () => {
...
describe("alliance-last6-excerpts-wide", () => {
...
describe("alliance-last6-excerpts-lovat", () => {
