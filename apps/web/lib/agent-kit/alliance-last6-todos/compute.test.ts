...
describe("alliance-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last6-todos");
...
describe("alliance-last6-todos-deep", () => {
...
describe("alliance-last6-todos-wide", () => {
...
describe("alliance-last6-todos-lovat", () => {
