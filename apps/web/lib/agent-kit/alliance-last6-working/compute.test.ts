...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 13.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 25.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 41.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 13.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 41.0 } },
];

describe("alliance-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-last6-working");
...
describe("alliance-last6-working-deep", () => {
...
describe("alliance-last6-working-wide", () => {
...
describe("alliance-last6-working-lovat", () => {
