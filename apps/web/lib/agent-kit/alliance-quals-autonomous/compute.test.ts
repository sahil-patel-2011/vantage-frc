...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 20.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 22.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 44.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 20.0 } },
...
describe("alliance-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-quals-autonomous");
...
describe("alliance-quals-autonomous-deep", () => {
...
describe("alliance-quals-autonomous-wide", () => {
...
describe("alliance-quals-autonomous-lovat", () => {
