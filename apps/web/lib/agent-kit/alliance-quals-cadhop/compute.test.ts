...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 27.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 29.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 39.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 39.0 } },
];

describe("alliance-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-quals-cadhop");
...
describe("alliance-quals-cadhop-deep", () => {
...
describe("alliance-quals-cadhop-wide", () => {
...
describe("alliance-quals-cadhop-lovat", () => {
