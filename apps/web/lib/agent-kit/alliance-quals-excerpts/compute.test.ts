...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 26.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 33.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 46.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 46.0 } },
];

describe("alliance-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-quals-excerpts");
...
describe("alliance-quals-excerpts-deep", () => {
...
describe("alliance-quals-excerpts-wide", () => {
...
describe("alliance-quals-excerpts-lovat", () => {
