...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 21.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 28.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 41.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 41.0 } },
];

describe("alliance-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-quals-todos");
...
describe("alliance-quals-todos-deep", () => {
...
describe("alliance-quals-todos-wide", () => {
...
describe("alliance-quals-todos-lovat", () => {
