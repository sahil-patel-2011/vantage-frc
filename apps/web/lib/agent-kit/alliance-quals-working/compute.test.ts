...
const rows = [
  { teamKey: "frc1", qual: true, values: { totalPoints: 19.0 } },
  { teamKey: "frc2", qual: true, values: { totalPoints: 21.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 43.0 } },
  { teamKey: "frc3", qual: true, values: { totalPoints: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { totalPoints: 19.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { totalPoints: 21.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { totalPoints: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { totalPoints: 43.0 } },
];

describe("alliance-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("alliance-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("alliance-quals-working");
...
describe("alliance-quals-working-deep", () => {
...
describe("alliance-quals-working-wide", () => {
...
describe("alliance-quals-working-lovat", () => {
