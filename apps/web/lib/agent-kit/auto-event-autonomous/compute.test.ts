...
describe("auto-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-autonomous");
...
describe("auto-event-autonomous-deep", () => {
...
describe("auto-event-autonomous-wide", () => {
...
describe("auto-event-autonomous-lovat", () => {
