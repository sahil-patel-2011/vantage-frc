...
describe("auto-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-cadhop");
...
describe("auto-event-cadhop-deep", () => {
...
describe("auto-event-cadhop-wide", () => {
...
describe("auto-event-cadhop-lovat", () => {
