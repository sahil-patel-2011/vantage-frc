...
describe("auto-event-distill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-distill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-distill");
...
describe("auto-event-distill-deep", () => {
...
describe("auto-event-distill-wide", () => {
...
describe("auto-event-distill-lovat", () => {
