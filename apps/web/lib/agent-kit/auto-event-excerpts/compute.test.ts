...
describe("auto-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-excerpts");
...
describe("auto-event-excerpts-deep", () => {
...
describe("auto-event-excerpts-wide", () => {
...
describe("auto-event-excerpts-lovat", () => {
