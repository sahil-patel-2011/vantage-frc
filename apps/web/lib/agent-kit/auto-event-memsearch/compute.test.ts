...
describe("auto-event-memsearch", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-memsearch");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-memsearch");
...
describe("auto-event-memsearch-deep", () => {
...
describe("auto-event-memsearch-wide", () => {
...
describe("auto-event-memsearch-lovat", () => {
