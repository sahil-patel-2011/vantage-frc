...
describe("auto-event-recall", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-recall");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-recall");
...
describe("auto-event-recall-deep", () => {
...
describe("auto-event-recall-wide", () => {
...
describe("auto-event-recall-lovat", () => {
