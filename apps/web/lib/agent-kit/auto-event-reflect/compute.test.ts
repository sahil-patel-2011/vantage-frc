...
describe("auto-event-reflect", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-reflect");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-reflect");
...
describe("auto-event-reflect-deep", () => {
...
describe("auto-event-reflect-wide", () => {
...
describe("auto-event-reflect-lovat", () => {
