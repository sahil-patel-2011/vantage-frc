...
describe("auto-event-retrieve", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-retrieve");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-retrieve");
...
describe("auto-event-retrieve-deep", () => {
...
describe("auto-event-retrieve-wide", () => {
...
describe("auto-event-retrieve-lovat", () => {
