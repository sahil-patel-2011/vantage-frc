...
describe("auto-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-todos");
...
describe("auto-event-todos-deep", () => {
...
describe("auto-event-todos-wide", () => {
...
describe("auto-event-todos-lovat", () => {
