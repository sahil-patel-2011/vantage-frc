...
describe("auto-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-working");
...
describe("auto-event-working-deep", () => {
...
describe("auto-event-working-wide", () => {
...
describe("auto-event-working-lovat", () => {
