...
describe("auto-last12-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-autonomous");
...
describe("auto-last12-autonomous-deep", () => {
...
describe("auto-last12-autonomous-wide", () => {
...
describe("auto-last12-autonomous-lovat", () => {
