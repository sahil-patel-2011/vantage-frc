...
describe("auto-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-cadhop");
...
describe("auto-last12-cadhop-deep", () => {
...
describe("auto-last12-cadhop-wide", () => {
...
describe("auto-last12-cadhop-lovat", () => {
