...
describe("auto-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-excerpts");
...
describe("auto-last12-excerpts-deep", () => {
...
describe("auto-last12-excerpts-wide", () => {
...
describe("auto-last12-excerpts-lovat", () => {
