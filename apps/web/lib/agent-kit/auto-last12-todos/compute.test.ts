...
describe("auto-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-todos");
...
describe("auto-last12-todos-deep", () => {
...
describe("auto-last12-todos-wide", () => {
...
describe("auto-last12-todos-lovat", () => {
