...
describe("auto-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-working");
...
describe("auto-last12-working-deep", () => {
...
describe("auto-last12-working-wide", () => {
...
describe("auto-last12-working-lovat", () => {
