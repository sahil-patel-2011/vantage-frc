...
describe("auto-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-autonomous");
...
describe("auto-last6-autonomous-deep", () => {
...
describe("auto-last6-autonomous-wide", () => {
...
describe("auto-last6-autonomous-lovat", () => {
