...
describe("auto-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-cadhop");
...
describe("auto-last6-cadhop-deep", () => {
...
describe("auto-last6-cadhop-wide", () => {
...
describe("auto-last6-cadhop-lovat", () => {
