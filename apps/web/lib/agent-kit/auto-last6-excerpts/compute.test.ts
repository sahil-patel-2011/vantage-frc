...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 26.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 23.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 42.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 26.0 } },
...
describe("auto-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-excerpts");
...
describe("auto-last6-excerpts-deep", () => {
...
describe("auto-last6-excerpts-wide", () => {
...
describe("auto-last6-excerpts-lovat", () => {
