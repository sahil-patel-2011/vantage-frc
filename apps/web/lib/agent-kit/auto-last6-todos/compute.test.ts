...
describe("auto-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-todos");
...
describe("auto-last6-todos-deep", () => {
...
describe("auto-last6-todos-wide", () => {
...
describe("auto-last6-todos-lovat", () => {
