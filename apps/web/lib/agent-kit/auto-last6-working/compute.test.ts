...
describe("auto-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-working");
...
describe("auto-last6-working-deep", () => {
...
describe("auto-last6-working-wide", () => {
...
describe("auto-last6-working-lovat", () => {
