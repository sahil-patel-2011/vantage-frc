...
describe("auto-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-autonomous");
...
describe("auto-quals-autonomous-deep", () => {
...
describe("auto-quals-autonomous-wide", () => {
...
describe("auto-quals-autonomous-lovat", () => {
