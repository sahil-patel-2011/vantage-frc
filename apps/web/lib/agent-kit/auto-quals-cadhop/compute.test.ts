...
describe("auto-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-cadhop");
...
describe("auto-quals-cadhop-deep", () => {
...
describe("auto-quals-cadhop-wide", () => {
...
describe("auto-quals-cadhop-lovat", () => {
