...
describe("auto-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-excerpts");
...
describe("auto-quals-excerpts-deep", () => {
...
describe("auto-quals-excerpts-wide", () => {
...
describe("auto-quals-excerpts-lovat", () => {
