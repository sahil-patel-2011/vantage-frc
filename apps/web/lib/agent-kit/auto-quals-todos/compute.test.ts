...
describe("auto-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-todos");
...
describe("auto-quals-todos-deep", () => {
...
describe("auto-quals-todos-wide", () => {
...
describe("auto-quals-todos-lovat", () => {
