...
describe("auto-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-working");
...
describe("auto-quals-working-deep", () => {
...
describe("auto-quals-working-wide", () => {
...
describe("auto-quals-working-lovat", () => {
