...
describe("defense-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-autonomous");
...
describe("defense-event-autonomous-deep", () => {
...
describe("defense-event-autonomous-wide", () => {
...
describe("defense-event-autonomous-lovat", () => {
