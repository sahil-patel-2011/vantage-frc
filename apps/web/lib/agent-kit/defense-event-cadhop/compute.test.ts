...
describe("defense-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-cadhop");
...
describe("defense-event-cadhop-deep", () => {
...
describe("defense-event-cadhop-wide", () => {
...
describe("defense-event-cadhop-lovat", () => {
