...
describe("defense-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-excerpts");
...
describe("defense-event-excerpts-deep", () => {
...
describe("defense-event-excerpts-wide", () => {
...
describe("defense-event-excerpts-lovat", () => {
