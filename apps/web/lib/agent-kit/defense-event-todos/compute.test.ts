...
describe("defense-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-todos");
...
describe("defense-event-todos-deep", () => {
...
describe("defense-event-todos-wide", () => {
...
describe("defense-event-todos-lovat", () => {
