...
describe("defense-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-working");
...
describe("defense-event-working-deep", () => {
...
describe("defense-event-working-wide", () => {
...
describe("defense-event-working-lovat", () => {
