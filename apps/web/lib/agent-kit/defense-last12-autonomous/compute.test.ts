...
describe("defense-last12-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-autonomous");
...
describe("defense-last12-autonomous-deep", () => {
...
describe("defense-last12-autonomous-wide", () => {
...
describe("defense-last12-autonomous-lovat", () => {
