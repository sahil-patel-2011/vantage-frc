...
describe("defense-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-cadhop");
...
describe("defense-last12-cadhop-deep", () => {
...
describe("defense-last12-cadhop-wide", () => {
...
describe("defense-last12-cadhop-lovat", () => {
