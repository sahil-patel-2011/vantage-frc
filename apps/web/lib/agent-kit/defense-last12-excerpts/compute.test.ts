...
describe("defense-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-excerpts");
...
describe("defense-last12-excerpts-deep", () => {
...
describe("defense-last12-excerpts-wide", () => {
...
describe("defense-last12-excerpts-lovat", () => {
