...
describe("defense-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-todos");
...
describe("defense-last12-todos-deep", () => {
...
describe("defense-last12-todos-wide", () => {
...
describe("defense-last12-todos-lovat", () => {
