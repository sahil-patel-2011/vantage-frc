...
describe("defense-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-working");
...
describe("defense-last12-working-deep", () => {
...
describe("defense-last12-working-wide", () => {
...
describe("defense-last12-working-lovat", () => {
