...
describe("defense-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-autonomous");
...
describe("defense-last6-autonomous-deep", () => {
...
describe("defense-last6-autonomous-wide", () => {
...
describe("defense-last6-autonomous-lovat", () => {
