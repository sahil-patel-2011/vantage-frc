...
describe("defense-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-cadhop");
...
describe("defense-last6-cadhop-deep", () => {
...
describe("defense-last6-cadhop-wide", () => {
...
describe("defense-last6-cadhop-lovat", () => {
