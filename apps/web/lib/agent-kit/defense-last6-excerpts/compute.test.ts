...
describe("defense-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-excerpts");
...
describe("defense-last6-excerpts-deep", () => {
...
describe("defense-last6-excerpts-wide", () => {
...
describe("defense-last6-excerpts-lovat", () => {
