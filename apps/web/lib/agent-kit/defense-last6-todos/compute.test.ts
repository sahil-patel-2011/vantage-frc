...
describe("defense-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-todos");
...
describe("defense-last6-todos-deep", () => {
...
describe("defense-last6-todos-wide", () => {
...
describe("defense-last6-todos-lovat", () => {
