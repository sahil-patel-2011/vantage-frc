...
describe("defense-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-autonomous");
...
describe("defense-quals-autonomous-deep", () => {
...
describe("defense-quals-autonomous-wide", () => {
...
describe("defense-quals-autonomous-lovat", () => {
