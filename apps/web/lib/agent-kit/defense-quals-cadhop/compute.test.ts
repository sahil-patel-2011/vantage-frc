...
describe("defense-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-cadhop");
...
describe("defense-quals-cadhop-deep", () => {
...
describe("defense-quals-cadhop-wide", () => {
...
describe("defense-quals-cadhop-lovat", () => {
