...
describe("defense-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-excerpts");
...
describe("defense-quals-excerpts-deep", () => {
...
describe("defense-quals-excerpts-wide", () => {
...
describe("defense-quals-excerpts-lovat", () => {
