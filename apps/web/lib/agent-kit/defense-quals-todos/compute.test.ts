...
describe("defense-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-todos");
...
describe("defense-quals-todos-deep", () => {
...
describe("defense-quals-todos-wide", () => {
...
describe("defense-quals-todos-lovat", () => {
