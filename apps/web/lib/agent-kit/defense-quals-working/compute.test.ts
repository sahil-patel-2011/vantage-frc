...
describe("defense-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-working");
...
describe("defense-quals-working-deep", () => {
...
describe("defense-quals-working-wide", () => {
...
describe("defense-quals-working-lovat", () => {
