...
describe("driver-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-autonomous");
...
describe("driver-event-autonomous-deep", () => {
...
describe("driver-event-autonomous-wide", () => {
...
describe("driver-event-autonomous-lovat", () => {
