...
describe("driver-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-cadhop");
...
describe("driver-event-cadhop-deep", () => {
...
describe("driver-event-cadhop-wide", () => {
...
describe("driver-event-cadhop-lovat", () => {
