...
describe("driver-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-excerpts");
    ...
    expect(bootstrapMean([15.0, 22.0, 47.0])).not.toBeNull();
...
describe("driver-event-excerpts-deep", () => {
...
describe("driver-event-excerpts-wide", () => {
...
describe("driver-event-excerpts-lovat", () => {
