...
describe("driver-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-todos");
...
describe("driver-event-todos-deep", () => {
...
describe("driver-event-todos-wide", () => {
...
describe("driver-event-todos-lovat", () => {
