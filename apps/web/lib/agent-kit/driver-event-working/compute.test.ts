...
describe("driver-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-working");
...
describe("driver-event-working-deep", () => {
...
describe("driver-event-working-wide", () => {
...
describe("driver-event-working-lovat", () => {
