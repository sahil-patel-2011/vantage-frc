...
describe("driver-last12-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-autonomous");
...
describe("driver-last12-autonomous-deep", () => {
...
describe("driver-last12-autonomous-wide", () => {
...
describe("driver-last12-autonomous-lovat", () => {
