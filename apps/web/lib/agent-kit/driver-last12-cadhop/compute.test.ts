...
describe("driver-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-cadhop");
...
describe("driver-last12-cadhop-deep", () => {
...
describe("driver-last12-cadhop-wide", () => {
...
describe("driver-last12-cadhop-lovat", () => {
