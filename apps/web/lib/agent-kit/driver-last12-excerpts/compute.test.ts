...
describe("driver-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-excerpts");
    ...
    expect(bootstrapMean([14.0, 26.0, 42.0])).not.toBeNull();
...
describe("driver-last12-excerpts-deep", () => {
...
describe("driver-last12-excerpts-wide", () => {
...
describe("driver-last12-excerpts-lovat", () => {
