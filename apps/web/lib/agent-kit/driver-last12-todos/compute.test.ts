...
describe("driver-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-todos");
...
describe("driver-last12-todos-deep", () => {
...
describe("driver-last12-todos-wide", () => {
...
describe("driver-last12-todos-lovat", () => {
