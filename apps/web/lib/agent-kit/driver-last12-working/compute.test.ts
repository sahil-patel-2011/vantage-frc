...
describe("driver-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-working");
...
describe("driver-last12-working-deep", () => {
...
describe("driver-last12-working-wide", () => {
...
describe("driver-last12-working-lovat", () => {
