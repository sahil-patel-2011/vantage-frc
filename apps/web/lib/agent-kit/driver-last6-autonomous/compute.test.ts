...
describe("driver-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-autonomous");
    ...
    expect(bootstrapMean([11.0, 28.0, 47.0])).not.toBeNull();
...
describe("driver-last6-autonomous-deep", () => {
...
describe("driver-last6-autonomous-wide", () => {
...
describe("driver-last6-autonomous-lovat", () => {
