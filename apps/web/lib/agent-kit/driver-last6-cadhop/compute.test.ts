...
describe("driver-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-cadhop");
...
describe("driver-last6-cadhop-deep", () => {
...
describe("driver-last6-cadhop-wide", () => {
...
describe("driver-last6-cadhop-lovat", () => {
