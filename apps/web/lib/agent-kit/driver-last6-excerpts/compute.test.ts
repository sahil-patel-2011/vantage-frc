...
describe("driver-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-excerpts");
...
describe("driver-last6-excerpts-deep", () => {
...
describe("driver-last6-excerpts-wide", () => {
...
describe("driver-last6-excerpts-lovat", () => {
