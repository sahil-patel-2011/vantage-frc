...
describe("driver-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-todos");
...
describe("driver-last6-todos-deep", () => {
...
describe("driver-last6-todos-wide", () => {
...
describe("driver-last6-todos-lovat", () => {
