...
describe("driver-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-working");
...
describe("driver-last6-working-deep", () => {
...
describe("driver-last6-working-wide", () => {
...
describe("driver-last6-working-lovat", () => {
