...
describe("driver-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-autonomous");
...
describe("driver-quals-autonomous-deep", () => {
...
describe("driver-quals-autonomous-wide", () => {
...
describe("driver-quals-autonomous-lovat", () => {
