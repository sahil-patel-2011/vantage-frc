...
describe("driver-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-cadhop");
...
describe("driver-quals-cadhop-deep", () => {
...
describe("driver-quals-cadhop-wide", () => {
...
describe("driver-quals-cadhop-lovat", () => {
