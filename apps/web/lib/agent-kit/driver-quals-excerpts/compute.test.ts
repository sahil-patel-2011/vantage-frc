...
describe("driver-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-excerpts");
...
describe("driver-quals-excerpts-deep", () => {
...
describe("driver-quals-excerpts-wide", () => {
...
describe("driver-quals-excerpts-lovat", () => {
