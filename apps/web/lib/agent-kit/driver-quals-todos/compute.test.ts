...
describe("driver-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-todos");
...
describe("driver-quals-todos-deep", () => {
...
describe("driver-quals-todos-wide", () => {
...
describe("driver-quals-todos-lovat", () => {
