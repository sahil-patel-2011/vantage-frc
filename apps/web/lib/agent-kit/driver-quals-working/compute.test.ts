...
describe("driver-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-working");
...
describe("driver-quals-working-deep", () => {
...
describe("driver-quals-working-wide", () => {
...
describe("driver-quals-working-lovat", () => {
