...
describe("endgame-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-autonomous");
...
describe("endgame-event-autonomous-deep", () => {
...
describe("endgame-event-autonomous-wide", () => {
...
describe("endgame-event-autonomous-lovat", () => {
