...
describe("endgame-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-cadhop");
...
describe("endgame-event-cadhop-deep", () => {
...
describe("endgame-event-cadhop-wide", () => {
...
describe("endgame-event-cadhop-lovat", () => {
