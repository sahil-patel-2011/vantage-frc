...
describe("endgame-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-excerpts");
...
describe("endgame-event-excerpts-deep", () => {
...
describe("endgame-event-excerpts-wide", () => {
...
describe("endgame-event-excerpts-lovat", () => {
