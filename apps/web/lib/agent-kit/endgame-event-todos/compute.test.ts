...
describe("endgame-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-todos");
...
describe("endgame-event-todos-deep", () => {
...
describe("endgame-event-todos-wide", () => {
...
describe("endgame-event-todos-lovat", () => {
