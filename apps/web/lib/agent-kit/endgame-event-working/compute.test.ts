...
describe("endgame-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-working");
...
describe("endgame-event-working-deep", () => {
...
describe("endgame-event-working-wide", () => {
...
describe("endgame-event-working-lovat", () => {
