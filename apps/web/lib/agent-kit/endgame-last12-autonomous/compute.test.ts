...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 23.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 25.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 47.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 47.0 } },
];

describe("endgame-last12-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-autonomous");
...
describe("endgame-last12-autonomous-deep", () => {
...
describe("endgame-last12-autonomous-wide", () => {
...
describe("endgame-last12-autonomous-lovat", () => {
