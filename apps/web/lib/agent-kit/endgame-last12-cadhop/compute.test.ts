...
describe("endgame-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-cadhop");
...
describe("endgame-last12-cadhop-deep", () => {
...
describe("endgame-last12-cadhop-wide", () => {
...
describe("endgame-last12-cadhop-lovat", () => {
