...
describe("endgame-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-excerpts");
...
describe("endgame-last12-excerpts-deep", () => {
...
describe("endgame-last12-excerpts-wide", () => {
...
describe("endgame-last12-excerpts-lovat", () => {
