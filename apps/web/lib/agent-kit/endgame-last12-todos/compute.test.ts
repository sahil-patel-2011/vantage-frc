...
describe("endgame-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-todos");
...
describe("endgame-last12-todos-deep", () => {
...
describe("endgame-last12-todos-wide", () => {
...
describe("endgame-last12-todos-lovat", () => {
