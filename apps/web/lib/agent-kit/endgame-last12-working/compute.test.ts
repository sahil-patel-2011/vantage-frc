...
describe("endgame-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-working");
...
describe("endgame-last12-working-deep", () => {
...
describe("endgame-last12-working-wide", () => {
...
describe("endgame-last12-working-lovat", () => {
