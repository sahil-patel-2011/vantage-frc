...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { endgameClimb: 42.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 42.0 } },
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 42.0 } },
];

describe("endgame-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-autonomous");
...
describe("endgame-last6-autonomous-deep", () => {
...
describe("endgame-last6-autonomous-wide", () => {
...
describe("endgame-last6-autonomous-lovat", () => {
