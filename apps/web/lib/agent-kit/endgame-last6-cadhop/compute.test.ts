...
describe("endgame-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-cadhop");
...
describe("endgame-last6-cadhop-deep", () => {
...
describe("endgame-last6-cadhop-wide", () => {
...
describe("endgame-last6-cadhop-lovat", () => {
