...
describe("endgame-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-excerpts");
...
describe("endgame-last6-excerpts-deep", () => {
...
describe("endgame-last6-excerpts-wide", () => {
...
describe("endgame-last6-excerpts-lovat", () => {
