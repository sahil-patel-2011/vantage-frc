...
describe("endgame-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-todos");
...
describe("endgame-last6-todos-deep", () => {
...
describe("endgame-last6-todos-wide", () => {
...
describe("endgame-last6-todos-lovat", () => {
