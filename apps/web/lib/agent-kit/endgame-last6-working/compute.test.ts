...
describe("endgame-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-working");
...
describe("endgame-last6-working-deep", () => {
...
describe("endgame-last6-working-wide", () => {
...
describe("endgame-last6-working-lovat", () => {
