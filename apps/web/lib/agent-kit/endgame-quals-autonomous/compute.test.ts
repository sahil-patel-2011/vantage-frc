...
describe("endgame-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-autonomous");
...
describe("endgame-quals-autonomous-deep", () => {
...
describe("endgame-quals-autonomous-wide", () => {
...
describe("endgame-quals-autonomous-lovat", () => {
