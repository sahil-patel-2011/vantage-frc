...
describe("endgame-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-cadhop");
...
describe("endgame-quals-cadhop-deep", () => {
...
describe("endgame-quals-cadhop-wide", () => {
...
describe("endgame-quals-cadhop-lovat", () => {
