...
describe("endgame-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-excerpts");
...
describe("endgame-quals-excerpts-deep", () => {
...
describe("endgame-quals-excerpts-wide", () => {
...
describe("endgame-quals-excerpts-lovat", () => {
