...
describe("endgame-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-todos");
...
describe("endgame-quals-todos-deep", () => {
...
describe("endgame-quals-todos-wide", () => {
...
describe("endgame-quals-todos-lovat", () => {
