...
describe("endgame-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-working");
...
describe("endgame-quals-working-deep", () => {
...
describe("endgame-quals-working-wide", () => {
...
describe("endgame-quals-working-lovat", () => {
