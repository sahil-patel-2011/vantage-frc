...
describe("fuel-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-cadhop");
...
describe("fuel-event-cadhop-deep", () => {
...
describe("fuel-event-cadhop-wide", () => {
...
describe("fuel-event-cadhop-lovat", () => {
