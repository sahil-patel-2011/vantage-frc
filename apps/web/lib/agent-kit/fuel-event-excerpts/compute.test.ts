...
describe("fuel-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-excerpts");
...
describe("fuel-event-excerpts-deep", () => {
...
describe("fuel-event-excerpts-wide", () => {
...
describe("fuel-event-excerpts-lovat", () => {
