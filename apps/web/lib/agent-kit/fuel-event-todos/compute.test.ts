...
describe("fuel-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-todos");
...
describe("fuel-event-todos-deep", () => {
...
describe("fuel-event-todos-wide", () => {
...
describe("fuel-event-todos-lovat", () => {
