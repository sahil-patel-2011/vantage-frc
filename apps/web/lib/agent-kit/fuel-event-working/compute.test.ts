...
describe("fuel-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-working");
...
describe("fuel-event-working-deep", () => {
...
describe("fuel-event-working-wide", () => {
...
describe("fuel-event-working-lovat", () => {
