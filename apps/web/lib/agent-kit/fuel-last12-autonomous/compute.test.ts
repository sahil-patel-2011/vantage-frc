...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 26.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 33.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 46.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 46.0 } },
];

describe("fuel-last12-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-autonomous");
...
describe("fuel-last12-autonomous-deep", () => {
...
describe("fuel-last12-autonomous-wide", () => {
...
describe("fuel-last12-autonomous-lovat", () => {
