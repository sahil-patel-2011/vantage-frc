...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 24.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 31.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 44.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 24.0 } },
...
describe("fuel-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-excerpts");
...
describe("fuel-last12-excerpts-deep", () => {
...
describe("fuel-last12-excerpts-wide", () => {
...
describe("fuel-last12-excerpts-lovat", () => {
