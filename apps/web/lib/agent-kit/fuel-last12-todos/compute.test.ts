...
describe("fuel-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-todos");
...
describe("fuel-last12-todos-deep", () => {
...
describe("fuel-last12-todos-wide", () => {
...
describe("fuel-last12-todos-lovat", () => {
