...
describe("fuel-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-working");
...
describe("fuel-last12-working-deep", () => {
...
describe("fuel-last12-working-wide", () => {
...
describe("fuel-last12-working-lovat", () => {
