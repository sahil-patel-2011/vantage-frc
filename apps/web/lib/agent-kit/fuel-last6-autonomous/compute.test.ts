...
describe("fuel-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-autonomous");
...
describe("fuel-last6-autonomous-deep", () => {
...
describe("fuel-last6-autonomous-wide", () => {
...
describe("fuel-last6-autonomous-lovat", () => {
