...
describe("fuel-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-cadhop");
...
describe("fuel-last6-cadhop-deep", () => {
...
describe("fuel-last6-cadhop-wide", () => {
...
describe("fuel-last6-cadhop-lovat", () => {
