...
describe("fuel-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-todos");
...
describe("fuel-last6-todos-deep", () => {
...
describe("fuel-last6-todos-wide", () => {
...
describe("fuel-last6-todos-lovat", () => {
