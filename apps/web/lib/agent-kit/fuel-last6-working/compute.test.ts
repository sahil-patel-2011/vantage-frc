...
describe("fuel-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-working");
...
describe("fuel-last6-working-deep", () => {
...
describe("fuel-last6-working-wide", () => {
...
describe("fuel-last6-working-lovat", () => {
