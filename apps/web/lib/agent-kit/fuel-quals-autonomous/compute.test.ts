...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 15.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 27.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 43.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 15.0 } },
...
describe("fuel-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-autonomous");
...
describe("fuel-quals-autonomous-deep", () => {
...
describe("fuel-quals-autonomous-wide", () => {
...
describe("fuel-quals-autonomous-lovat", () => {
