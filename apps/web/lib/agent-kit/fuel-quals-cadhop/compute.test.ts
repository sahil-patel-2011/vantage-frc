...
describe("fuel-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-cadhop");
...
describe("fuel-quals-cadhop-deep", () => {
...
describe("fuel-quals-cadhop-wide", () => {
...
describe("fuel-quals-cadhop-lovat", () => {
