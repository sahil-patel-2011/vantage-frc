...
describe("fuel-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-excerpts");
...
describe("fuel-quals-excerpts-deep", () => {
...
describe("fuel-quals-excerpts-wide", () => {
...
describe("fuel-quals-excerpts-lovat", () => {
