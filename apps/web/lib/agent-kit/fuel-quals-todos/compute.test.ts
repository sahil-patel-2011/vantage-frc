...
describe("fuel-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-todos");
...
describe("fuel-quals-todos-deep", () => {
...
describe("fuel-quals-todos-wide", () => {
...
describe("fuel-quals-todos-lovat", () => {
