...
describe("fuel-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-working");
...
describe("fuel-quals-working-deep", () => {
...
describe("fuel-quals-working-wide", () => {
...
describe("fuel-quals-working-lovat", () => {
