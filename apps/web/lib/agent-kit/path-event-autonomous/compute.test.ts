...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 26.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 23.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 42.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 23.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 42.0 } },
];

describe("path-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-event-autonomous");
...
describe("path-event-autonomous-deep", () => {
...
describe("path-event-autonomous-wide", () => {
...
describe("path-event-autonomous-lovat", () => {
