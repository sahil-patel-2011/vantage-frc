...
describe("path-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-event-cadhop");
...
describe("path-event-cadhop-deep", () => {
...
describe("path-event-cadhop-wide", () => {
...
describe("path-event-cadhop-lovat", () => {
