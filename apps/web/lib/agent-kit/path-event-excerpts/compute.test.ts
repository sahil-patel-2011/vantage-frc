...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 12.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 34.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 44.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 44.0 } },
];

describe("path-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-event-excerpts");
...
describe("path-event-excerpts-deep", () => {
...
describe("path-event-excerpts-wide", () => {
...
describe("path-event-excerpts-lovat", () => {
