...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 11.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 23.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 39.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 11.0 } },
...
describe("path-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-event-todos");
...
describe("path-event-todos-deep", () => {
...
describe("path-event-todos-wide", () => {
...
describe("path-event-todos-lovat", () => {
