...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 9.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 31.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 41.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 9.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 31.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 41.0 } },
];

describe("path-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-event-working");
...
describe("path-event-working-deep", () => {
...
describe("path-event-working-wide", () => {
...
describe("path-event-working-lovat", () => {
