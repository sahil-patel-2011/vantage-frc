...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 21.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 28.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 41.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 41.0 } },
];

describe("path-last12-autonomous", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "pathLength")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last12-autonomous");
...
describe("path-last12-autonomous-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { pathLength: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { pathLength: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { pathLength: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { pathLength: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { pathLength: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { pathLength: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "pathLength")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("path-last12-autonomous-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statPathLength(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesPathLength(rows, "frc9").length).toBe(0);
...
describe("path-last12-autonomous-lovat", () => {
