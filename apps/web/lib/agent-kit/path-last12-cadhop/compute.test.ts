...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { pathLength: 38.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 38.0 } },
];

describe("path-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last12-cadhop");
...
describe("path-last12-cadhop-deep", () => {
...
describe("path-last12-cadhop-wide", () => {
...
describe("path-last12-cadhop-lovat", () => {
