...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 27.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 34.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 47.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 47.0 } },
];

describe("path-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last12-excerpts");
...
describe("path-last12-excerpts-deep", () => {
...
describe("path-last12-excerpts-wide", () => {
...
describe("path-last12-excerpts-lovat", () => {
