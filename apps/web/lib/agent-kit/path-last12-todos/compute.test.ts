...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 14.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 31.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 38.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 14.0 } },
...
describe("path-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last12-todos");
...
describe("path-last12-todos-deep", () => {
...
describe("path-last12-todos-wide", () => {
...
describe("path-last12-todos-lovat", () => {
