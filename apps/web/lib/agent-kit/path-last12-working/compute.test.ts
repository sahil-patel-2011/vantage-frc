...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 16.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 28.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 44.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 16.0 } },
...
describe("path-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last12-working");
...
describe("path-last12-working-deep", () => {
...
describe("path-last12-working-wide", () => {
...
describe("path-last12-working-lovat", () => {
