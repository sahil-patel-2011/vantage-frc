...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 20.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 27.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 40.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 20.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 27.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 40.0 } },
];

describe("path-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last6-autonomous");
...
describe("path-last6-autonomous-deep", () => {
...
describe("path-last6-autonomous-wide", () => {
...
describe("path-last6-autonomous-lovat", () => {
