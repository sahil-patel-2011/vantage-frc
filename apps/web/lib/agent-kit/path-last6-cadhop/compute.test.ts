...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { pathLength: 29.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 39.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 39.0 } },
];

describe("path-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last6-cadhop");
...
describe("path-last6-cadhop-deep", () => {
...
describe("path-last6-cadhop-wide", () => {
...
describe("path-last6-cadhop-lovat", () => {
