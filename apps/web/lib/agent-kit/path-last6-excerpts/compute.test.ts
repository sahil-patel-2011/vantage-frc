...
describe("path-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last6-excerpts");
...
describe("path-last6-excerpts-deep", () => {
...
describe("path-last6-excerpts-wide", () => {
...
describe("path-last6-excerpts-lovat", () => {
