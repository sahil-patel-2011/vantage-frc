...
describe("path-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last6-todos");
...
describe("path-last6-todos-deep", () => {
...
describe("path-last6-todos-wide", () => {
...
describe("path-last6-todos-lovat", () => {
