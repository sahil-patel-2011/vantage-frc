...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 23.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 30.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 43.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 30.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 43.0 } },
];

describe("path-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-last6-working");
...
describe("path-last6-working-deep", () => {
...
describe("path-last6-working-wide", () => {
...
describe("path-last6-working-lovat", () => {
