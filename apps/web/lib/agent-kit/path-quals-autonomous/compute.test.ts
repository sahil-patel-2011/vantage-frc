...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 10.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 27.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 46.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 27.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 46.0 } },
];

describe("path-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-quals-autonomous");
...
describe("path-quals-autonomous-deep", () => {
...
describe("path-quals-autonomous-wide", () => {
...
describe("path-quals-autonomous-lovat", () => {
