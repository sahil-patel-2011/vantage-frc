...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { pathLength: 45.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { pathLength: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { pathLength: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { pathLength: 45.0 } },
];

describe("path-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-quals-cadhop");
...
describe("path-quals-cadhop-deep", () => {
...
describe("path-quals-cadhop-wide", () => {
...
describe("path-quals-cadhop-lovat", () => {
