...
describe("path-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-quals-excerpts");
...
describe("path-quals-excerpts-deep", () => {
...
describe("path-quals-excerpts-wide", () => {
...
describe("path-quals-excerpts-lovat", () => {
