...
describe("path-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-quals-todos");
...
describe("path-quals-todos-deep", () => {
...
describe("path-quals-todos-wide", () => {
...
describe("path-quals-todos-lovat", () => {
