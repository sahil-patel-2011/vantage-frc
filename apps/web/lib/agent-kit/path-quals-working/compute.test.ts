...
const rows = [
  { teamKey: "frc1", qual: true, values: { pathLength: 17.0 } },
  { teamKey: "frc2", qual: true, values: { pathLength: 34.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 41.0 } },
  { teamKey: "frc3", qual: true, values: { pathLength: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { pathLength: 17.0 } },
...
describe("path-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("path-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("path-quals-working");
...
describe("path-quals-working-deep", () => {
...
describe("path-quals-working-wide", () => {
...
describe("path-quals-working-lovat", () => {
