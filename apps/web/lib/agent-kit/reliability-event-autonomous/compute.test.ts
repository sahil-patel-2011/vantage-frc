...
describe("reliability-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-autonomous");
...
describe("reliability-event-autonomous-deep", () => {
...
describe("reliability-event-autonomous-wide", () => {
...
describe("reliability-event-autonomous-lovat", () => {
