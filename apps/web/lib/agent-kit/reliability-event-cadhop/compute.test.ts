...
describe("reliability-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-cadhop");
...
describe("reliability-event-cadhop-deep", () => {
...
describe("reliability-event-cadhop-wide", () => {
...
describe("reliability-event-cadhop-lovat", () => {
