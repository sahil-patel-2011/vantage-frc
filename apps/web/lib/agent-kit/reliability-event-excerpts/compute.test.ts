...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 11.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 33.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 43.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 11.0 } },
...
describe("reliability-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-excerpts");
...
describe("reliability-event-excerpts-deep", () => {
...
describe("reliability-event-excerpts-wide", () => {
...
describe("reliability-event-excerpts-lovat", () => {
