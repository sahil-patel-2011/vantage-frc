...
describe("reliability-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-todos");
...
describe("reliability-event-todos-deep", () => {
...
describe("reliability-event-todos-wide", () => {
...
describe("reliability-event-todos-lovat", () => {
