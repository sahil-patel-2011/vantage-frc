...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { uptime: 44.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 8.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 44.0 } },
];

describe("reliability-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-working");
...
describe("reliability-event-working-deep", () => {
...
describe("reliability-event-working-wide", () => {
...
describe("reliability-event-working-lovat", () => {
