...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 12.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 24.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 40.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 40.0 } },
];

describe("reliability-last12-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last12-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last12-autonomous");
...
describe("reliability-last12-autonomous-deep", () => {
...
describe("reliability-last12-autonomous-wide", () => {
...
describe("reliability-last12-autonomous-lovat", () => {
