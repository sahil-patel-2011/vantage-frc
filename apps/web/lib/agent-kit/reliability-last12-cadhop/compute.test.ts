...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 27.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 24.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 43.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 27.0 } },
...
describe("reliability-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last12-cadhop");
...
describe("reliability-last12-cadhop-deep", () => {
...
describe("reliability-last12-cadhop-wide", () => {
...
describe("reliability-last12-cadhop-lovat", () => {
