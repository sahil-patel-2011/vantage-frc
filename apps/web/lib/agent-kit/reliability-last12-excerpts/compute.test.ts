...
describe("reliability-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last12-excerpts");
...
describe("reliability-last12-excerpts-deep", () => {
...
describe("reliability-last12-excerpts-wide", () => {
...
describe("reliability-last12-excerpts-lovat", () => {
