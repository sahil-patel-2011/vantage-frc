...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { uptime: 37.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 37.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 37.0 } },
];

describe("reliability-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last12-todos");
...
describe("reliability-last12-todos-deep", () => {
...
describe("reliability-last12-todos-wide", () => {
...
describe("reliability-last12-todos-lovat", () => {
