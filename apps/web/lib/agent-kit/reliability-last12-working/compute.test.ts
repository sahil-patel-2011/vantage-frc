...
describe("reliability-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last12-working");
...
describe("reliability-last12-working-deep", () => {
...
describe("reliability-last12-working-wide", () => {
...
describe("reliability-last12-working-lovat", () => {
