...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 23.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 25.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 47.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 47.0 } },
];

describe("reliability-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-autonomous");
...
describe("reliability-last6-autonomous-deep", () => {
...
describe("reliability-last6-autonomous-wide", () => {
...
describe("reliability-last6-autonomous-lovat", () => {
