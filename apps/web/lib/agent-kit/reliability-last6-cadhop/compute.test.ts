...
describe("reliability-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-cadhop");
...
describe("reliability-last6-cadhop-deep", () => {
...
describe("reliability-last6-cadhop-wide", () => {
...
describe("reliability-last6-cadhop-lovat", () => {
