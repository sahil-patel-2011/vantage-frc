...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 9.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 31.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 41.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 9.0 } },
...
describe("reliability-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-excerpts");
...
describe("reliability-last6-excerpts-deep", () => {
...
describe("reliability-last6-excerpts-wide", () => {
...
describe("reliability-last6-excerpts-lovat", () => {
