...
describe("reliability-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-todos");
...
describe("reliability-last6-todos-deep", () => {
...
describe("reliability-last6-todos-wide", () => {
...
describe("reliability-last6-todos-lovat", () => {
