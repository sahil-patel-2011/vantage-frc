...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 10.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 27.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 46.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 27.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 46.0 } },
];

describe("reliability-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-working");
...
describe("reliability-last6-working-deep", () => {
...
describe("reliability-last6-working-wide", () => {
...
describe("reliability-last6-working-lovat", () => {
