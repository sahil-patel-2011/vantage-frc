...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 21.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 28.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 41.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 41.0 } },
];

describe("reliability-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-quals-autonomous");
...
describe("reliability-quals-autonomous-deep", () => {
...
describe("reliability-quals-autonomous-wide", () => {
...
describe("reliability-quals-autonomous-lovat", () => {
