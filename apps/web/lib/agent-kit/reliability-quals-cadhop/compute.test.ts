...
describe("reliability-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-quals-cadhop");
...
describe("reliability-quals-cadhop-deep", () => {
...
describe("reliability-quals-cadhop-wide", () => {
...
describe("reliability-quals-cadhop-lovat", () => {
