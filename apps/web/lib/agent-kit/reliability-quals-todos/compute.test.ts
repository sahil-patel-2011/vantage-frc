...
describe("reliability-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-quals-todos");
...
describe("reliability-quals-todos-deep", () => {
...
describe("reliability-quals-todos-wide", () => {
...
describe("reliability-quals-todos-lovat", () => {
