...
describe("reliability-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-quals-working");
...
describe("reliability-quals-working-deep", () => {
...
describe("reliability-quals-working-wide", () => {
...
describe("reliability-quals-working-lovat", () => {
