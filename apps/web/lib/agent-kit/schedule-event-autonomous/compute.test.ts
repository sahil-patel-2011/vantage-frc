...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { oppRating: 24.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 40.0 } },
];

describe("schedule-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-event-autonomous");
...
describe("schedule-event-autonomous-deep", () => {
...
describe("schedule-event-autonomous-wide", () => {
...
describe("schedule-event-autonomous-lovat", () => {
