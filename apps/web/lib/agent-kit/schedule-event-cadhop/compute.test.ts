...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 19.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 31.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 47.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 19.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 31.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 47.0 } },
];

describe("schedule-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-event-cadhop");
...
describe("schedule-event-cadhop-deep", () => {
...
describe("schedule-event-cadhop-wide", () => {
...
describe("schedule-event-cadhop-lovat", () => {
