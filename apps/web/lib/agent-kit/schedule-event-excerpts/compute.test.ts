...
describe("schedule-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-event-excerpts");
...
describe("schedule-event-excerpts-deep", () => {
...
describe("schedule-event-excerpts-wide", () => {
...
describe("schedule-event-excerpts-lovat", () => {
