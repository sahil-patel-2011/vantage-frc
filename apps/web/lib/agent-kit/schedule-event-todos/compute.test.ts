...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { oppRating: 37.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 37.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 37.0 } },
];

describe("schedule-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-event-todos");
...
describe("schedule-event-todos-deep", () => {
...
describe("schedule-event-todos-wide", () => {
...
describe("schedule-event-todos-lovat", () => {
