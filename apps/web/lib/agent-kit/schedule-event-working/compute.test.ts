...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 15.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 22.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 47.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 22.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 47.0 } },
];

describe("schedule-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-event-working");
...
describe("schedule-event-working-deep", () => {
...
describe("schedule-event-working-wide", () => {
...
describe("schedule-event-working-lovat", () => {
