...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 27.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 29.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 39.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 39.0 } },
];

describe("schedule-last12-autonomous", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "oppRating")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last12-autonomous");
...
describe("schedule-last12-autonomous-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { oppRating: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { oppRating: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { oppRating: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { oppRating: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { oppRating: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { oppRating: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "oppRating")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("schedule-last12-autonomous-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statOppRating(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesOppRating(rows, "frc9").length).toBe(0);
...
describe("schedule-last12-autonomous-lovat", () => {
