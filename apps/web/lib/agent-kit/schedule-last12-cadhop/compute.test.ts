...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 16.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 33.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 16.0 } },
...
describe("schedule-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last12-cadhop");
...
describe("schedule-last12-cadhop-deep", () => {
...
describe("schedule-last12-cadhop-wide", () => {
...
describe("schedule-last12-cadhop-lovat", () => {
