...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 17.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 34.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 41.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 41.0 } },
];

describe("schedule-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last12-excerpts");
...
describe("schedule-last12-excerpts-deep", () => {
...
describe("schedule-last12-excerpts-wide", () => {
...
describe("schedule-last12-excerpts-lovat", () => {
