...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 8.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 30.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 8.0 } },
...
describe("schedule-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last12-todos");
...
describe("schedule-last12-todos-deep", () => {
...
describe("schedule-last12-todos-wide", () => {
...
describe("schedule-last12-todos-lovat", () => {
