...
describe("schedule-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last12-working");
...
describe("schedule-last12-working-deep", () => {
...
describe("schedule-last12-working-wide", () => {
...
describe("schedule-last12-working-lovat", () => {
