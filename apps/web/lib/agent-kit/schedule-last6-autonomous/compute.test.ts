...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 26.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 33.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 46.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 46.0 } },
];

describe("schedule-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last6-autonomous");
...
describe("schedule-last6-autonomous-deep", () => {
...
describe("schedule-last6-autonomous-wide", () => {
...
describe("schedule-last6-autonomous-lovat", () => {
