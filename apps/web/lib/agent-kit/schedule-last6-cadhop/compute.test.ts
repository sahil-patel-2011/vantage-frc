...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 13.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 25.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 41.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 13.0 } },
...
describe("schedule-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last6-cadhop");
...
describe("schedule-last6-cadhop-deep", () => {
...
describe("schedule-last6-cadhop-wide", () => {
...
describe("schedule-last6-cadhop-lovat", () => {
