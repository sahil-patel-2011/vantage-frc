...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 24.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 21.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 24.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 21.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 40.0 } },
];

describe("schedule-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last6-excerpts");
...
describe("schedule-last6-excerpts-deep", () => {
...
describe("schedule-last6-excerpts-wide", () => {
...
describe("schedule-last6-excerpts-lovat", () => {
