...
describe("schedule-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last6-todos");
...
describe("schedule-last6-todos-deep", () => {
...
describe("schedule-last6-todos-wide", () => {
...
describe("schedule-last6-todos-lovat", () => {
