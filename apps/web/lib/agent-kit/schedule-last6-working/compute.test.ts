...
describe("schedule-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-last6-working");
...
describe("schedule-last6-working-deep", () => {
...
describe("schedule-last6-working-wide", () => {
...
describe("schedule-last6-working-lovat", () => {
