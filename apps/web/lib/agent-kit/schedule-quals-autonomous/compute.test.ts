...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 12.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 34.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 44.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 44.0 } },
];

describe("schedule-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-quals-autonomous");
...
describe("schedule-quals-autonomous-deep", () => {
...
describe("schedule-quals-autonomous-wide", () => {
...
describe("schedule-quals-autonomous-lovat", () => {
