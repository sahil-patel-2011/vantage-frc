...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 23.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 30.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 43.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 30.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 43.0 } },
];

describe("schedule-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-quals-cadhop");
...
describe("schedule-quals-cadhop-deep", () => {
...
describe("schedule-quals-cadhop-wide", () => {
...
describe("schedule-quals-cadhop-lovat", () => {
