...
const rows = [
  { teamKey: "frc1", qual: true, values: { oppRating: 18.0 } },
  { teamKey: "frc2", qual: true, values: { oppRating: 25.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 38.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 18.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 38.0 } },
];

describe("schedule-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-quals-excerpts");
...
describe("schedule-quals-excerpts-deep", () => {
...
describe("schedule-quals-excerpts-wide", () => {
...
describe("schedule-quals-excerpts-lovat", () => {
