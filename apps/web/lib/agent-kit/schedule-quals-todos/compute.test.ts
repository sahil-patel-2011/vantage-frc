...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { oppRating: 45.0 } },
  { teamKey: "frc3", qual: true, values: { oppRating: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { oppRating: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { oppRating: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { oppRating: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { oppRating: 45.0 } },
];

describe("schedule-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-quals-todos");
...
describe("schedule-quals-todos-deep", () => {
...
describe("schedule-quals-todos-wide", () => {
...
describe("schedule-quals-todos-lovat", () => {
