...
describe("schedule-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("schedule-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("schedule-quals-working");
...
describe("schedule-quals-working-deep", () => {
...
describe("schedule-quals-working-wide", () => {
...
describe("schedule-quals-working-lovat", () => {
