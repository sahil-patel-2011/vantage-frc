...
describe("teleop-event-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-autonomous");
...
describe("teleop-event-autonomous-deep", () => {
...
describe("teleop-event-autonomous-wide", () => {
...
describe("teleop-event-autonomous-lovat", () => {
