...
describe("teleop-event-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-cadhop");
...
describe("teleop-event-cadhop-deep", () => {
...
describe("teleop-event-cadhop-wide", () => {
...
describe("teleop-event-cadhop-lovat", () => {
