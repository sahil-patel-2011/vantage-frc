...
describe("teleop-event-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-excerpts");
...
describe("teleop-event-excerpts-deep", () => {
...
describe("teleop-event-excerpts-wide", () => {
...
describe("teleop-event-excerpts-lovat", () => {
