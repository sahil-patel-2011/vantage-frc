...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 19.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 31.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 19.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 31.0 } },
...
describe("teleop-event-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-todos");
...
describe("teleop-event-todos-deep", () => {
...
describe("teleop-event-todos-wide", () => {
...
describe("teleop-event-todos-lovat", () => {
