...
describe("teleop-event-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-working");
...
describe("teleop-event-working-deep", () => {
...
describe("teleop-event-working-wide", () => {
...
describe("teleop-event-working-lovat", () => {
