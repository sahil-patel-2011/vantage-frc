...
describe("teleop-last12-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-autonomous");
...
describe("teleop-last12-autonomous-deep", () => {
...
describe("teleop-last12-autonomous-wide", () => {
...
describe("teleop-last12-autonomous-lovat", () => {
