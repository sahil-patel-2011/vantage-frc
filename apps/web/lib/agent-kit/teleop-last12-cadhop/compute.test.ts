...
describe("teleop-last12-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-cadhop");
...
describe("teleop-last12-cadhop-deep", () => {
...
describe("teleop-last12-cadhop-wide", () => {
...
describe("teleop-last12-cadhop-lovat", () => {
