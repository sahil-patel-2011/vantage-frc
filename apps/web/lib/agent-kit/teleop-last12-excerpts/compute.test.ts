...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { teleopPoints: 27.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 43.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 27.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 43.0 } },
];

describe("teleop-last12-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-excerpts");
...
describe("teleop-last12-excerpts-deep", () => {
...
describe("teleop-last12-excerpts-wide", () => {
...
describe("teleop-last12-excerpts-lovat", () => {
