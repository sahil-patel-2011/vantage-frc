...
describe("teleop-last12-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-todos");
...
describe("teleop-last12-todos-deep", () => {
...
describe("teleop-last12-todos-wide", () => {
...
describe("teleop-last12-todos-lovat", () => {
