...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { teleopPoints: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 12.0 } },
...
describe("teleop-last12-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-working");
...
describe("teleop-last12-working-deep", () => {
...
describe("teleop-last12-working-wide", () => {
...
describe("teleop-last12-working-lovat", () => {
