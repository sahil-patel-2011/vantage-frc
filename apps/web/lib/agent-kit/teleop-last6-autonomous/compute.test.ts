...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 20.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 32.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 36.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 20.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 36.0 } },
];

describe("teleop-last6-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-autonomous");
...
describe("teleop-last6-autonomous-deep", () => {
...
describe("teleop-last6-autonomous-wide", () => {
...
describe("teleop-last6-autonomous-lovat", () => {
