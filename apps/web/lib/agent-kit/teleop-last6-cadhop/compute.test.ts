...
describe("teleop-last6-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-cadhop");
...
describe("teleop-last6-cadhop-deep", () => {
...
describe("teleop-last6-cadhop-wide", () => {
...
describe("teleop-last6-cadhop-lovat", () => {
