...
describe("teleop-last6-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-excerpts");
...
describe("teleop-last6-excerpts-deep", () => {
...
describe("teleop-last6-excerpts-wide", () => {
...
describe("teleop-last6-excerpts-lovat", () => {
