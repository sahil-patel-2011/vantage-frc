...
describe("teleop-last6-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-todos");
...
describe("teleop-last6-todos-deep", () => {
...
describe("teleop-last6-todos-wide", () => {
...
describe("teleop-last6-todos-lovat", () => {
