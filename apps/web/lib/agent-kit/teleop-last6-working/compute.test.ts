...
describe("teleop-last6-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-working");
...
describe("teleop-last6-working-deep", () => {
...
describe("teleop-last6-working-wide", () => {
...
describe("teleop-last6-working-lovat", () => {
