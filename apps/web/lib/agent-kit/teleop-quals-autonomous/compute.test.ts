...
describe("teleop-quals-autonomous", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-autonomous");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-autonomous");
...
describe("teleop-quals-autonomous-deep", () => {
...
describe("teleop-quals-autonomous-wide", () => {
...
describe("teleop-quals-autonomous-lovat", () => {
