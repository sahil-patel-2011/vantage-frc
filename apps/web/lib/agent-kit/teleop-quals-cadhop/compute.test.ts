...
describe("teleop-quals-cadhop", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-cadhop");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-cadhop");
...
describe("teleop-quals-cadhop-deep", () => {
...
describe("teleop-quals-cadhop-wide", () => {
...
describe("teleop-quals-cadhop-lovat", () => {
