...
describe("teleop-quals-excerpts", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-excerpts");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-excerpts");
...
describe("teleop-quals-excerpts-deep", () => {
...
describe("teleop-quals-excerpts-wide", () => {
...
describe("teleop-quals-excerpts-lovat", () => {
