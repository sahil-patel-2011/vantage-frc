...
describe("teleop-quals-todos", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-todos");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-todos");
...
describe("teleop-quals-todos-deep", () => {
...
describe("teleop-quals-todos-wide", () => {
...
describe("teleop-quals-todos-lovat", () => {
