...
describe("teleop-quals-working", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-working");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-working");
...
describe("teleop-quals-working-deep", () => {
...
describe("teleop-quals-working-wide", () => {
...
describe("teleop-quals-working-lovat", () => {
