...
describe("alliance-partner-brief pure helpers", () => {
  ...
  it("builds strengths only from real numbers, never inventing claims", () => {
    ...
    expect(strengths).toContain("Rating 40.5 (tba)");
          ...
          rows: [
            {
              ...
              partners: [
                { teamKey: "frc118", teamNumber: 118, nickname: "Robonauts", slot: "first", role: "teleop_scorer", roleLabel: "Teleop scorer", strengths: ["Rating 38.2 (tba)"], epa: null, matchScoutEntryCount: 3, pitScoutEntryCount: 0, evidenceNote: "Event metrics + our own scouting" },
