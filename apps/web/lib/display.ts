...
export const PRESET_META: Array<{ id: DisplayPreset; title: string; copy: string }> = [
  { id: "next_match", title: "Next Match", copy: "Countdown, alliances, scheduled time, and leave-now status from the official schedule" },
  ...
  { id: "event_command", title: "Event Command", copy: "Next team match plus rank and record when metrics are synced" },
