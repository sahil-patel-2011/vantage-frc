...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    summary:
      "Upload the team's photos and clips into albums with honest size caps — 8 MB photos after downscale, 100 MB videos in-database.",
    category: "media",
    keywords: [
      "media library",
      "photos",
    ...
    sections: [
      {
        heading: "Uploading",
        body: [
          "Photos (JPEG/PNG/WebP) are downscaled in the browser before upload and land under the 8 MB in-database cap; videos (MP4/WebM) are capped at 100 MB.",
