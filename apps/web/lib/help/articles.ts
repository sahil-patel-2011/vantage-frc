  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Lovat exports CSV (raw reports + notes, or team averages). Bring those in here with Scouting CSV and map columns. Vantage’s miss is not “Lovat has no export” — it is wide answers on the Scouting hub (hub Export today is identity/timestamps; payload lives as JSON in takeout). A separate change owns hub-wide columns; this page only imports.",
  ...
  // ------------------------------------------------- Integrations & connectors
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Team Data: match schedules, rankings, EPA-based strategy — read from a shared, rate-limited reference cache.",
