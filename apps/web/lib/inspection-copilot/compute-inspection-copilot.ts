...
export function parseFrameBumper(value: unknown): FrameBumperSpec {
  ...
  return {
    ...
    bumperCrossSectionOk: Boolean(row.bumperCrossSectionOk),
...
export function parseWiringPower(value: unknown): WiringPowerSpec {
  ...
  return {
    ...
    componentsRated: Boolean(row.componentsRated),
    compressorStops120: Boolean(row.compressorStops120),
    compressorPowerOk: Boolean(row.compressorPowerOk),
    tubingOdOk: Boolean(row.tubingOdOk),
    relievingRegulatorOk: Boolean(row.relievingRegulatorOk),
