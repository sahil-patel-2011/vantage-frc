...
export const INSPECTION_TEMPLATE: Array<{ category: string; items: string[] }> = [
  ...
  },
  {
    ...
    items: [
      ...
      "Radio 12V / PoE injector is the only load on its 10A PD branch (TU07)",
  ...
  },
  {
    ...
    items: [
      ...
      "PCM/PH connected to the roboRIO via CAN bus (inspectors fail a powered-only module)",
  ...
  },
  {
    ...
    items: [
      ...
      "Power Off: disable, open main breaker, all LEDs off, vent stored pressure to 0 psi",
