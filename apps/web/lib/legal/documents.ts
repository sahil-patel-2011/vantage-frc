  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "These events are linked to your account, not anonymous. Each one is stored with your account and your team, in your team's own space, behind the same protections as the rest of your team's data. Your team's owners and admins can read your team's events; other members of your team cannot. No advertising network, analytics vendor, data broker, or other third party receives them, and no third-party tracking script is embedded in the signed-in product. The separate Plausible analytics on our public marketing pages, described above, is a different thing, and it also carries no advertising cookies and builds no cross-site profile.",
