...
describe("auto-event-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-assign");
...
describe("auto-event-assign-deep", () => {
...
describe("auto-event-assign-wide", () => {
...
describe("auto-event-assign-lovat", () => {
