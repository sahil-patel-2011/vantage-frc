...
describe("auto-event-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-context");
...
describe("auto-event-context-deep", () => {
...
describe("auto-event-context-wide", () => {
...
describe("auto-event-context-lovat", () => {
