...
describe("auto-event-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-lookup");
...
describe("auto-event-lookup-deep", () => {
...
describe("auto-event-lookup-wide", () => {
...
describe("auto-event-lookup-lovat", () => {
