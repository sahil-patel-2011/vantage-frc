...
describe("auto-event-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-notes");
...
describe("auto-event-notes-deep", () => {
...
describe("auto-event-notes-wide", () => {
...
describe("auto-event-notes-lovat", () => {
