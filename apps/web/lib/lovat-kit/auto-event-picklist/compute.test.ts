...
describe("auto-event-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-picklist");
...
describe("auto-event-picklist-deep", () => {
...
describe("auto-event-picklist-wide", () => {
...
describe("auto-event-picklist-lovat", () => {
