...
describe("auto-event-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-playhead");
...
describe("auto-event-playhead-deep", () => {
...
describe("auto-event-playhead-wide", () => {
...
describe("auto-event-playhead-lovat", () => {
