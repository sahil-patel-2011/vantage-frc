...
describe("auto-event-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-timeline22");
...
describe("auto-event-timeline22-deep", () => {
...
describe("auto-event-timeline22-wide", () => {
...
describe("auto-event-timeline22-lovat", () => {
