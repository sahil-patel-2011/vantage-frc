...
describe("auto-last12-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-assign");
...
describe("auto-last12-assign-deep", () => {
...
describe("auto-last12-assign-wide", () => {
...
describe("auto-last12-assign-lovat", () => {
