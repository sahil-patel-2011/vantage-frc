...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { autoPoints: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 24.0 } },
...
describe("auto-last12-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-context");
...
describe("auto-last12-context-deep", () => {
...
describe("auto-last12-context-wide", () => {
...
describe("auto-last12-context-lovat", () => {
