...
describe("auto-last12-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-flip");
...
describe("auto-last12-flip-deep", () => {
...
describe("auto-last12-flip-wide", () => {
...
describe("auto-last12-flip-lovat", () => {
