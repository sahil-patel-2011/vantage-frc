...
describe("auto-last12-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-lookup");
...
describe("auto-last12-lookup-deep", () => {
...
describe("auto-last12-lookup-wide", () => {
...
describe("auto-last12-lookup-lovat", () => {
