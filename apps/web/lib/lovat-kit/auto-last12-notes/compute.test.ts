...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 18.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 20.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 42.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 18.0 } },
...
describe("auto-last12-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-notes");
...
describe("auto-last12-notes-deep", () => {
...
describe("auto-last12-notes-wide", () => {
...
describe("auto-last12-notes-lovat", () => {
