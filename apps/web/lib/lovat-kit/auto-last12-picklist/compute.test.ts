...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 8.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 20.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 36.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 8.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 20.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 36.0 } },
];

describe("auto-last12-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-picklist");
...
describe("auto-last12-picklist-deep", () => {
...
describe("auto-last12-picklist-wide", () => {
...
describe("auto-last12-picklist-lovat", () => {
