...
describe("auto-last12-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-playhead");
...
describe("auto-last12-playhead-deep", () => {
...
describe("auto-last12-playhead-wide", () => {
...
describe("auto-last12-playhead-lovat", () => {
