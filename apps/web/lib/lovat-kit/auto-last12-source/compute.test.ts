...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { autoPoints: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 20.0 } },
...
describe("auto-last12-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-source");
...
describe("auto-last12-source-deep", () => {
...
describe("auto-last12-source-wide", () => {
...
describe("auto-last12-source-lovat", () => {
