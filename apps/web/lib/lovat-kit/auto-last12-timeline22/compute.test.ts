...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 22.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 24.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 46.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 46.0 } },
];

describe("auto-last12-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-timeline22");
...
describe("auto-last12-timeline22-deep", () => {
...
describe("auto-last12-timeline22-wide", () => {
...
describe("auto-last12-timeline22-lovat", () => {
