...
describe("auto-last24-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-assign");
...
describe("auto-last24-assign-deep", () => {
...
describe("auto-last24-assign-wide", () => {
...
describe("auto-last24-assign-lovat", () => {
