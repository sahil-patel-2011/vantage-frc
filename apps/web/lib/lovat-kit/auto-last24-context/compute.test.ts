...
describe("auto-last24-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-context");
...
describe("auto-last24-context-deep", () => {
...
describe("auto-last24-context-wide", () => {
...
describe("auto-last24-context-lovat", () => {
