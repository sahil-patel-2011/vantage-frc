...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 25.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 32.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 45.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 25.0 } },
...
describe("auto-last24-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-flip");
...
describe("auto-last24-flip-deep", () => {
...
describe("auto-last24-flip-wide", () => {
...
describe("auto-last24-flip-lovat", () => {
