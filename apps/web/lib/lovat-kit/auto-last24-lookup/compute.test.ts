...
describe("auto-last24-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-lookup");
...
describe("auto-last24-lookup-deep", () => {
...
describe("auto-last24-lookup-wide", () => {
...
describe("auto-last24-lookup-lovat", () => {
