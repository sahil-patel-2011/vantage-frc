...
describe("auto-last24-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-notes");
...
describe("auto-last24-notes-deep", () => {
...
describe("auto-last24-notes-wide", () => {
...
describe("auto-last24-notes-lovat", () => {
