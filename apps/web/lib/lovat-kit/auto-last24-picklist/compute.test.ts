...
describe("auto-last24-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-picklist");
...
describe("auto-last24-picklist-deep", () => {
...
describe("auto-last24-picklist-wide", () => {
...
describe("auto-last24-picklist-lovat", () => {
