...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { autoPoints: 29.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 42.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 42.0 } },
];

describe("auto-last24-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-playhead");
...
describe("auto-last24-playhead-deep", () => {
...
describe("auto-last24-playhead-wide", () => {
...
describe("auto-last24-playhead-lovat", () => {
