...
describe("auto-last24-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-source");
...
describe("auto-last24-source-deep", () => {
...
describe("auto-last24-source-wide", () => {
...
describe("auto-last24-source-lovat", () => {
