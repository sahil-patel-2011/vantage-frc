...
describe("auto-last24-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-timeline22");
...
describe("auto-last24-timeline22-deep", () => {
...
describe("auto-last24-timeline22-wide", () => {
...
describe("auto-last24-timeline22-lovat", () => {
