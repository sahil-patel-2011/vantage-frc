...
describe("auto-last24-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last24-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last24-win");
...
describe("auto-last24-win-lovat", () => {
