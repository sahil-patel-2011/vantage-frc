...
describe("auto-last4-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last4-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last4-assign");
...
describe("auto-last4-assign-deep", () => {
...
describe("auto-last4-assign-wide", () => {
...
describe("auto-last4-assign-lovat", () => {
