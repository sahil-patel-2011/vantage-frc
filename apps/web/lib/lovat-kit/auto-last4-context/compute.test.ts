...
describe("auto-last4-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last4-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last4-context");
...
describe("auto-last4-context-deep", () => {
...
describe("auto-last4-context-wide", () => {
...
describe("auto-last4-context-lovat", () => {
