...
describe("auto-last4-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last4-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last4-lookup");
...
describe("auto-last4-lookup-deep", () => {
...
describe("auto-last4-lookup-wide", () => {
...
describe("auto-last4-lookup-lovat", () => {
