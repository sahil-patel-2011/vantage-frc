...
describe("auto-last4-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last4-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last4-notes");
...
describe("auto-last4-notes-deep", () => {
...
describe("auto-last4-notes-wide", () => {
...
describe("auto-last4-notes-lovat", () => {
