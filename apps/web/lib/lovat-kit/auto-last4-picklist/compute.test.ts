...
describe("auto-last4-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last4-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last4-picklist");
...
describe("auto-last4-picklist-deep", () => {
...
describe("auto-last4-picklist-wide", () => {
...
describe("auto-last4-picklist-lovat", () => {
