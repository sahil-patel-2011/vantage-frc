...
describe("auto-last4-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last4-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last4-source");
...
describe("auto-last4-source-deep", () => {
...
describe("auto-last4-source-wide", () => {
...
describe("auto-last4-source-lovat", () => {
