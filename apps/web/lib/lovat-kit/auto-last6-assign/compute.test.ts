...
describe("auto-last6-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-assign");
...
describe("auto-last6-assign-deep", () => {
...
describe("auto-last6-assign-wide", () => {
...
describe("auto-last6-assign-lovat", () => {
