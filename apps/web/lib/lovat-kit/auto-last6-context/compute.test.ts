...
describe("auto-last6-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-context");
...
describe("auto-last6-context-deep", () => {
...
describe("auto-last6-context-wide", () => {
...
describe("auto-last6-context-lovat", () => {
