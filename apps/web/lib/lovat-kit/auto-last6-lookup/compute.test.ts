...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 14.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 31.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 38.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 14.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 31.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 38.0 } },
];

describe("auto-last6-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-lookup");
...
describe("auto-last6-lookup-deep", () => {
...
describe("auto-last6-lookup-wide", () => {
...
describe("auto-last6-lookup-lovat", () => {
