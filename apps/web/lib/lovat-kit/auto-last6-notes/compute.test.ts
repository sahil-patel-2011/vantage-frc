...
describe("auto-last6-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-notes");
...
describe("auto-last6-notes-deep", () => {
...
describe("auto-last6-notes-wide", () => {
...
describe("auto-last6-notes-lovat", () => {
