...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 12.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 34.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 44.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 44.0 } },
];

describe("auto-last6-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-playhead");
...
describe("auto-last6-playhead-deep", () => {
...
describe("auto-last6-playhead-wide", () => {
...
describe("auto-last6-playhead-lovat", () => {
