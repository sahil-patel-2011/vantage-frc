...
describe("auto-last6-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-source");
...
describe("auto-last6-source-deep", () => {
...
describe("auto-last6-source-wide", () => {
...
describe("auto-last6-source-lovat", () => {
