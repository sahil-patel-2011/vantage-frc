...
const rows = [
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 39.0 } },
];

describe("auto-last6-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-timeline22");
...
describe("auto-last6-timeline22-deep", () => {
...
describe("auto-last6-timeline22-wide", () => {
...
describe("auto-last6-timeline22-lovat", () => {
