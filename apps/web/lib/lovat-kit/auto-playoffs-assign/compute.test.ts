...
describe("auto-playoffs-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-assign");
...
describe("auto-playoffs-assign-deep", () => {
...
describe("auto-playoffs-assign-wide", () => {
...
describe("auto-playoffs-assign-lovat", () => {
