...
describe("auto-playoffs-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-consistency");
...
describe("auto-playoffs-consistency-deep", () => {
