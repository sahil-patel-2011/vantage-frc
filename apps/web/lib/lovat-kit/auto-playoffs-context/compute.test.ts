...
describe("auto-playoffs-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-context");
...
describe("auto-playoffs-context-deep", () => {
...
describe("auto-playoffs-context-wide", () => {
...
describe("auto-playoffs-context-lovat", () => {
