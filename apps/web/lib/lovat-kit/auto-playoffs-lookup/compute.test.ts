...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { autoPoints: 34.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 38.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 38.0 } },
];

describe("auto-playoffs-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-lookup");
...
describe("auto-playoffs-lookup-deep", () => {
...
describe("auto-playoffs-lookup-wide", () => {
...
describe("auto-playoffs-lookup-lovat", () => {
