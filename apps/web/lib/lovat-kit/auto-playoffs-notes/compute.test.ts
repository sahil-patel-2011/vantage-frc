...
describe("auto-playoffs-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-notes");
...
describe("auto-playoffs-notes-deep", () => {
...
describe("auto-playoffs-notes-wide", () => {
...
describe("auto-playoffs-notes-lovat", () => {
