...
describe("auto-playoffs-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-picklist");
...
describe("auto-playoffs-picklist-deep", () => {
...
describe("auto-playoffs-picklist-wide", () => {
...
describe("auto-playoffs-picklist-lovat", () => {
