...
const rows = [
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 40.0 } },
];

describe("auto-playoffs-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-playhead");
...
describe("auto-playoffs-playhead-deep", () => {
...
describe("auto-playoffs-playhead-wide", () => {
...
describe("auto-playoffs-playhead-lovat", () => {
