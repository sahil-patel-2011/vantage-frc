...
describe("auto-playoffs-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-residual");
...
describe("auto-playoffs-residual-deep", () => {
