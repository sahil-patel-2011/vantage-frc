...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { autoPoints: 23.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 45.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 23.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 45.0 } },
];

describe("auto-playoffs-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-source");
...
describe("auto-playoffs-source-deep", () => {
...
describe("auto-playoffs-source-wide", () => {
...
describe("auto-playoffs-source-lovat", () => {
