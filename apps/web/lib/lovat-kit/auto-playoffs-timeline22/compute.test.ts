...
describe("auto-playoffs-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-timeline22");
...
describe("auto-playoffs-timeline22-deep", () => {
...
describe("auto-playoffs-timeline22-wide", () => {
...
describe("auto-playoffs-timeline22-lovat", () => {
