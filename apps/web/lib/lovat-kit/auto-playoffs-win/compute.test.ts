...
describe("auto-playoffs-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-playoffs-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-playoffs-win");
...
describe("auto-playoffs-win-deep", () => {
...
describe("auto-playoffs-win-wide", () => {
...
describe("auto-playoffs-win-lovat", () => {
