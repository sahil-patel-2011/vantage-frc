...
describe("auto-quals-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-assign");
...
describe("auto-quals-assign-deep", () => {
...
describe("auto-quals-assign-wide", () => {
...
describe("auto-quals-assign-lovat", () => {
