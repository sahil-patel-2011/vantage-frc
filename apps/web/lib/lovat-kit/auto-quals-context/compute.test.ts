...
describe("auto-quals-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-context");
...
describe("auto-quals-context-deep", () => {
...
describe("auto-quals-context-wide", () => {
...
describe("auto-quals-context-lovat", () => {
