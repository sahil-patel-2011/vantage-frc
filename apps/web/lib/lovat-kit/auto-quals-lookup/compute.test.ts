...
describe("auto-quals-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-lookup");
...
describe("auto-quals-lookup-deep", () => {
...
describe("auto-quals-lookup-wide", () => {
...
describe("auto-quals-lookup-lovat", () => {
