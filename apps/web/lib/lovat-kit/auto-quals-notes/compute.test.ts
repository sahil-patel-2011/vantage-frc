...
describe("auto-quals-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-notes");
...
describe("auto-quals-notes-deep", () => {
...
describe("auto-quals-notes-wide", () => {
...
describe("auto-quals-notes-lovat", () => {
