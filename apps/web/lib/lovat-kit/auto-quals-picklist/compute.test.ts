...
describe("auto-quals-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-picklist");
...
describe("auto-quals-picklist-deep", () => {
...
describe("auto-quals-picklist-wide", () => {
...
describe("auto-quals-picklist-lovat", () => {
