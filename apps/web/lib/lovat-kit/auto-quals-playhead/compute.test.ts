...
describe("auto-quals-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-playhead");
...
describe("auto-quals-playhead-deep", () => {
...
describe("auto-quals-playhead-wide", () => {
...
describe("auto-quals-playhead-lovat", () => {
