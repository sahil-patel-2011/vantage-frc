...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 23.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 30.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 43.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 30.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 43.0 } },
];

describe("auto-quals-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-source");
...
describe("auto-quals-source-deep", () => {
...
describe("auto-quals-source-wide", () => {
...
describe("auto-quals-source-lovat", () => {
