...
describe("auto-quals-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-timeline22");
...
describe("auto-quals-timeline22-deep", () => {
...
describe("auto-quals-timeline22-wide", () => {
...
describe("auto-quals-timeline22-lovat", () => {
