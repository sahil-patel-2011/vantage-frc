...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 11.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 33.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 43.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 43.0 } },
];

describe("auto-recent3-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-assign");
...
describe("auto-recent3-assign-deep", () => {
...
describe("auto-recent3-assign-wide", () => {
...
describe("auto-recent3-assign-lovat", () => {
