...
describe("auto-recent3-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-context");
...
describe("auto-recent3-context-deep", () => {
...
describe("auto-recent3-context-wide", () => {
...
describe("auto-recent3-context-lovat", () => {
