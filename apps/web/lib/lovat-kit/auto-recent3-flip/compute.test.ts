...
describe("auto-recent3-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-flip");
...
describe("auto-recent3-flip-deep", () => {
...
describe("auto-recent3-flip-wide", () => {
...
describe("auto-recent3-flip-lovat", () => {
