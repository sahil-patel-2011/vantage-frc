...
describe("auto-recent3-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-lookup");
...
describe("auto-recent3-lookup-deep", () => {
...
describe("auto-recent3-lookup-wide", () => {
...
describe("auto-recent3-lookup-lovat", () => {
