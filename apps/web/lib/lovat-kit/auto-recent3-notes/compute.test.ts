...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 15.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 27.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 43.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 27.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 43.0 } },
];

describe("auto-recent3-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-notes");
...
describe("auto-recent3-notes-deep", () => {
...
describe("auto-recent3-notes-wide", () => {
...
describe("auto-recent3-notes-lovat", () => {
