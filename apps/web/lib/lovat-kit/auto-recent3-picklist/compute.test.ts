...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { autoPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 19.0 } },
...
describe("auto-recent3-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-picklist");
...
describe("auto-recent3-picklist-deep", () => {
...
describe("auto-recent3-picklist-wide", () => {
...
describe("auto-recent3-picklist-lovat", () => {
