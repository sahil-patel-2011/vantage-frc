...
describe("auto-recent3-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-playhead");
...
describe("auto-recent3-playhead-deep", () => {
...
describe("auto-recent3-playhead-wide", () => {
...
describe("auto-recent3-playhead-lovat", () => {
