...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 27.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 34.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 47.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { autoPoints: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { autoPoints: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { autoPoints: 47.0 } },
];

describe("auto-recent3-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-source");
...
describe("auto-recent3-source-deep", () => {
...
describe("auto-recent3-source-wide", () => {
...
describe("auto-recent3-source-lovat", () => {
