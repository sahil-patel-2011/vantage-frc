...
describe("auto-recent3-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-recent3-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-recent3-win");
...
describe("auto-recent3-win-deep", () => {
...
describe("auto-recent3-win-wide", () => {
...
describe("auto-recent3-win-lovat", () => {
