...
describe("defense-event-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-assign");
...
describe("defense-event-assign-deep", () => {
...
describe("defense-event-assign-wide", () => {
...
describe("defense-event-assign-lovat", () => {
