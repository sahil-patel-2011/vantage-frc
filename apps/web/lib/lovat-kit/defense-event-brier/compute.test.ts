...
describe("defense-event-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-brier");
...
describe("defense-event-brier-deep", () => {
...
describe("defense-event-brier-wide", () => {
...
describe("defense-event-brier-lovat", () => {
