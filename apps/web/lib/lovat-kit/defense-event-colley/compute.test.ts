...
describe("defense-event-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-colley");
...
describe("defense-event-colley-deep", () => {
...
describe("defense-event-colley-wide", () => {
...
describe("defense-event-colley-lovat", () => {
