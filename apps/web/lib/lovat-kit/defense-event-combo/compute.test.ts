...
describe("defense-event-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-combo");
...
describe("defense-event-combo-deep", () => {
...
describe("defense-event-combo-wide", () => {
...
describe("defense-event-combo-lovat", () => {
