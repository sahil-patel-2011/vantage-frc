...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 23.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 30.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 43.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 30.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 43.0 } },
];

describe("defense-event-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-consistency");
...
describe("defense-event-consistency-deep", () => {
...
describe("defense-event-consistency-wide", () => {
...
describe("defense-event-consistency-lovat", () => {
