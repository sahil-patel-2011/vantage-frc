...
describe("defense-event-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-context");
...
describe("defense-event-context-deep", () => {
...
describe("defense-event-context-wide", () => {
...
describe("defense-event-context-lovat", () => {
