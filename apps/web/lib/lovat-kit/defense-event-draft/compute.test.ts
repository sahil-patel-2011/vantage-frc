...
describe("defense-event-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-draft");
...
describe("defense-event-draft-deep", () => {
...
describe("defense-event-draft-wide", () => {
...
describe("defense-event-draft-lovat", () => {
