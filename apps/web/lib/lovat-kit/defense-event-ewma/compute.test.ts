...
describe("defense-event-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-ewma");
...
describe("defense-event-ewma-deep", () => {
...
describe("defense-event-ewma-wide", () => {
...
describe("defense-event-ewma-lovat", () => {
