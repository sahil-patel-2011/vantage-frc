...
describe("defense-event-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-flip");
...
describe("defense-event-flip-deep", () => {
...
describe("defense-event-flip-wide", () => {
...
describe("defense-event-flip-lovat", () => {
