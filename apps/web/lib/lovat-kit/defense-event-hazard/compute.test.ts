...
describe("defense-event-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-hazard");
...
describe("defense-event-hazard-deep", () => {
...
describe("defense-event-hazard-wide", () => {
...
describe("defense-event-hazard-lovat", () => {
