...
describe("defense-event-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-interfere");
...
describe("defense-event-interfere-deep", () => {
...
describe("defense-event-interfere-wide", () => {
...
describe("defense-event-interfere-lovat", () => {
