...
describe("defense-event-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-lookup");
...
describe("defense-event-lookup-deep", () => {
...
describe("defense-event-lookup-wide", () => {
...
describe("defense-event-lookup-lovat", () => {
