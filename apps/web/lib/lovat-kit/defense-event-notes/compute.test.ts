...
describe("defense-event-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-notes");
...
describe("defense-event-notes-deep", () => {
...
describe("defense-event-notes-wide", () => {
...
describe("defense-event-notes-lovat", () => {
