...
describe("defense-event-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-pareto");
...
describe("defense-event-pareto-deep", () => {
...
describe("defense-event-pareto-wide", () => {
...
describe("defense-event-pareto-lovat", () => {
