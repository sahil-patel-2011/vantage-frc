...
describe("defense-event-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-path");
...
describe("defense-event-path-deep", () => {
...
describe("defense-event-path-wide", () => {
...
describe("defense-event-path-lovat", () => {
