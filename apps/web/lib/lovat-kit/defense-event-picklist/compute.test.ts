...
describe("defense-event-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-picklist");
...
describe("defense-event-picklist-deep", () => {
...
describe("defense-event-picklist-wide", () => {
...
describe("defense-event-picklist-lovat", () => {
