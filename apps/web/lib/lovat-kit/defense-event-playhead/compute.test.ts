...
describe("defense-event-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-playhead");
...
describe("defense-event-playhead-deep", () => {
...
describe("defense-event-playhead-wide", () => {
...
describe("defense-event-playhead-lovat", () => {
