...
describe("defense-event-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-rank");
...
describe("defense-event-rank-deep", () => {
...
describe("defense-event-rank-wide", () => {
...
describe("defense-event-rank-lovat", () => {
