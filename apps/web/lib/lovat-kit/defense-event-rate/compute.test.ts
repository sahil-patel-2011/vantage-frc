...
describe("defense-event-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-rate");
...
describe("defense-event-rate-deep", () => {
...
describe("defense-event-rate-wide", () => {
...
describe("defense-event-rate-lovat", () => {
