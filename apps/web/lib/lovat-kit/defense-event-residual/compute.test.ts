...
describe("defense-event-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-residual");
...
describe("defense-event-residual-deep", () => {
...
describe("defense-event-residual-wide", () => {
...
describe("defense-event-residual-lovat", () => {
