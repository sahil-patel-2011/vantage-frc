...
describe("defense-event-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-shrink");
...
describe("defense-event-shrink-deep", () => {
...
describe("defense-event-shrink-wide", () => {
...
describe("defense-event-shrink-lovat", () => {
