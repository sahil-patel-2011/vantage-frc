...
describe("defense-event-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-source");
...
describe("defense-event-source-deep", () => {
...
describe("defense-event-source-wide", () => {
...
describe("defense-event-source-lovat", () => {
