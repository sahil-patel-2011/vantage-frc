...
describe("defense-event-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-streak");
...
describe("defense-event-streak-deep", () => {
...
describe("defense-event-streak-wide", () => {
...
describe("defense-event-streak-lovat", () => {
