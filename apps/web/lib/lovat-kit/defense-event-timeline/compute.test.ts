...
describe("defense-event-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-timeline");
...
describe("defense-event-timeline-deep", () => {
...
describe("defense-event-timeline-wide", () => {
...
describe("defense-event-timeline-lovat", () => {
