...
describe("defense-event-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-timeline22");
...
describe("defense-event-timeline22-deep", () => {
...
describe("defense-event-timeline22-wide", () => {
...
describe("defense-event-timeline22-lovat", () => {
