...
describe("defense-event-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-trimmed");
...
describe("defense-event-trimmed-deep", () => {
...
describe("defense-event-trimmed-wide", () => {
...
describe("defense-event-trimmed-lovat", () => {
