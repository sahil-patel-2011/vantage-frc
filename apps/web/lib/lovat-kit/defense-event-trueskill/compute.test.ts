...
describe("defense-event-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-trueskill");
...
describe("defense-event-trueskill-deep", () => {
...
describe("defense-event-trueskill-wide", () => {
...
describe("defense-event-trueskill-lovat", () => {
