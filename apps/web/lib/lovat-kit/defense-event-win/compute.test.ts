...
describe("defense-event-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-win");
...
describe("defense-event-win-deep", () => {
...
describe("defense-event-win-wide", () => {
...
describe("defense-event-win-lovat", () => {
