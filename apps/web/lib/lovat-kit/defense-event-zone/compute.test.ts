...
describe("defense-event-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-zone");
...
describe("defense-event-zone-deep", () => {
...
describe("defense-event-zone-wide", () => {
...
describe("defense-event-zone-lovat", () => {
