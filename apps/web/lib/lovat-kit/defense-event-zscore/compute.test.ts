...
describe("defense-event-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-zscore");
...
describe("defense-event-zscore-deep", () => {
...
describe("defense-event-zscore-wide", () => {
...
describe("defense-event-zscore-lovat", () => {
