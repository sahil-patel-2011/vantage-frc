...
describe("defense-last12-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-assign");
...
describe("defense-last12-assign-deep", () => {
...
describe("defense-last12-assign-wide", () => {
...
describe("defense-last12-assign-lovat", () => {
