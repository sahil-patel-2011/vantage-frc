...
describe("defense-last12-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-brier");
...
describe("defense-last12-brier-deep", () => {
...
describe("defense-last12-brier-wide", () => {
...
describe("defense-last12-brier-lovat", () => {
