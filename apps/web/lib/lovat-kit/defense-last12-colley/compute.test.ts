...
describe("defense-last12-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-colley");
...
describe("defense-last12-colley-deep", () => {
...
describe("defense-last12-colley-wide", () => {
...
describe("defense-last12-colley-lovat", () => {
