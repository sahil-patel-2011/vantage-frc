...
describe("defense-last12-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-combo");
...
describe("defense-last12-combo-deep", () => {
...
describe("defense-last12-combo-wide", () => {
...
describe("defense-last12-combo-lovat", () => {
