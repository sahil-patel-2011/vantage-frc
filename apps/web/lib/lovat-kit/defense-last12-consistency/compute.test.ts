...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 8.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 20.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 36.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 8.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 20.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 36.0 } },
];

describe("defense-last12-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-consistency");
...
describe("defense-last12-consistency-deep", () => {
...
describe("defense-last12-consistency-wide", () => {
...
describe("defense-last12-consistency-lovat", () => {
