...
describe("defense-last12-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-context");
...
describe("defense-last12-context-deep", () => {
...
describe("defense-last12-context-wide", () => {
...
describe("defense-last12-context-lovat", () => {
