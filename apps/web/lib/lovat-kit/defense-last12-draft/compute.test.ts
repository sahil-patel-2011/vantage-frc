...
describe("defense-last12-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-draft");
...
describe("defense-last12-draft-deep", () => {
...
describe("defense-last12-draft-wide", () => {
...
describe("defense-last12-draft-lovat", () => {
