...
describe("defense-last12-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-ewma");
...
describe("defense-last12-ewma-deep", () => {
...
describe("defense-last12-ewma-wide", () => {
...
describe("defense-last12-ewma-lovat", () => {
