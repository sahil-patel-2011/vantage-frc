...
describe("defense-last12-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-flip");
...
describe("defense-last12-flip-deep", () => {
...
describe("defense-last12-flip-wide", () => {
...
describe("defense-last12-flip-lovat", () => {
