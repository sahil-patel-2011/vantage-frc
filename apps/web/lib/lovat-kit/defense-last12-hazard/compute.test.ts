...
describe("defense-last12-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-hazard");
...
describe("defense-last12-hazard-deep", () => {
...
describe("defense-last12-hazard-wide", () => {
...
describe("defense-last12-hazard-lovat", () => {
