...
describe("defense-last12-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-interfere");
...
describe("defense-last12-interfere-deep", () => {
...
describe("defense-last12-interfere-wide", () => {
...
describe("defense-last12-interfere-lovat", () => {
