...
describe("defense-last12-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-lookup");
...
describe("defense-last12-lookup-deep", () => {
...
describe("defense-last12-lookup-wide", () => {
...
describe("defense-last12-lookup-lovat", () => {
