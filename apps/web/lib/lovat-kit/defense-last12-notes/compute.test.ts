...
describe("defense-last12-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-notes");
...
describe("defense-last12-notes-deep", () => {
...
describe("defense-last12-notes-wide", () => {
...
describe("defense-last12-notes-lovat", () => {
