...
describe("defense-last12-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-pareto");
...
describe("defense-last12-pareto-deep", () => {
...
describe("defense-last12-pareto-wide", () => {
...
describe("defense-last12-pareto-lovat", () => {
