...
describe("defense-last12-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-path");
...
describe("defense-last12-path-deep", () => {
...
describe("defense-last12-path-wide", () => {
...
describe("defense-last12-path-lovat", () => {
