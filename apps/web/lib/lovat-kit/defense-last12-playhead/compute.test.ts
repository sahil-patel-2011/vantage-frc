...
describe("defense-last12-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-playhead");
...
describe("defense-last12-playhead-deep", () => {
...
describe("defense-last12-playhead-wide", () => {
...
describe("defense-last12-playhead-lovat", () => {
