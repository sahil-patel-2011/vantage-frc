...
describe("defense-last12-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-rank");
...
describe("defense-last12-rank-deep", () => {
...
describe("defense-last12-rank-wide", () => {
...
describe("defense-last12-rank-lovat", () => {
