...
describe("defense-last12-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-rate");
...
describe("defense-last12-rate-deep", () => {
...
describe("defense-last12-rate-wide", () => {
...
describe("defense-last12-rate-lovat", () => {
