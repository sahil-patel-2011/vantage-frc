...
describe("defense-last12-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-residual");
...
describe("defense-last12-residual-deep", () => {
...
describe("defense-last12-residual-wide", () => {
...
describe("defense-last12-residual-lovat", () => {
