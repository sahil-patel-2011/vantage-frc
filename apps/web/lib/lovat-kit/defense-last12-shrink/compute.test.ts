...
describe("defense-last12-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-shrink");
...
describe("defense-last12-shrink-deep", () => {
...
describe("defense-last12-shrink-wide", () => {
...
describe("defense-last12-shrink-lovat", () => {
