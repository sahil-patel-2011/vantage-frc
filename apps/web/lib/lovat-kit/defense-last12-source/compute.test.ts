...
describe("defense-last12-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-source");
...
describe("defense-last12-source-deep", () => {
...
describe("defense-last12-source-wide", () => {
...
describe("defense-last12-source-lovat", () => {
