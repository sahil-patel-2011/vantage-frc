...
describe("defense-last12-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-streak");
...
describe("defense-last12-streak-deep", () => {
...
describe("defense-last12-streak-wide", () => {
...
describe("defense-last12-streak-lovat", () => {
