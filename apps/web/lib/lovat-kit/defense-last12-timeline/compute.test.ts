...
describe("defense-last12-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-timeline");
...
describe("defense-last12-timeline-deep", () => {
...
describe("defense-last12-timeline-wide", () => {
...
describe("defense-last12-timeline-lovat", () => {
