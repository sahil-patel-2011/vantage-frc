...
describe("defense-last12-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-trimmed");
...
describe("defense-last12-trimmed-deep", () => {
...
describe("defense-last12-trimmed-wide", () => {
...
describe("defense-last12-trimmed-lovat", () => {
