...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 13.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 20.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 45.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 13.0 } },
...
describe("defense-last12-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-trueskill");
...
describe("defense-last12-trueskill-deep", () => {
...
describe("defense-last12-trueskill-wide", () => {
...
describe("defense-last12-trueskill-lovat", () => {
