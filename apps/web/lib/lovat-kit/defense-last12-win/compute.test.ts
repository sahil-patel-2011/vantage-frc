...
describe("defense-last12-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-win");
...
describe("defense-last12-win-deep", () => {
...
describe("defense-last12-win-wide", () => {
...
describe("defense-last12-win-lovat", () => {
