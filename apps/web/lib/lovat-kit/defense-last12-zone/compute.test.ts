...
describe("defense-last12-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-zone");
...
describe("defense-last12-zone-deep", () => {
...
describe("defense-last12-zone-wide", () => {
...
describe("defense-last12-zone-lovat", () => {
