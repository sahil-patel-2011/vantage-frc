...
describe("defense-last12-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-zscore");
...
describe("defense-last12-zscore-deep", () => {
...
describe("defense-last12-zscore-wide", () => {
...
describe("defense-last12-zscore-lovat", () => {
