...
describe("defense-last24-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-assign");
...
describe("defense-last24-assign-deep", () => {
...
describe("defense-last24-assign-wide", () => {
...
describe("defense-last24-assign-lovat", () => {
