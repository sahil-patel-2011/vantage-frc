...
describe("defense-last24-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-brier");
...
describe("defense-last24-brier-deep", () => {
...
describe("defense-last24-brier-wide", () => {
...
describe("defense-last24-brier-lovat", () => {
