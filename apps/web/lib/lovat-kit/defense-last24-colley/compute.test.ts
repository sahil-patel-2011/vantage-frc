...
describe("defense-last24-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-colley");
...
describe("defense-last24-colley-deep", () => {
...
describe("defense-last24-colley-wide", () => {
...
describe("defense-last24-colley-lovat", () => {
