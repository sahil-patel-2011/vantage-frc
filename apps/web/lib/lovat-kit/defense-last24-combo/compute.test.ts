...
describe("defense-last24-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-combo");
...
describe("defense-last24-combo-deep", () => {
...
describe("defense-last24-combo-wide", () => {
...
describe("defense-last24-combo-lovat", () => {
