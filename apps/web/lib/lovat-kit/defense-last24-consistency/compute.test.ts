...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 21.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 28.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 41.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 41.0 } },
];

describe("defense-last24-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-consistency");
...
describe("defense-last24-consistency-deep", () => {
...
describe("defense-last24-consistency-wide", () => {
...
describe("defense-last24-consistency-lovat", () => {
