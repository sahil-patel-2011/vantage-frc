...
describe("defense-last24-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-context");
...
describe("defense-last24-context-deep", () => {
...
describe("defense-last24-context-wide", () => {
...
describe("defense-last24-context-lovat", () => {
