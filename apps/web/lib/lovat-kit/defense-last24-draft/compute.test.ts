...
describe("defense-last24-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-draft");
...
describe("defense-last24-draft-deep", () => {
...
describe("defense-last24-draft-wide", () => {
...
describe("defense-last24-draft-lovat", () => {
