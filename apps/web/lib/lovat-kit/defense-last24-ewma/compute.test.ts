...
describe("defense-last24-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-ewma");
...
describe("defense-last24-ewma-deep", () => {
...
describe("defense-last24-ewma-wide", () => {
...
describe("defense-last24-ewma-lovat", () => {
