...
describe("defense-last24-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-flip");
...
describe("defense-last24-flip-deep", () => {
...
describe("defense-last24-flip-wide", () => {
...
describe("defense-last24-flip-lovat", () => {
