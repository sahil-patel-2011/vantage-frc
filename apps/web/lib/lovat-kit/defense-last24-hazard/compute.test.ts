...
describe("defense-last24-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-hazard");
...
describe("defense-last24-hazard-deep", () => {
...
describe("defense-last24-hazard-wide", () => {
...
describe("defense-last24-hazard-lovat", () => {
