...
describe("defense-last24-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-interfere");
...
describe("defense-last24-interfere-deep", () => {
...
describe("defense-last24-interfere-wide", () => {
...
describe("defense-last24-interfere-lovat", () => {
