...
describe("defense-last24-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-lookup");
...
describe("defense-last24-lookup-deep", () => {
...
describe("defense-last24-lookup-wide", () => {
...
describe("defense-last24-lookup-lovat", () => {
