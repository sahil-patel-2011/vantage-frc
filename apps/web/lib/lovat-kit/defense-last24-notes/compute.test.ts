...
describe("defense-last24-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-notes");
...
describe("defense-last24-notes-deep", () => {
...
describe("defense-last24-notes-wide", () => {
...
describe("defense-last24-notes-lovat", () => {
