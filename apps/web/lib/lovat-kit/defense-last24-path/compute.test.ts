...
describe("defense-last24-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-path");
...
describe("defense-last24-path-deep", () => {
...
describe("defense-last24-path-wide", () => {
...
describe("defense-last24-path-lovat", () => {
