...
describe("defense-last24-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-picklist");
...
describe("defense-last24-picklist-deep", () => {
...
describe("defense-last24-picklist-wide", () => {
...
describe("defense-last24-picklist-lovat", () => {
