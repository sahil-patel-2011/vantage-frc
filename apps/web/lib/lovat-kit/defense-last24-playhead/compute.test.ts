...
describe("defense-last24-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-playhead");
...
describe("defense-last24-playhead-deep", () => {
...
describe("defense-last24-playhead-wide", () => {
...
describe("defense-last24-playhead-lovat", () => {
