...
describe("defense-last24-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-rank");
...
describe("defense-last24-rank-deep", () => {
...
describe("defense-last24-rank-wide", () => {
...
describe("defense-last24-rank-lovat", () => {
