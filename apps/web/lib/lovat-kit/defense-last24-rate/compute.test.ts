...
describe("defense-last24-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-rate");
...
describe("defense-last24-rate-deep", () => {
...
describe("defense-last24-rate-wide", () => {
...
describe("defense-last24-rate-lovat", () => {
