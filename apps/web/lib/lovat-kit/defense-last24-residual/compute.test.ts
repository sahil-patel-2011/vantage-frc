...
describe("defense-last24-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-residual");
...
describe("defense-last24-residual-deep", () => {
...
describe("defense-last24-residual-wide", () => {
...
describe("defense-last24-residual-lovat", () => {
