...
describe("defense-last24-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-shrink");
...
describe("defense-last24-shrink-deep", () => {
...
describe("defense-last24-shrink-wide", () => {
...
describe("defense-last24-shrink-lovat", () => {
