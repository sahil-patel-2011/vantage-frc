...
describe("defense-last24-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-source");
...
describe("defense-last24-source-deep", () => {
...
describe("defense-last24-source-wide", () => {
...
describe("defense-last24-source-lovat", () => {
