...
describe("defense-last24-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-streak");
...
describe("defense-last24-streak-deep", () => {
...
describe("defense-last24-streak-wide", () => {
...
describe("defense-last24-streak-lovat", () => {
