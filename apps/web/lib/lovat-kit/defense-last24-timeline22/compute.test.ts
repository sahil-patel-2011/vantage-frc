...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 24.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 26.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 36.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 24.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 26.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 36.0 } },
];

describe("defense-last24-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-timeline22");
...
describe("defense-last24-timeline22-deep", () => {
...
describe("defense-last24-timeline22-wide", () => {
...
describe("defense-last24-timeline22-lovat", () => {
