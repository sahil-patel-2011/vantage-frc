...
describe("defense-last24-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-trimmed");
...
describe("defense-last24-trimmed-deep", () => {
...
describe("defense-last24-trimmed-wide", () => {
...
describe("defense-last24-trimmed-lovat", () => {
