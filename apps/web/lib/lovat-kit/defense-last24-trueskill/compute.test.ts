...
describe("defense-last24-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-trueskill");
...
describe("defense-last24-trueskill-deep", () => {
...
describe("defense-last24-trueskill-wide", () => {
...
describe("defense-last24-trueskill-lovat", () => {
