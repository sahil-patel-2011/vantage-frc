...
describe("defense-last24-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-win");
...
describe("defense-last24-win-deep", () => {
...
describe("defense-last24-win-wide", () => {
...
describe("defense-last24-win-lovat", () => {
