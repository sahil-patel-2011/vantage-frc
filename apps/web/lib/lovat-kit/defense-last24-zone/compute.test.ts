...
describe("defense-last24-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-zone");
...
describe("defense-last24-zone-deep", () => {
...
describe("defense-last24-zone-wide", () => {
...
describe("defense-last24-zone-lovat", () => {
