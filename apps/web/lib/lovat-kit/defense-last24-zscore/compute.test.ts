...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 19.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 31.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 47.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 19.0 } },
...
describe("defense-last24-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last24-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last24-zscore");
...
describe("defense-last24-zscore-deep", () => {
...
describe("defense-last24-zscore-wide", () => {
...
describe("defense-last24-zscore-lovat", () => {
