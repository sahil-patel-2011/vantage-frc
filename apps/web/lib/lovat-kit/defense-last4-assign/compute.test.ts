...
describe("defense-last4-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-assign");
...
describe("defense-last4-assign-deep", () => {
...
describe("defense-last4-assign-wide", () => {
...
describe("defense-last4-assign-lovat", () => {
