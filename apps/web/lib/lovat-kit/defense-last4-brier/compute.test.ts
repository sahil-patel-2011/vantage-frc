...
describe("defense-last4-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-brier");
...
describe("defense-last4-brier-deep", () => {
...
describe("defense-last4-brier-wide", () => {
...
describe("defense-last4-brier-lovat", () => {
