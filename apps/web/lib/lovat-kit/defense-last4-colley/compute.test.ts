...
describe("defense-last4-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-colley");
...
describe("defense-last4-colley-deep", () => {
...
describe("defense-last4-colley-wide", () => {
...
describe("defense-last4-colley-lovat", () => {
