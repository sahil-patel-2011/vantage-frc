...
describe("defense-last4-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-combo");
...
describe("defense-last4-combo-deep", () => {
...
describe("defense-last4-combo-wide", () => {
...
describe("defense-last4-combo-lovat", () => {
