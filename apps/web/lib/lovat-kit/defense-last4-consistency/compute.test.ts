...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { defenseTime: 47.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 47.0 } },
];

describe("defense-last4-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-consistency");
...
describe("defense-last4-consistency-deep", () => {
...
describe("defense-last4-consistency-wide", () => {
...
describe("defense-last4-consistency-lovat", () => {
