...
describe("defense-last4-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-context");
...
describe("defense-last4-context-deep", () => {
...
describe("defense-last4-context-wide", () => {
...
describe("defense-last4-context-lovat", () => {
