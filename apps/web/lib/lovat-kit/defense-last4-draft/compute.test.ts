...
describe("defense-last4-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-draft");
...
describe("defense-last4-draft-deep", () => {
...
describe("defense-last4-draft-wide", () => {
...
describe("defense-last4-draft-lovat", () => {
