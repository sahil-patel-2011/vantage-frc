...
describe("defense-last4-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-ewma");
...
describe("defense-last4-ewma-deep", () => {
...
describe("defense-last4-ewma-wide", () => {
...
describe("defense-last4-ewma-lovat", () => {
