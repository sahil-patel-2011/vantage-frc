...
describe("defense-last4-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-flip");
...
describe("defense-last4-flip-deep", () => {
...
describe("defense-last4-flip-wide", () => {
...
describe("defense-last4-flip-lovat", () => {
