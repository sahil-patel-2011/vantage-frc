...
describe("defense-last4-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-hazard");
...
describe("defense-last4-hazard-deep", () => {
...
describe("defense-last4-hazard-wide", () => {
...
describe("defense-last4-hazard-lovat", () => {
