...
describe("defense-last4-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-interfere");
...
describe("defense-last4-interfere-deep", () => {
...
describe("defense-last4-interfere-wide", () => {
...
describe("defense-last4-interfere-lovat", () => {
