...
describe("defense-last4-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-lookup");
...
describe("defense-last4-lookup-deep", () => {
...
describe("defense-last4-lookup-wide", () => {
...
describe("defense-last4-lookup-lovat", () => {
