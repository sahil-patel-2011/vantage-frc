...
describe("defense-last4-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-notes");
...
describe("defense-last4-notes-deep", () => {
...
describe("defense-last4-notes-wide", () => {
...
describe("defense-last4-notes-lovat", () => {
