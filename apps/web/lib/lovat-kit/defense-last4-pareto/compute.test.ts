...
describe("defense-last4-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-pareto");
...
describe("defense-last4-pareto-deep", () => {
...
describe("defense-last4-pareto-wide", () => {
...
describe("defense-last4-pareto-lovat", () => {
