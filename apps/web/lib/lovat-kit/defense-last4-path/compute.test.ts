...
describe("defense-last4-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-path");
...
describe("defense-last4-path-deep", () => {
...
describe("defense-last4-path-wide", () => {
...
describe("defense-last4-path-lovat", () => {
