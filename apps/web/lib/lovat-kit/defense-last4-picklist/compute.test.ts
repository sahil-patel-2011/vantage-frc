...
describe("defense-last4-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-picklist");
...
describe("defense-last4-picklist-deep", () => {
...
describe("defense-last4-picklist-wide", () => {
...
describe("defense-last4-picklist-lovat", () => {
