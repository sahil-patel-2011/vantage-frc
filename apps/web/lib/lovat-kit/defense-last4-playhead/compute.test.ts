...
describe("defense-last4-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-playhead");
...
describe("defense-last4-playhead-deep", () => {
...
describe("defense-last4-playhead-wide", () => {
...
describe("defense-last4-playhead-lovat", () => {
