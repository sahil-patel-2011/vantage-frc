...
describe("defense-last4-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-rank");
...
describe("defense-last4-rank-deep", () => {
...
describe("defense-last4-rank-wide", () => {
...
describe("defense-last4-rank-lovat", () => {
