...
describe("defense-last4-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-rate");
...
describe("defense-last4-rate-deep", () => {
...
describe("defense-last4-rate-wide", () => {
...
describe("defense-last4-rate-lovat", () => {
