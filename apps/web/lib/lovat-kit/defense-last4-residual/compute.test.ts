...
describe("defense-last4-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-residual");
...
describe("defense-last4-residual-deep", () => {
...
describe("defense-last4-residual-wide", () => {
...
describe("defense-last4-residual-lovat", () => {
