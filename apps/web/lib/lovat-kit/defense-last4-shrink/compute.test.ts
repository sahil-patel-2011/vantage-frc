...
describe("defense-last4-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-shrink");
...
describe("defense-last4-shrink-deep", () => {
...
describe("defense-last4-shrink-wide", () => {
...
describe("defense-last4-shrink-lovat", () => {
