...
describe("defense-last4-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-source");
...
describe("defense-last4-source-deep", () => {
...
describe("defense-last4-source-wide", () => {
...
describe("defense-last4-source-lovat", () => {
