...
describe("defense-last4-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-streak");
...
describe("defense-last4-streak-deep", () => {
...
describe("defense-last4-streak-wide", () => {
...
describe("defense-last4-streak-lovat", () => {
