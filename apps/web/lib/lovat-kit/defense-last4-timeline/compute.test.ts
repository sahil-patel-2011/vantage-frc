...
describe("defense-last4-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-timeline");
...
describe("defense-last4-timeline-deep", () => {
...
describe("defense-last4-timeline-wide", () => {
...
describe("defense-last4-timeline-lovat", () => {
