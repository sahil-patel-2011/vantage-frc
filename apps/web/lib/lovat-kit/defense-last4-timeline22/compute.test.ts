...
describe("defense-last4-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-timeline22");
...
describe("defense-last4-timeline22-deep", () => {
...
describe("defense-last4-timeline22-wide", () => {
...
describe("defense-last4-timeline22-lovat", () => {
