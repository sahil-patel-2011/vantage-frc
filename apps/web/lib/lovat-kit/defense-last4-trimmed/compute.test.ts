...
describe("defense-last4-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-trimmed");
...
describe("defense-last4-trimmed-deep", () => {
...
describe("defense-last4-trimmed-wide", () => {
...
describe("defense-last4-trimmed-lovat", () => {
