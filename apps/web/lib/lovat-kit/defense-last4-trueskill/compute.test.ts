...
describe("defense-last4-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-trueskill");
...
describe("defense-last4-trueskill-deep", () => {
...
describe("defense-last4-trueskill-wide", () => {
...
describe("defense-last4-trueskill-lovat", () => {
