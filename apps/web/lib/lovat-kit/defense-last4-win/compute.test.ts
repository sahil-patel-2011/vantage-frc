...
describe("defense-last4-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-win");
...
describe("defense-last4-win-deep", () => {
...
describe("defense-last4-win-wide", () => {
...
describe("defense-last4-win-lovat", () => {
