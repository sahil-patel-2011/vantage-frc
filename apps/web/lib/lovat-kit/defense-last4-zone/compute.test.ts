...
describe("defense-last4-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-zone");
...
describe("defense-last4-zone-deep", () => {
...
describe("defense-last4-zone-wide", () => {
...
describe("defense-last4-zone-lovat", () => {
