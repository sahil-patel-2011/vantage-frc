...
describe("defense-last4-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last4-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last4-zscore");
...
describe("defense-last4-zscore-deep", () => {
...
describe("defense-last4-zscore-wide", () => {
...
describe("defense-last4-zscore-lovat", () => {
