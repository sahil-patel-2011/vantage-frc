...
describe("defense-last6-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-assign");
...
describe("defense-last6-assign-deep", () => {
...
describe("defense-last6-assign-wide", () => {
...
describe("defense-last6-assign-lovat", () => {
