...
describe("defense-last6-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-brier");
...
describe("defense-last6-brier-deep", () => {
...
describe("defense-last6-brier-wide", () => {
...
describe("defense-last6-brier-lovat", () => {
