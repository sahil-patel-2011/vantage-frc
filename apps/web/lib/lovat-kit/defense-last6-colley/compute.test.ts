...
describe("defense-last6-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-colley");
...
describe("defense-last6-colley-deep", () => {
...
describe("defense-last6-colley-wide", () => {
...
describe("defense-last6-colley-lovat", () => {
