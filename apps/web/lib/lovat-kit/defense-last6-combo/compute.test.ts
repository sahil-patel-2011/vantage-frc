...
describe("defense-last6-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-combo");
...
describe("defense-last6-combo-deep", () => {
...
describe("defense-last6-combo-wide", () => {
...
describe("defense-last6-combo-lovat", () => {
