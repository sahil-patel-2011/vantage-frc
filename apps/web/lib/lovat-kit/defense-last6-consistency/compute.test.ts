...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 25.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 32.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 45.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 25.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 45.0 } },
];

describe("defense-last6-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-consistency");
...
describe("defense-last6-consistency-deep", () => {
...
describe("defense-last6-consistency-wide", () => {
...
describe("defense-last6-consistency-lovat", () => {
