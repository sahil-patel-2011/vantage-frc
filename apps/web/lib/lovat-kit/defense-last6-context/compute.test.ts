...
describe("defense-last6-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-context");
...
describe("defense-last6-context-deep", () => {
...
describe("defense-last6-context-wide", () => {
...
describe("defense-last6-context-lovat", () => {
