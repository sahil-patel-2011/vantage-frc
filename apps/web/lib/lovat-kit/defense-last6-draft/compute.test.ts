...
describe("defense-last6-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-draft");
...
describe("defense-last6-draft-deep", () => {
...
describe("defense-last6-draft-wide", () => {
...
describe("defense-last6-draft-lovat", () => {
