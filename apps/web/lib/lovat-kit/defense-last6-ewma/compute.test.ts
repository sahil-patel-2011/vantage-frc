...
describe("defense-last6-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-ewma");
...
describe("defense-last6-ewma-deep", () => {
...
describe("defense-last6-ewma-wide", () => {
...
describe("defense-last6-ewma-lovat", () => {
