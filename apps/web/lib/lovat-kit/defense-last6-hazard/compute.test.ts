...
describe("defense-last6-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-hazard");
...
describe("defense-last6-hazard-deep", () => {
...
describe("defense-last6-hazard-wide", () => {
...
describe("defense-last6-hazard-lovat", () => {
