...
describe("defense-last6-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-interfere");
...
describe("defense-last6-interfere-deep", () => {
...
describe("defense-last6-interfere-wide", () => {
...
describe("defense-last6-interfere-lovat", () => {
