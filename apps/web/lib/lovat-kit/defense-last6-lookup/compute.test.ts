...
describe("defense-last6-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-lookup");
...
describe("defense-last6-lookup-deep", () => {
...
describe("defense-last6-lookup-wide", () => {
...
describe("defense-last6-lookup-lovat", () => {
