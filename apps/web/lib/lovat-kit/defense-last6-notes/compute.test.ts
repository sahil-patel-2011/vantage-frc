...
describe("defense-last6-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-notes");
...
describe("defense-last6-notes-deep", () => {
...
describe("defense-last6-notes-wide", () => {
...
describe("defense-last6-notes-lovat", () => {
