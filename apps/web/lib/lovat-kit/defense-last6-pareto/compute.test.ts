...
describe("defense-last6-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-pareto");
...
describe("defense-last6-pareto-deep", () => {
...
describe("defense-last6-pareto-wide", () => {
...
describe("defense-last6-pareto-lovat", () => {
