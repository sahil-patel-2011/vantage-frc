...
describe("defense-last6-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-path");
...
describe("defense-last6-path-deep", () => {
...
describe("defense-last6-path-wide", () => {
...
describe("defense-last6-path-lovat", () => {
