...
describe("defense-last6-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-playhead");
...
describe("defense-last6-playhead-deep", () => {
...
describe("defense-last6-playhead-wide", () => {
...
describe("defense-last6-playhead-lovat", () => {
