...
describe("defense-last6-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-rank");
...
describe("defense-last6-rank-deep", () => {
...
describe("defense-last6-rank-wide", () => {
...
describe("defense-last6-rank-lovat", () => {
