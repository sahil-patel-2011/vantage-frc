...
describe("defense-last6-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-rate");
...
describe("defense-last6-rate-deep", () => {
...
describe("defense-last6-rate-wide", () => {
...
describe("defense-last6-rate-lovat", () => {
