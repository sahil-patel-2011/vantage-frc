...
describe("defense-last6-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-residual");
...
describe("defense-last6-residual-deep", () => {
...
describe("defense-last6-residual-wide", () => {
...
describe("defense-last6-residual-lovat", () => {
