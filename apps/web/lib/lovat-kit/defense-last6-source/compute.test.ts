...
describe("defense-last6-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-source");
...
describe("defense-last6-source-deep", () => {
...
describe("defense-last6-source-wide", () => {
...
describe("defense-last6-source-lovat", () => {
