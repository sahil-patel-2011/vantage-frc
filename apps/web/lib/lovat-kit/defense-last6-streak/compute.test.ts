...
describe("defense-last6-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-streak");
...
describe("defense-last6-streak-deep", () => {
...
describe("defense-last6-streak-wide", () => {
...
describe("defense-last6-streak-lovat", () => {
