...
describe("defense-last6-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-timeline");
...
describe("defense-last6-timeline-deep", () => {
...
describe("defense-last6-timeline-wide", () => {
...
describe("defense-last6-timeline-lovat", () => {
