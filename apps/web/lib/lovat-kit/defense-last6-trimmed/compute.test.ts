...
describe("defense-last6-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-trimmed");
...
describe("defense-last6-trimmed-deep", () => {
...
describe("defense-last6-trimmed-wide", () => {
...
describe("defense-last6-trimmed-lovat", () => {
