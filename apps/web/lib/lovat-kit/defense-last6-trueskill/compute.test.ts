...
describe("defense-last6-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-trueskill");
...
describe("defense-last6-trueskill-deep", () => {
...
describe("defense-last6-trueskill-wide", () => {
...
describe("defense-last6-trueskill-lovat", () => {
