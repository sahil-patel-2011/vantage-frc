...
describe("defense-last6-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-win");
...
describe("defense-last6-win-deep", () => {
...
describe("defense-last6-win-wide", () => {
...
describe("defense-last6-win-lovat", () => {
