...
describe("defense-last6-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-zone");
...
describe("defense-last6-zone-deep", () => {
...
describe("defense-last6-zone-wide", () => {
...
describe("defense-last6-zone-lovat", () => {
