...
describe("defense-last6-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-zscore");
...
describe("defense-last6-zscore-deep", () => {
...
describe("defense-last6-zscore-wide", () => {
...
describe("defense-last6-zscore-lovat", () => {
