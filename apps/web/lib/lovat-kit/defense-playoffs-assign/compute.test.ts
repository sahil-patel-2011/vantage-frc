...
describe("defense-playoffs-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-assign");
...
describe("defense-playoffs-assign-deep", () => {
...
describe("defense-playoffs-assign-wide", () => {
...
describe("defense-playoffs-assign-lovat", () => {
