...
describe("defense-playoffs-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-brier");
...
describe("defense-playoffs-brier-deep", () => {
...
describe("defense-playoffs-brier-wide", () => {
...
describe("defense-playoffs-brier-lovat", () => {
