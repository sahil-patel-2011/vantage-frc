...
describe("defense-playoffs-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-colley");
...
describe("defense-playoffs-colley-deep", () => {
...
describe("defense-playoffs-colley-wide", () => {
...
describe("defense-playoffs-colley-lovat", () => {
