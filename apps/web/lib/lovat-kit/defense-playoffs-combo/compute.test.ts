...
describe("defense-playoffs-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-combo");
...
describe("defense-playoffs-combo-deep", () => {
...
describe("defense-playoffs-combo-wide", () => {
...
describe("defense-playoffs-combo-lovat", () => {
