...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 27.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 24.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 43.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 43.0 } },
];

describe("defense-playoffs-consistency", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "defenseTime")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-consistency");
...
describe("defense-playoffs-consistency-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { defenseTime: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { defenseTime: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { defenseTime: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { defenseTime: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { defenseTime: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { defenseTime: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "defenseTime")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("defense-playoffs-consistency-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statDefenseTime(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesDefenseTime(rows, "frc9").length).toBe(0);
...
describe("defense-playoffs-consistency-lovat", () => {
