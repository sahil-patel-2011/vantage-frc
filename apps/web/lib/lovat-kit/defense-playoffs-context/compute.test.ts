...
describe("defense-playoffs-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-context");
...
describe("defense-playoffs-context-deep", () => {
...
describe("defense-playoffs-context-wide", () => {
...
describe("defense-playoffs-context-lovat", () => {
