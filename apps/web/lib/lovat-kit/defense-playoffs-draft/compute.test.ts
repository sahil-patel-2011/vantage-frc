...
describe("defense-playoffs-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-draft");
...
describe("defense-playoffs-draft-deep", () => {
...
describe("defense-playoffs-draft-wide", () => {
...
describe("defense-playoffs-draft-lovat", () => {
