...
describe("defense-playoffs-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-ewma");
...
describe("defense-playoffs-ewma-deep", () => {
...
describe("defense-playoffs-ewma-wide", () => {
...
describe("defense-playoffs-ewma-lovat", () => {
