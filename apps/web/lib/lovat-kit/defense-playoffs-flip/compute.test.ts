...
describe("defense-playoffs-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-flip");
...
describe("defense-playoffs-flip-deep", () => {
...
describe("defense-playoffs-flip-wide", () => {
...
describe("defense-playoffs-flip-lovat", () => {
