...
describe("defense-playoffs-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-hazard");
...
describe("defense-playoffs-hazard-deep", () => {
...
describe("defense-playoffs-hazard-wide", () => {
...
describe("defense-playoffs-hazard-lovat", () => {
