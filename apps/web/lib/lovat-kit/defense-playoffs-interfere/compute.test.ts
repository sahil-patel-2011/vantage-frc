...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 17.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 34.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 41.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 41.0 } },
];

describe("defense-playoffs-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-interfere");
...
describe("defense-playoffs-interfere-deep", () => {
...
describe("defense-playoffs-interfere-wide", () => {
...
describe("defense-playoffs-interfere-lovat", () => {
