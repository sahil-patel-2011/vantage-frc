...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 15.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 22.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 47.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 22.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 47.0 } },
];

describe("defense-playoffs-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-lookup");
...
describe("defense-playoffs-lookup-deep", () => {
...
describe("defense-playoffs-lookup-wide", () => {
...
describe("defense-playoffs-lookup-lovat", () => {
