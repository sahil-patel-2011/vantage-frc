...
describe("defense-playoffs-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-notes");
...
describe("defense-playoffs-notes-deep", () => {
...
describe("defense-playoffs-notes-wide", () => {
...
describe("defense-playoffs-notes-lovat", () => {
