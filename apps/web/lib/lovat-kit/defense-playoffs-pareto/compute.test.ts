...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 26.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 28.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 38.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 26.0 } },
...
describe("defense-playoffs-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-pareto");
...
describe("defense-playoffs-pareto-deep", () => {
...
describe("defense-playoffs-pareto-wide", () => {
...
describe("defense-playoffs-pareto-lovat", () => {
