...
describe("defense-playoffs-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-path");
...
describe("defense-playoffs-path-deep", () => {
...
describe("defense-playoffs-path-wide", () => {
...
describe("defense-playoffs-path-lovat", () => {
