...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 20.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 32.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 36.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 20.0 } },
...
describe("defense-playoffs-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-picklist");
...
describe("defense-playoffs-picklist-deep", () => {
...
describe("defense-playoffs-picklist-wide", () => {
...
describe("defense-playoffs-picklist-lovat", () => {
