...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 9.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 31.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 41.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 9.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 31.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 41.0 } },
];

describe("defense-playoffs-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-playhead");
...
describe("defense-playoffs-playhead-deep", () => {
...
describe("defense-playoffs-playhead-wide", () => {
...
describe("defense-playoffs-playhead-lovat", () => {
