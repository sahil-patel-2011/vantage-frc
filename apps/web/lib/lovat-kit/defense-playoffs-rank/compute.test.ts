...
describe("defense-playoffs-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-rank");
...
describe("defense-playoffs-rank-deep", () => {
...
describe("defense-playoffs-rank-wide", () => {
...
describe("defense-playoffs-rank-lovat", () => {
