...
describe("defense-playoffs-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-rate");
...
describe("defense-playoffs-rate-deep", () => {
...
describe("defense-playoffs-rate-wide", () => {
...
describe("defense-playoffs-rate-lovat", () => {
