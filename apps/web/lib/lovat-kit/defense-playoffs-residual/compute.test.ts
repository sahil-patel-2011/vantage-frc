...
describe("defense-playoffs-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-residual");
...
describe("defense-playoffs-residual-deep", () => {
...
describe("defense-playoffs-residual-wide", () => {
...
describe("defense-playoffs-residual-lovat", () => {
