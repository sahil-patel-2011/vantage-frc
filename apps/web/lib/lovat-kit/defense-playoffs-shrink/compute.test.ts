...
describe("defense-playoffs-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-shrink");
...
describe("defense-playoffs-shrink-deep", () => {
...
describe("defense-playoffs-shrink-wide", () => {
...
describe("defense-playoffs-shrink-lovat", () => {
