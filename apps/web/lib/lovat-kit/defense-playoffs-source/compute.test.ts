...
describe("defense-playoffs-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-source");
...
describe("defense-playoffs-source-deep", () => {
...
describe("defense-playoffs-source-wide", () => {
...
describe("defense-playoffs-source-lovat", () => {
