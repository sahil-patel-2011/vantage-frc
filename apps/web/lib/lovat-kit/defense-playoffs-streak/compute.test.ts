...
describe("defense-playoffs-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-streak");
...
describe("defense-playoffs-streak-deep", () => {
...
describe("defense-playoffs-streak-wide", () => {
...
describe("defense-playoffs-streak-lovat", () => {
