...
describe("defense-playoffs-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-timeline");
...
describe("defense-playoffs-timeline-deep", () => {
...
describe("defense-playoffs-timeline-wide", () => {
...
describe("defense-playoffs-timeline-lovat", () => {
