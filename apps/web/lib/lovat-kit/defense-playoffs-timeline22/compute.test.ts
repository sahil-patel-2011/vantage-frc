...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 22.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 24.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 46.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 46.0 } },
];

describe("defense-playoffs-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-timeline22");
...
describe("defense-playoffs-timeline22-deep", () => {
...
describe("defense-playoffs-timeline22-wide", () => {
...
describe("defense-playoffs-timeline22-lovat", () => {
