...
describe("defense-playoffs-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-trimmed");
...
describe("defense-playoffs-trimmed-deep", () => {
...
describe("defense-playoffs-trimmed-wide", () => {
...
describe("defense-playoffs-trimmed-lovat", () => {
