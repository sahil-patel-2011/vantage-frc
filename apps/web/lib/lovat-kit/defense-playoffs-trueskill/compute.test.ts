...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 10.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 32.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 42.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 42.0 } },
];

describe("defense-playoffs-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-trueskill");
...
describe("defense-playoffs-trueskill-deep", () => {
...
describe("defense-playoffs-trueskill-wide", () => {
...
describe("defense-playoffs-trueskill-lovat", () => {
