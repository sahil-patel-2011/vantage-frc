...
describe("defense-playoffs-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-win");
...
describe("defense-playoffs-win-deep", () => {
...
describe("defense-playoffs-win-wide", () => {
...
describe("defense-playoffs-win-lovat", () => {
