...
describe("defense-playoffs-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-zone");
...
describe("defense-playoffs-zone-deep", () => {
...
describe("defense-playoffs-zone-wide", () => {
...
describe("defense-playoffs-zone-lovat", () => {
