...
describe("defense-playoffs-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-playoffs-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-playoffs-zscore");
...
describe("defense-playoffs-zscore-deep", () => {
...
describe("defense-playoffs-zscore-wide", () => {
...
describe("defense-playoffs-zscore-lovat", () => {
