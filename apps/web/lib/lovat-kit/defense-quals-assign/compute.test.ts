...
describe("defense-quals-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-assign");
...
describe("defense-quals-assign-deep", () => {
...
describe("defense-quals-assign-wide", () => {
...
describe("defense-quals-assign-lovat", () => {
