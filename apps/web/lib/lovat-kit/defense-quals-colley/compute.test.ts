...
describe("defense-quals-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-colley");
...
describe("defense-quals-colley-deep", () => {
...
describe("defense-quals-colley-wide", () => {
...
describe("defense-quals-colley-lovat", () => {
