...
describe("defense-quals-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-combo");
...
describe("defense-quals-combo-deep", () => {
...
describe("defense-quals-combo-wide", () => {
...
describe("defense-quals-combo-lovat", () => {
