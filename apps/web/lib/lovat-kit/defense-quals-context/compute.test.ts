...
describe("defense-quals-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-context");
...
describe("defense-quals-context-deep", () => {
...
describe("defense-quals-context-wide", () => {
...
describe("defense-quals-context-lovat", () => {
