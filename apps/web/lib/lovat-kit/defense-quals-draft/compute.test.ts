...
describe("defense-quals-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-draft");
...
describe("defense-quals-draft-deep", () => {
...
describe("defense-quals-draft-wide", () => {
...
describe("defense-quals-draft-lovat", () => {
