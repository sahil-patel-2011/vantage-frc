...
describe("defense-quals-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-ewma");
...
describe("defense-quals-ewma-deep", () => {
...
describe("defense-quals-ewma-wide", () => {
...
describe("defense-quals-ewma-lovat", () => {
