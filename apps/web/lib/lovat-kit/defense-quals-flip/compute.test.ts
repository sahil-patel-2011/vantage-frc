...
describe("defense-quals-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-flip");
...
describe("defense-quals-flip-deep", () => {
...
describe("defense-quals-flip-wide", () => {
...
describe("defense-quals-flip-lovat", () => {
