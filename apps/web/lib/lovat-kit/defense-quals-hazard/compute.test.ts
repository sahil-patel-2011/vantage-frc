...
describe("defense-quals-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-hazard");
...
describe("defense-quals-hazard-deep", () => {
...
describe("defense-quals-hazard-wide", () => {
...
describe("defense-quals-hazard-lovat", () => {
