...
describe("defense-quals-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-interfere");
...
describe("defense-quals-interfere-deep", () => {
...
describe("defense-quals-interfere-wide", () => {
...
describe("defense-quals-interfere-lovat", () => {
