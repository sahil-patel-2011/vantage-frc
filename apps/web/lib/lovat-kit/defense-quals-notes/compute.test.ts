...
describe("defense-quals-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-notes");
...
describe("defense-quals-notes-deep", () => {
...
describe("defense-quals-notes-wide", () => {
...
describe("defense-quals-notes-lovat", () => {
