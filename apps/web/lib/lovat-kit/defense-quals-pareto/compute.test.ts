...
describe("defense-quals-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-pareto");
...
describe("defense-quals-pareto-deep", () => {
...
describe("defense-quals-pareto-wide", () => {
...
describe("defense-quals-pareto-lovat", () => {
