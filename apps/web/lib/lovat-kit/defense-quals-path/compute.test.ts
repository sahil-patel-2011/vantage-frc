...
describe("defense-quals-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-path");
...
describe("defense-quals-path-deep", () => {
...
describe("defense-quals-path-wide", () => {
...
describe("defense-quals-path-lovat", () => {
