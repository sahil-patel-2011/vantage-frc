...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 16.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 33.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 40.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 16.0 } },
...
describe("defense-quals-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-picklist");
...
describe("defense-quals-picklist-deep", () => {
...
describe("defense-quals-picklist-wide", () => {
...
describe("defense-quals-picklist-lovat", () => {
