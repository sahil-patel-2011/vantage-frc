...
describe("defense-quals-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-playhead");
...
describe("defense-quals-playhead-deep", () => {
...
describe("defense-quals-playhead-wide", () => {
...
describe("defense-quals-playhead-lovat", () => {
