...
describe("defense-quals-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-rank");
...
describe("defense-quals-rank-deep", () => {
...
describe("defense-quals-rank-wide", () => {
...
describe("defense-quals-rank-lovat", () => {
