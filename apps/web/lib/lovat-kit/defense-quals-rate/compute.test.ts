...
describe("defense-quals-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-rate");
...
describe("defense-quals-rate-deep", () => {
...
describe("defense-quals-rate-wide", () => {
...
describe("defense-quals-rate-lovat", () => {
