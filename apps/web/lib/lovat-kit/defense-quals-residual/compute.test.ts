...
describe("defense-quals-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-residual");
...
describe("defense-quals-residual-deep", () => {
...
describe("defense-quals-residual-wide", () => {
...
describe("defense-quals-residual-lovat", () => {
