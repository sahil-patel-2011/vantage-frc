...
describe("defense-quals-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-shrink");
...
describe("defense-quals-shrink-deep", () => {
...
describe("defense-quals-shrink-wide", () => {
...
describe("defense-quals-shrink-lovat", () => {
