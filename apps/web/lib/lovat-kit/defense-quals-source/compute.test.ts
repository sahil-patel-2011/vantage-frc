...
describe("defense-quals-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-source");
...
describe("defense-quals-source-deep", () => {
...
describe("defense-quals-source-wide", () => {
...
describe("defense-quals-source-lovat", () => {
