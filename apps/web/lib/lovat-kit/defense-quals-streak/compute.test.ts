...
describe("defense-quals-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-streak");
...
describe("defense-quals-streak-deep", () => {
...
describe("defense-quals-streak-wide", () => {
...
describe("defense-quals-streak-lovat", () => {
