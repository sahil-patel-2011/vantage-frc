...
describe("defense-quals-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-timeline");
...
describe("defense-quals-timeline-deep", () => {
...
describe("defense-quals-timeline-wide", () => {
...
describe("defense-quals-timeline-lovat", () => {
