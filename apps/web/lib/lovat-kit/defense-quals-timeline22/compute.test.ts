...
describe("defense-quals-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-timeline22");
...
describe("defense-quals-timeline22-deep", () => {
...
describe("defense-quals-timeline22-wide", () => {
...
describe("defense-quals-timeline22-lovat", () => {
