...
describe("defense-quals-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-trimmed");
...
describe("defense-quals-trimmed-deep", () => {
...
describe("defense-quals-trimmed-wide", () => {
...
describe("defense-quals-trimmed-lovat", () => {
