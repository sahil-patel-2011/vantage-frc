...
describe("defense-quals-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-trueskill");
    ...
    expect(bootstrapMean([26.0, 23.0, 42.0])).not.toBeNull();
...
describe("defense-quals-trueskill-deep", () => {
...
describe("defense-quals-trueskill-wide", () => {
...
describe("defense-quals-trueskill-lovat", () => {
