...
describe("defense-quals-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-win");
...
describe("defense-quals-win-deep", () => {
...
describe("defense-quals-win-wide", () => {
...
describe("defense-quals-win-lovat", () => {
