...
describe("defense-quals-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-zone");
...
describe("defense-quals-zone-deep", () => {
...
describe("defense-quals-zone-wide", () => {
...
describe("defense-quals-zone-lovat", () => {
