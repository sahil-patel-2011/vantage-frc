...
describe("defense-quals-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-zscore");
...
describe("defense-quals-zscore-deep", () => {
...
describe("defense-quals-zscore-wide", () => {
...
describe("defense-quals-zscore-lovat", () => {
