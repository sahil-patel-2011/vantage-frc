...
describe("defense-recent3-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-brier");
...
describe("defense-recent3-brier-deep", () => {
...
describe("defense-recent3-brier-wide", () => {
...
describe("defense-recent3-brier-lovat", () => {
