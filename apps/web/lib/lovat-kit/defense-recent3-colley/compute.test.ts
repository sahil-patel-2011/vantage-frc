...
describe("defense-recent3-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-colley");
...
describe("defense-recent3-colley-deep", () => {
...
describe("defense-recent3-colley-wide", () => {
...
describe("defense-recent3-colley-lovat", () => {
