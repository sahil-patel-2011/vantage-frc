...
describe("defense-recent3-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-combo");
...
describe("defense-recent3-combo-deep", () => {
...
describe("defense-recent3-combo-wide", () => {
...
describe("defense-recent3-combo-lovat", () => {
