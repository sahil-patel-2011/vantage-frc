...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 11.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 23.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 39.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 23.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 39.0 } },
];

describe("defense-recent3-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-consistency");
...
describe("defense-recent3-consistency-deep", () => {
...
describe("defense-recent3-consistency-wide", () => {
...
describe("defense-recent3-consistency-lovat", () => {
