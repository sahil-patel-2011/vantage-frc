...
describe("defense-recent3-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-context");
...
describe("defense-recent3-context-deep", () => {
...
describe("defense-recent3-context-wide", () => {
...
describe("defense-recent3-context-lovat", () => {
