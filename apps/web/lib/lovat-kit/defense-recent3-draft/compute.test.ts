...
describe("defense-recent3-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-draft");
...
describe("defense-recent3-draft-deep", () => {
...
describe("defense-recent3-draft-wide", () => {
...
describe("defense-recent3-draft-lovat", () => {
