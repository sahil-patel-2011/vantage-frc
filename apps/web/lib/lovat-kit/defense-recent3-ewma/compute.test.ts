...
describe("defense-recent3-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-ewma");
...
describe("defense-recent3-ewma-deep", () => {
...
describe("defense-recent3-ewma-wide", () => {
...
describe("defense-recent3-ewma-lovat", () => {
