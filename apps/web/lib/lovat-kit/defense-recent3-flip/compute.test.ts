...
describe("defense-recent3-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-flip");
...
describe("defense-recent3-flip-deep", () => {
...
describe("defense-recent3-flip-wide", () => {
...
describe("defense-recent3-flip-lovat", () => {
