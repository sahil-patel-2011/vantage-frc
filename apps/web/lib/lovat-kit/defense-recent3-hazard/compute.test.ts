...
describe("defense-recent3-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-hazard");
...
describe("defense-recent3-hazard-deep", () => {
...
describe("defense-recent3-hazard-wide", () => {
...
describe("defense-recent3-hazard-lovat", () => {
