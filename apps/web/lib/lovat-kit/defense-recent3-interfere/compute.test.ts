...
describe("defense-recent3-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-interfere");
...
describe("defense-recent3-interfere-deep", () => {
...
describe("defense-recent3-interfere-wide", () => {
...
describe("defense-recent3-interfere-lovat", () => {
