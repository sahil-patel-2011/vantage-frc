...
describe("defense-recent3-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-lookup");
...
describe("defense-recent3-lookup-deep", () => {
...
describe("defense-recent3-lookup-wide", () => {
...
describe("defense-recent3-lookup-lovat", () => {
