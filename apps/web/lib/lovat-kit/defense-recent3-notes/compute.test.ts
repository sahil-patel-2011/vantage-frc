...
describe("defense-recent3-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-notes");
...
describe("defense-recent3-notes-deep", () => {
...
describe("defense-recent3-notes-wide", () => {
...
describe("defense-recent3-notes-lovat", () => {
