...
describe("defense-recent3-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-pareto");
...
describe("defense-recent3-pareto-deep", () => {
...
describe("defense-recent3-pareto-wide", () => {
...
describe("defense-recent3-pareto-lovat", () => {
