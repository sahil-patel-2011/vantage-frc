...
describe("defense-recent3-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-path");
...
describe("defense-recent3-path-deep", () => {
...
describe("defense-recent3-path-wide", () => {
...
describe("defense-recent3-path-lovat", () => {
