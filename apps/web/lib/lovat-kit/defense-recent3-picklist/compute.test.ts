...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { defenseTime: 44.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 24.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 31.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 44.0 } },
];

describe("defense-recent3-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-picklist");
...
describe("defense-recent3-picklist-deep", () => {
...
describe("defense-recent3-picklist-wide", () => {
...
describe("defense-recent3-picklist-lovat", () => {
