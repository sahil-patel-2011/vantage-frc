...
describe("defense-recent3-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-rank");
...
describe("defense-recent3-rank-deep", () => {
...
describe("defense-recent3-rank-wide", () => {
...
describe("defense-recent3-rank-lovat", () => {
