...
describe("defense-recent3-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-rate");
...
describe("defense-recent3-rate-deep", () => {
...
describe("defense-recent3-rate-wide", () => {
...
describe("defense-recent3-rate-lovat", () => {
