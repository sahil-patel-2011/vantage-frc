...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 18.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 25.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 38.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 18.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 38.0 } },
];

describe("defense-recent3-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-residual");
...
describe("defense-recent3-residual-deep", () => {
...
describe("defense-recent3-residual-wide", () => {
...
describe("defense-recent3-residual-lovat", () => {
