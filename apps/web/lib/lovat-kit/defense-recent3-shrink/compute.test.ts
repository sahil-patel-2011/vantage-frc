...
describe("defense-recent3-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-shrink");
...
describe("defense-recent3-shrink-deep", () => {
...
describe("defense-recent3-shrink-wide", () => {
...
describe("defense-recent3-shrink-lovat", () => {
