...
describe("defense-recent3-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-source");
...
describe("defense-recent3-source-deep", () => {
...
describe("defense-recent3-source-wide", () => {
...
describe("defense-recent3-source-lovat", () => {
