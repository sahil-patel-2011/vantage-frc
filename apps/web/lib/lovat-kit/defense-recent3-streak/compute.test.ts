...
describe("defense-recent3-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-streak");
...
describe("defense-recent3-streak-deep", () => {
...
describe("defense-recent3-streak-wide", () => {
...
describe("defense-recent3-streak-lovat", () => {
