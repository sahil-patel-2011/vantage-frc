...
describe("defense-recent3-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-timeline");
...
describe("defense-recent3-timeline-deep", () => {
...
describe("defense-recent3-timeline-wide", () => {
...
describe("defense-recent3-timeline-lovat", () => {
