...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { defenseTime: 38.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 38.0 } },
];

describe("defense-recent3-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-timeline22");
...
describe("defense-recent3-timeline22-deep", () => {
...
describe("defense-recent3-timeline22-wide", () => {
...
describe("defense-recent3-timeline22-lovat", () => {
