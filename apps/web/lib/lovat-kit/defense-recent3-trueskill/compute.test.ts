...
const rows = [
  { teamKey: "frc1", qual: true, values: { defenseTime: 14.0 } },
  { teamKey: "frc2", qual: true, values: { defenseTime: 26.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 42.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 14.0 } },
...
describe("defense-recent3-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-trueskill");
...
describe("defense-recent3-trueskill-deep", () => {
...
describe("defense-recent3-trueskill-wide", () => {
...
describe("defense-recent3-trueskill-lovat", () => {
