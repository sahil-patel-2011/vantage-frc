...
describe("defense-recent3-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-win");
...
describe("defense-recent3-win-deep", () => {
...
describe("defense-recent3-win-wide", () => {
...
describe("defense-recent3-win-lovat", () => {
