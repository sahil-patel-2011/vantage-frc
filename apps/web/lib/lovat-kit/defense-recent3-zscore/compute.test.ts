...
describe("defense-recent3-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-recent3-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-recent3-zscore");
...
describe("defense-recent3-zscore-deep", () => {
...
describe("defense-recent3-zscore-wide", () => {
...
describe("defense-recent3-zscore-lovat", () => {
