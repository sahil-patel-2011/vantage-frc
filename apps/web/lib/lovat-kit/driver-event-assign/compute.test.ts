...
describe("driver-event-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-assign");
...
describe("driver-event-assign-deep", () => {
...
describe("driver-event-assign-wide", () => {
...
describe("driver-event-assign-lovat", () => {
