...
describe("driver-event-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-brier");
...
describe("driver-event-brier-deep", () => {
...
describe("driver-event-brier-wide", () => {
...
describe("driver-event-brier-lovat", () => {
