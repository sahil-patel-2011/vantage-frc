...
describe("driver-event-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-colley");
...
describe("driver-event-colley-deep", () => {
...
describe("driver-event-colley-wide", () => {
...
describe("driver-event-colley-lovat", () => {
