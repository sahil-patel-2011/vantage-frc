...
describe("driver-event-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-combo");
...
describe("driver-event-combo-deep", () => {
...
describe("driver-event-combo-wide", () => {
...
describe("driver-event-combo-lovat", () => {
