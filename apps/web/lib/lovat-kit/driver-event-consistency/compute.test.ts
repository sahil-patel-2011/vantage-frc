...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { driverAbility: 43.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 43.0 } },
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 43.0 } },
];

describe("driver-event-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-consistency");
    ...
    expect(bootstrapMean([27.0, 24.0, 43.0])).not.toBeNull();
...
describe("driver-event-consistency-deep", () => {
...
describe("driver-event-consistency-wide", () => {
...
describe("driver-event-consistency-lovat", () => {
