...
describe("driver-event-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-context");
...
describe("driver-event-context-deep", () => {
...
describe("driver-event-context-wide", () => {
...
describe("driver-event-context-lovat", () => {
