...
describe("driver-event-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-draft");
...
describe("driver-event-draft-deep", () => {
...
describe("driver-event-draft-wide", () => {
...
describe("driver-event-draft-lovat", () => {
