...
describe("driver-event-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-ewma");
...
describe("driver-event-ewma-deep", () => {
...
describe("driver-event-ewma-wide", () => {
...
describe("driver-event-ewma-lovat", () => {
