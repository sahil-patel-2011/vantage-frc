...
describe("driver-event-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-flip");
...
describe("driver-event-flip-deep", () => {
...
describe("driver-event-flip-wide", () => {
...
describe("driver-event-flip-lovat", () => {
