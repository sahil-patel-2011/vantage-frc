...
describe("driver-event-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-hazard");
...
describe("driver-event-hazard-deep", () => {
...
describe("driver-event-hazard-wide", () => {
...
describe("driver-event-hazard-lovat", () => {
