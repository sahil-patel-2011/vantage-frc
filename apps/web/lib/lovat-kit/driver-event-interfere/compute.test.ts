...
describe("driver-event-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-interfere");
...
describe("driver-event-interfere-deep", () => {
...
describe("driver-event-interfere-wide", () => {
...
describe("driver-event-interfere-lovat", () => {
