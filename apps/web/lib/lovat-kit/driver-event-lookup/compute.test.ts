...
describe("driver-event-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-lookup");
...
describe("driver-event-lookup-deep", () => {
...
describe("driver-event-lookup-wide", () => {
...
describe("driver-event-lookup-lovat", () => {
