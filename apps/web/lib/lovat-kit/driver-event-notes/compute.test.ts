...
describe("driver-event-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-notes");
...
describe("driver-event-notes-deep", () => {
...
describe("driver-event-notes-wide", () => {
...
describe("driver-event-notes-lovat", () => {
