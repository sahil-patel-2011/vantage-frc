...
describe("driver-event-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-pareto");
...
describe("driver-event-pareto-deep", () => {
...
describe("driver-event-pareto-wide", () => {
...
describe("driver-event-pareto-lovat", () => {
