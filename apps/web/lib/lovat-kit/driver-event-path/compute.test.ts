...
describe("driver-event-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-path");
...
describe("driver-event-path-deep", () => {
...
describe("driver-event-path-wide", () => {
...
describe("driver-event-path-lovat", () => {
