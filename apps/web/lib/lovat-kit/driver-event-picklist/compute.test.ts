...
describe("driver-event-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-picklist");
...
describe("driver-event-picklist-deep", () => {
...
describe("driver-event-picklist-wide", () => {
...
describe("driver-event-picklist-lovat", () => {
