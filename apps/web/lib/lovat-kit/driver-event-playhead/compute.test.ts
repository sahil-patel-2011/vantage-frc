...
describe("driver-event-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-playhead");
...
describe("driver-event-playhead-deep", () => {
...
describe("driver-event-playhead-wide", () => {
...
describe("driver-event-playhead-lovat", () => {
