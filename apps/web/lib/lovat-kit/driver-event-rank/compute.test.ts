...
describe("driver-event-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-rank");
...
describe("driver-event-rank-deep", () => {
...
describe("driver-event-rank-wide", () => {
...
describe("driver-event-rank-lovat", () => {
