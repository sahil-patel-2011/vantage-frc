...
describe("driver-event-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-rate");
...
describe("driver-event-rate-deep", () => {
...
describe("driver-event-rate-wide", () => {
...
describe("driver-event-rate-lovat", () => {
