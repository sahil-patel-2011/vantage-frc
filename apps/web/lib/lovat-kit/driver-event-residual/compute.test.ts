...
describe("driver-event-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-residual");
...
describe("driver-event-residual-deep", () => {
...
describe("driver-event-residual-wide", () => {
...
describe("driver-event-residual-lovat", () => {
