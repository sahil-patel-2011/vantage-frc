...
describe("driver-event-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-shrink");
...
describe("driver-event-shrink-deep", () => {
...
describe("driver-event-shrink-wide", () => {
...
describe("driver-event-shrink-lovat", () => {
