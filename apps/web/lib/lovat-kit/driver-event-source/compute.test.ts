...
describe("driver-event-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-source");
...
describe("driver-event-source-deep", () => {
...
describe("driver-event-source-wide", () => {
...
describe("driver-event-source-lovat", () => {
