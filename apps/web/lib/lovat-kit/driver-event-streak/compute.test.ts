...
describe("driver-event-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-streak");
...
describe("driver-event-streak-deep", () => {
...
describe("driver-event-streak-wide", () => {
...
describe("driver-event-streak-lovat", () => {
