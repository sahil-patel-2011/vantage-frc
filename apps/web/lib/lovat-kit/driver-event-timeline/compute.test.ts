...
describe("driver-event-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-timeline");
...
describe("driver-event-timeline-deep", () => {
...
describe("driver-event-timeline-wide", () => {
...
describe("driver-event-timeline-lovat", () => {
