...
describe("driver-event-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-timeline22");
    ...
    expect(bootstrapMean([26.0, 33.0, 46.0])).not.toBeNull();
...
describe("driver-event-timeline22-deep", () => {
...
describe("driver-event-timeline22-wide", () => {
...
describe("driver-event-timeline22-lovat", () => {
