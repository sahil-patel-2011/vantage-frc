...
describe("driver-event-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-trimmed");
    ...
    expect(bootstrapMean([25.0, 22.0, 41.0])).not.toBeNull();
...
describe("driver-event-trimmed-deep", () => {
...
describe("driver-event-trimmed-wide", () => {
...
describe("driver-event-trimmed-lovat", () => {
