...
describe("driver-event-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-trueskill");
    ...
    expect(bootstrapMean([10.0, 27.0, 46.0])).not.toBeNull();
...
describe("driver-event-trueskill-deep", () => {
...
describe("driver-event-trueskill-wide", () => {
...
describe("driver-event-trueskill-lovat", () => {
