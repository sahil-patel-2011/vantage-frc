...
describe("driver-event-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-win");
...
describe("driver-event-win-deep", () => {
...
describe("driver-event-win-wide", () => {
...
describe("driver-event-win-lovat", () => {
