...
describe("driver-event-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-zone");
...
describe("driver-event-zone-deep", () => {
...
describe("driver-event-zone-wide", () => {
...
describe("driver-event-zone-lovat", () => {
