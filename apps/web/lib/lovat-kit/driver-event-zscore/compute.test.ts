...
describe("driver-event-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-zscore");
...
describe("driver-event-zscore-deep", () => {
...
describe("driver-event-zscore-wide", () => {
...
describe("driver-event-zscore-lovat", () => {
