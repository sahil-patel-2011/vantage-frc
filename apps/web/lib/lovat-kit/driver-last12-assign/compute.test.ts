...
describe("driver-last12-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-assign");
    ...
    expect(bootstrapMean([13.0, 30.0, 37.0])).not.toBeNull();
...
describe("driver-last12-assign-deep", () => {
...
describe("driver-last12-assign-wide", () => {
...
describe("driver-last12-assign-lovat", () => {
