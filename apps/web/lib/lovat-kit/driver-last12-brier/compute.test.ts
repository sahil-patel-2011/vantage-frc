...
describe("driver-last12-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-brier");
...
describe("driver-last12-brier-deep", () => {
...
describe("driver-last12-brier-wide", () => {
...
describe("driver-last12-brier-lovat", () => {
