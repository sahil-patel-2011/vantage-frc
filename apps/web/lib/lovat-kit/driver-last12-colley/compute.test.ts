...
describe("driver-last12-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-colley");
...
describe("driver-last12-colley-deep", () => {
...
describe("driver-last12-colley-wide", () => {
...
describe("driver-last12-colley-lovat", () => {
