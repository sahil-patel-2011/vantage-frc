...
describe("driver-last12-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-combo");
...
describe("driver-last12-combo-deep", () => {
...
describe("driver-last12-combo-wide", () => {
...
describe("driver-last12-combo-lovat", () => {
