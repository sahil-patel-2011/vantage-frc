...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 24.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 26.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 36.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 24.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 26.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 36.0 } },
];

describe("driver-last12-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-consistency");
    ...
    expect(bootstrapMean([24.0, 26.0, 36.0])).not.toBeNull();
...
describe("driver-last12-consistency-deep", () => {
...
describe("driver-last12-consistency-wide", () => {
...
describe("driver-last12-consistency-lovat", () => {
