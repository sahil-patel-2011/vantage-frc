...
describe("driver-last12-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-context");
    ...
    expect(bootstrapMean([23.0, 30.0, 43.0])).not.toBeNull();
...
describe("driver-last12-context-deep", () => {
...
describe("driver-last12-context-wide", () => {
...
describe("driver-last12-context-lovat", () => {
