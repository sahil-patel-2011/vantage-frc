...
describe("driver-last12-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-draft");
...
describe("driver-last12-draft-deep", () => {
...
describe("driver-last12-draft-wide", () => {
...
describe("driver-last12-draft-lovat", () => {
