...
describe("driver-last12-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-flip");
...
describe("driver-last12-flip-deep", () => {
...
describe("driver-last12-flip-wide", () => {
...
describe("driver-last12-flip-lovat", () => {
