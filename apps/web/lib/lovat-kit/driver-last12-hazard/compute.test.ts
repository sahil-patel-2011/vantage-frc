...
describe("driver-last12-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-hazard");
...
describe("driver-last12-hazard-deep", () => {
...
describe("driver-last12-hazard-wide", () => {
...
describe("driver-last12-hazard-lovat", () => {
