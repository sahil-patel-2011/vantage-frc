...
describe("driver-last12-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-interfere");
...
describe("driver-last12-interfere-deep", () => {
...
describe("driver-last12-interfere-wide", () => {
...
describe("driver-last12-interfere-lovat", () => {
