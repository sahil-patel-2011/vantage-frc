...
describe("driver-last12-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-lookup");
...
describe("driver-last12-lookup-deep", () => {
...
describe("driver-last12-lookup-wide", () => {
...
describe("driver-last12-lookup-lovat", () => {
