...
describe("driver-last12-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-notes");
...
describe("driver-last12-notes-deep", () => {
...
describe("driver-last12-notes-wide", () => {
...
describe("driver-last12-notes-lovat", () => {
