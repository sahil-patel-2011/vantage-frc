...
describe("driver-last12-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-pareto");
...
describe("driver-last12-pareto-deep", () => {
...
describe("driver-last12-pareto-wide", () => {
...
describe("driver-last12-pareto-lovat", () => {
