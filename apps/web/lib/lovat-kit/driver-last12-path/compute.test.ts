...
describe("driver-last12-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-path");
...
describe("driver-last12-path-deep", () => {
...
describe("driver-last12-path-wide", () => {
...
describe("driver-last12-path-lovat", () => {
