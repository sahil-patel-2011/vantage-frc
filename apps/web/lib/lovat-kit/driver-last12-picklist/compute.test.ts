...
describe("driver-last12-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-picklist");
...
describe("driver-last12-picklist-deep", () => {
...
describe("driver-last12-picklist-wide", () => {
...
describe("driver-last12-picklist-lovat", () => {
