...
describe("driver-last12-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-playhead");
...
describe("driver-last12-playhead-deep", () => {
...
describe("driver-last12-playhead-wide", () => {
...
describe("driver-last12-playhead-lovat", () => {
