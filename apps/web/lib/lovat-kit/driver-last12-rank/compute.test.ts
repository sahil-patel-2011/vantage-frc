...
describe("driver-last12-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-rank");
...
describe("driver-last12-rank-deep", () => {
...
describe("driver-last12-rank-wide", () => {
...
describe("driver-last12-rank-lovat", () => {
