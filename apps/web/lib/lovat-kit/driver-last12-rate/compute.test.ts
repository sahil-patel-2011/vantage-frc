...
describe("driver-last12-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-rate");
...
describe("driver-last12-rate-deep", () => {
...
describe("driver-last12-rate-wide", () => {
...
describe("driver-last12-rate-lovat", () => {
