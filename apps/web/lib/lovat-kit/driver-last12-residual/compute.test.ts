...
describe("driver-last12-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-residual");
...
describe("driver-last12-residual-deep", () => {
...
describe("driver-last12-residual-wide", () => {
...
describe("driver-last12-residual-lovat", () => {
