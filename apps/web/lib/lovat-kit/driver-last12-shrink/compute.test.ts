...
describe("driver-last12-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-shrink");
...
describe("driver-last12-shrink-deep", () => {
...
describe("driver-last12-shrink-wide", () => {
...
describe("driver-last12-shrink-lovat", () => {
