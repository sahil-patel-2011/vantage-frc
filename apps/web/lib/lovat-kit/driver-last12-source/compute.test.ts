...
describe("driver-last12-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-source");
...
describe("driver-last12-source-deep", () => {
...
describe("driver-last12-source-wide", () => {
...
describe("driver-last12-source-lovat", () => {
