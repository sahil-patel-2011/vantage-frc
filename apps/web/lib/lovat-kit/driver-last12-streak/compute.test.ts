...
describe("driver-last12-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-streak");
...
describe("driver-last12-streak-deep", () => {
...
describe("driver-last12-streak-wide", () => {
...
describe("driver-last12-streak-lovat", () => {
