...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { driverAbility: 23.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 39.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 23.0 } },
...
describe("driver-last12-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-timeline");
    ...
    expect(bootstrapMean([11.0, 23.0, 39.0])).not.toBeNull();
...
describe("driver-last12-timeline-deep", () => {
...
describe("driver-last12-timeline-wide", () => {
...
describe("driver-last12-timeline-lovat", () => {
