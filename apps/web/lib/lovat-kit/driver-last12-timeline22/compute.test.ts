...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 11.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 33.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 43.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 33.0 } },
...
describe("driver-last12-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-timeline22");
    ...
    expect(bootstrapMean([11.0, 33.0, 43.0])).not.toBeNull();
...
describe("driver-last12-timeline22-deep", () => {
...
describe("driver-last12-timeline22-wide", () => {
...
describe("driver-last12-timeline22-lovat", () => {
