...
describe("driver-last12-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-trimmed");
...
describe("driver-last12-trimmed-deep", () => {
...
describe("driver-last12-trimmed-wide", () => {
...
describe("driver-last12-trimmed-lovat", () => {
