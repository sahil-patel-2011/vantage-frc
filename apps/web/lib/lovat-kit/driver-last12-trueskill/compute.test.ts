...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 25.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 32.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 45.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 25.0 } },
...
describe("driver-last12-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-trueskill");
    ...
    expect(bootstrapMean([25.0, 32.0, 45.0])).not.toBeNull();
...
describe("driver-last12-trueskill-deep", () => {
...
describe("driver-last12-trueskill-wide", () => {
...
describe("driver-last12-trueskill-lovat", () => {
