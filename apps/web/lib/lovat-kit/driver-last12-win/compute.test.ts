...
describe("driver-last12-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-win");
...
describe("driver-last12-win-deep", () => {
...
describe("driver-last12-win-wide", () => {
...
describe("driver-last12-win-lovat", () => {
