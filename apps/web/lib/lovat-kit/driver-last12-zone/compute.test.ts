...
describe("driver-last12-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-zone");
...
describe("driver-last12-zone-deep", () => {
...
describe("driver-last12-zone-wide", () => {
...
describe("driver-last12-zone-lovat", () => {
