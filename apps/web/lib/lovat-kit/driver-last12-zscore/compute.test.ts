...
describe("driver-last12-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last12-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last12-zscore");
...
describe("driver-last12-zscore-deep", () => {
...
describe("driver-last12-zscore-wide", () => {
...
describe("driver-last12-zscore-lovat", () => {
