...
describe("driver-last24-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-assign");
...
describe("driver-last24-assign-deep", () => {
...
describe("driver-last24-assign-wide", () => {
...
describe("driver-last24-assign-lovat", () => {
