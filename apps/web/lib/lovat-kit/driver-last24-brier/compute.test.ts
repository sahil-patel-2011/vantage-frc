...
describe("driver-last24-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-brier");
...
describe("driver-last24-brier-deep", () => {
...
describe("driver-last24-brier-wide", () => {
...
describe("driver-last24-brier-lovat", () => {
