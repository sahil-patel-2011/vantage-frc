...
describe("driver-last24-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-colley");
...
describe("driver-last24-colley-deep", () => {
...
describe("driver-last24-colley-wide", () => {
...
describe("driver-last24-colley-lovat", () => {
