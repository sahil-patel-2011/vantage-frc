...
describe("driver-last24-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-combo");
...
describe("driver-last24-combo-deep", () => {
...
describe("driver-last24-combo-wide", () => {
...
describe("driver-last24-combo-lovat", () => {
