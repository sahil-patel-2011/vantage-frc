...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 17.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 24.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 37.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 37.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 37.0 } },
];

describe("driver-last24-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-consistency");
    ...
    expect(bootstrapMean([17.0, 24.0, 37.0])).not.toBeNull();
...
describe("driver-last24-consistency-deep", () => {
...
describe("driver-last24-consistency-wide", () => {
...
describe("driver-last24-consistency-lovat", () => {
