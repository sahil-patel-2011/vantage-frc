...
describe("driver-last24-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-context");
...
describe("driver-last24-context-deep", () => {
...
describe("driver-last24-context-wide", () => {
...
describe("driver-last24-context-lovat", () => {
