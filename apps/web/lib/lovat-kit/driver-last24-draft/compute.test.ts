...
describe("driver-last24-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-draft");
...
describe("driver-last24-draft-deep", () => {
...
describe("driver-last24-draft-wide", () => {
...
describe("driver-last24-draft-lovat", () => {
