...
describe("driver-last24-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-ewma");
...
describe("driver-last24-ewma-deep", () => {
...
describe("driver-last24-ewma-wide", () => {
...
describe("driver-last24-ewma-lovat", () => {
