...
describe("driver-last24-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-flip");
...
describe("driver-last24-flip-deep", () => {
...
describe("driver-last24-flip-wide", () => {
...
describe("driver-last24-flip-lovat", () => {
