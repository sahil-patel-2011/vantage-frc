...
describe("driver-last24-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-hazard");
...
describe("driver-last24-hazard-deep", () => {
...
describe("driver-last24-hazard-wide", () => {
...
describe("driver-last24-hazard-lovat", () => {
