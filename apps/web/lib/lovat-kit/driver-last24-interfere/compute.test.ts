...
describe("driver-last24-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-interfere");
    ...
    expect(bootstrapMean([27.0, 29.0, 39.0])).not.toBeNull();
...
describe("driver-last24-interfere-deep", () => {
...
describe("driver-last24-interfere-wide", () => {
...
describe("driver-last24-interfere-lovat", () => {
