...
describe("driver-last24-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-lookup");
...
describe("driver-last24-lookup-deep", () => {
...
describe("driver-last24-lookup-wide", () => {
...
describe("driver-last24-lookup-lovat", () => {
