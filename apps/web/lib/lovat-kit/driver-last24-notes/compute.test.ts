...
describe("driver-last24-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-notes");
...
describe("driver-last24-notes-deep", () => {
...
describe("driver-last24-notes-wide", () => {
...
describe("driver-last24-notes-lovat", () => {
