...
describe("driver-last24-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-pareto");
...
describe("driver-last24-pareto-deep", () => {
...
describe("driver-last24-pareto-wide", () => {
...
describe("driver-last24-pareto-lovat", () => {
