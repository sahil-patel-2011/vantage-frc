...
describe("driver-last24-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-path");
...
describe("driver-last24-path-deep", () => {
...
describe("driver-last24-path-wide", () => {
...
describe("driver-last24-path-lovat", () => {
