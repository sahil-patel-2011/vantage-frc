...
describe("driver-last24-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-picklist");
...
describe("driver-last24-picklist-deep", () => {
...
describe("driver-last24-picklist-wide", () => {
...
describe("driver-last24-picklist-lovat", () => {
