...
describe("driver-last24-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-playhead");
...
describe("driver-last24-playhead-deep", () => {
...
describe("driver-last24-playhead-wide", () => {
...
describe("driver-last24-playhead-lovat", () => {
