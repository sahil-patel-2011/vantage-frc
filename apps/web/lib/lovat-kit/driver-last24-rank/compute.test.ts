...
describe("driver-last24-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-rank");
...
describe("driver-last24-rank-deep", () => {
...
describe("driver-last24-rank-wide", () => {
...
describe("driver-last24-rank-lovat", () => {
