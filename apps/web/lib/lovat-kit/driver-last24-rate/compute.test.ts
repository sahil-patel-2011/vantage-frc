...
describe("driver-last24-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-rate");
...
describe("driver-last24-rate-deep", () => {
...
describe("driver-last24-rate-wide", () => {
...
describe("driver-last24-rate-lovat", () => {
