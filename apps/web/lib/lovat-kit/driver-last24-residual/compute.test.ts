...
describe("driver-last24-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-residual");
    ...
    expect(bootstrapMean([8.0, 30.0, 40.0])).not.toBeNull();
...
describe("driver-last24-residual-deep", () => {
...
describe("driver-last24-residual-wide", () => {
...
describe("driver-last24-residual-lovat", () => {
