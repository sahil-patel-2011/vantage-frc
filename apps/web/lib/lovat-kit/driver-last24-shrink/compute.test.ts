...
describe("driver-last24-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-shrink");
...
describe("driver-last24-shrink-deep", () => {
...
describe("driver-last24-shrink-wide", () => {
...
describe("driver-last24-shrink-lovat", () => {
