...
describe("driver-last24-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-source");
...
describe("driver-last24-source-deep", () => {
...
describe("driver-last24-source-wide", () => {
...
describe("driver-last24-source-lovat", () => {
