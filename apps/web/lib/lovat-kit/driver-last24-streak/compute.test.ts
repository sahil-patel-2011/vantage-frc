...
describe("driver-last24-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-streak");
...
describe("driver-last24-streak-deep", () => {
...
describe("driver-last24-streak-wide", () => {
...
describe("driver-last24-streak-lovat", () => {
