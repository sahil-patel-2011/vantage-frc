...
describe("driver-last24-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-timeline");
...
describe("driver-last24-timeline-deep", () => {
...
describe("driver-last24-timeline-wide", () => {
...
describe("driver-last24-timeline-lovat", () => {
