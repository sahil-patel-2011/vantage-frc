...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 8.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 25.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 44.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 8.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 44.0 } },
];

describe("driver-last24-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-timeline22");
    ...
    expect(bootstrapMean([8.0, 25.0, 44.0])).not.toBeNull();
...
describe("driver-last24-timeline22-deep", () => {
...
describe("driver-last24-timeline22-wide", () => {
...
describe("driver-last24-timeline22-lovat", () => {
