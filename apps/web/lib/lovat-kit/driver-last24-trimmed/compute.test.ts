...
describe("driver-last24-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-trimmed");
...
describe("driver-last24-trimmed-deep", () => {
...
describe("driver-last24-trimmed-wide", () => {
...
describe("driver-last24-trimmed-lovat", () => {
