...
describe("driver-last24-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-trueskill");
...
describe("driver-last24-trueskill-deep", () => {
...
describe("driver-last24-trueskill-wide", () => {
...
describe("driver-last24-trueskill-lovat", () => {
