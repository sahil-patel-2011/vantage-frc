...
describe("driver-last24-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-zone");
...
describe("driver-last24-zone-deep", () => {
...
describe("driver-last24-zone-wide", () => {
...
describe("driver-last24-zone-lovat", () => {
