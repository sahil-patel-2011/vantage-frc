...
describe("driver-last24-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last24-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last24-zscore");
...
describe("driver-last24-zscore-deep", () => {
...
describe("driver-last24-zscore-wide", () => {
...
describe("driver-last24-zscore-lovat", () => {
