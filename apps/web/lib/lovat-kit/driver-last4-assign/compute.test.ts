...
describe("driver-last4-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-assign");
...
describe("driver-last4-assign-deep", () => {
...
describe("driver-last4-assign-wide", () => {
...
describe("driver-last4-assign-lovat", () => {
