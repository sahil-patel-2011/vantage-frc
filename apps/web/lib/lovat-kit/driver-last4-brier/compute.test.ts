...
describe("driver-last4-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-brier");
...
describe("driver-last4-brier-deep", () => {
...
describe("driver-last4-brier-wide", () => {
...
describe("driver-last4-brier-lovat", () => {
