...
describe("driver-last4-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-colley");
...
describe("driver-last4-colley-deep", () => {
...
describe("driver-last4-colley-wide", () => {
...
describe("driver-last4-colley-lovat", () => {
