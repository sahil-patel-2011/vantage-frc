...
describe("driver-last4-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-combo");
...
describe("driver-last4-combo-deep", () => {
...
describe("driver-last4-combo-wide", () => {
...
describe("driver-last4-combo-lovat", () => {
