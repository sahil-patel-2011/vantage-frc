...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 23.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 25.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 47.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 25.0 } },
...
describe("driver-last4-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-consistency");
    ...
    expect(bootstrapMean([23.0, 25.0, 47.0])).not.toBeNull();
...
describe("driver-last4-consistency-deep", () => {
...
describe("driver-last4-consistency-wide", () => {
...
describe("driver-last4-consistency-lovat", () => {
