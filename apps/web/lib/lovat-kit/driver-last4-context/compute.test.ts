...
describe("driver-last4-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-context");
...
describe("driver-last4-context-deep", () => {
...
describe("driver-last4-context-wide", () => {
...
describe("driver-last4-context-lovat", () => {
