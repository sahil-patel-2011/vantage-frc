...
describe("driver-last4-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-draft");
...
describe("driver-last4-draft-deep", () => {
...
describe("driver-last4-draft-wide", () => {
...
describe("driver-last4-draft-lovat", () => {
