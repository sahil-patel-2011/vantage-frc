...
describe("driver-last4-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-ewma");
...
describe("driver-last4-ewma-deep", () => {
...
describe("driver-last4-ewma-wide", () => {
...
describe("driver-last4-ewma-lovat", () => {
