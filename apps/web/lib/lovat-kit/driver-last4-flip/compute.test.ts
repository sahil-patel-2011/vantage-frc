...
describe("driver-last4-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-flip");
...
describe("driver-last4-flip-deep", () => {
...
describe("driver-last4-flip-wide", () => {
...
describe("driver-last4-flip-lovat", () => {
