...
describe("driver-last4-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-hazard");
...
describe("driver-last4-hazard-deep", () => {
...
describe("driver-last4-hazard-wide", () => {
...
describe("driver-last4-hazard-lovat", () => {
