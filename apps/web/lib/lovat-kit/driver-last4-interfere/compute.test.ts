...
describe("driver-last4-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-interfere");
...
describe("driver-last4-interfere-deep", () => {
...
describe("driver-last4-interfere-wide", () => {
...
describe("driver-last4-interfere-lovat", () => {
