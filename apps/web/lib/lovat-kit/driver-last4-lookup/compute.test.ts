...
describe("driver-last4-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-lookup");
...
describe("driver-last4-lookup-deep", () => {
...
describe("driver-last4-lookup-wide", () => {
...
describe("driver-last4-lookup-lovat", () => {
