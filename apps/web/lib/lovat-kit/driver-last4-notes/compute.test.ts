...
describe("driver-last4-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-notes");
...
describe("driver-last4-notes-deep", () => {
...
describe("driver-last4-notes-wide", () => {
...
describe("driver-last4-notes-lovat", () => {
