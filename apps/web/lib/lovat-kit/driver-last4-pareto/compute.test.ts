...
describe("driver-last4-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-pareto");
...
describe("driver-last4-pareto-deep", () => {
...
describe("driver-last4-pareto-wide", () => {
...
describe("driver-last4-pareto-lovat", () => {
