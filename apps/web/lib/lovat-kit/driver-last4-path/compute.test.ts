...
describe("driver-last4-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-path");
...
describe("driver-last4-path-deep", () => {
...
describe("driver-last4-path-wide", () => {
...
describe("driver-last4-path-lovat", () => {
