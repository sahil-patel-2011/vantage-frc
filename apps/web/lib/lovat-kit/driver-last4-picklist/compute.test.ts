...
describe("driver-last4-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-picklist");
...
describe("driver-last4-picklist-deep", () => {
...
describe("driver-last4-picklist-wide", () => {
...
describe("driver-last4-picklist-lovat", () => {
