...
describe("driver-last4-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-playhead");
...
describe("driver-last4-playhead-deep", () => {
...
describe("driver-last4-playhead-wide", () => {
...
describe("driver-last4-playhead-lovat", () => {
