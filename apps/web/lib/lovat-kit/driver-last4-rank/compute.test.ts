...
describe("driver-last4-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-rank");
...
describe("driver-last4-rank-deep", () => {
...
describe("driver-last4-rank-wide", () => {
...
describe("driver-last4-rank-lovat", () => {
