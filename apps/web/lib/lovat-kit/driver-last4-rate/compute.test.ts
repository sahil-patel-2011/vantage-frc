...
describe("driver-last4-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-rate");
...
describe("driver-last4-rate-deep", () => {
...
describe("driver-last4-rate-wide", () => {
...
describe("driver-last4-rate-lovat", () => {
