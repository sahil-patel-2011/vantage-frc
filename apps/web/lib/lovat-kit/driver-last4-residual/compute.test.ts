...
describe("driver-last4-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-residual");
...
describe("driver-last4-residual-deep", () => {
...
describe("driver-last4-residual-wide", () => {
...
describe("driver-last4-residual-lovat", () => {
