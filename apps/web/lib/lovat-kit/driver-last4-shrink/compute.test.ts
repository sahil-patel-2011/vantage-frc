...
describe("driver-last4-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-shrink");
...
describe("driver-last4-shrink-deep", () => {
...
describe("driver-last4-shrink-wide", () => {
...
describe("driver-last4-shrink-lovat", () => {
