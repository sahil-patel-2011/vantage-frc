...
describe("driver-last4-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-source");
...
describe("driver-last4-source-deep", () => {
...
describe("driver-last4-source-wide", () => {
...
describe("driver-last4-source-lovat", () => {
