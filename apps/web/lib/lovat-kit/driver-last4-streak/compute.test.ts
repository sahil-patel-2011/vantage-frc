...
describe("driver-last4-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-streak");
...
describe("driver-last4-streak-deep", () => {
...
describe("driver-last4-streak-wide", () => {
...
describe("driver-last4-streak-lovat", () => {
