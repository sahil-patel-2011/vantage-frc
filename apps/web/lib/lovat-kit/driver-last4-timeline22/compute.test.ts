...
describe("driver-last4-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-timeline22");
...
describe("driver-last4-timeline22-deep", () => {
...
describe("driver-last4-timeline22-wide", () => {
...
describe("driver-last4-timeline22-lovat", () => {
