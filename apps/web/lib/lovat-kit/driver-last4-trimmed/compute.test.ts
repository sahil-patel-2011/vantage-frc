...
describe("driver-last4-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-trimmed");
...
describe("driver-last4-trimmed-deep", () => {
...
describe("driver-last4-trimmed-wide", () => {
...
describe("driver-last4-trimmed-lovat", () => {
