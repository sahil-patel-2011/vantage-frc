...
describe("driver-last4-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-trueskill");
...
describe("driver-last4-trueskill-deep", () => {
...
describe("driver-last4-trueskill-wide", () => {
...
describe("driver-last4-trueskill-lovat", () => {
