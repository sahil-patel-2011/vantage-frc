...
describe("driver-last4-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-win");
...
describe("driver-last4-win-deep", () => {
...
describe("driver-last4-win-wide", () => {
...
describe("driver-last4-win-lovat", () => {
