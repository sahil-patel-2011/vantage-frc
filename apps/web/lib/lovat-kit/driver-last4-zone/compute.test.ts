...
describe("driver-last4-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-zone");
...
describe("driver-last4-zone-deep", () => {
...
describe("driver-last4-zone-wide", () => {
...
describe("driver-last4-zone-lovat", () => {
