...
describe("driver-last4-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last4-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last4-zscore");
...
describe("driver-last4-zscore-deep", () => {
...
describe("driver-last4-zscore-wide", () => {
...
describe("driver-last4-zscore-lovat", () => {
