...
describe("driver-last6-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-assign");
...
describe("driver-last6-assign-deep", () => {
...
describe("driver-last6-assign-wide", () => {
...
describe("driver-last6-assign-lovat", () => {
