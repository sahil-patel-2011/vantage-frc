...
describe("driver-last6-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-brier");
...
describe("driver-last6-brier-deep", () => {
...
describe("driver-last6-brier-wide", () => {
...
describe("driver-last6-brier-lovat", () => {
