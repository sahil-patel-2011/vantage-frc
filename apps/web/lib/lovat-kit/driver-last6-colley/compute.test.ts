...
describe("driver-last6-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-colley");
...
describe("driver-last6-colley-deep", () => {
...
describe("driver-last6-colley-wide", () => {
...
describe("driver-last6-colley-lovat", () => {
