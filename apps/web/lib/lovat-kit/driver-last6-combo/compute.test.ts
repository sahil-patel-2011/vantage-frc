...
describe("driver-last6-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-combo");
...
describe("driver-last6-combo-deep", () => {
...
describe("driver-last6-combo-wide", () => {
...
describe("driver-last6-combo-lovat", () => {
