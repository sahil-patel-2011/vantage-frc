...
describe("driver-last6-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-consistency");
...
describe("driver-last6-consistency-deep", () => {
...
describe("driver-last6-consistency-wide", () => {
...
describe("driver-last6-consistency-lovat", () => {
