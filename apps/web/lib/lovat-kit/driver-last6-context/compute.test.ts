...
describe("driver-last6-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-context");
...
describe("driver-last6-context-deep", () => {
...
describe("driver-last6-context-wide", () => {
...
describe("driver-last6-context-lovat", () => {
