...
describe("driver-last6-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-draft");
...
describe("driver-last6-draft-deep", () => {
...
describe("driver-last6-draft-wide", () => {
...
describe("driver-last6-draft-lovat", () => {
