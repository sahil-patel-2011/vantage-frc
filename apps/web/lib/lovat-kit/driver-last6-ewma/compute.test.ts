...
describe("driver-last6-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-ewma");
...
describe("driver-last6-ewma-deep", () => {
...
describe("driver-last6-ewma-wide", () => {
...
describe("driver-last6-ewma-lovat", () => {
