...
describe("driver-last6-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-flip");
...
describe("driver-last6-flip-deep", () => {
...
describe("driver-last6-flip-wide", () => {
...
describe("driver-last6-flip-lovat", () => {
