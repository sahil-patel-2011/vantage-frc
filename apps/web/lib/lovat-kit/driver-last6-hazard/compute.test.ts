...
describe("driver-last6-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-hazard");
...
describe("driver-last6-hazard-deep", () => {
...
describe("driver-last6-hazard-wide", () => {
...
describe("driver-last6-hazard-lovat", () => {
