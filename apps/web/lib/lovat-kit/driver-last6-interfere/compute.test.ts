...
describe("driver-last6-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-interfere");
...
describe("driver-last6-interfere-deep", () => {
...
describe("driver-last6-interfere-wide", () => {
...
describe("driver-last6-interfere-lovat", () => {
