...
describe("driver-last6-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-lookup");
...
describe("driver-last6-lookup-deep", () => {
...
describe("driver-last6-lookup-wide", () => {
...
describe("driver-last6-lookup-lovat", () => {
