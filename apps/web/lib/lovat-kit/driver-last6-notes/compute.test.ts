...
describe("driver-last6-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-notes");
...
describe("driver-last6-notes-deep", () => {
...
describe("driver-last6-notes-wide", () => {
...
describe("driver-last6-notes-lovat", () => {
