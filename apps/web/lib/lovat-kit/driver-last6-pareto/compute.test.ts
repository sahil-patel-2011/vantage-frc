...
describe("driver-last6-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-pareto");
...
describe("driver-last6-pareto-deep", () => {
...
describe("driver-last6-pareto-wide", () => {
...
describe("driver-last6-pareto-lovat", () => {
