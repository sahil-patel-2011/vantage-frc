...
describe("driver-last6-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-path");
...
describe("driver-last6-path-deep", () => {
...
describe("driver-last6-path-wide", () => {
...
describe("driver-last6-path-lovat", () => {
