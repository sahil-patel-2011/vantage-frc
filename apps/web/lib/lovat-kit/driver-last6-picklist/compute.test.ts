...
describe("driver-last6-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-picklist");
    ...
    expect(bootstrapMean([22.0, 24.0, 46.0])).not.toBeNull();
...
describe("driver-last6-picklist-deep", () => {
...
describe("driver-last6-picklist-wide", () => {
...
describe("driver-last6-picklist-lovat", () => {
