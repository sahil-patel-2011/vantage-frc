...
describe("driver-last6-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-playhead");
...
describe("driver-last6-playhead-deep", () => {
...
describe("driver-last6-playhead-wide", () => {
...
describe("driver-last6-playhead-lovat", () => {
