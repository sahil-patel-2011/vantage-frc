...
describe("driver-last6-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-rank");
...
describe("driver-last6-rank-deep", () => {
...
describe("driver-last6-rank-wide", () => {
...
describe("driver-last6-rank-lovat", () => {
