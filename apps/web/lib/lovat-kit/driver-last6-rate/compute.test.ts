...
describe("driver-last6-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-rate");
...
describe("driver-last6-rate-deep", () => {
...
describe("driver-last6-rate-wide", () => {
...
describe("driver-last6-rate-lovat", () => {
