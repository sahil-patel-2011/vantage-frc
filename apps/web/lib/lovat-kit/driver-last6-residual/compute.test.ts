...
describe("driver-last6-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-residual");
...
describe("driver-last6-residual-deep", () => {
...
describe("driver-last6-residual-wide", () => {
...
describe("driver-last6-residual-lovat", () => {
