...
describe("driver-last6-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-shrink");
...
describe("driver-last6-shrink-deep", () => {
...
describe("driver-last6-shrink-wide", () => {
...
describe("driver-last6-shrink-lovat", () => {
