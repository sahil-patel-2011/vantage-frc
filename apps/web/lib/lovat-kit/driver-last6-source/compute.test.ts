...
describe("driver-last6-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-source");
...
describe("driver-last6-source-deep", () => {
...
describe("driver-last6-source-wide", () => {
...
describe("driver-last6-source-lovat", () => {
