...
describe("driver-last6-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-streak");
...
describe("driver-last6-streak-deep", () => {
...
describe("driver-last6-streak-wide", () => {
...
describe("driver-last6-streak-lovat", () => {
