...
describe("driver-last6-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-timeline");
    ...
    expect(bootstrapMean([24.0, 31.0, 44.0])).not.toBeNull();
...
describe("driver-last6-timeline-deep", () => {
...
describe("driver-last6-timeline-wide", () => {
...
describe("driver-last6-timeline-lovat", () => {
