...
describe("driver-last6-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-trimmed");
...
describe("driver-last6-trimmed-deep", () => {
...
describe("driver-last6-trimmed-wide", () => {
...
describe("driver-last6-trimmed-lovat", () => {
