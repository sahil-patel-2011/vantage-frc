...
describe("driver-last6-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-trueskill");
    ...
    expect(bootstrapMean([8.0, 20.0, 36.0])).not.toBeNull();
...
describe("driver-last6-trueskill-deep", () => {
...
describe("driver-last6-trueskill-wide", () => {
...
describe("driver-last6-trueskill-lovat", () => {
