...
describe("driver-last6-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-win");
...
describe("driver-last6-win-deep", () => {
...
describe("driver-last6-win-wide", () => {
...
describe("driver-last6-win-lovat", () => {
