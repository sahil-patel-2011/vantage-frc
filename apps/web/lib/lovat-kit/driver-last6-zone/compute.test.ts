...
describe("driver-last6-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-zone");
...
describe("driver-last6-zone-deep", () => {
...
describe("driver-last6-zone-wide", () => {
...
describe("driver-last6-zone-lovat", () => {
