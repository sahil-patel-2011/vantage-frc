...
describe("driver-last6-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-last6-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-last6-zscore");
...
describe("driver-last6-zscore-deep", () => {
...
describe("driver-last6-zscore-wide", () => {
...
describe("driver-last6-zscore-lovat", () => {
