...
describe("driver-playoffs-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-assign");
    ...
    expect(bootstrapMean([20.0, 32.0, 36.0])).not.toBeNull();
...
describe("driver-playoffs-assign-deep", () => {
...
describe("driver-playoffs-assign-wide", () => {
...
describe("driver-playoffs-assign-lovat", () => {
