...
describe("driver-playoffs-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-brier");
...
describe("driver-playoffs-brier-deep", () => {
...
describe("driver-playoffs-brier-wide", () => {
...
describe("driver-playoffs-brier-lovat", () => {
