...
describe("driver-playoffs-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-colley");
...
describe("driver-playoffs-colley-deep", () => {
...
describe("driver-playoffs-colley-wide", () => {
...
describe("driver-playoffs-colley-lovat", () => {
