...
describe("driver-playoffs-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-combo");
...
describe("driver-playoffs-combo-deep", () => {
...
describe("driver-playoffs-combo-wide", () => {
...
describe("driver-playoffs-combo-lovat", () => {
