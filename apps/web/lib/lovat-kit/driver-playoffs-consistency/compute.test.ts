...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 27.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 34.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 47.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 47.0 } },
];

describe("driver-playoffs-consistency", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "driverAbility")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-consistency");
    ...
    expect(bootstrapMean([27.0, 34.0, 47.0])).not.toBeNull();
...
describe("driver-playoffs-consistency-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { driverAbility: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { driverAbility: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { driverAbility: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { driverAbility: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { driverAbility: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { driverAbility: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "driverAbility")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("driver-playoffs-consistency-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statDriverAbility(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesDriverAbility(rows, "frc9").length).toBe(0);
...
describe("driver-playoffs-consistency-lovat", () => {
