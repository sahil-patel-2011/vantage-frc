...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 16.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 33.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 40.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 16.0 } },
...
describe("driver-playoffs-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-context");
    ...
    expect(bootstrapMean([16.0, 33.0, 40.0])).not.toBeNull();
...
describe("driver-playoffs-context-deep", () => {
...
describe("driver-playoffs-context-wide", () => {
...
describe("driver-playoffs-context-lovat", () => {
