...
describe("driver-playoffs-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-draft");
...
describe("driver-playoffs-draft-deep", () => {
...
describe("driver-playoffs-draft-wide", () => {
...
describe("driver-playoffs-draft-lovat", () => {
