...
describe("driver-playoffs-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-ewma");
...
describe("driver-playoffs-ewma-deep", () => {
...
describe("driver-playoffs-ewma-wide", () => {
...
describe("driver-playoffs-ewma-lovat", () => {
