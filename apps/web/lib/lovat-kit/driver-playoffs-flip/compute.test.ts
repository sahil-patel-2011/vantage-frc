...
describe("driver-playoffs-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-flip");
...
describe("driver-playoffs-flip-deep", () => {
...
describe("driver-playoffs-flip-wide", () => {
...
describe("driver-playoffs-flip-lovat", () => {
