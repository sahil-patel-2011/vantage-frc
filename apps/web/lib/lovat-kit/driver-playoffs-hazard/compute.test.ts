...
describe("driver-playoffs-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-hazard");
...
describe("driver-playoffs-hazard-deep", () => {
...
describe("driver-playoffs-hazard-wide", () => {
...
describe("driver-playoffs-hazard-lovat", () => {
