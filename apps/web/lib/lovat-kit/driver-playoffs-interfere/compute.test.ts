...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 9.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 26.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 45.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 9.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 26.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 45.0 } },
];

describe("driver-playoffs-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-interfere");
    ...
    expect(bootstrapMean([9.0, 26.0, 45.0])).not.toBeNull();
...
describe("driver-playoffs-interfere-deep", () => {
...
describe("driver-playoffs-interfere-wide", () => {
...
describe("driver-playoffs-interfere-lovat", () => {
