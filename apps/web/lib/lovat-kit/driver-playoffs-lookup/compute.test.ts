...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 15.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 27.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 43.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 15.0 } },
...
describe("driver-playoffs-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-lookup");
...
describe("driver-playoffs-lookup-deep", () => {
...
describe("driver-playoffs-lookup-wide", () => {
...
describe("driver-playoffs-lookup-lovat", () => {
