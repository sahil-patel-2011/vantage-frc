...
describe("driver-playoffs-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-notes");
...
describe("driver-playoffs-notes-deep", () => {
...
describe("driver-playoffs-notes-wide", () => {
...
describe("driver-playoffs-notes-lovat", () => {
