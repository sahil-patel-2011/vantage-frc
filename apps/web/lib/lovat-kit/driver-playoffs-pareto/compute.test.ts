...
describe("driver-playoffs-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-pareto");
...
describe("driver-playoffs-pareto-deep", () => {
...
describe("driver-playoffs-pareto-wide", () => {
...
describe("driver-playoffs-pareto-lovat", () => {
