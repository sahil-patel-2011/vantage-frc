...
describe("driver-playoffs-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-path");
...
describe("driver-playoffs-path-deep", () => {
...
describe("driver-playoffs-path-wide", () => {
...
describe("driver-playoffs-path-lovat", () => {
