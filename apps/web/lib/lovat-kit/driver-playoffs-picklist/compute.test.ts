...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 12.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 24.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 40.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 40.0 } },
];

describe("driver-playoffs-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-picklist");
    ...
    expect(bootstrapMean([12.0, 24.0, 40.0])).not.toBeNull();
...
describe("driver-playoffs-picklist-deep", () => {
...
describe("driver-playoffs-picklist-wide", () => {
...
describe("driver-playoffs-picklist-lovat", () => {
