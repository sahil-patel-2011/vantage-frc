...
describe("driver-playoffs-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-playhead");
    ...
    expect(bootstrapMean([17.0, 29.0, 45.0])).not.toBeNull();
...
describe("driver-playoffs-playhead-deep", () => {
...
describe("driver-playoffs-playhead-wide", () => {
...
describe("driver-playoffs-playhead-lovat", () => {
