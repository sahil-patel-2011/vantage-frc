...
describe("driver-playoffs-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-rank");
...
describe("driver-playoffs-rank-deep", () => {
...
describe("driver-playoffs-rank-wide", () => {
...
describe("driver-playoffs-rank-lovat", () => {
