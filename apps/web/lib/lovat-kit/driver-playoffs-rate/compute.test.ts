...
describe("driver-playoffs-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-rate");
...
describe("driver-playoffs-rate-deep", () => {
...
describe("driver-playoffs-rate-wide", () => {
...
describe("driver-playoffs-rate-lovat", () => {
