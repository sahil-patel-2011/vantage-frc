...
describe("driver-playoffs-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-residual");
...
describe("driver-playoffs-residual-deep", () => {
...
describe("driver-playoffs-residual-wide", () => {
...
describe("driver-playoffs-residual-lovat", () => {
