...
describe("driver-playoffs-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-shrink");
...
describe("driver-playoffs-shrink-deep", () => {
...
describe("driver-playoffs-shrink-wide", () => {
...
describe("driver-playoffs-shrink-lovat", () => {
