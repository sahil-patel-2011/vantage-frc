...
describe("driver-playoffs-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-source");
...
describe("driver-playoffs-source-deep", () => {
...
describe("driver-playoffs-source-wide", () => {
...
describe("driver-playoffs-source-lovat", () => {
