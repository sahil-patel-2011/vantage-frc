...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 19.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 31.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 47.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 19.0 } },
...
describe("driver-playoffs-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-streak");
    ...
    expect(bootstrapMean([19.0, 31.0, 47.0])).not.toBeNull();
...
describe("driver-playoffs-streak-deep", () => {
...
describe("driver-playoffs-streak-wide", () => {
...
describe("driver-playoffs-streak-lovat", () => {
