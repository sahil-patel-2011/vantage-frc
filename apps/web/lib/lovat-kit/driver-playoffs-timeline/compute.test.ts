...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 10.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 32.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 42.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 32.0 } },
...
describe("driver-playoffs-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-timeline");
    ...
    expect(bootstrapMean([10.0, 32.0, 42.0])).not.toBeNull();
...
describe("driver-playoffs-timeline-deep", () => {
...
describe("driver-playoffs-timeline-wide", () => {
...
describe("driver-playoffs-timeline-lovat", () => {
