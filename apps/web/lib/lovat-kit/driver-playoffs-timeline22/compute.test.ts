...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 26.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 28.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 38.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 38.0 } },
];

describe("driver-playoffs-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-timeline22");
    ...
    expect(bootstrapMean([26.0, 28.0, 38.0])).not.toBeNull();
...
describe("driver-playoffs-timeline22-deep", () => {
...
describe("driver-playoffs-timeline22-wide", () => {
...
describe("driver-playoffs-timeline22-lovat", () => {
