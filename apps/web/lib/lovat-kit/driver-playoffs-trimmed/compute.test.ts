...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 21.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 28.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 41.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 21.0 } },
...
describe("driver-playoffs-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-trimmed");
    ...
    expect(bootstrapMean([21.0, 28.0, 41.0])).not.toBeNull();
...
describe("driver-playoffs-trimmed-deep", () => {
...
describe("driver-playoffs-trimmed-wide", () => {
...
describe("driver-playoffs-trimmed-lovat", () => {
