...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 22.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 29.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 42.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 42.0 } },
];

describe("driver-playoffs-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-trueskill");
    ...
    expect(bootstrapMean([22.0, 29.0, 42.0])).not.toBeNull();
...
describe("driver-playoffs-trueskill-deep", () => {
...
describe("driver-playoffs-trueskill-wide", () => {
...
describe("driver-playoffs-trueskill-lovat", () => {
