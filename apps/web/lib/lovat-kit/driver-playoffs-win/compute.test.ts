...
describe("driver-playoffs-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-win");
...
describe("driver-playoffs-win-deep", () => {
...
describe("driver-playoffs-win-wide", () => {
...
describe("driver-playoffs-win-lovat", () => {
