...
describe("driver-playoffs-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-zone");
...
describe("driver-playoffs-zone-deep", () => {
...
describe("driver-playoffs-zone-wide", () => {
...
describe("driver-playoffs-zone-lovat", () => {
