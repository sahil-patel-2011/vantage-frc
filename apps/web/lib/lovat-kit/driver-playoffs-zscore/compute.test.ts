...
describe("driver-playoffs-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-playoffs-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-playoffs-zscore");
    ...
    expect(bootstrapMean([25.0, 27.0, 37.0])).not.toBeNull();
...
describe("driver-playoffs-zscore-deep", () => {
...
describe("driver-playoffs-zscore-wide", () => {
...
describe("driver-playoffs-zscore-lovat", () => {
