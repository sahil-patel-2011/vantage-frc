...
describe("driver-quals-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-assign");
...
describe("driver-quals-assign-deep", () => {
...
describe("driver-quals-assign-wide", () => {
...
describe("driver-quals-assign-lovat", () => {
