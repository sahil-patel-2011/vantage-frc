...
describe("driver-quals-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-brier");
...
describe("driver-quals-brier-deep", () => {
...
describe("driver-quals-brier-wide", () => {
...
describe("driver-quals-brier-lovat", () => {
