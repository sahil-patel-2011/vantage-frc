...
describe("driver-quals-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-colley");
...
describe("driver-quals-colley-deep", () => {
...
describe("driver-quals-colley-wide", () => {
...
describe("driver-quals-colley-lovat", () => {
