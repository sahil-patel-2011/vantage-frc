...
describe("driver-quals-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-combo");
...
describe("driver-quals-combo-deep", () => {
...
describe("driver-quals-combo-wide", () => {
...
describe("driver-quals-combo-lovat", () => {
