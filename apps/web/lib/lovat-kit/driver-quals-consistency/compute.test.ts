...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { driverAbility: 20.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 39.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 20.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 39.0 } },
];

describe("driver-quals-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-consistency");
    ...
    expect(bootstrapMean([23.0, 20.0, 39.0])).not.toBeNull();
...
describe("driver-quals-consistency-deep", () => {
...
describe("driver-quals-consistency-wide", () => {
...
describe("driver-quals-consistency-lovat", () => {
