...
describe("driver-quals-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-context");
...
describe("driver-quals-context-deep", () => {
...
describe("driver-quals-context-wide", () => {
...
describe("driver-quals-context-lovat", () => {
