...
describe("driver-quals-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-draft");
...
describe("driver-quals-draft-deep", () => {
...
describe("driver-quals-draft-wide", () => {
...
describe("driver-quals-draft-lovat", () => {
