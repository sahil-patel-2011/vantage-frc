...
describe("driver-quals-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-ewma");
...
describe("driver-quals-ewma-deep", () => {
...
describe("driver-quals-ewma-wide", () => {
...
describe("driver-quals-ewma-lovat", () => {
