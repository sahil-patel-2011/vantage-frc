...
describe("driver-quals-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-flip");
...
describe("driver-quals-flip-deep", () => {
...
describe("driver-quals-flip-wide", () => {
...
describe("driver-quals-flip-lovat", () => {
