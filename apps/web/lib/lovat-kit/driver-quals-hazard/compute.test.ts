...
describe("driver-quals-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-hazard");
...
describe("driver-quals-hazard-deep", () => {
...
describe("driver-quals-hazard-wide", () => {
...
describe("driver-quals-hazard-lovat", () => {
