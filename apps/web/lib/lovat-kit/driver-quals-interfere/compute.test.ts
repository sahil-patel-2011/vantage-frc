...
describe("driver-quals-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-interfere");
    ...
    expect(bootstrapMean([21.0, 33.0, 37.0])).not.toBeNull();
...
describe("driver-quals-interfere-deep", () => {
...
describe("driver-quals-interfere-wide", () => {
...
describe("driver-quals-interfere-lovat", () => {
