...
describe("driver-quals-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-lookup");
...
describe("driver-quals-lookup-deep", () => {
...
describe("driver-quals-lookup-wide", () => {
...
describe("driver-quals-lookup-lovat", () => {
