...
describe("driver-quals-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-notes");
...
describe("driver-quals-notes-deep", () => {
...
describe("driver-quals-notes-wide", () => {
...
describe("driver-quals-notes-lovat", () => {
