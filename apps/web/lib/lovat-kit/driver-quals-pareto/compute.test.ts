...
describe("driver-quals-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-pareto");
...
describe("driver-quals-pareto-deep", () => {
...
describe("driver-quals-pareto-wide", () => {
...
describe("driver-quals-pareto-lovat", () => {
