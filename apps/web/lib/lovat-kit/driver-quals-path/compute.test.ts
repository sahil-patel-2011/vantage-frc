...
describe("driver-quals-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-path");
...
describe("driver-quals-path-deep", () => {
...
describe("driver-quals-path-wide", () => {
...
describe("driver-quals-path-lovat", () => {
