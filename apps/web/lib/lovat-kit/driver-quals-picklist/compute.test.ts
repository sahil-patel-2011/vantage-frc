...
describe("driver-quals-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-picklist");
...
describe("driver-quals-picklist-deep", () => {
...
describe("driver-quals-picklist-wide", () => {
...
describe("driver-quals-picklist-lovat", () => {
