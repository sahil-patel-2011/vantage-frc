...
describe("driver-quals-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-playhead");
...
describe("driver-quals-playhead-deep", () => {
...
describe("driver-quals-playhead-wide", () => {
...
describe("driver-quals-playhead-lovat", () => {
