...
describe("driver-quals-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-rank");
...
describe("driver-quals-rank-deep", () => {
...
describe("driver-quals-rank-wide", () => {
...
describe("driver-quals-rank-lovat", () => {
