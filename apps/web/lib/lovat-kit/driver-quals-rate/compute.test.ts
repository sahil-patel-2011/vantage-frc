...
describe("driver-quals-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-rate");
...
describe("driver-quals-rate-deep", () => {
...
describe("driver-quals-rate-wide", () => {
...
describe("driver-quals-rate-lovat", () => {
