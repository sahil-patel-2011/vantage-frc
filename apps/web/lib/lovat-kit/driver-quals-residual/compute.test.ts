...
describe("driver-quals-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-residual");
...
describe("driver-quals-residual-deep", () => {
...
describe("driver-quals-residual-wide", () => {
...
describe("driver-quals-residual-lovat", () => {
