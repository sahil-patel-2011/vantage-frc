...
describe("driver-quals-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-shrink");
...
describe("driver-quals-shrink-deep", () => {
...
describe("driver-quals-shrink-wide", () => {
...
describe("driver-quals-shrink-lovat", () => {
