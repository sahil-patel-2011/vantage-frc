...
describe("driver-quals-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-source");
...
describe("driver-quals-source-deep", () => {
...
describe("driver-quals-source-wide", () => {
...
describe("driver-quals-source-lovat", () => {
