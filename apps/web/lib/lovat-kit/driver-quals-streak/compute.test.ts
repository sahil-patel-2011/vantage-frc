...
describe("driver-quals-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-streak");
...
describe("driver-quals-streak-deep", () => {
...
describe("driver-quals-streak-wide", () => {
...
describe("driver-quals-streak-lovat", () => {
