...
describe("driver-quals-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-timeline");
...
describe("driver-quals-timeline-deep", () => {
...
describe("driver-quals-timeline-wide", () => {
...
describe("driver-quals-timeline-lovat", () => {
