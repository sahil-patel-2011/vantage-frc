...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { driverAbility: 22.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 38.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 22.0 } },
...
describe("driver-quals-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-timeline22");
    ...
    expect(bootstrapMean([10.0, 22.0, 38.0])).not.toBeNull();
...
describe("driver-quals-timeline22-deep", () => {
...
describe("driver-quals-timeline22-wide", () => {
...
describe("driver-quals-timeline22-lovat", () => {
