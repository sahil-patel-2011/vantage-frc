...
describe("driver-quals-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-trimmed");
...
describe("driver-quals-trimmed-deep", () => {
...
describe("driver-quals-trimmed-wide", () => {
...
describe("driver-quals-trimmed-lovat", () => {
