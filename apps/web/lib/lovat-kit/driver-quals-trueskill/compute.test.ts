...
describe("driver-quals-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-trueskill");
    ...
    expect(bootstrapMean([18.0, 25.0, 38.0])).not.toBeNull();
...
describe("driver-quals-trueskill-deep", () => {
...
describe("driver-quals-trueskill-wide", () => {
...
describe("driver-quals-trueskill-lovat", () => {
