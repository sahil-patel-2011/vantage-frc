...
describe("driver-quals-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-zone");
...
describe("driver-quals-zone-deep", () => {
...
describe("driver-quals-zone-wide", () => {
...
describe("driver-quals-zone-lovat", () => {
