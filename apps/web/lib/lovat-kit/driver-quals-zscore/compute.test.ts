...
describe("driver-quals-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-quals-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-quals-zscore");
...
describe("driver-quals-zscore-deep", () => {
...
describe("driver-quals-zscore-wide", () => {
...
describe("driver-quals-zscore-lovat", () => {
