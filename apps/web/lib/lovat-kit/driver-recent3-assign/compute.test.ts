...
describe("driver-recent3-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-assign");
...
describe("driver-recent3-assign-deep", () => {
...
describe("driver-recent3-assign-wide", () => {
...
describe("driver-recent3-assign-lovat", () => {
