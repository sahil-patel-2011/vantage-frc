...
describe("driver-recent3-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-brier");
...
describe("driver-recent3-brier-deep", () => {
...
describe("driver-recent3-brier-wide", () => {
...
describe("driver-recent3-brier-lovat", () => {
