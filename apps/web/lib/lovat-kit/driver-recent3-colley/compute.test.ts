...
describe("driver-recent3-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-colley");
    ...
    expect(bootstrapMean([21.0, 23.0, 45.0])).not.toBeNull();
...
describe("driver-recent3-colley-deep", () => {
...
describe("driver-recent3-colley-wide", () => {
...
describe("driver-recent3-colley-lovat", () => {
