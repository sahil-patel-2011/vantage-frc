...
describe("driver-recent3-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-combo");
...
describe("driver-recent3-combo-deep", () => {
...
describe("driver-recent3-combo-wide", () => {
...
describe("driver-recent3-combo-lovat", () => {
