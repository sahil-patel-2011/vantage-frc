...
describe("driver-recent3-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-consistency");
...
describe("driver-recent3-consistency-deep", () => {
...
describe("driver-recent3-consistency-wide", () => {
...
describe("driver-recent3-consistency-lovat", () => {
