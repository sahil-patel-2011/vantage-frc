...
describe("driver-recent3-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-draft");
...
describe("driver-recent3-draft-deep", () => {
...
describe("driver-recent3-draft-wide", () => {
...
describe("driver-recent3-draft-lovat", () => {
