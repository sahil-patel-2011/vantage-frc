...
describe("driver-recent3-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-ewma");
...
describe("driver-recent3-ewma-deep", () => {
...
describe("driver-recent3-ewma-wide", () => {
...
describe("driver-recent3-ewma-lovat", () => {
