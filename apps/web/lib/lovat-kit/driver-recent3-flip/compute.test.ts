...
describe("driver-recent3-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-flip");
...
describe("driver-recent3-flip-deep", () => {
...
describe("driver-recent3-flip-wide", () => {
...
describe("driver-recent3-flip-lovat", () => {
