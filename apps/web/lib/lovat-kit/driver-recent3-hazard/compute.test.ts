...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 13.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 20.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 45.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 13.0 } },
...
describe("driver-recent3-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-hazard");
    ...
    expect(bootstrapMean([13.0, 20.0, 45.0])).not.toBeNull();
...
describe("driver-recent3-hazard-deep", () => {
...
describe("driver-recent3-hazard-wide", () => {
...
describe("driver-recent3-hazard-lovat", () => {
