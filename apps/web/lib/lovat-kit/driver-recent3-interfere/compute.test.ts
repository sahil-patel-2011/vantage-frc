...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { driverAbility: 41.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 41.0 } },
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 41.0 } },
];

describe("driver-recent3-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-interfere");
    ...
    expect(bootstrapMean([17.0, 34.0, 41.0])).not.toBeNull();
...
describe("driver-recent3-interfere-deep", () => {
...
describe("driver-recent3-interfere-wide", () => {
...
describe("driver-recent3-interfere-lovat", () => {
