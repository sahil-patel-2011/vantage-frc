...
describe("driver-recent3-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-lookup");
...
describe("driver-recent3-lookup-deep", () => {
...
describe("driver-recent3-lookup-wide", () => {
...
describe("driver-recent3-lookup-lovat", () => {
