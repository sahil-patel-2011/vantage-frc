...
describe("driver-recent3-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-notes");
...
describe("driver-recent3-notes-deep", () => {
...
describe("driver-recent3-notes-wide", () => {
...
describe("driver-recent3-notes-lovat", () => {
