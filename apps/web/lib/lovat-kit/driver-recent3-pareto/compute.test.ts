...
describe("driver-recent3-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-pareto");
...
describe("driver-recent3-pareto-deep", () => {
...
describe("driver-recent3-pareto-wide", () => {
...
describe("driver-recent3-pareto-lovat", () => {
