...
describe("driver-recent3-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-path");
...
describe("driver-recent3-path-deep", () => {
...
describe("driver-recent3-path-wide", () => {
...
describe("driver-recent3-path-lovat", () => {
