...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 20.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 27.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 40.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 20.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 27.0 } },
...
describe("driver-recent3-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-picklist");
    ...
    expect(bootstrapMean([20.0, 27.0, 40.0])).not.toBeNull();
...
describe("driver-recent3-picklist-deep", () => {
...
describe("driver-recent3-picklist-wide", () => {
...
describe("driver-recent3-picklist-lovat", () => {
