...
describe("driver-recent3-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-playhead");
...
describe("driver-recent3-playhead-deep", () => {
...
describe("driver-recent3-playhead-wide", () => {
...
describe("driver-recent3-playhead-lovat", () => {
