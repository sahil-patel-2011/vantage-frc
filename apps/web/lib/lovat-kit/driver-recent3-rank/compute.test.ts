...
describe("driver-recent3-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-rank");
...
describe("driver-recent3-rank-deep", () => {
...
describe("driver-recent3-rank-wide", () => {
...
describe("driver-recent3-rank-lovat", () => {
