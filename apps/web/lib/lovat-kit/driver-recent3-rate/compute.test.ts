...
describe("driver-recent3-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-rate");
...
describe("driver-recent3-rate-deep", () => {
...
describe("driver-recent3-rate-wide", () => {
...
describe("driver-recent3-rate-lovat", () => {
