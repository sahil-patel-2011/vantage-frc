...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { driverAbility: 31.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 38.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 14.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 31.0 } },
...
describe("driver-recent3-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-residual");
    ...
    expect(bootstrapMean([14.0, 31.0, 38.0])).not.toBeNull();
...
describe("driver-recent3-residual-deep", () => {
...
describe("driver-recent3-residual-wide", () => {
...
describe("driver-recent3-residual-lovat", () => {
