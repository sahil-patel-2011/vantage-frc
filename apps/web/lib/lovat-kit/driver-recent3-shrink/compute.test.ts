...
describe("driver-recent3-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-shrink");
...
describe("driver-recent3-shrink-deep", () => {
...
describe("driver-recent3-shrink-wide", () => {
...
describe("driver-recent3-shrink-lovat", () => {
