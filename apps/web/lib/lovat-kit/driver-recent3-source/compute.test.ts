...
describe("driver-recent3-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-source");
    ...
    expect(bootstrapMean([12.0, 34.0, 44.0])).not.toBeNull();
...
describe("driver-recent3-source-deep", () => {
...
describe("driver-recent3-source-wide", () => {
...
describe("driver-recent3-source-lovat", () => {
