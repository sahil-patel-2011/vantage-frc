...
describe("driver-recent3-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-streak");
...
describe("driver-recent3-streak-deep", () => {
...
describe("driver-recent3-streak-wide", () => {
...
describe("driver-recent3-streak-lovat", () => {
