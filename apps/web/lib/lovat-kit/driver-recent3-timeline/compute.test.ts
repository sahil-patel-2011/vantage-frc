...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 18.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 30.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 46.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 18.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 30.0 } },
...
describe("driver-recent3-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-timeline");
    ...
    expect(bootstrapMean([18.0, 30.0, 46.0])).not.toBeNull();
...
describe("driver-recent3-timeline-deep", () => {
...
describe("driver-recent3-timeline-wide", () => {
...
describe("driver-recent3-timeline-lovat", () => {
