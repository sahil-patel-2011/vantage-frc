...
const rows = [
  { teamKey: "frc1", qual: true, values: { driverAbility: 14.0 } },
  { teamKey: "frc2", qual: true, values: { driverAbility: 21.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 46.0 } },
  { teamKey: "frc3", qual: true, values: { driverAbility: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { driverAbility: 14.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { driverAbility: 21.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { driverAbility: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { driverAbility: 46.0 } },
];

describe("driver-recent3-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-timeline22");
    ...
    expect(bootstrapMean([14.0, 21.0, 46.0])).not.toBeNull();
...
describe("driver-recent3-timeline22-deep", () => {
...
describe("driver-recent3-timeline22-wide", () => {
...
describe("driver-recent3-timeline22-lovat", () => {
