...
describe("driver-recent3-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-trimmed");
    ...
    expect(bootstrapMean([9.0, 31.0, 41.0])).not.toBeNull();
...
describe("driver-recent3-trimmed-deep", () => {
...
describe("driver-recent3-trimmed-wide", () => {
...
describe("driver-recent3-trimmed-lovat", () => {
