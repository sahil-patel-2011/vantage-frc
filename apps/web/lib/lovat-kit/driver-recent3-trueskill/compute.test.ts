...
describe("driver-recent3-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-trueskill");
...
describe("driver-recent3-trueskill-deep", () => {
...
describe("driver-recent3-trueskill-wide", () => {
...
describe("driver-recent3-trueskill-lovat", () => {
