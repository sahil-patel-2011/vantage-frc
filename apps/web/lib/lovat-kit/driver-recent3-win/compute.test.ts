...
describe("driver-recent3-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-win");
...
describe("driver-recent3-win-deep", () => {
...
describe("driver-recent3-win-wide", () => {
...
describe("driver-recent3-win-lovat", () => {
