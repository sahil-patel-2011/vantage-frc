...
describe("driver-recent3-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-zone");
...
describe("driver-recent3-zone-deep", () => {
...
describe("driver-recent3-zone-wide", () => {
...
describe("driver-recent3-zone-lovat", () => {
