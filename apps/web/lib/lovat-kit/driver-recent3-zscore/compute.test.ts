...
describe("driver-recent3-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-recent3-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-recent3-zscore");
...
describe("driver-recent3-zscore-deep", () => {
...
describe("driver-recent3-zscore-wide", () => {
...
describe("driver-recent3-zscore-lovat", () => {
