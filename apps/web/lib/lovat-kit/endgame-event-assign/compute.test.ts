...
describe("endgame-event-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-assign");
...
describe("endgame-event-assign-deep", () => {
...
describe("endgame-event-assign-wide", () => {
...
describe("endgame-event-assign-lovat", () => {
