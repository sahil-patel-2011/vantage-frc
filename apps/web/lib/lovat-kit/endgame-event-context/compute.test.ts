...
describe("endgame-event-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-context");
...
describe("endgame-event-context-deep", () => {
...
describe("endgame-event-context-wide", () => {
...
describe("endgame-event-context-lovat", () => {
