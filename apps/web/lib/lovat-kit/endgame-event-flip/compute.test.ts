...
describe("endgame-event-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-flip");
...
describe("endgame-event-flip-deep", () => {
...
describe("endgame-event-flip-wide", () => {
...
describe("endgame-event-flip-lovat", () => {
