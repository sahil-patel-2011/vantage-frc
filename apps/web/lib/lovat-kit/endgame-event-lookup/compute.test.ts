...
describe("endgame-event-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-lookup");
...
describe("endgame-event-lookup-deep", () => {
...
describe("endgame-event-lookup-wide", () => {
...
describe("endgame-event-lookup-lovat", () => {
