...
describe("endgame-event-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-notes");
...
describe("endgame-event-notes-deep", () => {
...
describe("endgame-event-notes-wide", () => {
...
describe("endgame-event-notes-lovat", () => {
