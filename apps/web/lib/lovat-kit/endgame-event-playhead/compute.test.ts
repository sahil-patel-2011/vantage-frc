...
describe("endgame-event-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-playhead");
...
describe("endgame-event-playhead-deep", () => {
...
describe("endgame-event-playhead-wide", () => {
...
describe("endgame-event-playhead-lovat", () => {
