...
describe("endgame-event-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-source");
...
describe("endgame-event-source-deep", () => {
...
describe("endgame-event-source-wide", () => {
...
describe("endgame-event-source-lovat", () => {
