...
describe("endgame-event-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-timeline22");
...
describe("endgame-event-timeline22-deep", () => {
...
describe("endgame-event-timeline22-wide", () => {
...
describe("endgame-event-timeline22-lovat", () => {
