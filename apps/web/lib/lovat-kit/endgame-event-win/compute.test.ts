...
describe("endgame-event-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-win");
...
describe("endgame-event-win-deep", () => {
...
describe("endgame-event-win-wide", () => {
...
describe("endgame-event-win-lovat", () => {
