...
describe("endgame-last12-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-assign");
...
describe("endgame-last12-assign-deep", () => {
...
describe("endgame-last12-assign-wide", () => {
...
describe("endgame-last12-assign-lovat", () => {
