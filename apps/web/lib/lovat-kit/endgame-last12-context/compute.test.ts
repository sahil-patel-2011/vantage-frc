...
describe("endgame-last12-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-context");
...
describe("endgame-last12-context-deep", () => {
...
describe("endgame-last12-context-wide", () => {
...
describe("endgame-last12-context-lovat", () => {
