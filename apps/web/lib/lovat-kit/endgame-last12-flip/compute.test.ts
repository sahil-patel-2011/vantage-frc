...
describe("endgame-last12-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-flip");
...
describe("endgame-last12-flip-deep", () => {
...
describe("endgame-last12-flip-wide", () => {
...
describe("endgame-last12-flip-lovat", () => {
