...
describe("endgame-last12-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-lookup");
...
describe("endgame-last12-lookup-deep", () => {
...
describe("endgame-last12-lookup-wide", () => {
...
describe("endgame-last12-lookup-lovat", () => {
