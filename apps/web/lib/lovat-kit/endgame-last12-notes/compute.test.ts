...
describe("endgame-last12-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-notes");
...
describe("endgame-last12-notes-deep", () => {
...
describe("endgame-last12-notes-wide", () => {
...
describe("endgame-last12-notes-lovat", () => {
