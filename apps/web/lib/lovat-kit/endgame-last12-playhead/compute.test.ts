...
describe("endgame-last12-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-playhead");
...
describe("endgame-last12-playhead-deep", () => {
...
describe("endgame-last12-playhead-wide", () => {
...
describe("endgame-last12-playhead-lovat", () => {
