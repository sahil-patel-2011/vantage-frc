...
describe("endgame-last12-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-source");
...
describe("endgame-last12-source-deep", () => {
...
describe("endgame-last12-source-wide", () => {
...
describe("endgame-last12-source-lovat", () => {
