...
describe("endgame-last12-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-win");
...
describe("endgame-last12-win-deep", () => {
...
describe("endgame-last12-win-wide", () => {
...
describe("endgame-last12-win-lovat", () => {
