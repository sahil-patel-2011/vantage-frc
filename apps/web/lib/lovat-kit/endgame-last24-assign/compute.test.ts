...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 13.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 20.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 13.0 } },
...
describe("endgame-last24-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-assign");
...
describe("endgame-last24-assign-deep", () => {
...
describe("endgame-last24-assign-wide", () => {
...
describe("endgame-last24-assign-lovat", () => {
