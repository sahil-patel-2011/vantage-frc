...
describe("endgame-last24-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-brier");
...
describe("endgame-last24-brier-deep", () => {
...
describe("endgame-last24-brier-wide", () => {
...
describe("endgame-last24-brier-lovat", () => {
