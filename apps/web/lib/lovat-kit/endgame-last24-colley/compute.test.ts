...
describe("endgame-last24-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-colley");
...
describe("endgame-last24-colley-deep", () => {
...
describe("endgame-last24-colley-wide", () => {
...
describe("endgame-last24-colley-lovat", () => {
