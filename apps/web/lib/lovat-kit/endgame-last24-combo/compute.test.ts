...
describe("endgame-last24-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-combo");
...
describe("endgame-last24-combo-deep", () => {
...
describe("endgame-last24-combo-wide", () => {
