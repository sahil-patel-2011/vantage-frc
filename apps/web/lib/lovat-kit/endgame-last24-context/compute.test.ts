...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 11.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 23.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 39.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 11.0 } },
...
describe("endgame-last24-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-context");
...
describe("endgame-last24-context-deep", () => {
...
describe("endgame-last24-context-wide", () => {
...
describe("endgame-last24-context-lovat", () => {
