...
describe("endgame-last24-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-draft");
...
describe("endgame-last24-draft-deep", () => {
...
describe("endgame-last24-draft-wide", () => {
...
describe("endgame-last24-draft-lovat", () => {
