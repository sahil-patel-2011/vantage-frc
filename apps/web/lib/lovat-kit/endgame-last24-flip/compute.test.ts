...
describe("endgame-last24-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-flip");
...
describe("endgame-last24-flip-deep", () => {
...
describe("endgame-last24-flip-wide", () => {
...
describe("endgame-last24-flip-lovat", () => {
