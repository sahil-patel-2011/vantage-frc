...
describe("endgame-last24-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-hazard");
...
describe("endgame-last24-hazard-deep", () => {
...
describe("endgame-last24-hazard-wide", () => {
...
describe("endgame-last24-hazard-lovat", () => {
