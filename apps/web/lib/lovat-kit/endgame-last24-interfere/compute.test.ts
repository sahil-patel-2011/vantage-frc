...
describe("endgame-last24-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-interfere");
...
describe("endgame-last24-interfere-deep", () => {
...
describe("endgame-last24-interfere-wide", () => {
