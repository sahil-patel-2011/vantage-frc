...
describe("endgame-last24-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-lookup");
...
describe("endgame-last24-lookup-deep", () => {
...
describe("endgame-last24-lookup-wide", () => {
...
describe("endgame-last24-lookup-lovat", () => {
