...
describe("endgame-last24-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-notes");
...
describe("endgame-last24-notes-deep", () => {
...
describe("endgame-last24-notes-wide", () => {
...
describe("endgame-last24-notes-lovat", () => {
