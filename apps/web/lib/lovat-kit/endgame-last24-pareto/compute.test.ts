...
describe("endgame-last24-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-pareto");
...
describe("endgame-last24-pareto-deep", () => {
...
describe("endgame-last24-pareto-wide", () => {
...
describe("endgame-last24-pareto-lovat", () => {
