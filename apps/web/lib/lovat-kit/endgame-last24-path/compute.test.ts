...
describe("endgame-last24-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-path");
...
describe("endgame-last24-path-deep", () => {
...
describe("endgame-last24-path-wide", () => {
