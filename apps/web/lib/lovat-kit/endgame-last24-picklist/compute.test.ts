...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { endgameClimb: 23.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 23.0 } },
...
describe("endgame-last24-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-picklist");
...
describe("endgame-last24-picklist-deep", () => {
...
describe("endgame-last24-picklist-wide", () => {
...
describe("endgame-last24-picklist-lovat", () => {
