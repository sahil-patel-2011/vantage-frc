...
describe("endgame-last24-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-playhead");
...
describe("endgame-last24-playhead-deep", () => {
...
describe("endgame-last24-playhead-wide", () => {
...
describe("endgame-last24-playhead-lovat", () => {
