...
describe("endgame-last24-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-rank");
...
describe("endgame-last24-rank-deep", () => {
...
describe("endgame-last24-rank-wide", () => {
