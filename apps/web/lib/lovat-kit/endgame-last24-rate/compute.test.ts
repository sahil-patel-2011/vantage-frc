...
describe("endgame-last24-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-rate");
...
describe("endgame-last24-rate-deep", () => {
...
describe("endgame-last24-rate-wide", () => {
