...
describe("endgame-last24-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-residual");
...
describe("endgame-last24-residual-deep", () => {
...
describe("endgame-last24-residual-wide", () => {
...
describe("endgame-last24-residual-lovat", () => {
