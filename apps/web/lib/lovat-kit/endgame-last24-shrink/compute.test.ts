...
describe("endgame-last24-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-shrink");
...
describe("endgame-last24-shrink-deep", () => {
...
describe("endgame-last24-shrink-wide", () => {
