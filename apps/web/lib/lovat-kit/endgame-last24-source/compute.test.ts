...
describe("endgame-last24-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-source");
...
describe("endgame-last24-source-deep", () => {
...
describe("endgame-last24-source-wide", () => {
...
describe("endgame-last24-source-lovat", () => {
