...
describe("endgame-last24-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-streak");
...
describe("endgame-last24-streak-deep", () => {
...
describe("endgame-last24-streak-wide", () => {
...
describe("endgame-last24-streak-lovat", () => {
