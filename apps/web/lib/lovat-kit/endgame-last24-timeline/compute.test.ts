...
describe("endgame-last24-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-timeline");
...
describe("endgame-last24-timeline-deep", () => {
...
describe("endgame-last24-timeline-wide", () => {
