...
describe("endgame-last24-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-timeline22");
...
describe("endgame-last24-timeline22-deep", () => {
...
describe("endgame-last24-timeline22-wide", () => {
...
describe("endgame-last24-timeline22-lovat", () => {
