...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { endgameClimb: 41.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 41.0 } },
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 41.0 } },
];

describe("endgame-last24-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-trueskill");
...
describe("endgame-last24-trueskill-deep", () => {
...
describe("endgame-last24-trueskill-wide", () => {
...
describe("endgame-last24-trueskill-lovat", () => {
