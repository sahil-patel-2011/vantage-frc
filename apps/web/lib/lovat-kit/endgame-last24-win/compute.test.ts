...
describe("endgame-last24-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-win");
...
describe("endgame-last24-win-deep", () => {
...
describe("endgame-last24-win-wide", () => {
...
describe("endgame-last24-win-lovat", () => {
