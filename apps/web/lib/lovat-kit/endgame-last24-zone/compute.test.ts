...
describe("endgame-last24-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last24-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last24-zone");
...
describe("endgame-last24-zone-deep", () => {
...
describe("endgame-last24-zone-wide", () => {
...
describe("endgame-last24-zone-lovat", () => {
