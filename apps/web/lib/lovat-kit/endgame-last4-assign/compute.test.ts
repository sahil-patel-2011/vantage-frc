...
describe("endgame-last4-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-assign");
...
describe("endgame-last4-assign-deep", () => {
...
describe("endgame-last4-assign-wide", () => {
...
describe("endgame-last4-assign-lovat", () => {
