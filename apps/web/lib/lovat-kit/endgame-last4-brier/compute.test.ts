...
describe("endgame-last4-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-brier");
...
describe("endgame-last4-brier-deep", () => {
...
describe("endgame-last4-brier-wide", () => {
...
describe("endgame-last4-brier-lovat", () => {
