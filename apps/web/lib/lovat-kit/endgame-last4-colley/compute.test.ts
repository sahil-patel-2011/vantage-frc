...
describe("endgame-last4-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-colley");
...
describe("endgame-last4-colley-deep", () => {
...
describe("endgame-last4-colley-wide", () => {
...
describe("endgame-last4-colley-lovat", () => {
