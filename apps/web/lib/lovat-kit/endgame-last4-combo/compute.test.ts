...
describe("endgame-last4-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-combo");
...
describe("endgame-last4-combo-deep", () => {
...
describe("endgame-last4-combo-wide", () => {
...
describe("endgame-last4-combo-lovat", () => {
