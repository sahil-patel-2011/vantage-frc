...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 8.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 20.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 36.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 8.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 20.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 36.0 } },
];

describe("endgame-last4-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-consistency");
...
describe("endgame-last4-consistency-deep", () => {
...
describe("endgame-last4-consistency-wide", () => {
...
describe("endgame-last4-consistency-lovat", () => {
