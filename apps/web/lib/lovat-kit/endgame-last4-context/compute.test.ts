...
describe("endgame-last4-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-context");
...
describe("endgame-last4-context-deep", () => {
...
describe("endgame-last4-context-wide", () => {
...
describe("endgame-last4-context-lovat", () => {
