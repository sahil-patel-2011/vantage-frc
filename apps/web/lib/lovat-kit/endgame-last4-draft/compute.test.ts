...
describe("endgame-last4-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-draft");
...
describe("endgame-last4-draft-deep", () => {
...
describe("endgame-last4-draft-wide", () => {
...
describe("endgame-last4-draft-lovat", () => {
