...
describe("endgame-last4-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-ewma");
...
describe("endgame-last4-ewma-deep", () => {
...
describe("endgame-last4-ewma-wide", () => {
...
describe("endgame-last4-ewma-lovat", () => {
