...
describe("endgame-last4-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-flip");
...
describe("endgame-last4-flip-deep", () => {
...
describe("endgame-last4-flip-wide", () => {
...
describe("endgame-last4-flip-lovat", () => {
