...
describe("endgame-last4-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-hazard");
...
describe("endgame-last4-hazard-deep", () => {
...
describe("endgame-last4-hazard-wide", () => {
...
describe("endgame-last4-hazard-lovat", () => {
