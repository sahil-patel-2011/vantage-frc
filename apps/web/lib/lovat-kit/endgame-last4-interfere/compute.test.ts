...
describe("endgame-last4-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-interfere");
...
describe("endgame-last4-interfere-deep", () => {
...
describe("endgame-last4-interfere-wide", () => {
...
describe("endgame-last4-interfere-lovat", () => {
