...
describe("endgame-last4-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-lookup");
...
describe("endgame-last4-lookup-deep", () => {
...
describe("endgame-last4-lookup-wide", () => {
...
describe("endgame-last4-lookup-lovat", () => {
