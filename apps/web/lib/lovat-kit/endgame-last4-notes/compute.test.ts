...
describe("endgame-last4-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-notes");
...
describe("endgame-last4-notes-deep", () => {
...
describe("endgame-last4-notes-wide", () => {
...
describe("endgame-last4-notes-lovat", () => {
