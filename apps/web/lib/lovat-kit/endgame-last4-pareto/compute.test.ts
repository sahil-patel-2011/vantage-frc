...
describe("endgame-last4-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-pareto");
...
describe("endgame-last4-pareto-deep", () => {
...
describe("endgame-last4-pareto-wide", () => {
...
describe("endgame-last4-pareto-lovat", () => {
