...
describe("endgame-last4-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-path");
...
describe("endgame-last4-path-deep", () => {
...
describe("endgame-last4-path-wide", () => {
...
describe("endgame-last4-path-lovat", () => {
