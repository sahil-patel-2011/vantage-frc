...
describe("endgame-last4-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-picklist");
...
describe("endgame-last4-picklist-deep", () => {
...
describe("endgame-last4-picklist-wide", () => {
...
describe("endgame-last4-picklist-lovat", () => {
