...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { endgameClimb: 26.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 36.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 24.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 26.0 } },
...
describe("endgame-last4-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-playhead");
...
describe("endgame-last4-playhead-deep", () => {
...
describe("endgame-last4-playhead-wide", () => {
...
describe("endgame-last4-playhead-lovat", () => {
