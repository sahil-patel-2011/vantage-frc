...
describe("endgame-last4-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-rank");
...
describe("endgame-last4-rank-deep", () => {
...
describe("endgame-last4-rank-wide", () => {
...
describe("endgame-last4-rank-lovat", () => {
