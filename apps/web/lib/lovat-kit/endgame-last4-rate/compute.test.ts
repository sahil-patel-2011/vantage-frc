...
describe("endgame-last4-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-rate");
...
describe("endgame-last4-rate-deep", () => {
...
describe("endgame-last4-rate-wide", () => {
...
describe("endgame-last4-rate-lovat", () => {
