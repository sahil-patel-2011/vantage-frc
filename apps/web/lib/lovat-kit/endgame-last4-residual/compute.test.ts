...
describe("endgame-last4-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-residual");
...
describe("endgame-last4-residual-deep", () => {
...
describe("endgame-last4-residual-wide", () => {
...
describe("endgame-last4-residual-lovat", () => {
