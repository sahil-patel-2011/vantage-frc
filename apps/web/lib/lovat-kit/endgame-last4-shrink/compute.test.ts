...
describe("endgame-last4-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-shrink");
...
describe("endgame-last4-shrink-deep", () => {
...
describe("endgame-last4-shrink-wide", () => {
...
describe("endgame-last4-shrink-lovat", () => {
