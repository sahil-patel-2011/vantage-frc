...
describe("endgame-last4-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-source");
...
describe("endgame-last4-source-deep", () => {
...
describe("endgame-last4-source-wide", () => {
...
describe("endgame-last4-source-lovat", () => {
