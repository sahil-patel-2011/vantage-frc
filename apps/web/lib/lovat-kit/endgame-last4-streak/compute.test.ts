...
describe("endgame-last4-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-streak");
...
describe("endgame-last4-streak-deep", () => {
...
describe("endgame-last4-streak-wide", () => {
...
describe("endgame-last4-streak-lovat", () => {
