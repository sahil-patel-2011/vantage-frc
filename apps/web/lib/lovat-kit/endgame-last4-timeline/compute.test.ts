...
describe("endgame-last4-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-timeline");
...
describe("endgame-last4-timeline-deep", () => {
...
describe("endgame-last4-timeline-wide", () => {
...
describe("endgame-last4-timeline-lovat", () => {
