...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { endgameClimb: 32.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 39.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 39.0 } },
];

describe("endgame-last4-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-timeline22");
    ...
    expect(bootstrapMean([15.0, 32.0, 39.0])).not.toBeNull();
...
describe("endgame-last4-timeline22-deep", () => {
...
describe("endgame-last4-timeline22-wide", () => {
...
describe("endgame-last4-timeline22-lovat", () => {
