...
describe("endgame-last4-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-trimmed");
...
describe("endgame-last4-trimmed-deep", () => {
...
describe("endgame-last4-trimmed-wide", () => {
...
describe("endgame-last4-trimmed-lovat", () => {
