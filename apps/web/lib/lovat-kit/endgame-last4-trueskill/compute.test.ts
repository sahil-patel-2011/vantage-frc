...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 25.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 32.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 25.0 } },
...
describe("endgame-last4-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-trueskill");
...
describe("endgame-last4-trueskill-deep", () => {
...
describe("endgame-last4-trueskill-wide", () => {
...
describe("endgame-last4-trueskill-lovat", () => {
