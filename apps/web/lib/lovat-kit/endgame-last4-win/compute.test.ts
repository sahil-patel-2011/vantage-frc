...
describe("endgame-last4-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-win");
...
describe("endgame-last4-win-deep", () => {
...
describe("endgame-last4-win-wide", () => {
...
describe("endgame-last4-win-lovat", () => {
