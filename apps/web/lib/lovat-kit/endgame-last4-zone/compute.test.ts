...
describe("endgame-last4-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-zone");
...
describe("endgame-last4-zone-deep", () => {
...
describe("endgame-last4-zone-wide", () => {
...
describe("endgame-last4-zone-lovat", () => {
