...
describe("endgame-last4-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last4-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last4-zscore");
...
describe("endgame-last4-zscore-deep", () => {
...
describe("endgame-last4-zscore-wide", () => {
...
describe("endgame-last4-zscore-lovat", () => {
