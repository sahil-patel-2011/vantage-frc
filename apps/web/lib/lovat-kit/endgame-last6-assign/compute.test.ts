...
describe("endgame-last6-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-assign");
...
describe("endgame-last6-assign-deep", () => {
...
describe("endgame-last6-assign-wide", () => {
...
describe("endgame-last6-assign-lovat", () => {
