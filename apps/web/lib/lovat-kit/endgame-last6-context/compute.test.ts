...
describe("endgame-last6-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-context");
...
describe("endgame-last6-context-deep", () => {
...
describe("endgame-last6-context-wide", () => {
...
describe("endgame-last6-context-lovat", () => {
