...
describe("endgame-last6-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-flip");
...
describe("endgame-last6-flip-deep", () => {
...
describe("endgame-last6-flip-wide", () => {
...
describe("endgame-last6-flip-lovat", () => {
