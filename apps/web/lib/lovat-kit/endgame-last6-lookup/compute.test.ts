...
describe("endgame-last6-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-lookup");
...
describe("endgame-last6-lookup-deep", () => {
...
describe("endgame-last6-lookup-wide", () => {
...
describe("endgame-last6-lookup-lovat", () => {
