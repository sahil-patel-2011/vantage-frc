...
describe("endgame-last6-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-notes");
...
describe("endgame-last6-notes-deep", () => {
...
describe("endgame-last6-notes-wide", () => {
...
describe("endgame-last6-notes-lovat", () => {
