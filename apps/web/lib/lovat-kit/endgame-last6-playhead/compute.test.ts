...
describe("endgame-last6-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-playhead");
...
describe("endgame-last6-playhead-deep", () => {
...
describe("endgame-last6-playhead-wide", () => {
...
describe("endgame-last6-playhead-lovat", () => {
