...
describe("endgame-last6-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-source");
...
describe("endgame-last6-source-deep", () => {
...
describe("endgame-last6-source-wide", () => {
...
describe("endgame-last6-source-lovat", () => {
