...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 21.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 28.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 41.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 28.0 } },
...
describe("endgame-last6-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-timeline22");
...
describe("endgame-last6-timeline22-deep", () => {
...
describe("endgame-last6-timeline22-wide", () => {
...
describe("endgame-last6-timeline22-lovat", () => {
