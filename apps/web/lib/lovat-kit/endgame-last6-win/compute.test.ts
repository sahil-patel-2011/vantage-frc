...
describe("endgame-last6-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-win");
...
describe("endgame-last6-win-deep", () => {
...
describe("endgame-last6-win-wide", () => {
...
describe("endgame-last6-win-lovat", () => {
