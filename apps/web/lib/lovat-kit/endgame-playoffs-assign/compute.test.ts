...
describe("endgame-playoffs-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-assign");
...
describe("endgame-playoffs-assign-deep", () => {
...
describe("endgame-playoffs-assign-wide", () => {
...
describe("endgame-playoffs-assign-lovat", () => {
