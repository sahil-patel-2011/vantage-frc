...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 26.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 28.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 38.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 26.0 } },
...
describe("endgame-playoffs-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-brier");
...
describe("endgame-playoffs-brier-deep", () => {
...
describe("endgame-playoffs-brier-wide", () => {
...
describe("endgame-playoffs-brier-lovat", () => {
