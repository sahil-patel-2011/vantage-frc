...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 18.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 30.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 46.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 18.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 30.0 } },
...
describe("endgame-playoffs-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-colley");
...
describe("endgame-playoffs-colley-deep", () => {
...
describe("endgame-playoffs-colley-wide", () => {
...
describe("endgame-playoffs-colley-lovat", () => {
