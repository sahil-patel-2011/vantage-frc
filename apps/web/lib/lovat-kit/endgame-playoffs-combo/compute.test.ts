...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 12.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 24.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 40.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 12.0 } },
...
describe("endgame-playoffs-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-combo");
...
describe("endgame-playoffs-combo-deep", () => {
...
describe("endgame-playoffs-combo-wide", () => {
...
describe("endgame-playoffs-combo-lovat", () => {
