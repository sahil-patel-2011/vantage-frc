...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 22.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 34.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 38.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 38.0 } },
];

describe("endgame-playoffs-consistency", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "endgameClimb")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-consistency");
    ...
    expect(bootstrapMean([22.0, 34.0, 38.0])).not.toBeNull();
...
describe("endgame-playoffs-consistency-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { endgameClimb: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { endgameClimb: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { endgameClimb: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { endgameClimb: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { endgameClimb: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { endgameClimb: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "endgameClimb")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("endgame-playoffs-consistency-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statEndgameClimb(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesEndgameClimb(rows, "frc9").length).toBe(0);
...
describe("endgame-playoffs-consistency-lovat", () => {
