...
describe("endgame-playoffs-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-context");
...
describe("endgame-playoffs-context-deep", () => {
...
describe("endgame-playoffs-context-wide", () => {
...
describe("endgame-playoffs-context-lovat", () => {
