...
describe("endgame-playoffs-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-draft");
...
describe("endgame-playoffs-draft-deep", () => {
...
describe("endgame-playoffs-draft-wide", () => {
...
describe("endgame-playoffs-draft-lovat", () => {
