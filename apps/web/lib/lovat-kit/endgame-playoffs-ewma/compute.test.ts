...
describe("endgame-playoffs-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-ewma");
...
describe("endgame-playoffs-ewma-deep", () => {
...
describe("endgame-playoffs-ewma-wide", () => {
...
describe("endgame-playoffs-ewma-lovat", () => {
