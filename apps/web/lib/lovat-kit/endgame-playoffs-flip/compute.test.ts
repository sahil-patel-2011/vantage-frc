...
describe("endgame-playoffs-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-flip");
...
describe("endgame-playoffs-flip-deep", () => {
...
describe("endgame-playoffs-flip-wide", () => {
...
describe("endgame-playoffs-flip-lovat", () => {
