...
describe("endgame-playoffs-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-hazard");
...
describe("endgame-playoffs-hazard-deep", () => {
...
describe("endgame-playoffs-hazard-wide", () => {
...
describe("endgame-playoffs-hazard-lovat", () => {
