...
describe("endgame-playoffs-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-interfere");
...
describe("endgame-playoffs-interfere-deep", () => {
...
describe("endgame-playoffs-interfere-wide", () => {
...
describe("endgame-playoffs-interfere-lovat", () => {
