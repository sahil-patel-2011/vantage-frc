...
describe("endgame-playoffs-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-lookup");
...
describe("endgame-playoffs-lookup-deep", () => {
...
describe("endgame-playoffs-lookup-wide", () => {
...
describe("endgame-playoffs-lookup-lovat", () => {
