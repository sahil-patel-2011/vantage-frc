...
describe("endgame-playoffs-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-notes");
...
describe("endgame-playoffs-notes-deep", () => {
...
describe("endgame-playoffs-notes-wide", () => {
...
describe("endgame-playoffs-notes-lovat", () => {
