...
describe("endgame-playoffs-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-pareto");
...
describe("endgame-playoffs-pareto-deep", () => {
...
describe("endgame-playoffs-pareto-wide", () => {
...
describe("endgame-playoffs-pareto-lovat", () => {
