...
describe("endgame-playoffs-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-path");
...
describe("endgame-playoffs-path-deep", () => {
...
describe("endgame-playoffs-path-wide", () => {
...
describe("endgame-playoffs-path-lovat", () => {
