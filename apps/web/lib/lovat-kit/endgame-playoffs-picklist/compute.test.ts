...
describe("endgame-playoffs-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-picklist");
...
describe("endgame-playoffs-picklist-deep", () => {
...
describe("endgame-playoffs-picklist-wide", () => {
...
describe("endgame-playoffs-picklist-lovat", () => {
