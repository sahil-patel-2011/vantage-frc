...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 14.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 21.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 46.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 14.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 21.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 46.0 } },
];

describe("endgame-playoffs-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-playhead");
...
describe("endgame-playoffs-playhead-deep", () => {
...
describe("endgame-playoffs-playhead-wide", () => {
...
describe("endgame-playoffs-playhead-lovat", () => {
