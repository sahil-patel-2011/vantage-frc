...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 20.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 27.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 40.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 20.0 } },
...
describe("endgame-playoffs-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-rank");
...
describe("endgame-playoffs-rank-deep", () => {
...
describe("endgame-playoffs-rank-wide", () => {
...
describe("endgame-playoffs-rank-lovat", () => {
