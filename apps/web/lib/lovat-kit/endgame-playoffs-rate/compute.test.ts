...
describe("endgame-playoffs-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-rate");
...
describe("endgame-playoffs-rate-deep", () => {
...
describe("endgame-playoffs-rate-wide", () => {
...
describe("endgame-playoffs-rate-lovat", () => {
