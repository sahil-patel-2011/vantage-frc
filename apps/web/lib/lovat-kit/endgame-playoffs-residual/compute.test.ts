...
describe("endgame-playoffs-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-residual");
...
describe("endgame-playoffs-residual-deep", () => {
...
describe("endgame-playoffs-residual-wide", () => {
...
describe("endgame-playoffs-residual-lovat", () => {
