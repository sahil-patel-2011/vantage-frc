...
describe("endgame-playoffs-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-shrink");
...
describe("endgame-playoffs-shrink-deep", () => {
...
describe("endgame-playoffs-shrink-wide", () => {
...
describe("endgame-playoffs-shrink-lovat", () => {
