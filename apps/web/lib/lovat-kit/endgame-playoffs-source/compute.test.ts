...
describe("endgame-playoffs-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-source");
...
describe("endgame-playoffs-source-deep", () => {
...
describe("endgame-playoffs-source-wide", () => {
...
describe("endgame-playoffs-source-lovat", () => {
