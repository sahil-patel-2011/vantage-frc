...
describe("endgame-playoffs-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-streak");
...
describe("endgame-playoffs-streak-deep", () => {
...
describe("endgame-playoffs-streak-wide", () => {
...
describe("endgame-playoffs-streak-lovat", () => {
