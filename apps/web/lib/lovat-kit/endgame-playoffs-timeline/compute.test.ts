...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { endgameClimb: 29.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 45.0 } },
];

describe("endgame-playoffs-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-timeline");
...
describe("endgame-playoffs-timeline-deep", () => {
...
describe("endgame-playoffs-timeline-wide", () => {
...
describe("endgame-playoffs-timeline-lovat", () => {
