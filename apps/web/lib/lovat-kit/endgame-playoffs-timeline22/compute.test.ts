...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 17.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 24.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 37.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 37.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 37.0 } },
];

describe("endgame-playoffs-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-timeline22");
...
describe("endgame-playoffs-timeline22-deep", () => {
...
describe("endgame-playoffs-timeline22-wide", () => {
...
describe("endgame-playoffs-timeline22-lovat", () => {
