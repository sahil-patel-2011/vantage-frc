...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 16.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 33.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 40.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 16.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 40.0 } },
];

describe("endgame-playoffs-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-trimmed");
...
describe("endgame-playoffs-trimmed-deep", () => {
...
describe("endgame-playoffs-trimmed-wide", () => {
...
describe("endgame-playoffs-trimmed-lovat", () => {
