...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 15.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 27.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 43.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 27.0 } },
...
describe("endgame-playoffs-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-trueskill");
    ...
    expect(bootstrapMean([15.0, 27.0, 43.0])).not.toBeNull();
...
describe("endgame-playoffs-trueskill-deep", () => {
...
describe("endgame-playoffs-trueskill-wide", () => {
...
describe("endgame-playoffs-trueskill-lovat", () => {
