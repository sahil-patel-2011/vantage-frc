...
describe("endgame-playoffs-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-win");
...
describe("endgame-playoffs-win-deep", () => {
...
describe("endgame-playoffs-win-wide", () => {
...
describe("endgame-playoffs-win-lovat", () => {
