...
describe("endgame-playoffs-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-zone");
...
describe("endgame-playoffs-zone-deep", () => {
...
describe("endgame-playoffs-zone-wide", () => {
...
describe("endgame-playoffs-zone-lovat", () => {
