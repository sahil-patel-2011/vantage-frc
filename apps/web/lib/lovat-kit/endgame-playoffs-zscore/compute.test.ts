...
describe("endgame-playoffs-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-playoffs-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-playoffs-zscore");
...
describe("endgame-playoffs-zscore-deep", () => {
...
describe("endgame-playoffs-zscore-wide", () => {
...
describe("endgame-playoffs-zscore-lovat", () => {
