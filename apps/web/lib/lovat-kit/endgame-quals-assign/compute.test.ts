...
describe("endgame-quals-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-assign");
...
describe("endgame-quals-assign-deep", () => {
...
describe("endgame-quals-assign-wide", () => {
...
describe("endgame-quals-assign-lovat", () => {
