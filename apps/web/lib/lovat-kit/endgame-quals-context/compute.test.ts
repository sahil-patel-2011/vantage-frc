...
describe("endgame-quals-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-context");
...
describe("endgame-quals-context-deep", () => {
...
describe("endgame-quals-context-wide", () => {
...
describe("endgame-quals-context-lovat", () => {
