...
describe("endgame-quals-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-flip");
...
describe("endgame-quals-flip-deep", () => {
...
describe("endgame-quals-flip-wide", () => {
...
describe("endgame-quals-flip-lovat", () => {
