...
describe("endgame-quals-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-lookup");
...
describe("endgame-quals-lookup-deep", () => {
...
describe("endgame-quals-lookup-wide", () => {
...
describe("endgame-quals-lookup-lovat", () => {
