...
describe("endgame-quals-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-notes");
...
describe("endgame-quals-notes-deep", () => {
...
describe("endgame-quals-notes-wide", () => {
...
describe("endgame-quals-notes-lovat", () => {
