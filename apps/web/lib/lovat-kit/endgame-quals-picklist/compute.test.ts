...
describe("endgame-quals-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-picklist");
...
describe("endgame-quals-picklist-deep", () => {
...
describe("endgame-quals-picklist-wide", () => {
...
describe("endgame-quals-picklist-lovat", () => {
