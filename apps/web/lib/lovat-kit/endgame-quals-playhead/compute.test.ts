...
describe("endgame-quals-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-playhead");
...
describe("endgame-quals-playhead-deep", () => {
...
describe("endgame-quals-playhead-wide", () => {
...
describe("endgame-quals-playhead-lovat", () => {
