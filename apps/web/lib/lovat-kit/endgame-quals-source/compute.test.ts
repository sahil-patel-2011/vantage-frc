...
describe("endgame-quals-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-source");
...
describe("endgame-quals-source-deep", () => {
...
describe("endgame-quals-source-wide", () => {
...
describe("endgame-quals-source-lovat", () => {
