...
describe("endgame-quals-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-timeline22");
...
describe("endgame-quals-timeline22-deep", () => {
...
describe("endgame-quals-timeline22-wide", () => {
...
describe("endgame-quals-timeline22-lovat", () => {
