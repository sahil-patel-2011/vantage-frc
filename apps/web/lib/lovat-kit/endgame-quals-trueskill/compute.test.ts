...
describe("endgame-quals-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-trueskill");
...
describe("endgame-quals-trueskill-deep", () => {
