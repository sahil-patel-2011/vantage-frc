...
describe("endgame-quals-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-win");
...
describe("endgame-quals-win-deep", () => {
...
describe("endgame-quals-win-wide", () => {
...
describe("endgame-quals-win-lovat", () => {
