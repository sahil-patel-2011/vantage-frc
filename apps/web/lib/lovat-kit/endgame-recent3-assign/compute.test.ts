...
describe("endgame-recent3-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-assign");
...
describe("endgame-recent3-assign-deep", () => {
...
describe("endgame-recent3-assign-wide", () => {
...
describe("endgame-recent3-assign-lovat", () => {
