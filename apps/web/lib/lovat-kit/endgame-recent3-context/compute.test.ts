...
describe("endgame-recent3-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-context");
...
describe("endgame-recent3-context-deep", () => {
...
describe("endgame-recent3-context-wide", () => {
...
describe("endgame-recent3-context-lovat", () => {
