...
describe("endgame-recent3-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-flip");
...
describe("endgame-recent3-flip-deep", () => {
...
describe("endgame-recent3-flip-wide", () => {
...
describe("endgame-recent3-flip-lovat", () => {
