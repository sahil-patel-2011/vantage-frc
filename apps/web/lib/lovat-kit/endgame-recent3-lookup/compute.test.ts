...
describe("endgame-recent3-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-lookup");
...
describe("endgame-recent3-lookup-deep", () => {
...
describe("endgame-recent3-lookup-wide", () => {
...
describe("endgame-recent3-lookup-lovat", () => {
