...
describe("endgame-recent3-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-notes");
...
describe("endgame-recent3-notes-deep", () => {
...
describe("endgame-recent3-notes-wide", () => {
...
describe("endgame-recent3-notes-lovat", () => {
