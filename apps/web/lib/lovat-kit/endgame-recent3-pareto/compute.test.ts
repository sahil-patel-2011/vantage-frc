...
describe("endgame-recent3-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-pareto");
...
describe("endgame-recent3-pareto-deep", () => {
