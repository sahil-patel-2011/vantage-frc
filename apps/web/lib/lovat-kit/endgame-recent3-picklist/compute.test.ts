...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 9.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 31.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 41.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 9.0 } },
...
describe("endgame-recent3-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-picklist");
...
describe("endgame-recent3-picklist-deep", () => {
...
describe("endgame-recent3-picklist-wide", () => {
...
describe("endgame-recent3-picklist-lovat", () => {
