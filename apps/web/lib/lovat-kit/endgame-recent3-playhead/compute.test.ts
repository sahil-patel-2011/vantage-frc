...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 24.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 31.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 44.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 24.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 31.0 } },
...
describe("endgame-recent3-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-playhead");
...
describe("endgame-recent3-playhead-deep", () => {
...
describe("endgame-recent3-playhead-wide", () => {
...
describe("endgame-recent3-playhead-lovat", () => {
