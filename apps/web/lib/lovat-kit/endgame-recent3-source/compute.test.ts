...
describe("endgame-recent3-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-source");
...
describe("endgame-recent3-source-deep", () => {
...
describe("endgame-recent3-source-wide", () => {
...
describe("endgame-recent3-source-lovat", () => {
