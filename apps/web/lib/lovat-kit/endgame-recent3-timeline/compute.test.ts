...
describe("endgame-recent3-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-timeline");
...
describe("endgame-recent3-timeline-deep", () => {
