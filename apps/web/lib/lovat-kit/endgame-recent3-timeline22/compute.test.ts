...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 19.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 21.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 43.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 19.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 21.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 43.0 } },
];

describe("endgame-recent3-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-timeline22");
    ...
    expect(bootstrapMean([19.0, 21.0, 43.0])).not.toBeNull();
...
describe("endgame-recent3-timeline22-deep", () => {
...
describe("endgame-recent3-timeline22-wide", () => {
...
describe("endgame-recent3-timeline22-lovat", () => {
