...
describe("endgame-recent3-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-recent3-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-recent3-win");
...
describe("endgame-recent3-win-deep", () => {
...
describe("endgame-recent3-win-wide", () => {
...
describe("endgame-recent3-win-lovat", () => {
