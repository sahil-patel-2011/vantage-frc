...
describe("fuel-event-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-assign");
...
describe("fuel-event-assign-deep", () => {
...
describe("fuel-event-assign-wide", () => {
...
describe("fuel-event-assign-lovat", () => {
