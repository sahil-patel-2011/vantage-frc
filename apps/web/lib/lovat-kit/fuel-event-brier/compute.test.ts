...
describe("fuel-event-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-brier");
...
describe("fuel-event-brier-deep", () => {
...
describe("fuel-event-brier-wide", () => {
...
describe("fuel-event-brier-lovat", () => {
