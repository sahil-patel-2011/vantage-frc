...
describe("fuel-event-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-colley");
...
describe("fuel-event-colley-deep", () => {
...
describe("fuel-event-colley-wide", () => {
...
describe("fuel-event-colley-lovat", () => {
