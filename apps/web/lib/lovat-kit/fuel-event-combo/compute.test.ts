...
describe("fuel-event-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-combo");
...
describe("fuel-event-combo-deep", () => {
...
describe("fuel-event-combo-wide", () => {
...
describe("fuel-event-combo-lovat", () => {
