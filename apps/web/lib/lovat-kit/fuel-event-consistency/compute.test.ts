...
describe("fuel-event-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-consistency");
...
describe("fuel-event-consistency-deep", () => {
...
describe("fuel-event-consistency-wide", () => {
...
describe("fuel-event-consistency-lovat", () => {
