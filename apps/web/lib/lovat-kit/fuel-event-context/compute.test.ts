...
describe("fuel-event-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-context");
...
describe("fuel-event-context-deep", () => {
...
describe("fuel-event-context-wide", () => {
...
describe("fuel-event-context-lovat", () => {
