...
describe("fuel-event-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-draft");
...
describe("fuel-event-draft-deep", () => {
...
describe("fuel-event-draft-wide", () => {
...
describe("fuel-event-draft-lovat", () => {
