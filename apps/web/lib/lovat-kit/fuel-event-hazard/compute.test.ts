...
describe("fuel-event-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-hazard");
...
describe("fuel-event-hazard-deep", () => {
...
describe("fuel-event-hazard-wide", () => {
...
describe("fuel-event-hazard-lovat", () => {
