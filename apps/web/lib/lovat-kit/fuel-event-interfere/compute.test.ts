...
describe("fuel-event-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-interfere");
...
describe("fuel-event-interfere-deep", () => {
...
describe("fuel-event-interfere-wide", () => {
...
describe("fuel-event-interfere-lovat", () => {
