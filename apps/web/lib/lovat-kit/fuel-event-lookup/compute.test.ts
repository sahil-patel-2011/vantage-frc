...
describe("fuel-event-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-lookup");
...
describe("fuel-event-lookup-deep", () => {
...
describe("fuel-event-lookup-wide", () => {
...
describe("fuel-event-lookup-lovat", () => {
