...
describe("fuel-event-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-notes");
...
describe("fuel-event-notes-deep", () => {
...
describe("fuel-event-notes-wide", () => {
...
describe("fuel-event-notes-lovat", () => {
