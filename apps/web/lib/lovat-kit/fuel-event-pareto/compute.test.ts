...
describe("fuel-event-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-pareto");
...
describe("fuel-event-pareto-deep", () => {
...
describe("fuel-event-pareto-wide", () => {
...
describe("fuel-event-pareto-lovat", () => {
