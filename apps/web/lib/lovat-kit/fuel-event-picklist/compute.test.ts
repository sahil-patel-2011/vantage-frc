...
describe("fuel-event-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-picklist");
...
describe("fuel-event-picklist-deep", () => {
...
describe("fuel-event-picklist-wide", () => {
...
describe("fuel-event-picklist-lovat", () => {
