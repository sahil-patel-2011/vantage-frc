...
describe("fuel-event-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-playhead");
...
describe("fuel-event-playhead-deep", () => {
...
describe("fuel-event-playhead-wide", () => {
...
describe("fuel-event-playhead-lovat", () => {
