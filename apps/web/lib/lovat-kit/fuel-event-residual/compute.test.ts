...
describe("fuel-event-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-residual");
...
describe("fuel-event-residual-deep", () => {
...
describe("fuel-event-residual-wide", () => {
...
describe("fuel-event-residual-lovat", () => {
