...
describe("fuel-event-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-shrink");
...
describe("fuel-event-shrink-deep", () => {
...
describe("fuel-event-shrink-wide", () => {
...
describe("fuel-event-shrink-lovat", () => {
