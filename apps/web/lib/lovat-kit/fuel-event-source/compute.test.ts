...
describe("fuel-event-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-source");
...
describe("fuel-event-source-deep", () => {
...
describe("fuel-event-source-wide", () => {
...
describe("fuel-event-source-lovat", () => {
