...
describe("fuel-event-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-streak");
...
describe("fuel-event-streak-deep", () => {
...
describe("fuel-event-streak-wide", () => {
...
describe("fuel-event-streak-lovat", () => {
