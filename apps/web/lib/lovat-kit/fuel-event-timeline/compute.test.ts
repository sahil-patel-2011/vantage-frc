...
describe("fuel-event-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-timeline");
...
describe("fuel-event-timeline-deep", () => {
...
describe("fuel-event-timeline-wide", () => {
...
describe("fuel-event-timeline-lovat", () => {
