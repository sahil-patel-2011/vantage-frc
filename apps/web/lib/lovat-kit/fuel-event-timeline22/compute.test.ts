...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 8.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 25.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 44.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 8.0 } },
...
describe("fuel-event-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-timeline22");
...
describe("fuel-event-timeline22-deep", () => {
...
describe("fuel-event-timeline22-wide", () => {
...
describe("fuel-event-timeline22-lovat", () => {
