...
describe("fuel-event-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-trimmed");
...
describe("fuel-event-trimmed-deep", () => {
...
describe("fuel-event-trimmed-wide", () => {
...
describe("fuel-event-trimmed-lovat", () => {
