...
describe("fuel-event-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-trueskill");
...
describe("fuel-event-trueskill-deep", () => {
...
describe("fuel-event-trueskill-wide", () => {
...
describe("fuel-event-trueskill-lovat", () => {
