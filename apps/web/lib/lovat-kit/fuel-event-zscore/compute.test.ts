...
describe("fuel-event-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-zscore");
...
describe("fuel-event-zscore-deep", () => {
...
describe("fuel-event-zscore-wide", () => {
...
describe("fuel-event-zscore-lovat", () => {
