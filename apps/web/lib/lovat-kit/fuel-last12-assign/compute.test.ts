...
describe("fuel-last12-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-assign");
...
describe("fuel-last12-assign-deep", () => {
...
describe("fuel-last12-assign-wide", () => {
...
describe("fuel-last12-assign-lovat", () => {
