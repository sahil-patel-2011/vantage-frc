...
describe("fuel-last12-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-brier");
...
describe("fuel-last12-brier-deep", () => {
...
describe("fuel-last12-brier-wide", () => {
...
describe("fuel-last12-brier-lovat", () => {
