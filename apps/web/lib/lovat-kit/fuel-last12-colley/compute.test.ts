...
describe("fuel-last12-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-colley");
...
describe("fuel-last12-colley-deep", () => {
...
describe("fuel-last12-colley-wide", () => {
...
describe("fuel-last12-colley-lovat", () => {
