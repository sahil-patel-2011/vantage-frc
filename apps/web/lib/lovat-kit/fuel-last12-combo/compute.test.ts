...
describe("fuel-last12-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-combo");
...
describe("fuel-last12-combo-deep", () => {
...
describe("fuel-last12-combo-wide", () => {
...
describe("fuel-last12-combo-lovat", () => {
