...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 14.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 31.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 38.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 14.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 31.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 38.0 } },
];

describe("fuel-last12-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-consistency");
...
describe("fuel-last12-consistency-deep", () => {
...
describe("fuel-last12-consistency-wide", () => {
...
describe("fuel-last12-consistency-lovat", () => {
