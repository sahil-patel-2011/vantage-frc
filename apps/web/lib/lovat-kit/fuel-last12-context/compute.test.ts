...
describe("fuel-last12-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-context");
...
describe("fuel-last12-context-deep", () => {
...
describe("fuel-last12-context-wide", () => {
...
describe("fuel-last12-context-lovat", () => {
