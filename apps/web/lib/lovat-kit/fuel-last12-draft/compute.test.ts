...
describe("fuel-last12-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-draft");
...
describe("fuel-last12-draft-deep", () => {
...
describe("fuel-last12-draft-wide", () => {
...
describe("fuel-last12-draft-lovat", () => {
