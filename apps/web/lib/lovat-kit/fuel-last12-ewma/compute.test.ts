...
describe("fuel-last12-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-ewma");
...
describe("fuel-last12-ewma-deep", () => {
...
describe("fuel-last12-ewma-wide", () => {
...
describe("fuel-last12-ewma-lovat", () => {
