...
describe("fuel-last12-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-flip");
...
describe("fuel-last12-flip-deep", () => {
...
describe("fuel-last12-flip-wide", () => {
...
describe("fuel-last12-flip-lovat", () => {
