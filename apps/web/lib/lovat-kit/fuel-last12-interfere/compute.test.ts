...
describe("fuel-last12-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-interfere");
...
describe("fuel-last12-interfere-deep", () => {
...
describe("fuel-last12-interfere-wide", () => {
...
describe("fuel-last12-interfere-lovat", () => {
