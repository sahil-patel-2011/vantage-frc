...
describe("fuel-last12-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-lookup");
...
describe("fuel-last12-lookup-deep", () => {
...
describe("fuel-last12-lookup-wide", () => {
...
describe("fuel-last12-lookup-lovat", () => {
