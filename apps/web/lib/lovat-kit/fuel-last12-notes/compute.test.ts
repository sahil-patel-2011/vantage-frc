...
describe("fuel-last12-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-notes");
...
describe("fuel-last12-notes-deep", () => {
...
describe("fuel-last12-notes-wide", () => {
...
describe("fuel-last12-notes-lovat", () => {
