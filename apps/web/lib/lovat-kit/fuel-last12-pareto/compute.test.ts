...
describe("fuel-last12-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-pareto");
...
describe("fuel-last12-pareto-deep", () => {
...
describe("fuel-last12-pareto-wide", () => {
...
describe("fuel-last12-pareto-lovat", () => {
