...
describe("fuel-last12-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-path");
...
describe("fuel-last12-path-deep", () => {
...
describe("fuel-last12-path-wide", () => {
...
describe("fuel-last12-path-lovat", () => {
