...
describe("fuel-last12-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-picklist");
...
describe("fuel-last12-picklist-deep", () => {
...
describe("fuel-last12-picklist-wide", () => {
...
describe("fuel-last12-picklist-lovat", () => {
