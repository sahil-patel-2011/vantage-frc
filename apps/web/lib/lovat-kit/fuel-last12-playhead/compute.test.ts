...
describe("fuel-last12-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-playhead");
...
describe("fuel-last12-playhead-deep", () => {
...
describe("fuel-last12-playhead-wide", () => {
...
describe("fuel-last12-playhead-lovat", () => {
