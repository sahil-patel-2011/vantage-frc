...
describe("fuel-last12-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-rank");
...
describe("fuel-last12-rank-deep", () => {
...
describe("fuel-last12-rank-wide", () => {
...
describe("fuel-last12-rank-lovat", () => {
