...
describe("fuel-last12-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-residual");
...
describe("fuel-last12-residual-deep", () => {
...
describe("fuel-last12-residual-wide", () => {
...
describe("fuel-last12-residual-lovat", () => {
