...
describe("fuel-last12-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-shrink");
...
describe("fuel-last12-shrink-deep", () => {
...
describe("fuel-last12-shrink-wide", () => {
...
describe("fuel-last12-shrink-lovat", () => {
