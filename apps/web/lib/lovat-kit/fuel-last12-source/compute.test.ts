...
describe("fuel-last12-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-source");
...
describe("fuel-last12-source-deep", () => {
...
describe("fuel-last12-source-wide", () => {
...
describe("fuel-last12-source-lovat", () => {
