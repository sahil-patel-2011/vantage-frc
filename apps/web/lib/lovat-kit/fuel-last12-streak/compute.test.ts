...
describe("fuel-last12-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-streak");
...
describe("fuel-last12-streak-deep", () => {
...
describe("fuel-last12-streak-wide", () => {
...
describe("fuel-last12-streak-lovat", () => {
