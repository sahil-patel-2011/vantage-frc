...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 21.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 28.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 41.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 41.0 } },
];

describe("fuel-last12-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-timeline");
...
describe("fuel-last12-timeline-deep", () => {
...
describe("fuel-last12-timeline-wide", () => {
...
describe("fuel-last12-timeline-lovat", () => {
