...
describe("fuel-last12-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-timeline22");
...
describe("fuel-last12-timeline22-deep", () => {
...
describe("fuel-last12-timeline22-wide", () => {
...
describe("fuel-last12-timeline22-lovat", () => {
