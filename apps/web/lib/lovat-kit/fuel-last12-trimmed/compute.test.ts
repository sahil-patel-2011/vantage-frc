...
describe("fuel-last12-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-trimmed");
...
describe("fuel-last12-trimmed-deep", () => {
...
describe("fuel-last12-trimmed-wide", () => {
...
describe("fuel-last12-trimmed-lovat", () => {
