...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 19.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 21.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 43.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 19.0 } },
...
describe("fuel-last12-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-trueskill");
...
describe("fuel-last12-trueskill-deep", () => {
...
describe("fuel-last12-trueskill-wide", () => {
...
describe("fuel-last12-trueskill-lovat", () => {
