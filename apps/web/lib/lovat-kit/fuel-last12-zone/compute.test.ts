...
describe("fuel-last12-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-zone");
...
describe("fuel-last12-zone-deep", () => {
...
describe("fuel-last12-zone-wide", () => {
...
describe("fuel-last12-zone-lovat", () => {
