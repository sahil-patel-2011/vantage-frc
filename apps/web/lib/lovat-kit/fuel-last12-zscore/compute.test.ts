...
describe("fuel-last12-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-zscore");
...
describe("fuel-last12-zscore-deep", () => {
...
describe("fuel-last12-zscore-wide", () => {
...
describe("fuel-last12-zscore-lovat", () => {
