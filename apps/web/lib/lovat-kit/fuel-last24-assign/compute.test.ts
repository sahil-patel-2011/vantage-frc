...
describe("fuel-last24-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-assign");
...
describe("fuel-last24-assign-deep", () => {
...
describe("fuel-last24-assign-wide", () => {
...
describe("fuel-last24-assign-lovat", () => {
