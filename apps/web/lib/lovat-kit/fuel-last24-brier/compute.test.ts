...
describe("fuel-last24-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-brier");
...
describe("fuel-last24-brier-deep", () => {
...
describe("fuel-last24-brier-wide", () => {
...
describe("fuel-last24-brier-lovat", () => {
