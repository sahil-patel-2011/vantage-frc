...
describe("fuel-last24-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-colley");
...
describe("fuel-last24-colley-deep", () => {
...
describe("fuel-last24-colley-wide", () => {
...
describe("fuel-last24-colley-lovat", () => {
