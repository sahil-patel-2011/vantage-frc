...
describe("fuel-last24-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-combo");
...
describe("fuel-last24-combo-deep", () => {
...
describe("fuel-last24-combo-wide", () => {
...
describe("fuel-last24-combo-lovat", () => {
