...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 23.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 30.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 43.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 23.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 30.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 43.0 } },
];

describe("fuel-last24-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-consistency");
...
describe("fuel-last24-consistency-deep", () => {
...
describe("fuel-last24-consistency-wide", () => {
...
describe("fuel-last24-consistency-lovat", () => {
