...
describe("fuel-last24-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-context");
...
describe("fuel-last24-context-deep", () => {
...
describe("fuel-last24-context-wide", () => {
...
describe("fuel-last24-context-lovat", () => {
