...
describe("fuel-last24-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-draft");
...
describe("fuel-last24-draft-deep", () => {
...
describe("fuel-last24-draft-wide", () => {
...
describe("fuel-last24-draft-lovat", () => {
