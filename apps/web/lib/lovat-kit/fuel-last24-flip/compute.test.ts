...
describe("fuel-last24-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-flip");
...
describe("fuel-last24-flip-deep", () => {
...
describe("fuel-last24-flip-wide", () => {
...
describe("fuel-last24-flip-lovat", () => {
