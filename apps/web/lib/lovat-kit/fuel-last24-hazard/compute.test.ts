...
describe("fuel-last24-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-hazard");
...
describe("fuel-last24-hazard-deep", () => {
...
describe("fuel-last24-hazard-wide", () => {
...
describe("fuel-last24-hazard-lovat", () => {
