...
describe("fuel-last24-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-interfere");
...
describe("fuel-last24-interfere-deep", () => {
...
describe("fuel-last24-interfere-wide", () => {
...
describe("fuel-last24-interfere-lovat", () => {
