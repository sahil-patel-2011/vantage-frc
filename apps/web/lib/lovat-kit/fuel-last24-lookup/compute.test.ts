...
describe("fuel-last24-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-lookup");
...
describe("fuel-last24-lookup-deep", () => {
...
describe("fuel-last24-lookup-wide", () => {
...
describe("fuel-last24-lookup-lovat", () => {
