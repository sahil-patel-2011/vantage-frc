...
describe("fuel-last24-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-notes");
...
describe("fuel-last24-notes-deep", () => {
...
describe("fuel-last24-notes-wide", () => {
...
describe("fuel-last24-notes-lovat", () => {
