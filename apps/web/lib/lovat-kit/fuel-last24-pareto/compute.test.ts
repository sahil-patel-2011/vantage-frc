...
describe("fuel-last24-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-pareto");
...
describe("fuel-last24-pareto-deep", () => {
...
describe("fuel-last24-pareto-wide", () => {
...
describe("fuel-last24-pareto-lovat", () => {
