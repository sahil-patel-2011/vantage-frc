...
describe("fuel-last24-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-path");
...
describe("fuel-last24-path-deep", () => {
...
describe("fuel-last24-path-wide", () => {
...
describe("fuel-last24-path-lovat", () => {
