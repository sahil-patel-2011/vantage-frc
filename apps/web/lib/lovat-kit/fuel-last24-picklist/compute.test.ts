...
describe("fuel-last24-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-picklist");
...
describe("fuel-last24-picklist-deep", () => {
...
describe("fuel-last24-picklist-wide", () => {
...
describe("fuel-last24-picklist-lovat", () => {
