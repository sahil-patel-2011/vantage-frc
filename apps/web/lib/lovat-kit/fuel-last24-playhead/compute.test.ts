...
describe("fuel-last24-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-playhead");
...
describe("fuel-last24-playhead-deep", () => {
...
describe("fuel-last24-playhead-wide", () => {
...
describe("fuel-last24-playhead-lovat", () => {
