...
describe("fuel-last24-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-rank");
...
describe("fuel-last24-rank-deep", () => {
...
describe("fuel-last24-rank-wide", () => {
...
describe("fuel-last24-rank-lovat", () => {
