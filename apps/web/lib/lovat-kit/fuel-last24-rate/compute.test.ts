...
describe("fuel-last24-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-rate");
...
describe("fuel-last24-rate-deep", () => {
...
describe("fuel-last24-rate-wide", () => {
...
describe("fuel-last24-rate-lovat", () => {
