...
describe("fuel-last24-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-residual");
...
describe("fuel-last24-residual-deep", () => {
...
describe("fuel-last24-residual-wide", () => {
...
describe("fuel-last24-residual-lovat", () => {
