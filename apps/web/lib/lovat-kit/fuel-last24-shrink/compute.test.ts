...
describe("fuel-last24-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-shrink");
...
describe("fuel-last24-shrink-deep", () => {
...
describe("fuel-last24-shrink-wide", () => {
...
describe("fuel-last24-shrink-lovat", () => {
