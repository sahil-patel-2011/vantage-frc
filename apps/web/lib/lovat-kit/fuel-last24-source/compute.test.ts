...
describe("fuel-last24-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-source");
...
describe("fuel-last24-source-deep", () => {
...
describe("fuel-last24-source-wide", () => {
...
describe("fuel-last24-source-lovat", () => {
