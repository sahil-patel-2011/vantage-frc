...
describe("fuel-last24-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-streak");
...
describe("fuel-last24-streak-deep", () => {
...
describe("fuel-last24-streak-wide", () => {
...
describe("fuel-last24-streak-lovat", () => {
