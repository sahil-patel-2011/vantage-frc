...
describe("fuel-last24-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-timeline");
...
describe("fuel-last24-timeline-deep", () => {
...
describe("fuel-last24-timeline-wide", () => {
...
describe("fuel-last24-timeline-lovat", () => {
