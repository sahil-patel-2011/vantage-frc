...
describe("fuel-last24-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-trimmed");
...
describe("fuel-last24-trimmed-deep", () => {
...
describe("fuel-last24-trimmed-wide", () => {
...
describe("fuel-last24-trimmed-lovat", () => {
