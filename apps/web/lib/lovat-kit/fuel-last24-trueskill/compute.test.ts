...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 18.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 25.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 38.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 18.0 } },
...
describe("fuel-last24-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-trueskill");
...
describe("fuel-last24-trueskill-deep", () => {
...
describe("fuel-last24-trueskill-wide", () => {
...
describe("fuel-last24-trueskill-lovat", () => {
