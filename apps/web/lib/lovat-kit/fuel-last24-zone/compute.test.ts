...
describe("fuel-last24-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-zone");
...
describe("fuel-last24-zone-deep", () => {
...
describe("fuel-last24-zone-wide", () => {
...
describe("fuel-last24-zone-lovat", () => {
