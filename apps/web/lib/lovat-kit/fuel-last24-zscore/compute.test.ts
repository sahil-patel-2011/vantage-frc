...
describe("fuel-last24-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last24-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last24-zscore");
...
describe("fuel-last24-zscore-deep", () => {
...
describe("fuel-last24-zscore-wide", () => {
...
describe("fuel-last24-zscore-lovat", () => {
