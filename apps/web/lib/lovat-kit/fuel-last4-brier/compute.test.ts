...
describe("fuel-last4-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-brier");
...
describe("fuel-last4-brier-deep", () => {
...
describe("fuel-last4-brier-wide", () => {
...
describe("fuel-last4-brier-lovat", () => {
