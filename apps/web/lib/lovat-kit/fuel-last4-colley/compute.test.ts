...
describe("fuel-last4-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-colley");
...
describe("fuel-last4-colley-deep", () => {
...
describe("fuel-last4-colley-wide", () => {
...
describe("fuel-last4-colley-lovat", () => {
