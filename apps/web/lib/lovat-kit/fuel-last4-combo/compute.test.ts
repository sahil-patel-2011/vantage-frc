...
describe("fuel-last4-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-combo");
...
describe("fuel-last4-combo-deep", () => {
...
describe("fuel-last4-combo-wide", () => {
...
describe("fuel-last4-combo-lovat", () => {
