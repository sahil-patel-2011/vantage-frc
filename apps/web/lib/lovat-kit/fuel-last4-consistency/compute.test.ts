...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 9.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 31.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 41.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 9.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 31.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 41.0 } },
];

describe("fuel-last4-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-consistency");
...
describe("fuel-last4-consistency-deep", () => {
...
describe("fuel-last4-consistency-wide", () => {
...
describe("fuel-last4-consistency-lovat", () => {
