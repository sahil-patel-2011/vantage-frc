...
describe("fuel-last4-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-context");
...
describe("fuel-last4-context-deep", () => {
...
describe("fuel-last4-context-wide", () => {
...
describe("fuel-last4-context-lovat", () => {
