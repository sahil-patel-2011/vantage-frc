...
describe("fuel-last4-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-draft");
...
describe("fuel-last4-draft-deep", () => {
...
describe("fuel-last4-draft-wide", () => {
...
describe("fuel-last4-draft-lovat", () => {
