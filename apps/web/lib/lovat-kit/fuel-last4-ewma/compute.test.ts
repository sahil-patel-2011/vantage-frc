...
describe("fuel-last4-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-ewma");
...
describe("fuel-last4-ewma-lovat", () => {
