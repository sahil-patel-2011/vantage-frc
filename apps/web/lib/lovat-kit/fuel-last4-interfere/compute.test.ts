...
describe("fuel-last4-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-interfere");
...
describe("fuel-last4-interfere-deep", () => {
...
describe("fuel-last4-interfere-wide", () => {
...
describe("fuel-last4-interfere-lovat", () => {
