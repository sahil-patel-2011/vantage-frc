...
describe("fuel-last4-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-lookup");
...
describe("fuel-last4-lookup-deep", () => {
...
describe("fuel-last4-lookup-wide", () => {
...
describe("fuel-last4-lookup-lovat", () => {
