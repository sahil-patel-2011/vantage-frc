...
describe("fuel-last4-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-notes");
...
describe("fuel-last4-notes-deep", () => {
...
describe("fuel-last4-notes-wide", () => {
...
describe("fuel-last4-notes-lovat", () => {
