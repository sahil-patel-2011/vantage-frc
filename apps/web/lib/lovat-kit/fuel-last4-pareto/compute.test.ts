...
describe("fuel-last4-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-pareto");
...
describe("fuel-last4-pareto-deep", () => {
...
describe("fuel-last4-pareto-wide", () => {
...
describe("fuel-last4-pareto-lovat", () => {
