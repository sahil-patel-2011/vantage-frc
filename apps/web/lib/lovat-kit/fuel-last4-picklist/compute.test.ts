...
describe("fuel-last4-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-picklist");
...
describe("fuel-last4-picklist-deep", () => {
...
describe("fuel-last4-picklist-wide", () => {
...
describe("fuel-last4-picklist-lovat", () => {
