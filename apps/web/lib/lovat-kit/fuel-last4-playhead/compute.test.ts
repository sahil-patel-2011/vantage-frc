...
describe("fuel-last4-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-playhead");
...
describe("fuel-last4-playhead-deep", () => {
...
describe("fuel-last4-playhead-wide", () => {
...
describe("fuel-last4-playhead-lovat", () => {
