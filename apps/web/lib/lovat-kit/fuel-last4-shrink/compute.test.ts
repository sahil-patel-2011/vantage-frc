...
describe("fuel-last4-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-shrink");
...
describe("fuel-last4-shrink-deep", () => {
...
describe("fuel-last4-shrink-wide", () => {
...
describe("fuel-last4-shrink-lovat", () => {
