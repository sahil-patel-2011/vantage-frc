...
describe("fuel-last4-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-source");
...
describe("fuel-last4-source-deep", () => {
...
describe("fuel-last4-source-wide", () => {
...
describe("fuel-last4-source-lovat", () => {
