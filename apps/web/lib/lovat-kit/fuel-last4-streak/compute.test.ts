...
describe("fuel-last4-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-streak");
...
describe("fuel-last4-streak-deep", () => {
...
describe("fuel-last4-streak-wide", () => {
...
describe("fuel-last4-streak-lovat", () => {
