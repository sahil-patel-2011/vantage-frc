...
describe("fuel-last4-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-timeline");
...
describe("fuel-last4-timeline-deep", () => {
...
describe("fuel-last4-timeline-wide", () => {
...
describe("fuel-last4-timeline-lovat", () => {
