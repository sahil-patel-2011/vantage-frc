...
describe("fuel-last4-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-trimmed");
...
describe("fuel-last4-trimmed-deep", () => {
...
describe("fuel-last4-trimmed-wide", () => {
...
describe("fuel-last4-trimmed-lovat", () => {
