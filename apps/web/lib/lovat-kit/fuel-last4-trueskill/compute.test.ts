...
describe("fuel-last4-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-trueskill");
...
describe("fuel-last4-trueskill-deep", () => {
...
describe("fuel-last4-trueskill-wide", () => {
...
describe("fuel-last4-trueskill-lovat", () => {
