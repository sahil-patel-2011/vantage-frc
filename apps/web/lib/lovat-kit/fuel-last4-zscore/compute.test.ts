...
describe("fuel-last4-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last4-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last4-zscore");
...
describe("fuel-last4-zscore-deep", () => {
...
describe("fuel-last4-zscore-wide", () => {
...
describe("fuel-last4-zscore-lovat", () => {
