...
describe("fuel-last6-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-assign");
...
describe("fuel-last6-assign-deep", () => {
...
describe("fuel-last6-assign-wide", () => {
...
describe("fuel-last6-assign-lovat", () => {
