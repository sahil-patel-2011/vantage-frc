...
describe("fuel-last6-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-brier");
...
describe("fuel-last6-brier-deep", () => {
...
describe("fuel-last6-brier-wide", () => {
...
describe("fuel-last6-brier-lovat", () => {
