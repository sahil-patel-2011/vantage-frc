...
describe("fuel-last6-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-colley");
...
describe("fuel-last6-colley-deep", () => {
...
describe("fuel-last6-colley-wide", () => {
...
describe("fuel-last6-colley-lovat", () => {
