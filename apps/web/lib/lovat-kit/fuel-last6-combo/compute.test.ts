...
describe("fuel-last6-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-combo");
...
describe("fuel-last6-combo-deep", () => {
...
describe("fuel-last6-combo-wide", () => {
...
describe("fuel-last6-combo-lovat", () => {
