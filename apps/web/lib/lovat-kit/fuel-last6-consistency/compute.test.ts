...
describe("fuel-last6-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-consistency");
...
describe("fuel-last6-consistency-deep", () => {
...
describe("fuel-last6-consistency-wide", () => {
...
describe("fuel-last6-consistency-lovat", () => {
