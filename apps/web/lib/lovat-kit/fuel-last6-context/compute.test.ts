...
describe("fuel-last6-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-context");
...
describe("fuel-last6-context-deep", () => {
...
describe("fuel-last6-context-wide", () => {
...
describe("fuel-last6-context-lovat", () => {
