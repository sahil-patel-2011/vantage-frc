...
describe("fuel-last6-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-draft");
...
describe("fuel-last6-draft-deep", () => {
...
describe("fuel-last6-draft-wide", () => {
...
describe("fuel-last6-draft-lovat", () => {
