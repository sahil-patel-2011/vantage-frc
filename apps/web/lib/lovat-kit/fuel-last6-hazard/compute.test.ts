...
describe("fuel-last6-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-hazard");
...
describe("fuel-last6-hazard-deep", () => {
...
describe("fuel-last6-hazard-wide", () => {
...
describe("fuel-last6-hazard-lovat", () => {
