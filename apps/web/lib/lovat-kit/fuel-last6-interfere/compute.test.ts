...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 13.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 20.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 45.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 13.0 } },
...
describe("fuel-last6-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-interfere");
...
describe("fuel-last6-interfere-deep", () => {
...
describe("fuel-last6-interfere-wide", () => {
...
describe("fuel-last6-interfere-lovat", () => {
