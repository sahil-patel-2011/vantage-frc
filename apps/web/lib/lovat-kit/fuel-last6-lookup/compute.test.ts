...
describe("fuel-last6-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-lookup");
...
describe("fuel-last6-lookup-deep", () => {
...
describe("fuel-last6-lookup-wide", () => {
...
describe("fuel-last6-lookup-lovat", () => {
