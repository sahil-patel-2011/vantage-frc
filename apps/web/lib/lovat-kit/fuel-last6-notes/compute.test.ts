...
describe("fuel-last6-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-notes");
...
describe("fuel-last6-notes-deep", () => {
...
describe("fuel-last6-notes-wide", () => {
...
describe("fuel-last6-notes-lovat", () => {
