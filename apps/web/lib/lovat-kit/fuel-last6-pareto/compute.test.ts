...
describe("fuel-last6-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-pareto");
...
describe("fuel-last6-pareto-deep", () => {
...
describe("fuel-last6-pareto-wide", () => {
...
describe("fuel-last6-pareto-lovat", () => {
