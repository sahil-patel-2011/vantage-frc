...
describe("fuel-last6-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-picklist");
...
describe("fuel-last6-picklist-deep", () => {
...
describe("fuel-last6-picklist-wide", () => {
...
describe("fuel-last6-picklist-lovat", () => {
