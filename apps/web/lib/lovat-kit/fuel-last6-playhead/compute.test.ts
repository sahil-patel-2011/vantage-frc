...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 17.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 29.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 45.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 45.0 } },
];

describe("fuel-last6-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-playhead");
...
describe("fuel-last6-playhead-deep", () => {
...
describe("fuel-last6-playhead-wide", () => {
...
describe("fuel-last6-playhead-lovat", () => {
