...
describe("fuel-last6-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-residual");
...
describe("fuel-last6-residual-deep", () => {
...
describe("fuel-last6-residual-wide", () => {
...
describe("fuel-last6-residual-lovat", () => {
