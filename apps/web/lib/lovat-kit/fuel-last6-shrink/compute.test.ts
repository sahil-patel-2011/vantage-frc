...
describe("fuel-last6-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-shrink");
...
describe("fuel-last6-shrink-deep", () => {
...
describe("fuel-last6-shrink-wide", () => {
...
describe("fuel-last6-shrink-lovat", () => {
