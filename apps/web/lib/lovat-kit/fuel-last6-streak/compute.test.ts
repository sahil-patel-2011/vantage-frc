...
describe("fuel-last6-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-streak");
...
describe("fuel-last6-streak-deep", () => {
...
describe("fuel-last6-streak-wide", () => {
...
describe("fuel-last6-streak-lovat", () => {
