...
describe("fuel-last6-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-timeline");
...
describe("fuel-last6-timeline-deep", () => {
...
describe("fuel-last6-timeline-wide", () => {
...
describe("fuel-last6-timeline-lovat", () => {
