...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 10.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 27.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 46.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 10.0 } },
...
describe("fuel-last6-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-timeline22");
...
describe("fuel-last6-timeline22-deep", () => {
...
describe("fuel-last6-timeline22-wide", () => {
...
describe("fuel-last6-timeline22-lovat", () => {
