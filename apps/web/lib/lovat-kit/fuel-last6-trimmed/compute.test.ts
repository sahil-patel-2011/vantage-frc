...
describe("fuel-last6-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-trimmed");
...
describe("fuel-last6-trimmed-deep", () => {
...
describe("fuel-last6-trimmed-wide", () => {
...
describe("fuel-last6-trimmed-lovat", () => {
