...
describe("fuel-last6-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-trueskill");
...
describe("fuel-last6-trueskill-deep", () => {
...
describe("fuel-last6-trueskill-wide", () => {
...
describe("fuel-last6-trueskill-lovat", () => {
