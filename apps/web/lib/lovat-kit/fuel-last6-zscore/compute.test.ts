...
describe("fuel-last6-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-zscore");
...
describe("fuel-last6-zscore-deep", () => {
...
describe("fuel-last6-zscore-wide", () => {
...
describe("fuel-last6-zscore-lovat", () => {
