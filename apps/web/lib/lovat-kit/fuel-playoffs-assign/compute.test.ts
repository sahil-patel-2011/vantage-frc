...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { throughput: 42.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 23.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 42.0 } },
];

describe("fuel-playoffs-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-assign");
...
describe("fuel-playoffs-assign-deep", () => {
...
describe("fuel-playoffs-assign-wide", () => {
...
describe("fuel-playoffs-assign-lovat", () => {
