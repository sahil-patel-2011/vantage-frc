...
describe("fuel-playoffs-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-brier");
...
describe("fuel-playoffs-brier-deep", () => {
...
describe("fuel-playoffs-brier-wide", () => {
...
describe("fuel-playoffs-brier-lovat", () => {
