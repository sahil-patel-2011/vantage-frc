...
describe("fuel-playoffs-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-colley");
...
describe("fuel-playoffs-colley-deep", () => {
...
describe("fuel-playoffs-colley-wide", () => {
...
describe("fuel-playoffs-colley-lovat", () => {
