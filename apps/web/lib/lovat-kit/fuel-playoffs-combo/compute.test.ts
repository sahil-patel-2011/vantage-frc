...
describe("fuel-playoffs-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-combo");
...
describe("fuel-playoffs-combo-deep", () => {
...
describe("fuel-playoffs-combo-wide", () => {
...
describe("fuel-playoffs-combo-lovat", () => {
