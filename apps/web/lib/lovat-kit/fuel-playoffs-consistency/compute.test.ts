...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 25.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 27.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 37.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 25.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 27.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 37.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 37.0 } },
];

describe("fuel-playoffs-consistency", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "throughput")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-consistency");
...
describe("fuel-playoffs-consistency-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { throughput: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { throughput: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { throughput: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { throughput: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { throughput: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { throughput: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "throughput")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("fuel-playoffs-consistency-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statThroughput(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesThroughput(rows, "frc9").length).toBe(0);
...
describe("fuel-playoffs-consistency-lovat", () => {
