...
describe("fuel-playoffs-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-context");
...
describe("fuel-playoffs-context-deep", () => {
...
describe("fuel-playoffs-context-wide", () => {
...
describe("fuel-playoffs-context-lovat", () => {
