...
describe("fuel-playoffs-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-draft");
...
describe("fuel-playoffs-draft-deep", () => {
...
describe("fuel-playoffs-draft-wide", () => {
...
describe("fuel-playoffs-draft-lovat", () => {
