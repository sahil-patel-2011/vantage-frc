...
describe("fuel-playoffs-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-ewma");
...
describe("fuel-playoffs-ewma-deep", () => {
...
describe("fuel-playoffs-ewma-wide", () => {
...
describe("fuel-playoffs-ewma-lovat", () => {
