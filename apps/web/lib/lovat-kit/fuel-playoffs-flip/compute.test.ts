...
describe("fuel-playoffs-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-flip");
...
describe("fuel-playoffs-flip-deep", () => {
...
describe("fuel-playoffs-flip-wide", () => {
...
describe("fuel-playoffs-flip-lovat", () => {
