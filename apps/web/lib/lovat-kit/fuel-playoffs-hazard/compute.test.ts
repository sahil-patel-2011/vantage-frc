...
describe("fuel-playoffs-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-hazard");
...
describe("fuel-playoffs-hazard-deep", () => {
...
describe("fuel-playoffs-hazard-wide", () => {
...
describe("fuel-playoffs-hazard-lovat", () => {
