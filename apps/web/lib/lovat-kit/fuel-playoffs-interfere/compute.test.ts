...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 11.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 23.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 39.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 23.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 39.0 } },
];

describe("fuel-playoffs-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-interfere");
...
describe("fuel-playoffs-interfere-deep", () => {
...
describe("fuel-playoffs-interfere-wide", () => {
...
describe("fuel-playoffs-interfere-lovat", () => {
