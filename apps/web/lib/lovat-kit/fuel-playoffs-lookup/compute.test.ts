...
describe("fuel-playoffs-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-lookup");
...
describe("fuel-playoffs-lookup-deep", () => {
...
describe("fuel-playoffs-lookup-wide", () => {
...
describe("fuel-playoffs-lookup-lovat", () => {
