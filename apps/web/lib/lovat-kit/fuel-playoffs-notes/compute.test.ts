...
describe("fuel-playoffs-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-notes");
...
describe("fuel-playoffs-notes-deep", () => {
...
describe("fuel-playoffs-notes-wide", () => {
...
describe("fuel-playoffs-notes-lovat", () => {
