...
describe("fuel-playoffs-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-pareto");
...
describe("fuel-playoffs-pareto-deep", () => {
...
describe("fuel-playoffs-pareto-wide", () => {
...
describe("fuel-playoffs-pareto-lovat", () => {
