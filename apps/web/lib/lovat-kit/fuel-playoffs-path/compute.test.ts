...
describe("fuel-playoffs-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-path");
...
describe("fuel-playoffs-path-deep", () => {
...
describe("fuel-playoffs-path-wide", () => {
...
describe("fuel-playoffs-path-lovat", () => {
