...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 22.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 34.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 38.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 22.0 } },
...
describe("fuel-playoffs-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-picklist");
...
describe("fuel-playoffs-picklist-deep", () => {
...
describe("fuel-playoffs-picklist-wide", () => {
...
describe("fuel-playoffs-picklist-lovat", () => {
