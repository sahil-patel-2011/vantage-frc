...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 27.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 34.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 47.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 47.0 } },
];

describe("fuel-playoffs-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-playhead");
...
describe("fuel-playoffs-playhead-deep", () => {
...
describe("fuel-playoffs-playhead-wide", () => {
...
describe("fuel-playoffs-playhead-lovat", () => {
