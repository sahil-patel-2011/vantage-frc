...
describe("fuel-playoffs-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-rate");
...
describe("fuel-playoffs-rate-deep", () => {
...
describe("fuel-playoffs-rate-wide", () => {
...
describe("fuel-playoffs-rate-lovat", () => {
