...
describe("fuel-playoffs-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-residual");
...
describe("fuel-playoffs-residual-deep", () => {
...
describe("fuel-playoffs-residual-wide", () => {
...
describe("fuel-playoffs-residual-lovat", () => {
