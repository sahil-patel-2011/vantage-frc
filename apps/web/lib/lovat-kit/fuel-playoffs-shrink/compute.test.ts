...
describe("fuel-playoffs-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-shrink");
...
describe("fuel-playoffs-shrink-deep", () => {
...
describe("fuel-playoffs-shrink-wide", () => {
...
describe("fuel-playoffs-shrink-lovat", () => {
