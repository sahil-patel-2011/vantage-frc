...
describe("fuel-playoffs-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-source");
...
describe("fuel-playoffs-source-deep", () => {
...
describe("fuel-playoffs-source-wide", () => {
...
describe("fuel-playoffs-source-lovat", () => {
