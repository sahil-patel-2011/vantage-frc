...
describe("fuel-playoffs-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-streak");
...
describe("fuel-playoffs-streak-deep", () => {
...
describe("fuel-playoffs-streak-wide", () => {
...
describe("fuel-playoffs-streak-lovat", () => {
