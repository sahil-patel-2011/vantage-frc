...
describe("fuel-playoffs-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-timeline");
...
describe("fuel-playoffs-timeline-deep", () => {
...
describe("fuel-playoffs-timeline-wide", () => {
...
describe("fuel-playoffs-timeline-lovat", () => {
