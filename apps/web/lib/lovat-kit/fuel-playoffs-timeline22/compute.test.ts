...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 16.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 33.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 40.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 16.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 40.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 40.0 } },
];

describe("fuel-playoffs-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-timeline22");
...
describe("fuel-playoffs-timeline22-deep", () => {
...
describe("fuel-playoffs-timeline22-wide", () => {
...
describe("fuel-playoffs-timeline22-lovat", () => {
