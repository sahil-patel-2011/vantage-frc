...
describe("fuel-playoffs-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-trimmed");
...
describe("fuel-playoffs-trimmed-deep", () => {
...
describe("fuel-playoffs-trimmed-wide", () => {
...
describe("fuel-playoffs-trimmed-lovat", () => {
