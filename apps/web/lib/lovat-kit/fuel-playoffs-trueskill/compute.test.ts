...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { throughput: 32.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 36.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 20.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 36.0 } },
];

describe("fuel-playoffs-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-trueskill");
...
describe("fuel-playoffs-trueskill-deep", () => {
...
describe("fuel-playoffs-trueskill-wide", () => {
...
describe("fuel-playoffs-trueskill-lovat", () => {
