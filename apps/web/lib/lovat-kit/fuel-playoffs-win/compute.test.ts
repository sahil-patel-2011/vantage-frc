...
describe("fuel-playoffs-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-win");
...
describe("fuel-playoffs-win-deep", () => {
...
describe("fuel-playoffs-win-wide", () => {
...
describe("fuel-playoffs-win-lovat", () => {
