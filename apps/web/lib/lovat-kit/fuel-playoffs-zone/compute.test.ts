...
describe("fuel-playoffs-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-zone");
...
describe("fuel-playoffs-zone-deep", () => {
...
describe("fuel-playoffs-zone-wide", () => {
...
describe("fuel-playoffs-zone-lovat", () => {
