...
describe("fuel-playoffs-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-playoffs-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-playoffs-zscore");
...
describe("fuel-playoffs-zscore-deep", () => {
...
describe("fuel-playoffs-zscore-wide", () => {
...
describe("fuel-playoffs-zscore-lovat", () => {
