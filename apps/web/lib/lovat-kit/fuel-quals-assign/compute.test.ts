...
describe("fuel-quals-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-assign");
...
describe("fuel-quals-assign-deep", () => {
...
describe("fuel-quals-assign-wide", () => {
...
describe("fuel-quals-assign-lovat", () => {
