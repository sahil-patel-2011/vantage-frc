...
describe("fuel-quals-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-brier");
...
describe("fuel-quals-brier-deep", () => {
...
describe("fuel-quals-brier-wide", () => {
...
describe("fuel-quals-brier-lovat", () => {
