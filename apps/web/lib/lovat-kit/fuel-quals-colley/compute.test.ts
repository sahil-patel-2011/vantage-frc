...
describe("fuel-quals-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-colley");
...
describe("fuel-quals-colley-deep", () => {
...
describe("fuel-quals-colley-wide", () => {
...
describe("fuel-quals-colley-lovat", () => {
