...
describe("fuel-quals-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-combo");
...
describe("fuel-quals-combo-deep", () => {
...
describe("fuel-quals-combo-wide", () => {
...
describe("fuel-quals-combo-lovat", () => {
