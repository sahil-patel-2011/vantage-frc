...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { throughput: 45.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 25.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 45.0 } },
];

describe("fuel-quals-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-consistency");
...
describe("fuel-quals-consistency-deep", () => {
...
describe("fuel-quals-consistency-wide", () => {
...
describe("fuel-quals-consistency-lovat", () => {
