...
describe("fuel-quals-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-context");
...
describe("fuel-quals-context-deep", () => {
...
describe("fuel-quals-context-wide", () => {
...
describe("fuel-quals-context-lovat", () => {
