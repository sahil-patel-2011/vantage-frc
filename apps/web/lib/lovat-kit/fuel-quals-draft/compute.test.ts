...
describe("fuel-quals-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-draft");
...
describe("fuel-quals-draft-deep", () => {
...
describe("fuel-quals-draft-wide", () => {
...
describe("fuel-quals-draft-lovat", () => {
