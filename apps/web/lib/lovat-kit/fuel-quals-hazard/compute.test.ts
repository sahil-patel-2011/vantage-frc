...
describe("fuel-quals-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-hazard");
...
describe("fuel-quals-hazard-deep", () => {
...
describe("fuel-quals-hazard-wide", () => {
...
describe("fuel-quals-hazard-lovat", () => {
