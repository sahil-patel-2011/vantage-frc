...
describe("fuel-quals-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-interfere");
...
describe("fuel-quals-interfere-deep", () => {
...
describe("fuel-quals-interfere-wide", () => {
...
describe("fuel-quals-interfere-lovat", () => {
