...
describe("fuel-quals-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-notes");
...
describe("fuel-quals-notes-deep", () => {
...
describe("fuel-quals-notes-wide", () => {
...
describe("fuel-quals-notes-lovat", () => {
