...
describe("fuel-quals-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-pareto");
...
describe("fuel-quals-pareto-deep", () => {
...
describe("fuel-quals-pareto-wide", () => {
...
describe("fuel-quals-pareto-lovat", () => {
