...
describe("fuel-quals-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-playhead");
...
describe("fuel-quals-playhead-deep", () => {
...
describe("fuel-quals-playhead-wide", () => {
...
describe("fuel-quals-playhead-lovat", () => {
