...
describe("fuel-quals-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-residual");
...
describe("fuel-quals-residual-deep", () => {
...
describe("fuel-quals-residual-wide", () => {
...
describe("fuel-quals-residual-lovat", () => {
