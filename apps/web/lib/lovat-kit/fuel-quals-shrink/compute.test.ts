...
describe("fuel-quals-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-shrink");
...
describe("fuel-quals-shrink-deep", () => {
...
describe("fuel-quals-shrink-wide", () => {
...
describe("fuel-quals-shrink-lovat", () => {
