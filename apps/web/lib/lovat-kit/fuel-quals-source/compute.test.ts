...
describe("fuel-quals-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-source");
...
describe("fuel-quals-source-deep", () => {
...
describe("fuel-quals-source-wide", () => {
...
describe("fuel-quals-source-lovat", () => {
