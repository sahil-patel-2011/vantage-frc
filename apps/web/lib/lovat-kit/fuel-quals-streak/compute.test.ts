...
describe("fuel-quals-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-streak");
...
describe("fuel-quals-streak-deep", () => {
...
describe("fuel-quals-streak-wide", () => {
...
describe("fuel-quals-streak-lovat", () => {
