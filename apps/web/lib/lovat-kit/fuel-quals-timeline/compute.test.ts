...
describe("fuel-quals-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-timeline");
...
describe("fuel-quals-timeline-deep", () => {
...
describe("fuel-quals-timeline-wide", () => {
...
describe("fuel-quals-timeline-lovat", () => {
