...
describe("fuel-quals-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-timeline22");
...
describe("fuel-quals-timeline22-deep", () => {
...
describe("fuel-quals-timeline22-wide", () => {
...
describe("fuel-quals-timeline22-lovat", () => {
