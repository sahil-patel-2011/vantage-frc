...
describe("fuel-quals-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-trimmed");
...
describe("fuel-quals-trimmed-deep", () => {
...
describe("fuel-quals-trimmed-wide", () => {
...
describe("fuel-quals-trimmed-lovat", () => {
