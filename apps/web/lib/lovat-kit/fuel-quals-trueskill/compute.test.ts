...
describe("fuel-quals-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-trueskill");
...
describe("fuel-quals-trueskill-deep", () => {
...
describe("fuel-quals-trueskill-wide", () => {
...
describe("fuel-quals-trueskill-lovat", () => {
