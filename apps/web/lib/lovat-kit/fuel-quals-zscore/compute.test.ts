...
describe("fuel-quals-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-zscore");
...
describe("fuel-quals-zscore-deep", () => {
...
describe("fuel-quals-zscore-wide", () => {
...
describe("fuel-quals-zscore-lovat", () => {
