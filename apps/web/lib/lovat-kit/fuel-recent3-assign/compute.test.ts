...
describe("fuel-recent3-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-assign");
...
describe("fuel-recent3-assign-deep", () => {
...
describe("fuel-recent3-assign-wide", () => {
...
describe("fuel-recent3-assign-lovat", () => {
