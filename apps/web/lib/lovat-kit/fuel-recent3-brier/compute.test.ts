...
describe("fuel-recent3-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-brier");
...
describe("fuel-recent3-brier-deep", () => {
...
describe("fuel-recent3-brier-wide", () => {
...
describe("fuel-recent3-brier-lovat", () => {
