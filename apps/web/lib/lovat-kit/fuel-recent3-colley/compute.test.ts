...
describe("fuel-recent3-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-colley");
...
describe("fuel-recent3-colley-deep", () => {
...
describe("fuel-recent3-colley-wide", () => {
...
describe("fuel-recent3-colley-lovat", () => {
