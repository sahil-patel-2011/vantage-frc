...
describe("fuel-recent3-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-combo");
...
describe("fuel-recent3-combo-deep", () => {
...
describe("fuel-recent3-combo-wide", () => {
...
describe("fuel-recent3-combo-lovat", () => {
