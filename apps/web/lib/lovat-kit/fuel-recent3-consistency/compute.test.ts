...
describe("fuel-recent3-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-consistency");
...
describe("fuel-recent3-consistency-deep", () => {
...
describe("fuel-recent3-consistency-wide", () => {
...
describe("fuel-recent3-consistency-lovat", () => {
