...
describe("fuel-recent3-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-context");
...
describe("fuel-recent3-context-deep", () => {
...
describe("fuel-recent3-context-wide", () => {
...
describe("fuel-recent3-context-lovat", () => {
