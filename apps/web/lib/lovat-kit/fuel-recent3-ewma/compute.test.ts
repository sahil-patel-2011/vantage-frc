...
describe("fuel-recent3-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-ewma");
...
describe("fuel-recent3-ewma-deep", () => {
...
describe("fuel-recent3-ewma-wide", () => {
...
describe("fuel-recent3-ewma-lovat", () => {
