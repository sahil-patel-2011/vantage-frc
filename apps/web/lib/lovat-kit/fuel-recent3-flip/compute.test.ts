...
describe("fuel-recent3-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-flip");
...
describe("fuel-recent3-flip-deep", () => {
...
describe("fuel-recent3-flip-wide", () => {
...
describe("fuel-recent3-flip-lovat", () => {
