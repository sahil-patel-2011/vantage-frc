...
describe("fuel-recent3-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-hazard");
...
describe("fuel-recent3-hazard-deep", () => {
...
describe("fuel-recent3-hazard-wide", () => {
...
describe("fuel-recent3-hazard-lovat", () => {
