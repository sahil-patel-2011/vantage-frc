...
describe("fuel-recent3-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-interfere");
...
describe("fuel-recent3-interfere-deep", () => {
...
describe("fuel-recent3-interfere-wide", () => {
...
describe("fuel-recent3-interfere-lovat", () => {
