...
describe("fuel-recent3-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-lookup");
...
describe("fuel-recent3-lookup-deep", () => {
...
describe("fuel-recent3-lookup-wide", () => {
...
describe("fuel-recent3-lookup-lovat", () => {
