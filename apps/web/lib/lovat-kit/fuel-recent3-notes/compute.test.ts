...
describe("fuel-recent3-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-notes");
...
describe("fuel-recent3-notes-deep", () => {
...
describe("fuel-recent3-notes-wide", () => {
...
describe("fuel-recent3-notes-lovat", () => {
