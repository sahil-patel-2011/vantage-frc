...
describe("fuel-recent3-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-pareto");
...
describe("fuel-recent3-pareto-deep", () => {
...
describe("fuel-recent3-pareto-wide", () => {
...
describe("fuel-recent3-pareto-lovat", () => {
