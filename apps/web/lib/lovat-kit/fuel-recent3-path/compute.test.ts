...
describe("fuel-recent3-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-path");
...
describe("fuel-recent3-path-deep", () => {
...
describe("fuel-recent3-path-wide", () => {
...
describe("fuel-recent3-path-lovat", () => {
