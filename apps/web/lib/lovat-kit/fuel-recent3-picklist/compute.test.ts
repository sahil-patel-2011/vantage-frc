...
describe("fuel-recent3-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-picklist");
...
describe("fuel-recent3-picklist-deep", () => {
...
describe("fuel-recent3-picklist-wide", () => {
...
describe("fuel-recent3-picklist-lovat", () => {
