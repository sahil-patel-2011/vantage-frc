...
describe("fuel-recent3-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-playhead");
...
describe("fuel-recent3-playhead-deep", () => {
...
describe("fuel-recent3-playhead-wide", () => {
...
describe("fuel-recent3-playhead-lovat", () => {
