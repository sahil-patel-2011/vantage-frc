...
describe("fuel-recent3-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-rank");
...
describe("fuel-recent3-rank-deep", () => {
...
describe("fuel-recent3-rank-wide", () => {
...
describe("fuel-recent3-rank-lovat", () => {
