...
describe("fuel-recent3-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-rate");
...
describe("fuel-recent3-rate-deep", () => {
...
describe("fuel-recent3-rate-wide", () => {
...
describe("fuel-recent3-rate-lovat", () => {
