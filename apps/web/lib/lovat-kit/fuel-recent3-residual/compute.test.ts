...
describe("fuel-recent3-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-residual");
...
describe("fuel-recent3-residual-deep", () => {
...
describe("fuel-recent3-residual-wide", () => {
...
describe("fuel-recent3-residual-lovat", () => {
