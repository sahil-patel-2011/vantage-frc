...
describe("fuel-recent3-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-shrink");
...
describe("fuel-recent3-shrink-deep", () => {
...
describe("fuel-recent3-shrink-wide", () => {
...
describe("fuel-recent3-shrink-lovat", () => {
