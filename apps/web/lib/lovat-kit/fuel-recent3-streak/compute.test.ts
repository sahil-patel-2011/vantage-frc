...
describe("fuel-recent3-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-streak");
...
describe("fuel-recent3-streak-deep", () => {
...
describe("fuel-recent3-streak-wide", () => {
...
describe("fuel-recent3-streak-lovat", () => {
