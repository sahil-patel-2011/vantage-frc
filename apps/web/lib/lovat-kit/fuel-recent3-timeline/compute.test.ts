...
describe("fuel-recent3-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-timeline");
...
describe("fuel-recent3-timeline-deep", () => {
...
describe("fuel-recent3-timeline-wide", () => {
...
describe("fuel-recent3-timeline-lovat", () => {
