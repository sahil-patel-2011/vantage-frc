...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 12.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 34.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 44.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 12.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { throughput: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { throughput: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { throughput: 44.0 } },
];

describe("fuel-recent3-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-timeline22");
...
describe("fuel-recent3-timeline22-deep", () => {
...
describe("fuel-recent3-timeline22-wide", () => {
...
describe("fuel-recent3-timeline22-lovat", () => {
