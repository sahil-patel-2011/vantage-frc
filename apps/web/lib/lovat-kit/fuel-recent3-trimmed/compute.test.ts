...
describe("fuel-recent3-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-trimmed");
...
describe("fuel-recent3-trimmed-deep", () => {
...
describe("fuel-recent3-trimmed-wide", () => {
...
describe("fuel-recent3-trimmed-lovat", () => {
