...
describe("fuel-recent3-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-trueskill");
...
describe("fuel-recent3-trueskill-deep", () => {
...
describe("fuel-recent3-trueskill-wide", () => {
...
describe("fuel-recent3-trueskill-lovat", () => {
