...
describe("fuel-recent3-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-win");
...
describe("fuel-recent3-win-deep", () => {
...
describe("fuel-recent3-win-wide", () => {
...
describe("fuel-recent3-win-lovat", () => {
