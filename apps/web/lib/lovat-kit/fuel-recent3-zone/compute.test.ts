...
describe("fuel-recent3-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-zone");
...
describe("fuel-recent3-zone-deep", () => {
...
describe("fuel-recent3-zone-wide", () => {
...
describe("fuel-recent3-zone-lovat", () => {
