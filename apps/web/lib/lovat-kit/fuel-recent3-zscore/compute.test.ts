...
describe("fuel-recent3-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-recent3-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-recent3-zscore");
...
describe("fuel-recent3-zscore-deep", () => {
...
describe("fuel-recent3-zscore-wide", () => {
...
describe("fuel-recent3-zscore-lovat", () => {
