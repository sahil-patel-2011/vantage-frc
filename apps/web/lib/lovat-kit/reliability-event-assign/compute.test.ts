...
describe("reliability-event-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-assign");
...
describe("reliability-event-assign-deep", () => {
...
describe("reliability-event-assign-wide", () => {
...
describe("reliability-event-assign-lovat", () => {
