...
describe("reliability-event-brier", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-brier");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-brier");
...
describe("reliability-event-brier-deep", () => {
...
describe("reliability-event-brier-wide", () => {
...
describe("reliability-event-brier-lovat", () => {
