...
describe("reliability-event-colley", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-colley");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-colley");
...
describe("reliability-event-colley-deep", () => {
...
describe("reliability-event-colley-wide", () => {
...
describe("reliability-event-colley-lovat", () => {
