...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 13.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 20.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 45.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 13.0 } },
...
describe("reliability-event-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-combo");
...
describe("reliability-event-combo-deep", () => {
...
describe("reliability-event-combo-wide", () => {
...
describe("reliability-event-combo-lovat", () => {
