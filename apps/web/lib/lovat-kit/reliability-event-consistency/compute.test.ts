...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 19.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 21.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 43.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 19.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 21.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 43.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 43.0 } },
];

describe("reliability-event-consistency", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-consistency");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-consistency");
...
describe("reliability-event-consistency-deep", () => {
...
describe("reliability-event-consistency-wide", () => {
...
describe("reliability-event-consistency-lovat", () => {
