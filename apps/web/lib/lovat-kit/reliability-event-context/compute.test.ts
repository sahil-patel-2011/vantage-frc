...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 20.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 32.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 36.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 20.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 36.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 36.0 } },
];

describe("reliability-event-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-context");
...
describe("reliability-event-context-deep", () => {
...
describe("reliability-event-context-wide", () => {
...
describe("reliability-event-context-lovat", () => {
