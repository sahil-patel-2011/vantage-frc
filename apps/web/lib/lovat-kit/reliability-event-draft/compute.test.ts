...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 24.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 31.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 44.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 24.0 } },
...
describe("reliability-event-draft", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-draft");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-draft");
...
describe("reliability-event-draft-deep", () => {
...
describe("reliability-event-draft-wide", () => {
...
describe("reliability-event-draft-lovat", () => {
