...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 14.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 31.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 38.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 14.0 } },
...
describe("reliability-event-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-flip");
...
describe("reliability-event-flip-deep", () => {
...
describe("reliability-event-flip-wide", () => {
...
describe("reliability-event-flip-lovat", () => {
