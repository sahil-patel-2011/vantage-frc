...
describe("reliability-event-hazard", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-hazard");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-hazard");
...
describe("reliability-event-hazard-deep", () => {
...
describe("reliability-event-hazard-wide", () => {
...
describe("reliability-event-hazard-lovat", () => {
