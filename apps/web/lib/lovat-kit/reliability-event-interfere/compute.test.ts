...
describe("reliability-event-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-interfere");
...
describe("reliability-event-interfere-deep", () => {
...
describe("reliability-event-interfere-wide", () => {
...
describe("reliability-event-interfere-lovat", () => {
