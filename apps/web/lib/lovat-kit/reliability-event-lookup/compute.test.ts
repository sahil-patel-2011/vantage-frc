...
describe("reliability-event-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-lookup");
...
describe("reliability-event-lookup-deep", () => {
...
describe("reliability-event-lookup-wide", () => {
...
describe("reliability-event-lookup-lovat", () => {
