...
describe("reliability-event-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-notes");
...
describe("reliability-event-notes-deep", () => {
...
describe("reliability-event-notes-wide", () => {
...
describe("reliability-event-notes-lovat", () => {
