...
describe("reliability-event-pareto", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-pareto");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-pareto");
...
describe("reliability-event-pareto-deep", () => {
...
describe("reliability-event-pareto-wide", () => {
...
describe("reliability-event-pareto-lovat", () => {
