...
describe("reliability-event-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-path");
...
describe("reliability-event-path-deep", () => {
...
describe("reliability-event-path-wide", () => {
...
describe("reliability-event-path-lovat", () => {
