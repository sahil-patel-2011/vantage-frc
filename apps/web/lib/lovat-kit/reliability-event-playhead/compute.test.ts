...
describe("reliability-event-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-playhead");
...
describe("reliability-event-playhead-deep", () => {
...
describe("reliability-event-playhead-wide", () => {
...
describe("reliability-event-playhead-lovat", () => {
