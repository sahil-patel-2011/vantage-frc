...
describe("reliability-event-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-rank");
...
describe("reliability-event-rank-deep", () => {
...
describe("reliability-event-rank-wide", () => {
...
describe("reliability-event-rank-lovat", () => {
