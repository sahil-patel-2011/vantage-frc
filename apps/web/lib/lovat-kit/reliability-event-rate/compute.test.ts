...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 15.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 22.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 47.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 15.0 } },
...
describe("reliability-event-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-rate");
...
describe("reliability-event-rate-deep", () => {
...
describe("reliability-event-rate-wide", () => {
...
describe("reliability-event-rate-lovat", () => {
