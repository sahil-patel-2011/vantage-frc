...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 22.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 24.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 46.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 22.0 } },
...
describe("reliability-event-residual", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-residual");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-residual");
...
describe("reliability-event-residual-deep", () => {
...
describe("reliability-event-residual-wide", () => {
...
describe("reliability-event-residual-lovat", () => {
