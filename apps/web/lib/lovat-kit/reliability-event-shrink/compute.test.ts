...
describe("reliability-event-shrink", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-shrink");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-shrink");
...
describe("reliability-event-shrink-deep", () => {
...
describe("reliability-event-shrink-wide", () => {
...
describe("reliability-event-shrink-lovat", () => {
