...
describe("reliability-event-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-source");
...
describe("reliability-event-source-deep", () => {
...
describe("reliability-event-source-wide", () => {
...
describe("reliability-event-source-lovat", () => {
