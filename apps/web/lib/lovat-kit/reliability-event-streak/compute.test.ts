...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { uptime: 39.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 23.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 39.0 } },
];

describe("reliability-event-streak", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-streak");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-streak");
...
describe("reliability-event-streak-deep", () => {
...
describe("reliability-event-streak-wide", () => {
...
describe("reliability-event-streak-lovat", () => {
