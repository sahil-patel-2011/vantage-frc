...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { uptime: 42.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 23.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 42.0 } },
];

describe("reliability-event-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-timeline");
...
describe("reliability-event-timeline-deep", () => {
...
describe("reliability-event-timeline-wide", () => {
...
describe("reliability-event-timeline-lovat", () => {
