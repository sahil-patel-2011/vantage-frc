...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 26.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 28.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 38.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 28.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 38.0 } },
];

describe("reliability-event-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-timeline22");
...
describe("reliability-event-timeline22-deep", () => {
...
describe("reliability-event-timeline22-wide", () => {
...
describe("reliability-event-timeline22-lovat", () => {
