...
describe("reliability-event-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-trimmed");
...
describe("reliability-event-trimmed-deep", () => {
...
describe("reliability-event-trimmed-wide", () => {
...
describe("reliability-event-trimmed-lovat", () => {
