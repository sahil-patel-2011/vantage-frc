...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { uptime: 33.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 46.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 26.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 46.0 } },
];

describe("reliability-event-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-trueskill");
...
describe("reliability-event-trueskill-deep", () => {
...
describe("reliability-event-trueskill-wide", () => {
...
describe("reliability-event-trueskill-lovat", () => {
