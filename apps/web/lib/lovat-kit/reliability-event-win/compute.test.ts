...
describe("reliability-event-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-win");
...
describe("reliability-event-win-deep", () => {
...
describe("reliability-event-win-wide", () => {
...
describe("reliability-event-win-lovat", () => {
