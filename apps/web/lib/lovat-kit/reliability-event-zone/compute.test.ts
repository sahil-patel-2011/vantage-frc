...
describe("reliability-event-zone", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-zone");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-zone");
...
describe("reliability-event-zone-deep", () => {
...
describe("reliability-event-zone-wide", () => {
...
describe("reliability-event-zone-lovat", () => {
