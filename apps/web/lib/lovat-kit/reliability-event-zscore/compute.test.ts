...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 25.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 22.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 41.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 25.0 } },
...
describe("reliability-event-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-event-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-event-zscore");
...
describe("reliability-event-zscore-deep", () => {
...
describe("reliability-event-zscore-wide", () => {
...
describe("reliability-event-zscore-lovat", () => {
