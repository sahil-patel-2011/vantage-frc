...
describe("reliability-last6-combo", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-combo");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-combo");
...
describe("reliability-last6-combo-deep", () => {
...
describe("reliability-last6-combo-wide", () => {
...
describe("reliability-last6-combo-lovat", () => {
