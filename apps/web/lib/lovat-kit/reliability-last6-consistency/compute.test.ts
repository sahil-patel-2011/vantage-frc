...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 17.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 29.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 45.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 17.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 29.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { uptime: 45.0 } },
];

describe("reliability-last6-consistency", () => {
  ...
  it("windows and own-filter never invent rows", () => {
    ...
    expect(teamValue(rows, "frc3", "uptime")).not.toBeNull();
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-consistency");
...
describe("reliability-last6-consistency-deep", () => {
  ...
  it("builds a deep report without inventing ratings", () => {
    const rows = [
      { teamKey: "frc1", matchKey: "qm1", qual: true, values: { uptime: 10 } },
      { teamKey: "frc2", matchKey: "qm1", qual: true, values: { uptime: 14 } },
      { teamKey: "frc3", matchKey: "qm2", qual: true, values: { uptime: 18 } },
      { teamKey: "frc1", matchKey: "qm3", qual: true, values: { uptime: 11 } },
      { teamKey: "frc2", matchKey: "qm3", qual: true, values: { uptime: 15 } },
      { teamKey: "frc3", matchKey: "qm3", qual: true, values: { uptime: 20 } },
      { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 12 } },
      { teamKey: "frc2", matchKey: "sf1", qual: false, values: { uptime: 16 } },
      { teamKey: "frc3", matchKey: "sf1", qual: false, values: { uptime: 21 } },
    ];
    ...
    expect(counterfactualSwap(rows, ["frc1", "frc2"], "frc2", "frc3", "uptime")).not.toBeNull();
    expect(noticeableFocus().length).toBeGreaterThan(10);
  });
});


describe("reliability-last6-consistency-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statUptime(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesUptime(rows, "frc9").length).toBe(0);
...
describe("reliability-last6-consistency-lovat", () => {
