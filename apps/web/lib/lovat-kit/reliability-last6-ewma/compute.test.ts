...
describe("reliability-last6-ewma", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-ewma");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-ewma");
...
describe("reliability-last6-ewma-deep", () => {
...
describe("reliability-last6-ewma-wide", () => {
...
describe("reliability-last6-ewma-lovat", () => {
