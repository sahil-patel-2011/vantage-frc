...
describe("reliability-last6-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-interfere");
...
describe("reliability-last6-interfere-deep", () => {
...
describe("reliability-last6-interfere-wide", () => {
...
describe("reliability-last6-interfere-lovat", () => {
