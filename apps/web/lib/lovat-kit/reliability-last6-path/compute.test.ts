...
describe("reliability-last6-path", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-path");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-path");
...
describe("reliability-last6-path-deep", () => {
...
describe("reliability-last6-path-wide", () => {
...
describe("reliability-last6-path-lovat", () => {
