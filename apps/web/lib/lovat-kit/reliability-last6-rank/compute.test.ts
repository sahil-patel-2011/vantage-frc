...
describe("reliability-last6-rank", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-rank");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-rank");
...
describe("reliability-last6-rank-deep", () => {
...
describe("reliability-last6-rank-wide", () => {
...
describe("reliability-last6-rank-lovat", () => {
