...
describe("reliability-last6-rate", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-rate");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-rate");
...
describe("reliability-last6-rate-deep", () => {
...
describe("reliability-last6-rate-wide", () => {
...
describe("reliability-last6-rate-lovat", () => {
