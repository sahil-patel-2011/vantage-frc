...
const rows = [
  { teamKey: "frc1", qual: true, values: { uptime: 16.0 } },
  { teamKey: "frc2", qual: true, values: { uptime: 33.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 40.0 } },
  { teamKey: "frc3", qual: true, values: { uptime: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { uptime: 16.0 } },
...
describe("reliability-last6-timeline", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-timeline");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-timeline");
...
describe("reliability-last6-timeline-deep", () => {
...
describe("reliability-last6-timeline-wide", () => {
...
describe("reliability-last6-timeline-lovat", () => {
