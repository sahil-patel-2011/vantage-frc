...
describe("reliability-last6-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-trimmed");
...
describe("reliability-last6-trimmed-deep", () => {
...
describe("reliability-last6-trimmed-wide", () => {
...
describe("reliability-last6-trimmed-lovat", () => {
