...
describe("reliability-last6-zscore", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("reliability-last6-zscore");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("reliability-last6-zscore");
...
describe("reliability-last6-zscore-deep", () => {
...
describe("reliability-last6-zscore-wide", () => {
...
describe("reliability-last6-zscore-lovat", () => {
