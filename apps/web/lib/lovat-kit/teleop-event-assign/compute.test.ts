...
describe("teleop-event-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-assign");
...
describe("teleop-event-assign-deep", () => {
...
describe("teleop-event-assign-wide", () => {
...
describe("teleop-event-assign-lovat", () => {
