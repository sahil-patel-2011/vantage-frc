...
describe("teleop-event-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-context");
...
describe("teleop-event-context-deep", () => {
...
describe("teleop-event-context-wide", () => {
...
describe("teleop-event-context-lovat", () => {
