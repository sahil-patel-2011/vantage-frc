...
describe("teleop-event-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-flip");
...
describe("teleop-event-flip-deep", () => {
...
describe("teleop-event-flip-wide", () => {
...
describe("teleop-event-flip-lovat", () => {
