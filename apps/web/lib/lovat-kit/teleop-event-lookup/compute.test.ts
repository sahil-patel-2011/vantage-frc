...
describe("teleop-event-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-lookup");
...
describe("teleop-event-lookup-deep", () => {
...
describe("teleop-event-lookup-wide", () => {
...
describe("teleop-event-lookup-lovat", () => {
