...
describe("teleop-event-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-notes");
...
describe("teleop-event-notes-deep", () => {
...
describe("teleop-event-notes-wide", () => {
...
describe("teleop-event-notes-lovat", () => {
