...
describe("teleop-event-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-playhead");
...
describe("teleop-event-playhead-deep", () => {
...
describe("teleop-event-playhead-wide", () => {
...
describe("teleop-event-playhead-lovat", () => {
