...
describe("teleop-event-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-source");
...
describe("teleop-event-source-deep", () => {
...
describe("teleop-event-source-wide", () => {
...
describe("teleop-event-source-lovat", () => {
