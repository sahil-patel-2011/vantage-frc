...
describe("teleop-event-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-timeline22");
...
describe("teleop-event-timeline22-deep", () => {
...
describe("teleop-event-timeline22-wide", () => {
...
describe("teleop-event-timeline22-lovat", () => {
