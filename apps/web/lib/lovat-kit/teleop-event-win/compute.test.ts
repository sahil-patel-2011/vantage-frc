...
describe("teleop-event-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-win");
...
describe("teleop-event-win-deep", () => {
...
describe("teleop-event-win-wide", () => {
...
describe("teleop-event-win-lovat", () => {
