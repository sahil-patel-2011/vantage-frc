...
describe("teleop-last12-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-assign");
...
describe("teleop-last12-assign-deep", () => {
...
describe("teleop-last12-assign-wide", () => {
...
describe("teleop-last12-assign-lovat", () => {
