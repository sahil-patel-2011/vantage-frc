...
describe("teleop-last12-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-context");
...
describe("teleop-last12-context-deep", () => {
...
describe("teleop-last12-context-wide", () => {
...
describe("teleop-last12-context-lovat", () => {
