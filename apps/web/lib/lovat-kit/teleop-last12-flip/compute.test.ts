...
describe("teleop-last12-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-flip");
...
describe("teleop-last12-flip-deep", () => {
...
describe("teleop-last12-flip-wide", () => {
...
describe("teleop-last12-flip-lovat", () => {
