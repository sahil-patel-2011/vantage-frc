...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 11.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 28.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 28.0 } },
...
describe("teleop-last12-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-lookup");
...
describe("teleop-last12-lookup-deep", () => {
...
describe("teleop-last12-lookup-wide", () => {
...
describe("teleop-last12-lookup-lovat", () => {
