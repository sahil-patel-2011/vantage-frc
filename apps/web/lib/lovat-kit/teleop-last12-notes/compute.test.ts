...
describe("teleop-last12-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-notes");
...
describe("teleop-last12-notes-deep", () => {
...
describe("teleop-last12-notes-wide", () => {
...
describe("teleop-last12-notes-lovat", () => {
