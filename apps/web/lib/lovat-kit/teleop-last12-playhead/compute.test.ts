...
const rows = [
  ...
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 20.0 } },
...
describe("teleop-last12-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-playhead");
...
describe("teleop-last12-playhead-deep", () => {
...
describe("teleop-last12-playhead-wide", () => {
...
describe("teleop-last12-playhead-lovat", () => {
