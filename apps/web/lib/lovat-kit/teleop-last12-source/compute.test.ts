...
describe("teleop-last12-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-source");
...
describe("teleop-last12-source-deep", () => {
...
describe("teleop-last12-source-wide", () => {
...
describe("teleop-last12-source-lovat", () => {
