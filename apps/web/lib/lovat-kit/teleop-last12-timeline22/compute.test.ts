...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { teleopPoints: 26.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 42.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 42.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 14.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 26.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 42.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 42.0 } },
];

describe("teleop-last12-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-timeline22");
...
describe("teleop-last12-timeline22-deep", () => {
...
describe("teleop-last12-timeline22-wide", () => {
...
describe("teleop-last12-timeline22-lovat", () => {
