...
describe("teleop-last12-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-win");
...
describe("teleop-last12-win-deep", () => {
...
describe("teleop-last12-win-wide", () => {
...
describe("teleop-last12-win-lovat", () => {
