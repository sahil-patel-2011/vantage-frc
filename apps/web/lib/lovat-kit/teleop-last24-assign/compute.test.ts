...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { teleopPoints: 32.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 39.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 39.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 15.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 32.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 39.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 39.0 } },
];

describe("teleop-last24-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-assign");
...
describe("teleop-last24-assign-deep", () => {
...
describe("teleop-last24-assign-wide", () => {
...
describe("teleop-last24-assign-lovat", () => {
