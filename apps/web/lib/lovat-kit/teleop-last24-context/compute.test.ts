...
describe("teleop-last24-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-context");
...
describe("teleop-last24-context-deep", () => {
...
describe("teleop-last24-context-wide", () => {
...
describe("teleop-last24-context-lovat", () => {
