...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 17.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 34.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 41.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 17.0 } },
...
describe("teleop-last24-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-flip");
...
describe("teleop-last24-flip-deep", () => {
...
describe("teleop-last24-flip-wide", () => {
...
describe("teleop-last24-flip-lovat", () => {
