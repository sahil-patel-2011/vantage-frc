...
describe("teleop-last24-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-lookup");
...
describe("teleop-last24-lookup-deep", () => {
...
describe("teleop-last24-lookup-wide", () => {
...
describe("teleop-last24-lookup-lovat", () => {
