...
describe("teleop-last24-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-notes");
...
describe("teleop-last24-notes-deep", () => {
...
describe("teleop-last24-notes-wide", () => {
...
describe("teleop-last24-notes-lovat", () => {
