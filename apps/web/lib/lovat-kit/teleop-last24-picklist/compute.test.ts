...
describe("teleop-last24-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-picklist");
...
describe("teleop-last24-picklist-deep", () => {
...
describe("teleop-last24-picklist-wide", () => {
...
describe("teleop-last24-picklist-lovat", () => {
