...
describe("teleop-last24-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-playhead");
...
describe("teleop-last24-playhead-deep", () => {
...
describe("teleop-last24-playhead-wide", () => {
...
describe("teleop-last24-playhead-lovat", () => {
