...
describe("teleop-last24-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-source");
...
describe("teleop-last24-source-deep", () => {
...
describe("teleop-last24-source-wide", () => {
...
describe("teleop-last24-source-lovat", () => {
