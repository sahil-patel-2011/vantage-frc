...
describe("teleop-last24-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last24-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last24-win");
...
describe("teleop-last24-win-deep", () => {
...
describe("teleop-last24-win-wide", () => {
...
describe("teleop-last24-win-lovat", () => {
