...
describe("teleop-last4-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-assign");
...
describe("teleop-last4-assign-deep", () => {
...
describe("teleop-last4-assign-wide", () => {
...
describe("teleop-last4-assign-lovat", () => {
