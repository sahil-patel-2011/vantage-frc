...
describe("teleop-last4-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-context");
...
describe("teleop-last4-context-deep", () => {
...
describe("teleop-last4-context-wide", () => {
...
describe("teleop-last4-context-lovat", () => {
