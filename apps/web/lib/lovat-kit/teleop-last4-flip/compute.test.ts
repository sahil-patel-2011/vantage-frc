...
describe("teleop-last4-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-flip");
...
describe("teleop-last4-flip-deep", () => {
...
describe("teleop-last4-flip-wide", () => {
...
describe("teleop-last4-flip-lovat", () => {
