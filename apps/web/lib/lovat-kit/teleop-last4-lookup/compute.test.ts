...
describe("teleop-last4-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-lookup");
...
describe("teleop-last4-lookup-deep", () => {
...
describe("teleop-last4-lookup-wide", () => {
...
describe("teleop-last4-lookup-lovat", () => {
