...
describe("teleop-last4-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-notes");
...
describe("teleop-last4-notes-deep", () => {
...
describe("teleop-last4-notes-wide", () => {
...
describe("teleop-last4-notes-lovat", () => {
