...
describe("teleop-last4-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-picklist");
...
describe("teleop-last4-picklist-deep", () => {
...
describe("teleop-last4-picklist-wide", () => {
...
describe("teleop-last4-picklist-lovat", () => {
