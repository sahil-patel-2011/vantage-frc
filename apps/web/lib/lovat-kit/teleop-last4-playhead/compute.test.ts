...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 10.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 22.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 38.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 22.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 38.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 38.0 } },
];

describe("teleop-last4-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-playhead");
...
describe("teleop-last4-playhead-deep", () => {
...
describe("teleop-last4-playhead-wide", () => {
...
describe("teleop-last4-playhead-lovat", () => {
