...
describe("teleop-last4-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-source");
...
describe("teleop-last4-source-deep", () => {
...
describe("teleop-last4-source-wide", () => {
...
describe("teleop-last4-source-lovat", () => {
