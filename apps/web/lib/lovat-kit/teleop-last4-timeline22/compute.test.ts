...
describe("teleop-last4-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-timeline22");
...
describe("teleop-last4-timeline22-deep", () => {
...
describe("teleop-last4-timeline22-wide", () => {
...
describe("teleop-last4-timeline22-lovat", () => {
