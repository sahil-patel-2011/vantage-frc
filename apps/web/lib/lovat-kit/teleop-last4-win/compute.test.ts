...
describe("teleop-last4-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last4-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last4-win");
...
describe("teleop-last4-win-deep", () => {
...
describe("teleop-last4-win-wide", () => {
...
describe("teleop-last4-win-lovat", () => {
