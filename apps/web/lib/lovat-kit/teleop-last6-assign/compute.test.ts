...
describe("teleop-last6-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-assign");
...
describe("teleop-last6-assign-deep", () => {
...
describe("teleop-last6-assign-wide", () => {
...
describe("teleop-last6-assign-lovat", () => {
