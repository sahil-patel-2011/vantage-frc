...
describe("teleop-last6-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-context");
...
describe("teleop-last6-context-deep", () => {
...
describe("teleop-last6-context-wide", () => {
...
describe("teleop-last6-context-lovat", () => {
