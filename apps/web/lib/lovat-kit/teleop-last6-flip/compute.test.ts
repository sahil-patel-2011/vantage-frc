...
describe("teleop-last6-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-flip");
...
describe("teleop-last6-flip-deep", () => {
...
describe("teleop-last6-flip-wide", () => {
...
describe("teleop-last6-flip-lovat", () => {
