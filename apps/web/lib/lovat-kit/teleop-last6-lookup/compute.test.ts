...
describe("teleop-last6-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-lookup");
...
describe("teleop-last6-lookup-deep", () => {
...
describe("teleop-last6-lookup-wide", () => {
...
describe("teleop-last6-lookup-lovat", () => {
