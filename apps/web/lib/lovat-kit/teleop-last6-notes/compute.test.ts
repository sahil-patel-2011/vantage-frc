...
describe("teleop-last6-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-notes");
...
describe("teleop-last6-notes-deep", () => {
...
describe("teleop-last6-notes-wide", () => {
...
describe("teleop-last6-notes-lovat", () => {
