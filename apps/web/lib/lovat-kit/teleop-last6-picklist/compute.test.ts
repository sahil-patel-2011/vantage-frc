...
describe("teleop-last6-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-picklist");
...
describe("teleop-last6-picklist-deep", () => {
...
describe("teleop-last6-picklist-wide", () => {
...
describe("teleop-last6-picklist-lovat", () => {
