...
describe("teleop-last6-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-playhead");
...
describe("teleop-last6-playhead-deep", () => {
...
describe("teleop-last6-playhead-wide", () => {
...
describe("teleop-last6-playhead-lovat", () => {
