...
describe("teleop-last6-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-source");
...
describe("teleop-last6-source-deep", () => {
...
describe("teleop-last6-source-wide", () => {
...
describe("teleop-last6-source-lovat", () => {
