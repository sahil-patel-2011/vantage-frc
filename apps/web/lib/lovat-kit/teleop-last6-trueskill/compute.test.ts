...
describe("teleop-last6-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-trueskill");
...
describe("teleop-last6-trueskill-deep", () => {
