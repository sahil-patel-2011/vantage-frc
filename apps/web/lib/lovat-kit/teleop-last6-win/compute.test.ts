...
describe("teleop-last6-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-win");
...
describe("teleop-last6-win-deep", () => {
...
describe("teleop-last6-win-wide", () => {
...
describe("teleop-last6-win-lovat", () => {
