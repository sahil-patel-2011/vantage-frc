...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 13.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 30.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 37.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 13.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 30.0 } },
...
describe("teleop-playoffs-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-assign");
...
describe("teleop-playoffs-assign-deep", () => {
...
describe("teleop-playoffs-assign-wide", () => {
...
describe("teleop-playoffs-assign-lovat", () => {
