...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 27.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 34.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 27.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 34.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 47.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 47.0 } },
];

describe("teleop-playoffs-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-context");
...
describe("teleop-playoffs-context-deep", () => {
...
describe("teleop-playoffs-context-wide", () => {
...
describe("teleop-playoffs-context-lovat", () => {
