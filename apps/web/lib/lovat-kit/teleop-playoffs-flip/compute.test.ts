...
describe("teleop-playoffs-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-flip");
...
describe("teleop-playoffs-flip-deep", () => {
...
describe("teleop-playoffs-flip-wide", () => {
...
describe("teleop-playoffs-flip-lovat", () => {
