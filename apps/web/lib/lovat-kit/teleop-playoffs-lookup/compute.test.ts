...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 22.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 24.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 46.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 46.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 22.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 24.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 46.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 46.0 } },
];

describe("teleop-playoffs-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-lookup");
...
describe("teleop-playoffs-lookup-deep", () => {
...
describe("teleop-playoffs-lookup-wide", () => {
...
describe("teleop-playoffs-lookup-lovat", () => {
