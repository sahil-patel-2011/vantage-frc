...
describe("teleop-playoffs-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-notes");
...
describe("teleop-playoffs-notes-deep", () => {
...
describe("teleop-playoffs-notes-wide", () => {
...
describe("teleop-playoffs-notes-lovat", () => {
