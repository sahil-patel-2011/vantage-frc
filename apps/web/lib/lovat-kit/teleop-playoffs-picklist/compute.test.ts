...
describe("teleop-playoffs-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-picklist");
...
describe("teleop-playoffs-picklist-deep", () => {
...
describe("teleop-playoffs-picklist-wide", () => {
...
describe("teleop-playoffs-picklist-lovat", () => {
