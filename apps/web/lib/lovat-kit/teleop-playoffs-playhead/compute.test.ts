...
describe("teleop-playoffs-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-playhead");
...
describe("teleop-playoffs-playhead-deep", () => {
...
describe("teleop-playoffs-playhead-wide", () => {
...
describe("teleop-playoffs-playhead-lovat", () => {
