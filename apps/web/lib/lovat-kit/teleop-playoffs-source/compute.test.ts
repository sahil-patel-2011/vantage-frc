...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 21.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 33.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 37.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 21.0 } },
...
describe("teleop-playoffs-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-source");
...
describe("teleop-playoffs-source-deep", () => {
...
describe("teleop-playoffs-source-wide", () => {
...
describe("teleop-playoffs-source-lovat", () => {
