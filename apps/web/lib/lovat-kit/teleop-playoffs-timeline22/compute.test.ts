...
const rows = [
  ...
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 23.0 } },
...
describe("teleop-playoffs-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-timeline22");
...
describe("teleop-playoffs-timeline22-deep", () => {
...
describe("teleop-playoffs-timeline22-wide", () => {
...
describe("teleop-playoffs-timeline22-lovat", () => {
