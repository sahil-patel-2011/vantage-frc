...
describe("teleop-playoffs-trimmed", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-trimmed");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-trimmed");
...
describe("teleop-playoffs-trimmed-deep", () => {
