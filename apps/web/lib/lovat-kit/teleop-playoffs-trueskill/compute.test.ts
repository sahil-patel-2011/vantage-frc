...
describe("teleop-playoffs-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-trueskill");
...
describe("teleop-playoffs-trueskill-deep", () => {
