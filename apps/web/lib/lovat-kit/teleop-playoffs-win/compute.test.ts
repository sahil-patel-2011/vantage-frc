...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 26.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 28.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 38.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 26.0 } },
...
describe("teleop-playoffs-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-playoffs-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-playoffs-win");
...
describe("teleop-playoffs-win-deep", () => {
...
describe("teleop-playoffs-win-wide", () => {
...
describe("teleop-playoffs-win-lovat", () => {
