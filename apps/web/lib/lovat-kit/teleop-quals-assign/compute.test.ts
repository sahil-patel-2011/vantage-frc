...
describe("teleop-quals-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-assign");
...
describe("teleop-quals-assign-deep", () => {
...
describe("teleop-quals-assign-wide", () => {
...
describe("teleop-quals-assign-lovat", () => {
