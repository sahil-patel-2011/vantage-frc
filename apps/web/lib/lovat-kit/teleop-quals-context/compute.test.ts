...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { teleopPoints: 45.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 45.0 } },
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 45.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 45.0 } },
];

describe("teleop-quals-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-context");
...
describe("teleop-quals-context-deep", () => {
...
describe("teleop-quals-context-wide", () => {
...
describe("teleop-quals-context-lovat", () => {
