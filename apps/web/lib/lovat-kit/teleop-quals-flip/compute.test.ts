...
describe("teleop-quals-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-flip");
...
describe("teleop-quals-flip-deep", () => {
...
describe("teleop-quals-flip-wide", () => {
...
describe("teleop-quals-flip-lovat", () => {
