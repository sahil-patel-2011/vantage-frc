...
describe("teleop-quals-interfere", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-interfere");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-interfere");
...
describe("teleop-quals-interfere-deep", () => {
