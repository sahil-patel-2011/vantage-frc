...
describe("teleop-quals-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-lookup");
...
describe("teleop-quals-lookup-deep", () => {
...
describe("teleop-quals-lookup-wide", () => {
...
describe("teleop-quals-lookup-lovat", () => {
