...
describe("teleop-quals-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-notes");
...
describe("teleop-quals-notes-deep", () => {
...
describe("teleop-quals-notes-wide", () => {
...
describe("teleop-quals-notes-lovat", () => {
