...
describe("teleop-quals-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-picklist");
...
describe("teleop-quals-picklist-deep", () => {
...
describe("teleop-quals-picklist-wide", () => {
...
describe("teleop-quals-picklist-lovat", () => {
