...
describe("teleop-quals-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-playhead");
...
describe("teleop-quals-playhead-deep", () => {
...
describe("teleop-quals-playhead-wide", () => {
...
describe("teleop-quals-playhead-lovat", () => {
