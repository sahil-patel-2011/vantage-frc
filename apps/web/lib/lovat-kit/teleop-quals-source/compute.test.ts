...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { teleopPoints: 33.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 43.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 11.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 33.0 } },
...
describe("teleop-quals-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-source");
...
describe("teleop-quals-source-deep", () => {
...
describe("teleop-quals-source-wide", () => {
...
describe("teleop-quals-source-lovat", () => {
