...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { teleopPoints: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 9.0 } },
...
describe("teleop-quals-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-timeline22");
...
describe("teleop-quals-timeline22-deep", () => {
...
describe("teleop-quals-timeline22-wide", () => {
...
describe("teleop-quals-timeline22-lovat", () => {
