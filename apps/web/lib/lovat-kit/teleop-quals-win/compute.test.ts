...
describe("teleop-quals-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-win");
...
describe("teleop-quals-win-deep", () => {
...
describe("teleop-quals-win-wide", () => {
...
describe("teleop-quals-win-lovat", () => {
