...
const rows = [
  ...
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 29.0 } },
...
describe("teleop-recent3-assign", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-assign");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-assign");
...
describe("teleop-recent3-assign-deep", () => {
...
describe("teleop-recent3-assign-wide", () => {
...
describe("teleop-recent3-assign-lovat", () => {
