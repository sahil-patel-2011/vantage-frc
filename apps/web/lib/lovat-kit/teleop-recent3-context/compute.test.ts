...
describe("teleop-recent3-context", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-context");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-context");
...
describe("teleop-recent3-context-deep", () => {
...
describe("teleop-recent3-context-wide", () => {
...
describe("teleop-recent3-context-lovat", () => {
