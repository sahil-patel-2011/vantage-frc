...
describe("teleop-recent3-flip", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-flip");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-flip");
...
describe("teleop-recent3-flip-deep", () => {
...
describe("teleop-recent3-flip-wide", () => {
...
describe("teleop-recent3-flip-lovat", () => {
