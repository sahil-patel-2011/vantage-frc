...
describe("teleop-recent3-lookup", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-lookup");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-lookup");
...
describe("teleop-recent3-lookup-deep", () => {
...
describe("teleop-recent3-lookup-wide", () => {
...
describe("teleop-recent3-lookup-lovat", () => {
