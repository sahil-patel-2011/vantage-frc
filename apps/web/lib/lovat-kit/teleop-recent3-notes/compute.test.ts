...
describe("teleop-recent3-notes", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-notes");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-notes");
...
describe("teleop-recent3-notes-deep", () => {
...
describe("teleop-recent3-notes-wide", () => {
...
describe("teleop-recent3-notes-lovat", () => {
