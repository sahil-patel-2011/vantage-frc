...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 15.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 22.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 15.0 } },
...
describe("teleop-recent3-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-picklist");
...
describe("teleop-recent3-picklist-deep", () => {
...
describe("teleop-recent3-picklist-wide", () => {
...
describe("teleop-recent3-picklist-lovat", () => {
