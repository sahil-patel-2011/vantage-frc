...
describe("teleop-recent3-playhead", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-playhead");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-playhead");
...
describe("teleop-recent3-playhead-deep", () => {
...
describe("teleop-recent3-playhead-wide", () => {
...
describe("teleop-recent3-playhead-lovat", () => {
