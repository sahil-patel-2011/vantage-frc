...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 23.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 25.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 47.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 23.0 } },
...
describe("teleop-recent3-source", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-source");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-source");
...
describe("teleop-recent3-source-deep", () => {
...
describe("teleop-recent3-source-wide", () => {
...
describe("teleop-recent3-source-lovat", () => {
