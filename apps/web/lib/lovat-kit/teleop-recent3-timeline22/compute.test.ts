...
const rows = [
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 37.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 37.0 } },
];

describe("teleop-recent3-timeline22", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-timeline22");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-timeline22");
...
describe("teleop-recent3-timeline22-deep", () => {
...
describe("teleop-recent3-timeline22-wide", () => {
...
describe("teleop-recent3-timeline22-lovat", () => {
