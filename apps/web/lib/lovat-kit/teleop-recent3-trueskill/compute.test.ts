...
describe("teleop-recent3-trueskill", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-trueskill");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-trueskill");
...
describe("teleop-recent3-trueskill-deep", () => {
