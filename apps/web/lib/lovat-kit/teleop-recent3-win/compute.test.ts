...
describe("teleop-recent3-win", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-recent3-win");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-recent3-win");
...
describe("teleop-recent3-win-deep", () => {
...
describe("teleop-recent3-win-wide", () => {
...
describe("teleop-recent3-win-lovat", () => {
