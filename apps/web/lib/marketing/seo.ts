  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: SITE_URL,
        description:
          "Invite-only FRC app: scouting, event day, strategy, alliance selection, season planning, CAD agent, Code Coach, and metered assistant. Screens stay empty until official matches, scout, or connector data exists.",
        offers: {
          "@type": "Offer",
          price: "0",
          priceCurrency: "USD",
