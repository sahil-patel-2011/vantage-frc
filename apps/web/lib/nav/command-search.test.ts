...
describe("this wave's tools are findable by the words teams type", () => {
  const cases: Array<[string, string]> = [
    ...
    ["grant calendar", "/business?tab=grant-calendar"],
    ["grant deadline", "/business?tab=grant-calendar"],
    ["invite the team", "/team?tab=getting-started"],
    ["who we are", "/team?tab=team-background"],
