...
export const PRODUCT_HUBS: ProductHubDef[] = [
  {
    ...
    tabs: [
      ...
      { id: "forms", label: "Form builder", legacyHref: "/scouting/forms", primary: false },
      { id: "match-checklist", label: "Match checklist", legacyHref: "/match-checklist", primary: false },
      { id: "pick-clock", label: "Pick clock", legacyHref: "/pick-clock", primary: false },
      { id: "chemistry", label: "Chemistry", legacyHref: "/chemistry", primary: false },
      ...
      {
        id: "team-tags",
        label: "Drive-team tags",
        legacyHref: "/team-tags",
        primary: false,
      },
  ...
  },
  {
    ...
    label: "Team",
    title: "Team",
    description: "Calendar, team chat, todos, and team ops.",
    defaultTab: "calendar",
    tabs: [
      { id: "calendar", label: "Calendar", legacyHref: "/team/calendar" },
      { id: "messages", label: "Team chat", legacyHref: "/messages" },
      ...
      { id: "knowledge", label: "Knowledge", legacyHref: "/team/knowledge", primary: false },
      { id: "hours", label: "Hours", legacyHref: "/hours", primary: false, featured: true },
      { id: "batteries", label: "Batteries", legacyHref: "/batteries", primary: false },
      { id: "fmea", label: "FMEA", legacyHref: "/fmea", primary: false },
  ...
  },
  {
    ...
    label: "Business",
    title: "Business",
    description: "Season finance, budget, sponsors, grants, and orders.",
    defaultTab: "overview",
    tabs: [
      ...
      { id: "media-kit", label: "Media Kit", legacyHref: "/media?tab=kit", primary: false },
      { id: "outreach-calendar", label: "Outreach Calendar", legacyHref: "/media?tab=calendar", primary: false },
      ...
      { id: "sponsor-wall", label: "Sponsor Wall", legacyHref: "/sponsor-wall", primary: false },
      {
        ...
        label: "Sponsor Renewal ROI",
        legacyHref: "/sponsor-renewal-roi",
        primary: false,
      },
      {
        id: "grant-eligibility-matcher",
        label: "Grant Eligibility Matcher",
        legacyHref: "/grant-eligibility-matcher",
        primary: false,
      },
      {
        id: "matching-gift-finder",
        label: "Matching Gift Finder",
        legacyHref: "/matching-gift-finder",
        primary: false,
      },
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: "robot", label: "Robot", legacyHref: "/robot", primary: false, featured: true },
      { id: "bugbot", label: "AI Bugbot", legacyHref: "/bugbot", primary: false, featured: true },
      { id: "fmea", label: "FMEA", legacyHref: "/fmea", primary: false },
      { id: "prototype", label: "Prototypes", legacyHref: "/prototype-tracker", primary: false },
      { id: "batteries", label: "Batteries", legacyHref: "/batteries", primary: false },
      ...
      { id: "cad-change-radar", label: "CAD Change Impact Radar", legacyHref: "/cad-change-radar", primary: false },
      ...
      { id: "bin-shelf-locator", label: "Bin/Shelf Locator", legacyHref: "/bin-shelf-locator", primary: false },
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: "code", label: "Code assist", legacyHref: "/code", primary: false },
      { id: "bugbot", label: "AI Bugbot", legacyHref: "/bugbot", primary: false },
      { id: "memory", label: "Memory", legacyHref: "/team/ai-memory", primary: false },
      { id: "governance", label: "Governance", legacyHref: "/team/ai-policy", primary: false },
      { id: "finance", label: "Finance" },
