...
export type HubTabDef = {
  ...
  featured?: boolean;
  /**
   * Heading this tool sits under once a workbench's tool strip is expanded.
   *
   * Only worth setting where a workbench carries enough tools that the open
   * strip reads as a wall of chips (Robot has 27, Strategy 25). Grouping the
   * expanded panel is presentation, not a third nav tier — the collapsed strip
   * and ⌘K are unchanged.
   */
  family?: string;
};
...
export const PRODUCT_HUBS: ProductHubDef[] = [
  {
    ...
    tabs: [
      ...
      ...nest("scouting", [
        ...
        { id: "scout-coverage-live", label: "Coverage", legacyHref: "/scout-coverage-live", family: "Run the crew" },
        { id: "shift-balancer", label: "Shifts", legacyHref: "/shift-balancer", family: "Run the crew" },
        { id: "scout-training-mode", label: "Training", legacyHref: "/scout-training-mode", family: "Run the crew" },
        { id: "scout-field-budget", label: "Field budget", legacyHref: "/scout-field-budget", family: "Run the crew" },
        { id: "scout-p2p-relay", label: "Pit mesh", legacyHref: "/scout-p2p-relay", family: "Sync & schema" },
        { id: "scout-schema-negotiate", label: "Schema sync", legacyHref: "/scout-schema-negotiate", family: "Sync & schema" },
        { id: "scouting-schema-ab", label: "Schema A/B", legacyHref: "/scouting-schema-ab", family: "Sync & schema" },
        { id: "scout-accuracy", label: "Accuracy", legacyHref: "/scout-accuracy", family: "Data quality" },
        { id: "scout-crossval", label: "Cross-check", legacyHref: "/scout-crossval", family: "Data quality" },
        { id: "scout-disagreements", label: "Disagreements", legacyHref: "/scout-disagreements", family: "Data quality" },
        { id: "data-quality-scorecard", label: "Data quality", legacyHref: "/data-quality-scorecard", family: "Data quality" },
        { id: "scout-data-impact", label: "Data impact", legacyHref: "/scout-data-impact", family: "Data quality" },
        { id: "scout-assisted-count", label: "Assisted count", legacyHref: "/scout-assisted-count", family: "Data quality" },
        { id: "scouting-heat-signals", label: "Heat signals", legacyHref: "/scouting-heat-signals", family: "Data quality" },
      ]),
      ...
      ...nest("strategy", [
        ...
        { id: "pick-clock", label: "Pick clock", legacyHref: "/pick-clock", family: "Alliance selection" },
        { id: "picklist-collab", label: "Pick list", legacyHref: "/picklist-collab", family: "Alliance selection" },
        { id: "picklist-justifier", label: "Justifier", legacyHref: "/picklist-justifier", family: "Alliance selection" },
        { id: "pairwise", label: "Pairwise", legacyHref: "/pairwise", family: "Alliance selection" },
        { id: "team-tags", label: "Drive-team tags", legacyHref: "/team-tags", family: "Alliance selection" },
        { id: "chemistry", label: "Chemistry", legacyHref: "/chemistry", family: "Alliance selection" },
        { id: "alliance-sim", label: "Alliance sim", legacyHref: "/alliance-sim", family: "Alliance selection" },
        { id: "alliance-partner-brief", label: "Partner brief", legacyHref: "/alliance-partner-brief", family: "Alliance selection" },
        { id: "match-strategy-cards", label: "Match cards", legacyHref: "/match-strategy-cards", family: "Per match" },
        // "Match copilot" was consolidated into the Pre-match briefing (Event day tab);
        // /match-copilot now redirects to /briefing.
        { id: "match-sim", label: "Match sim", legacyHref: "/match-sim", family: "Per match" },
        { id: "match-notes-timeline", label: "Match notes", legacyHref: "/match-notes-timeline", family: "Per match" },
        { id: "match-delta-watcher", label: "Match delta", legacyHref: "/match-delta-watcher", family: "Per match" },
        { id: "match-video-index", label: "Match video", legacyHref: "/match-video-index", family: "Per match" },
        { id: "video", label: "Video review", legacyHref: "/video", family: "Per match" },
        { id: "counter-book", label: "Counter-book", legacyHref: "/counter-book", family: "Opponents" },
        { id: "defense-planner", label: "Defense", legacyHref: "/defense-planner", family: "Opponents" },
        { id: "opponent-watchlist", label: "Watchlist", legacyHref: "/opponent-watchlist", family: "Opponents" },
        { id: "dossier", label: "Team dossier", legacyHref: "/dossier", family: "Opponents" },
        { id: "intel", label: "Intel", legacyHref: "/intel", family: "Opponents" },
        { id: "epa-trend-alerts", label: "EPA alerts", legacyHref: "/epa-trend-alerts", family: "Trends" },
        { id: "overnight-intel", label: "Overnight intel", legacyHref: "/overnight-intel", family: "Trends" },
        { id: "district-advancement", label: "Districts", legacyHref: "/district-advancement", family: "Trends" },
        { id: "ranking-projection", label: "Rank projection", legacyHref: "/ranking-projection", family: "Trends" },
      ]),
  ...
  },
  {
    ...
    tabs: [
      ...
      ...nest("attendance", [
        ...
        { id: "presence", label: "Presence", legacyHref: "/presence", family: "Hours & presence" },
        { id: "hours-self-view", label: "My hours", legacyHref: "/hours-self-view", family: "Hours & presence" },
        { id: "mentor-hours", label: "Mentor hours", legacyHref: "/mentor-hours", family: "Hours & presence" },
        { id: "my-kit", label: "My kit", legacyHref: "/my-kit", family: "Hours & presence" },
        { id: "onboarding-buddy", label: "Onboarding buddy", legacyHref: "/onboarding-buddy", family: "Growth" },
        { id: "alumni-network", label: "Alumni", legacyHref: "/alumni-network", family: "Growth" },
        { id: "skills-graph", label: "Skills", legacyHref: "/skills-graph", family: "Growth" },
        ...
        { id: "learning", label: "Learning", legacyHref: "/learning", family: "Growth" },
        { id: "training", label: "Training matrix", legacyHref: "/training", family: "Growth" },
        { id: "roles", label: "Season roles", legacyHref: "/roles", family: "Roster" },
        { id: "driver-tryouts", label: "Driver tryouts", legacyHref: "/driver-tryouts", family: "Roster" },
        { id: "exit-interview", label: "Exit interviews", legacyHref: "/exit-interview", family: "Roster" },
        ...
        { id: "parents", label: "Parents", legacyHref: "/parents", family: "Roster" },
      ]),
      { id: "todos", label: "Work", legacyHref: "/todos" },
      ...nest("todos", [
        { id: "practice", label: "Practice", legacyHref: "/practice", family: "Plan the week" },
        {
        ...
        { id: "goals-tracker", label: "Goals", legacyHref: "/goals-tracker", family: "Plan the week" },
        { id: "goals", label: "Objectives", legacyHref: "/goals", family: "Plan the week" },
        { id: "standup-digest", label: "Standup", legacyHref: "/standup-digest", family: "Plan the week" },
        { id: "meeting-autopilot", label: "Meeting agenda", legacyHref: "/meeting-autopilot", family: "Plan the week" },
        { id: "retro", label: "Retro", legacyHref: "/retro", family: "Plan the week" },
        { id: "batteries", label: "Batteries", legacyHref: "/batteries", family: "Shop" },
        { id: "fmea", label: "FMEA", legacyHref: "/fmea", family: "Shop" },
        { id: "tool-checkout", label: "Tool checkout", legacyHref: "/tool-checkout", family: "Shop" },
        { id: "equipment-maintenance", label: "Equipment", legacyHref: "/equipment-maintenance", family: "Shop" },
        { id: "safety-training", label: "Safety", legacyHref: "/safety-training", family: "Safety" },
        { id: "safety", label: "Safety log", legacyHref: "/safety", family: "Safety" },
        { id: "checklist-library", label: "Checklists", legacyHref: "/checklist-library", family: "Shop" },
        { id: "pit-map-planner", label: "Pit map", legacyHref: "/pit-map-planner", family: "Shop" },
        { id: "field-reset-timer", label: "Field reset", legacyHref: "/field-reset-timer", family: "Shop" },
      ]),
      ...
      ...nest("knowledge", [
        ...
        { id: "team-storage", label: "Storage node", legacyHref: "/team/storage", family: "Write it down" },
        ...
        { id: "knowledge-drafts", label: "Knowledge drafts", legacyHref: "/knowledge-drafts", family: "Write it down" },
        { id: "knowledge-gap", label: "Knowledge gaps", legacyHref: "/knowledge-gap", family: "Write it down" },
        { id: "notebook", label: "Engineering notebook", legacyHref: "/notebook", family: "Write it down" },
        { id: "object-chat-bridge", label: "Object chat", legacyHref: "/object-chat-bridge", family: "Write it down" },
        { id: "bus-factor", label: "Bus factor", legacyHref: "/bus-factor", family: "Team health" },
        { id: "team-health-dashboard", label: "Team health", legacyHref: "/team-health-dashboard", family: "Team health" },
        { id: "build-burndown", label: "Burndown", legacyHref: "/build-burndown", family: "Team health" },
        { id: "risk-burndown", label: "Risk burndown", legacyHref: "/risk-burndown", family: "Risk" },
        { id: "risks", label: "Risk register", legacyHref: "/risks", family: "Risk" },
        { id: "cross-team-scrim", label: "Scrims", legacyHref: "/cross-team-scrim", family: "Resilience" },
        { id: "offline-shell", label: "Offline", legacyHref: "/offline-shell", family: "Resilience" },
        { id: "degraded-mode", label: "Degraded mode", legacyHref: "/degraded-mode", family: "Resilience" },
      ]),
    ],
  },
  {
  ...
  },
  {
    ...
    tabs: [
      ...
      ...nest("fmea", [
        ...
        { id: "subsystems", label: "Subsystem specs", legacyHref: "/subsystems", family: "Design" },
        { id: "gearbox", label: "Gearbox calculator", legacyHref: "/gearbox", family: "Design" },
        { id: "shooter-table", label: "Shooter table", legacyHref: "/shooter-table", family: "Design" },
        { id: "weight-budget", label: "Weight budget", legacyHref: "/weight-budget", family: "Design" },
        { id: "power-budget", label: "Power budget", legacyHref: "/power-budget", family: "Design" },
        { id: "reviews", label: "Design reviews", legacyHref: "/reviews", family: "Design" },
        { id: "prototype", label: "Prototypes", legacyHref: "/prototype-tracker", family: "Build & tune" },
        { id: "bringup", label: "Bring-up", legacyHref: "/bringup", family: "Build & tune" },
        { id: "auton-path-library", label: "Auton paths", legacyHref: "/auton-path-library", family: "Build & tune" },
        { id: "tuning-autopilot", label: "Tuning advisor", legacyHref: "/tuning-autopilot", family: "Build & tune" },
        { id: "tuning-log", label: "Tuning log", legacyHref: "/tuning", family: "Build & tune" },
        { id: "batteries", label: "Batteries", legacyHref: "/batteries", family: "Reliability" },
        { id: "battery-health-forecast", label: "Pack health", legacyHref: "/battery-health-forecast", family: "Reliability" },
        { id: "wiring-diagnoser", label: "Wiring check", legacyHref: "/wiring-diagnoser", family: "Reliability" },
        { id: "wiring-map", label: "CAN-bus map", legacyHref: "/wiring", family: "Reliability" },
        { id: "failure-patterns", label: "Failure patterns", legacyHref: "/failure-patterns", family: "Reliability" },
        { id: "incident-heatmap", label: "Incidents", legacyHref: "/incident-heatmap", family: "Reliability" },
        { id: "inspection-copilot", label: "Inspection", legacyHref: "/inspection-copilot", family: "Inspection & rules" },
        { id: "robot-weigh-in", label: "Weigh-in", legacyHref: "/robot-weigh-in", family: "Inspection & rules" },
        { id: "readiness-score", label: "Readiness", legacyHref: "/readiness-score", family: "Inspection & rules" },
        { id: "rule-impact", label: "Rule impact", legacyHref: "/rule-impact", family: "Inspection & rules" },
        { id: "reuse-advisor", label: "Reuse", legacyHref: "/reuse-advisor", family: "Review" },
        { id: "budget-reconciler", label: "Budget check", legacyHref: "/budget-reconciler", family: "Review" },
        { id: "cross-domain-alerts", label: "Cross-domain", legacyHref: "/cross-domain-alerts", family: "Review" },
        { id: "decision-critic", label: "Decision critic", legacyHref: "/decision-critic", family: "Review" },
      ]),
