...
export const PRODUCT_NAV_GROUPS: ProductNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/sponsor-renewal-roi", label: "Sponsor Renewal ROI", icon: "clipboard" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/cad-change-radar", label: "CAD Change Impact Radar", icon: "cube" },
      ...
      { href: "/bin-shelf-locator", label: "Bin/Shelf Locator", icon: "cube" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/team/ai-usage", label: "BYOK usage", icon: "stats" },
