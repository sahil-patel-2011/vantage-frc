  ...
  switch (kind) {
    ...
    default:
      return {
        ...
        description:
          "Slots cite official hard metrics and your scout rows only.",
      };
  }
}
...
export function picklistJustifierNextActions(input: {
  ...
  if (slotCount === 0) {
    ...
    actions.push({
      ...
      detail: `${slotCount} slot${slotCount === 1 ? "" : "s"} ready — rationales cite the official record and your scout rows only.`,
