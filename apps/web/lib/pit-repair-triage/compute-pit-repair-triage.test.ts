...
describe("canDeletePitRepairReport", () => {
  it("lets the logger and an owner or admin delete, and keeps other members out", () => {
    expect(canDeletePitRepairReport({ role: "scout", userId: "noah", authorId: "noah" })).toBe(true);
    expect(canDeletePitRepairReport({ role: "scout", userId: "noah", authorId: "ada" })).toBe(false);
    expect(canDeletePitRepairReport({ role: "owner", userId: "ada", authorId: "noah" })).toBe(true);
    expect(canDeletePitRepairReport({ role: "admin", userId: "jamie", authorId: "noah" })).toBe(true);
    expect(canDeletePitRepairReport({ role: "viewer", userId: "sam", authorId: "sam" })).toBe(true);
    expect(canDeletePitRepairReport({ role: null, userId: null, authorId: "noah" })).toBe(false);
    expect(canDeletePitRepairReport({ role: "scout", userId: "noah", authorId: null })).toBe(false);
  });
});
