      ...
      return [
        {
          ...
          detail: "Choose your team before loading match rows.",
          href: "/workspace",
          primary: true,
        },
        {
    ...
    if (needsEvent) {
      return [
        ...
        },
        {
          id: "calendar",
          label: "Open Calendar",
          detail: "Team practices stay on Calendar while competition matches sync from Team Data.",
    ...
    return [
      {
        ...
        detail: "Matches appear after Team Data sync for the active event.",
        href: hubHref("/competition", "command", orgId),
        primary: true,
      },
      {
  ...
  return [
    {
      id: "my-day",
      label: "Open My Day",
      detail: "Countdowns and your next match use the same schedule rows.",
      href: hubHref("/competition", "my-day", orgId),
      primary: true,
    },
    {
