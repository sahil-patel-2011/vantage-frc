  ...
  switch (kind) {
    case "loading":
      return {
        ...
        description:
          "Checking which team you are on and officially verified scout rows.",
      };
    case "error":
      return {
        kind,
    ...
    case "setup":
      return {
        ...
        description:
          "Choose your team before officially verified ranks appear.",
      };
    case "empty":
      return {
        kind,
    ...
    return [
      {
        id: "scouting",
        label: "Open Scouting",
        detail: "Log match-scout entries so official totals can verify them.",
        href: hubHref("/competition", "scouting", orgId),
        primary: true,
      },
      {
    ...
    return [
      {
        ...
        detail: "Reload real officially verified ranks.",
  ...
  return [
    {
      ...
      detail:
        suggestedPromotions > 0
          ? "Confirm officially accurate scouts into the pick-desk conversation."
