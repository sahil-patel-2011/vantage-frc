  ...
  return [
    {
      ...
      detail: "Choose your team to open official cross-validation.",
    ...
    },
    {
      ...
      detail: "Official score breakdowns must be cached before fields can agree or conflict.",
    ...
    },
    {
      id: "accuracy",
      label: "Open Accuracy",
      detail: "Post-event ranks use the same officially verified totals.",
    ...
    if (!orgId) {
      return [
        ...
        },
        {
          id: "accuracy",
          label: "Open Accuracy",
          detail: "Ranks stay blank until officially verified totals exist.",
    ...
    return [
      {
        id: "scouting",
        label: "Open Scouting",
        detail: "Log match-scout entries so official totals can be compared.",
        href: hubHref("/competition", "scouting", orgId),
        primary: true,
      },
      {
        id: "command",
        label: "Sync event results",
        detail: "Confirm the active event so official score breakdowns can cache.",
        href: hubHref("/competition", "command", orgId),
      },
      {
        id: "coverage-live",
  ...
  if (input.shell === "empty") {
    return [
      ...
      },
      {
        id: "accuracy",
        label: "Open Accuracy",
        detail: "Leaderboard waits on the same real officially verified totals.",
        href: withOrgHref("/scout-accuracy", orgId),
      },
      {
        id: "command",
        label: "Sync event results",
        detail: "Official score breakdowns must be cached before fields verify.",
        href: hubHref("/competition", "command", orgId),
      },
    ];
  }
