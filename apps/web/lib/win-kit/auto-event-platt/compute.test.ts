...
describe("auto-event-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-platt");
...
describe("auto-event-platt-deep", () => {
...
describe("auto-event-platt-wide", () => {
...
describe("auto-event-platt-lovat", () => {
