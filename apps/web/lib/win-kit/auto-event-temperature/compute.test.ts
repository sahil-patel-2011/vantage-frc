...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { autoPoints: 36.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 16.0 } },
...
describe("auto-event-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-event-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-event-temperature");
...
describe("auto-event-temperature-deep", () => {
...
describe("auto-event-temperature-wide", () => {
...
describe("auto-event-temperature-lovat", () => {
