...
describe("auto-last12-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-corr");
...
describe("auto-last12-corr-deep", () => {
...
describe("auto-last12-corr-wide", () => {
...
describe("auto-last12-corr-lovat", () => {
