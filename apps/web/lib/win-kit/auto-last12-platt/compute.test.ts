...
describe("auto-last12-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-platt");
...
describe("auto-last12-platt-deep", () => {
...
describe("auto-last12-platt-wide", () => {
...
describe("auto-last12-platt-lovat", () => {
