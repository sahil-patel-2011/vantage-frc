...
describe("auto-last12-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last12-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last12-temperature");
...
describe("auto-last12-temperature-deep", () => {
...
describe("auto-last12-temperature-wide", () => {
...
describe("auto-last12-temperature-lovat", () => {
