...
const rows = [
  { teamKey: "frc1", qual: true, values: { autoPoints: 17.0 } },
  { teamKey: "frc2", qual: true, values: { autoPoints: 29.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 45.0 } },
  { teamKey: "frc3", qual: true, values: { autoPoints: 45.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { autoPoints: 17.0 } },
...
describe("auto-last6-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-picklist");
...
describe("auto-last6-picklist-deep", () => {
...
describe("auto-last6-picklist-wide", () => {
...
describe("auto-last6-picklist-lovat", () => {
