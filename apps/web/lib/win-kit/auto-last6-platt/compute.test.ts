...
describe("auto-last6-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-platt");
...
describe("auto-last6-platt-deep", () => {
...
describe("auto-last6-platt-wide", () => {
...
describe("auto-last6-platt-lovat", () => {
