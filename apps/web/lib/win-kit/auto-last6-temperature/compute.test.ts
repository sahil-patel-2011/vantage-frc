...
describe("auto-last6-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-last6-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-last6-temperature");
...
describe("auto-last6-temperature-deep", () => {
...
describe("auto-last6-temperature-wide", () => {
...
describe("auto-last6-temperature-lovat", () => {
