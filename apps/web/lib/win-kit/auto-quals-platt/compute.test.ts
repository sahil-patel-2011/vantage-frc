...
describe("auto-quals-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-platt");
...
describe("auto-quals-platt-deep", () => {
...
describe("auto-quals-platt-wide", () => {
...
describe("auto-quals-platt-lovat", () => {
