...
describe("auto-quals-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("auto-quals-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("auto-quals-temperature");
...
describe("auto-quals-temperature-deep", () => {
...
describe("auto-quals-temperature-wide", () => {
...
describe("auto-quals-temperature-lovat", () => {
