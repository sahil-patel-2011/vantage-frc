...
describe("defense-event-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-corr");
...
describe("defense-event-corr-deep", () => {
...
describe("defense-event-corr-wide", () => {
...
describe("defense-event-corr-lovat", () => {
