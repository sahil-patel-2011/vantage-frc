...
describe("defense-event-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-phi");
...
describe("defense-event-phi-deep", () => {
...
describe("defense-event-phi-wide", () => {
...
describe("defense-event-phi-lovat", () => {
