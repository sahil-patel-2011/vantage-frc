...
describe("defense-event-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-platt");
...
describe("defense-event-platt-deep", () => {
...
describe("defense-event-platt-wide", () => {
...
describe("defense-event-platt-lovat", () => {
