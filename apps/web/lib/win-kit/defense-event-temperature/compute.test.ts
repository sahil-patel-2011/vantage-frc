...
describe("defense-event-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-event-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-event-temperature");
...
describe("defense-event-temperature-deep", () => {
...
describe("defense-event-temperature-wide", () => {
...
describe("defense-event-temperature-lovat", () => {
