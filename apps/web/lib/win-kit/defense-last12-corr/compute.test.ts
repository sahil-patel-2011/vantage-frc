...
describe("defense-last12-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-corr");
...
describe("defense-last12-corr-deep", () => {
...
describe("defense-last12-corr-wide", () => {
...
describe("defense-last12-corr-lovat", () => {
