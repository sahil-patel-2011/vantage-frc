...
describe("defense-last12-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-phi");
...
describe("defense-last12-phi-deep", () => {
...
describe("defense-last12-phi-wide", () => {
...
describe("defense-last12-phi-lovat", () => {
