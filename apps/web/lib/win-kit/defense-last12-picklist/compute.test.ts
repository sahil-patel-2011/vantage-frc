...
describe("defense-last12-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-picklist");
...
describe("defense-last12-picklist-deep", () => {
...
describe("defense-last12-picklist-wide", () => {
...
describe("defense-last12-picklist-lovat", () => {
