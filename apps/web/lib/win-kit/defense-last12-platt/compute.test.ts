...
describe("defense-last12-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-platt");
...
describe("defense-last12-platt-deep", () => {
...
describe("defense-last12-platt-wide", () => {
...
describe("defense-last12-platt-lovat", () => {
