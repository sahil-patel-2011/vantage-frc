...
describe("defense-last12-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last12-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last12-temperature");
...
describe("defense-last12-temperature-deep", () => {
...
describe("defense-last12-temperature-wide", () => {
...
describe("defense-last12-temperature-lovat", () => {
