...
describe("defense-last6-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-corr");
...
describe("defense-last6-corr-deep", () => {
...
describe("defense-last6-corr-wide", () => {
...
describe("defense-last6-corr-lovat", () => {
