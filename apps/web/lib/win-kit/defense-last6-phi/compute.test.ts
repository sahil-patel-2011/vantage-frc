...
describe("defense-last6-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-phi");
...
describe("defense-last6-phi-deep", () => {
...
describe("defense-last6-phi-wide", () => {
...
describe("defense-last6-phi-lovat", () => {
