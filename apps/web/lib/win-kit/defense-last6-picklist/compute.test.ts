...
describe("defense-last6-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-picklist");
...
describe("defense-last6-picklist-deep", () => {
...
describe("defense-last6-picklist-wide", () => {
...
describe("defense-last6-picklist-lovat", () => {
