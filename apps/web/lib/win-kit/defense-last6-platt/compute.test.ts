...
describe("defense-last6-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-platt");
...
describe("defense-last6-platt-deep", () => {
...
describe("defense-last6-platt-wide", () => {
...
describe("defense-last6-platt-lovat", () => {
