...
describe("defense-last6-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-last6-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-last6-temperature");
...
describe("defense-last6-temperature-deep", () => {
...
describe("defense-last6-temperature-wide", () => {
...
describe("defense-last6-temperature-lovat", () => {
