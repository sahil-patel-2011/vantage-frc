...
describe("defense-quals-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-corr");
...
describe("defense-quals-corr-deep", () => {
...
describe("defense-quals-corr-wide", () => {
...
describe("defense-quals-corr-lovat", () => {
