...
describe("defense-quals-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-phi");
...
describe("defense-quals-phi-deep", () => {
...
describe("defense-quals-phi-wide", () => {
...
describe("defense-quals-phi-lovat", () => {
