...
describe("defense-quals-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-platt");
...
describe("defense-quals-platt-deep", () => {
...
describe("defense-quals-platt-wide", () => {
...
describe("defense-quals-platt-lovat", () => {
