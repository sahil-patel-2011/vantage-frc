...
const rows = [
  ...
  { teamKey: "frc2", qual: true, values: { defenseTime: 33.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 37.0 } },
  { teamKey: "frc3", qual: true, values: { defenseTime: 37.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { defenseTime: 21.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { defenseTime: 33.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { defenseTime: 37.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { defenseTime: 37.0 } },
];

describe("defense-quals-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("defense-quals-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("defense-quals-temperature");
...
describe("defense-quals-temperature-deep", () => {
...
describe("defense-quals-temperature-wide", () => {
...
describe("defense-quals-temperature-lovat", () => {
