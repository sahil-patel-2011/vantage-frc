...
describe("driver-event-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-corr");
...
describe("driver-event-corr-deep", () => {
...
describe("driver-event-corr-wide", () => {
...
describe("driver-event-corr-lovat", () => {
