...
describe("driver-event-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("driver-event-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("driver-event-phi");
...
describe("driver-event-phi-deep", () => {
...
describe("driver-event-phi-wide", () => {
...
describe("driver-event-phi-lovat", () => {
