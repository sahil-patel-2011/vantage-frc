...
describe("endgame-event-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-corr");
...
describe("endgame-event-corr-deep", () => {
...
describe("endgame-event-corr-wide", () => {
...
describe("endgame-event-corr-lovat", () => {
