...
describe("endgame-event-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-phi");
...
describe("endgame-event-phi-deep", () => {
...
describe("endgame-event-phi-wide", () => {
...
describe("endgame-event-phi-lovat", () => {
