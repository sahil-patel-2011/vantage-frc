...
describe("endgame-event-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-picklist");
...
describe("endgame-event-picklist-deep", () => {
...
describe("endgame-event-picklist-wide", () => {
...
describe("endgame-event-picklist-lovat", () => {
