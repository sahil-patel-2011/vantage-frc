...
describe("endgame-event-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-platt");
...
describe("endgame-event-platt-deep", () => {
...
describe("endgame-event-platt-wide", () => {
...
describe("endgame-event-platt-lovat", () => {
