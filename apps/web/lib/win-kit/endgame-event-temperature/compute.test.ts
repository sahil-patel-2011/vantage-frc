...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 10.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 22.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 38.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 10.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { endgameClimb: 22.0 } },
...
describe("endgame-event-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-event-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-event-temperature");
...
describe("endgame-event-temperature-deep", () => {
...
describe("endgame-event-temperature-wide", () => {
...
describe("endgame-event-temperature-lovat", () => {
