...
describe("endgame-last12-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-corr");
...
describe("endgame-last12-corr-deep", () => {
...
describe("endgame-last12-corr-wide", () => {
...
describe("endgame-last12-corr-lovat", () => {
