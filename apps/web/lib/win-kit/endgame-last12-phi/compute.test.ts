...
describe("endgame-last12-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-phi");
...
describe("endgame-last12-phi-deep", () => {
...
describe("endgame-last12-phi-wide", () => {
...
describe("endgame-last12-phi-lovat", () => {
