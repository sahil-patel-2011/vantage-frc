...
describe("endgame-last12-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-picklist");
...
describe("endgame-last12-picklist-deep", () => {
...
describe("endgame-last12-picklist-wide", () => {
...
describe("endgame-last12-picklist-lovat", () => {
