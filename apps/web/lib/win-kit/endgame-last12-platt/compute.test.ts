...
describe("endgame-last12-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-platt");
...
describe("endgame-last12-platt-deep", () => {
...
describe("endgame-last12-platt-wide", () => {
...
describe("endgame-last12-platt-lovat", () => {
