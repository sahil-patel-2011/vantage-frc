...
const rows = [
  { teamKey: "frc1", qual: true, values: { endgameClimb: 27.0 } },
  { teamKey: "frc2", qual: true, values: { endgameClimb: 24.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 43.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 43.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { endgameClimb: 27.0 } },
...
describe("endgame-last12-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last12-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last12-temperature");
...
describe("endgame-last12-temperature-deep", () => {
...
describe("endgame-last12-temperature-wide", () => {
...
describe("endgame-last12-temperature-lovat", () => {
