...
describe("endgame-last6-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-corr");
...
describe("endgame-last6-corr-deep", () => {
...
describe("endgame-last6-corr-wide", () => {
...
describe("endgame-last6-corr-lovat", () => {
