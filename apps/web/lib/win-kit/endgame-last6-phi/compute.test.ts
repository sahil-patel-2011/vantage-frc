...
describe("endgame-last6-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-phi");
...
describe("endgame-last6-phi-deep", () => {
...
describe("endgame-last6-phi-wide", () => {
...
describe("endgame-last6-phi-lovat", () => {
