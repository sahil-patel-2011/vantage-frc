...
describe("endgame-last6-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-picklist");
...
describe("endgame-last6-picklist-deep", () => {
...
describe("endgame-last6-picklist-wide", () => {
...
describe("endgame-last6-picklist-lovat", () => {
