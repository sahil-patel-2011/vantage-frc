...
describe("endgame-last6-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-platt");
...
describe("endgame-last6-platt-deep", () => {
...
describe("endgame-last6-platt-wide", () => {
...
describe("endgame-last6-platt-lovat", () => {
