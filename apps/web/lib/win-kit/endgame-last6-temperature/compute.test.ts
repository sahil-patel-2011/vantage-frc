...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { endgameClimb: 44.0 } },
  { teamKey: "frc3", qual: true, values: { endgameClimb: 44.0 } },
  ...
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { endgameClimb: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { endgameClimb: 44.0 } },
];

describe("endgame-last6-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-last6-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-last6-temperature");
...
describe("endgame-last6-temperature-deep", () => {
...
describe("endgame-last6-temperature-wide", () => {
...
describe("endgame-last6-temperature-lovat", () => {
