...
describe("endgame-quals-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-corr");
...
describe("endgame-quals-corr-deep", () => {
...
describe("endgame-quals-corr-wide", () => {
...
describe("endgame-quals-corr-lovat", () => {
