...
describe("endgame-quals-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-phi");
...
describe("endgame-quals-phi-deep", () => {
...
describe("endgame-quals-phi-wide", () => {
...
describe("endgame-quals-phi-lovat", () => {
