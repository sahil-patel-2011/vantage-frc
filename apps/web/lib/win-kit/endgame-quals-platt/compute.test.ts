...
describe("endgame-quals-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-platt");
...
describe("endgame-quals-platt-deep", () => {
...
describe("endgame-quals-platt-wide", () => {
...
describe("endgame-quals-platt-lovat", () => {
