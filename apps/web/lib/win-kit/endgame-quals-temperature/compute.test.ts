...
describe("endgame-quals-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("endgame-quals-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("endgame-quals-temperature");
...
describe("endgame-quals-temperature-deep", () => {
...
describe("endgame-quals-temperature-wide", () => {
...
describe("endgame-quals-temperature-lovat", () => {
