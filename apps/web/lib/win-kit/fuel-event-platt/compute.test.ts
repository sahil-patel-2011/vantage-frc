...
describe("fuel-event-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-platt");
...
describe("fuel-event-platt-deep", () => {
...
describe("fuel-event-platt-wide", () => {
...
describe("fuel-event-platt-lovat", () => {
