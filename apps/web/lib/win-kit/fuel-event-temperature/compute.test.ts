...
describe("fuel-event-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-event-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-event-temperature");
...
describe("fuel-event-temperature-deep", () => {
...
describe("fuel-event-temperature-wide", () => {
...
describe("fuel-event-temperature-lovat", () => {
