...
describe("fuel-last12-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-corr");
...
describe("fuel-last12-corr-deep", () => {
...
describe("fuel-last12-corr-wide", () => {
...
describe("fuel-last12-corr-lovat", () => {
