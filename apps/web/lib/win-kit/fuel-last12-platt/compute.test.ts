...
describe("fuel-last12-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-platt");
...
describe("fuel-last12-platt-deep", () => {
...
describe("fuel-last12-platt-wide", () => {
...
describe("fuel-last12-platt-lovat", () => {
