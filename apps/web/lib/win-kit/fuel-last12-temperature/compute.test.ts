...
const rows = [
  { teamKey: "frc1", qual: true, values: { throughput: 20.0 } },
  { teamKey: "frc2", qual: true, values: { throughput: 27.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 40.0 } },
  { teamKey: "frc3", qual: true, values: { throughput: 40.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { throughput: 20.0 } },
...
describe("fuel-last12-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last12-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last12-temperature");
...
describe("fuel-last12-temperature-deep", () => {
...
describe("fuel-last12-temperature-wide", () => {
...
describe("fuel-last12-temperature-lovat", () => {
