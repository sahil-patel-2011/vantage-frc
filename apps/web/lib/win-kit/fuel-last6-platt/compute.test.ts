...
describe("fuel-last6-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-platt");
...
describe("fuel-last6-platt-deep", () => {
...
describe("fuel-last6-platt-wide", () => {
...
describe("fuel-last6-platt-lovat", () => {
