...
describe("fuel-last6-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-last6-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-last6-temperature");
...
describe("fuel-last6-temperature-deep", () => {
...
describe("fuel-last6-temperature-wide", () => {
...
describe("fuel-last6-temperature-lovat", () => {
