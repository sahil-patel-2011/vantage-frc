...
describe("fuel-quals-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-picklist");
...
describe("fuel-quals-picklist-deep", () => {
...
describe("fuel-quals-picklist-wide", () => {
...
describe("fuel-quals-picklist-lovat", () => {
