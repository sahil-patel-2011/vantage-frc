...
describe("fuel-quals-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-platt");
...
describe("fuel-quals-platt-deep", () => {
...
describe("fuel-quals-platt-wide", () => {
...
describe("fuel-quals-platt-lovat", () => {
