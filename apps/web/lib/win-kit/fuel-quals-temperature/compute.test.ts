...
describe("fuel-quals-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("fuel-quals-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("fuel-quals-temperature");
...
describe("fuel-quals-temperature-deep", () => {
...
describe("fuel-quals-temperature-wide", () => {
...
describe("fuel-quals-temperature-lovat", () => {
