...
describe("teleop-event-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-corr");
...
describe("teleop-event-corr-deep", () => {
...
describe("teleop-event-corr-wide", () => {
...
describe("teleop-event-corr-lovat", () => {
