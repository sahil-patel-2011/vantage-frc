...
describe("teleop-event-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-phi");
...
describe("teleop-event-phi-deep", () => {
...
describe("teleop-event-phi-wide", () => {
...
describe("teleop-event-phi-lovat", () => {
