...
describe("teleop-event-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-picklist");
...
describe("teleop-event-picklist-deep", () => {
...
describe("teleop-event-picklist-wide", () => {
...
describe("teleop-event-picklist-lovat", () => {
