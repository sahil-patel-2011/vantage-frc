...
describe("teleop-event-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-platt");
...
describe("teleop-event-platt-deep", () => {
...
describe("teleop-event-platt-wide", () => {
...
describe("teleop-event-platt-lovat", () => {
