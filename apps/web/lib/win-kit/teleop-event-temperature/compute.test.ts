...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 8.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 25.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 44.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 8.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 25.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 44.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 44.0 } },
];

describe("teleop-event-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-event-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-event-temperature");
...
describe("teleop-event-temperature-deep", () => {
...
describe("teleop-event-temperature-wide", () => {
...
describe("teleop-event-temperature-lovat", () => {
