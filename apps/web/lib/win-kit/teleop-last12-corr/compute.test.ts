...
describe("teleop-last12-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-corr");
...
describe("teleop-last12-corr-deep", () => {
...
describe("teleop-last12-corr-wide", () => {
...
describe("teleop-last12-corr-lovat", () => {
