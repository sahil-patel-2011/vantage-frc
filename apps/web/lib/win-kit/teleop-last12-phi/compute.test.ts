...
describe("teleop-last12-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-phi");
...
describe("teleop-last12-phi-deep", () => {
...
describe("teleop-last12-phi-wide", () => {
...
describe("teleop-last12-phi-lovat", () => {
