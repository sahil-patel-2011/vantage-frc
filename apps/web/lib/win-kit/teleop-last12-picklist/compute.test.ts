...
const rows = [
  ...
  { teamKey: "frc3", qual: true, values: { teleopPoints: 44.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 16.0 } },
...
describe("teleop-last12-picklist", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-picklist");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-picklist");
...
describe("teleop-last12-picklist-deep", () => {
...
describe("teleop-last12-picklist-wide", () => {
...
describe("teleop-last12-picklist-lovat", () => {
