...
describe("teleop-last12-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-platt");
...
describe("teleop-last12-platt-deep", () => {
...
describe("teleop-last12-platt-wide", () => {
...
describe("teleop-last12-platt-lovat", () => {
