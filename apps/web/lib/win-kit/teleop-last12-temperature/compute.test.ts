...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 25.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 22.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 41.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 41.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 25.0 } },
  { teamKey: "frc2", matchKey: "sf1", qual: false, values: { teleopPoints: 22.0 } },
  { teamKey: "frc3", matchKey: "sf1", qual: false, values: { teleopPoints: 41.0 } },
  { teamKey: "frc3", matchKey: "sf2", qual: false, values: { teleopPoints: 41.0 } },
];

describe("teleop-last12-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last12-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last12-temperature");
...
describe("teleop-last12-temperature-deep", () => {
...
describe("teleop-last12-temperature-wide", () => {
  ...
  it("builds a wide report from real samples only", () => {
    ...
    expect(statTeleopPoints(rows, "frc3").n).toBeGreaterThan(0);
    expect(seriesTeleopPoints(rows, "frc9").length).toBe(0);
...
describe("teleop-last12-temperature-lovat", () => {
