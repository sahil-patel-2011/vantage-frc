...
const rows = [
  { teamKey: "frc1", qual: true, values: { teleopPoints: 14.0 } },
  { teamKey: "frc2", qual: true, values: { teleopPoints: 31.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 38.0 } },
  { teamKey: "frc3", qual: true, values: { teleopPoints: 38.0 } },
  { teamKey: "frc1", matchKey: "sf1", qual: false, values: { teleopPoints: 14.0 } },
...
describe("teleop-last6-corr", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-corr");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-corr");
...
describe("teleop-last6-corr-deep", () => {
...
describe("teleop-last6-corr-wide", () => {
...
describe("teleop-last6-corr-lovat", () => {
