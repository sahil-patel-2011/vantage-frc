...
describe("teleop-last6-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-phi");
...
describe("teleop-last6-phi-deep", () => {
...
describe("teleop-last6-phi-wide", () => {
...
describe("teleop-last6-phi-lovat", () => {
