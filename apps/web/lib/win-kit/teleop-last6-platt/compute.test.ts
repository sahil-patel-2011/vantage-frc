...
describe("teleop-last6-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-platt");
...
describe("teleop-last6-platt-deep", () => {
...
describe("teleop-last6-platt-wide", () => {
...
describe("teleop-last6-platt-lovat", () => {
