...
describe("teleop-last6-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-last6-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-last6-temperature");
...
describe("teleop-last6-temperature-deep", () => {
...
describe("teleop-last6-temperature-wide", () => {
...
describe("teleop-last6-temperature-lovat", () => {
