...
describe("teleop-quals-phi", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-phi");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-phi");
...
describe("teleop-quals-phi-deep", () => {
...
describe("teleop-quals-phi-wide", () => {
...
describe("teleop-quals-phi-lovat", () => {
