...
describe("teleop-quals-platt", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-platt");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-platt");
...
describe("teleop-quals-platt-deep", () => {
...
describe("teleop-quals-platt-wide", () => {
...
describe("teleop-quals-platt-lovat", () => {
