...
describe("teleop-quals-temperature", () => {
  it("does not invent a field average from one blank team", () => {
    ...
    expect(SLUG).toBe("teleop-quals-temperature");
  });
  ...
  it("builds a report without filling missing ratings", () => {
    ...
    expect(report.slug).toBe("teleop-quals-temperature");
...
describe("teleop-quals-temperature-deep", () => {
...
describe("teleop-quals-temperature-wide", () => {
...
describe("teleop-quals-temperature-lovat", () => {
