...
| `/team/ai-keys` | Hub shell was 1186 lines; chrome, provider cards, and the painted workbench now live in sibling modules. Shell is 485 lines. Mine / Team stay sections, not a nested TabBar. | this commit |
