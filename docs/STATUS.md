...
| `/team/admin` | Hub shell was 1094 lines; chrome, access requests, invites, GitHub, and leftover providers now live in sibling modules. Shell is 743 lines. No nested TabBar. | this commit |
