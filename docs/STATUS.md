...
| `/code` | Hub shell was 1838 lines; Bugbot/coach types and the painted workbench now live in sibling modules. Bugbot billing stays a `role="group"`, not a nested TabBar. | this commit |
