...
export const CAD_TOOL_CATALOG: readonly CadToolSpec[] = [
  ...
  },
  {
    ...
    group: "session",
    description:
      "Make a detailed Onshape Drawing first with controlling millimetres. Sketch and extrude then cast from those same sizes. Never invent dimensions.",
    params: [
      { name: "documentId", type: "string", description: "Document id; defaults to the bound document." },
      { name: "workspaceId", type: "string", description: "Workspace id; defaults to the bound workspace." },
      { name: "name", type: "string", required: true, description: "Name for the drawing tab." },
      mm("widthMm", "Controlling width in millimetres from the brief. Do not invent.", false),
      mm("heightMm", "Controlling height in millimetres from the brief. Do not invent.", false),
      mm("depthMm", "Controlling depth in millimetres from the brief. Do not invent.", false),
    ],
    onshape: "supported",
    fusion: "unsupported",
    fusionNote: "Fusion drawings stay in the local design; this hosted loop creates Onshape Drawing tabs.",
    mutating: true,
  },
  {
    ...
    group: "session",
    description:
      "Add named views (front, top, side, iso) to an Onshape Drawing tab so a person can read the part from more than one face.",
    params: [
      { name: "drawingElementId", type: "string", required: true, description: "Drawing tab id from onshape_create_drawing. Do not invent." },
      { name: "views", type: "array", required: true, description: "front, top, side, and/or iso.", items: { type: "string" } },
    ],
    onshape: "supported",
    fusion: "unsupported",
    fusionNote: "Fusion drawings stay in the local design.",
    mutating: true,
  },
  {
    name: "onshape_drawing_notes",
    label: "Drawing labels",
    group: "session",
    description:
      "Put notes and millimetre callouts on an Onshape Drawing. Only sizes from the brief. Never invent dimensions.",
    params: [
      { name: "drawingElementId", type: "string", required: true, description: "Drawing tab id from onshape_create_drawing. Do not invent." },
      { name: "notes", type: "array", description: "Plain-language notes a person can CAD from.", items: { type: "string" } },
      {
        name: "callouts",
        type: "array",
        description: "Labeled millimetres: { label, valueMm, view }. Do not invent valueMm.",
        items: { type: "object" },
      },
    ],
    onshape: "supported",
  ...
  {
    name: "onshape_drawing_pack",
    label: "Drawing pack",
    group: "session",
    description:
      "Plan one or more labeled drawings per part (front/top, side, holes when the brief has those sizes). Then create each sheet. Never invent millimetres.",
    params: [
      { name: "name", type: "string", required: true, description: "Part name for the drawing tabs." },
      mm("widthMm", "Controlling width in millimetres from the brief. Do not invent.", false),
      mm("heightMm", "Controlling height in millimetres from the brief. Do not invent.", false),
      mm("depthMm", "Controlling depth in millimetres from the brief. Do not invent.", false),
      { name: "briefSummary", type: "string", description: "Untrusted brief text. Used only to decide extra sheets, never to invent sizes." },
    ],
    onshape: "supported",
    fusion: "unsupported",
    fusionNote: "Fusion drawings stay in the local design.",
