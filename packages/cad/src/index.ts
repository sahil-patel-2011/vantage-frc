...
export * from "./ai-plan";
export * from "./drawing-first";
export * from "./drawing-pack";
...
export const CAD_OPERATIONS=["create_drawing","label_drawing","create_sketch","create_extrude","create_fillet","create_chamfer","create_shell","create_pattern","set_variable","create_part_studio","create_assembly","add_assembly_instance","create_mate","create_hole","create_mirror","create_revolve","create_boolean","delete_feature","feature_script","verify_topology","render_views","create_checkpoint","rollback_checkpoint","export_step","export_stl","export_gltf"] as const;
