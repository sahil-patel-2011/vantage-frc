...
CREATE INDEX driver_sessions_attendance_idx ON driver_sessions(attendance_event_id)
  WHERE attendance_event_id IS NOT NULL;
CREATE INDEX driver_sessions_task_idx ON driver_sessions(build_task_id)
