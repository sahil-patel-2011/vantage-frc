...
export function flipAllianceWin(pred: LovatWinPrediction): LovatWinPrediction {
  return {
    redPredicted: pred.bluePredicted,
    bluePredicted: pred.redPredicted,
    redWinPct: pred.blueWinPct,
    blueWinPct: pred.redWinPct,
    differentialMean: round4(-pred.differentialMean),
    differentialStd: pred.differentialStd,
  };
}
