...
echo "  vantage-cad doctor"
echo ""
echo "OS notes:"
echo "  macOS / Windows: Fusion 360 add-in supported (see install-fusion-addin.sh / .ps1)"
echo "  Linux: Fusion Autodesk app is unavailable — use install-linux-relay.sh, Onshape, or VANTAGE_CAD_MOCK=1"
echo "  Package: npm run cad:package:macos | cad:package:linux"
